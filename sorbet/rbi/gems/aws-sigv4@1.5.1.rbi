...
# source://aws-sigv4-1.5.1/lib/aws-sigv4/credentials.rb:3
module Aws
  class << self
...
# source://aws-sigv4-1.5.1/lib/aws-sigv4/credentials.rb:4
...
# @api private
#
# source://aws-sigv4-1.5.1/lib/aws-sigv4/credentials.rb:8
class Aws::Sigv4::Credentials
  ...
  #
  # source://aws-sigv4-1.5.1/lib/aws-sigv4/credentials.rb:13
  def initialize(options = T.unsafe(nil)); end

  # @api private
  # @return [String]
  #
  # source://aws-sigv4-1.5.1/lib/aws-sigv4/credentials.rb:25
  def access_key_id; end

  # @api private
  # @return [String]
  #
  # source://aws-sigv4-1.5.1/lib/aws-sigv4/credentials.rb:28
  def secret_access_key; end

  # @api private
  # @return [String, nil]
  #
  # source://aws-sigv4-1.5.1/lib/aws-sigv4/credentials.rb:31
  ...
  #
  # source://aws-sigv4-1.5.1/lib/aws-sigv4/credentials.rb:35
  def set?; end
end

# source://aws-sigv4-1.5.1/lib/aws-sigv4/errors.rb:5
module Aws::Sigv4::Errors; end

# source://aws-sigv4-1.5.1/lib/aws-sigv4/errors.rb:7
class Aws::Sigv4::Errors::MissingCredentialsError < ::ArgumentError
  ...
  #
  # source://aws-sigv4-1.5.1/lib/aws-sigv4/errors.rb:8
  def initialize(msg = T.unsafe(nil)); end
end

# source://aws-sigv4-1.5.1/lib/aws-sigv4/errors.rb:18
class Aws::Sigv4::Errors::MissingRegionError < ::ArgumentError
  # @return [MissingRegionError] a new instance of MissingRegionError
  #
  # source://aws-sigv4-1.5.1/lib/aws-sigv4/errors.rb:19
  def initialize(*args); end
end

# source://aws-sigv4-1.5.1/lib/aws-sigv4/signature.rb:5
class Aws::Sigv4::Signature
  # @api private
  # @return [Signature] a new instance of Signature
  #
  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signature.rb:8
  def initialize(options); end

  # @return [String] For debugging purposes.
  #
  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signature.rb:27
  ...
  # @return [String] For debugging purposes.
  #
  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signature.rb:33
  ...
  #
  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signature.rb:36
  def extra; end
  ...
  #   * 'authorization'
  #
  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signature.rb:24
  def headers; end
  ...
  # @return [String] For debugging purposes.
  #
  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signature.rb:30
...
# and `#session_token`.
#
# source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:75
class Aws::Sigv4::Signer
  ...
  #   * `#set?` => Boolean
  #
  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:177
  ...
  #
  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:402
  def presign_url(options); end

  # @return [String]
  #
  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:166
  def region; end

  # @return [String]
  #
  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:163
  def service; end
  ...
  #
  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:315
  ...
  #
  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:234
  ...
  #
  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:181
  def unsigned_headers; end

  private

  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:591
  def canonical_header_value(value); end

  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:579
  def canonical_headers(headers); end

  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:448
  def canonical_request(http_method, url, headers, content_sha256); end

  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:500
  def credential(credentials, date); end

  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:491
  ...
  # @return [Boolean]
  #
  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:716
  def credentials_set?(credentials); end

  # the credentials used by CRT must be a
  # CRT StaticCredentialsProvider object
  #
  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:727
  def crt_fetch_credentials; end

  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:795
  def crt_presign_url(options); end

  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:736
  def crt_sign_request(request); end

  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:676
  ...
  #
  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:521
  ...
  #
  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:477
  def event_string_to_sign(datetime, headers, payload, prior_signature, encoder); end

  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:648
  def extract_credentials_provider(options); end

  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:683
  def extract_expires_in(options); end

  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:658
  def extract_http_method(request); end

  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:640
  def extract_region(options); end

  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:631
  def extract_service(options); end

  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:667
  def extract_url(request); end

  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:702
  def fetch_credentials; end

  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:627
  def hexhmac(key, value); end

  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:623
  def hmac(key, value); end

  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:595
  def host(uri); end

  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:540
  def normalized_querystring(querystring); end

  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:530
  def path(url); end

  # @param value [File, Tempfile, IO#read, String]
  # @return [String<SHA256 Hexdigest>]
  #
  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:606
  def sha256_hexdigest(value); end

  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:504
  def signature(secret_access_key, date, string_to_sign); end

  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:569
  def signed_headers(headers); end

  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:459
  def string_to_sign(datetime, canonical_request); end

  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:693
  def uri_escape(string); end

  # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:697
  def uri_escape_path(string); end

  class << self
    # @api private
    #
    # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:853
    def uri_escape(string); end

    # @api private
    #
    # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:848
    def uri_escape_path(path); end

    # @return [Boolean]
    #
    # source://aws-sigv4-1.5.1/lib/aws-sigv4/signer.rb:843
    def use_crt?; end
  end
end
...
# @api private
#
# source://aws-sigv4-1.5.1/lib/aws-sigv4/credentials.rb:46
class Aws::Sigv4::StaticCredentialsProvider
  ...
  #
  # source://aws-sigv4-1.5.1/lib/aws-sigv4/credentials.rb:52
  def initialize(options = T.unsafe(nil)); end

  # @api private
  # @return [Credentials]
  #
  # source://aws-sigv4-1.5.1/lib/aws-sigv4/credentials.rb:59
  def credentials; end

  # @api private
  # @return [Boolean]
  #
  # source://aws-sigv4-1.5.1/lib/aws-sigv4/credentials.rb:62
  def set?; end
end

# source://aws-sigv4-1.5.1/lib/aws-sigv4.rb:10
