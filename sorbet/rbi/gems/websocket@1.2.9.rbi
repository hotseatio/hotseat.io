...
#
# source://websocket-1.2.9/lib/websocket.rb:8
module WebSocket
  class << self
...
# source://websocket-1.2.9/lib/websocket/error.rb:4
class WebSocket::Error < ::RuntimeError; end

# source://websocket-1.2.9/lib/websocket/error.rb:5
class WebSocket::Error::Frame < ::WebSocket::Error; end

# source://websocket-1.2.9/lib/websocket/error.rb:6
class WebSocket::Error::Frame::ControlFramePayloadTooLong < ::WebSocket::Error::Frame
  # source://websocket-1.2.9/lib/websocket/error.rb:7
  def message; end
end

# source://websocket-1.2.9/lib/websocket/error.rb:12
class WebSocket::Error::Frame::DataFrameInsteadContinuation < ::WebSocket::Error::Frame
  # source://websocket-1.2.9/lib/websocket/error.rb:13
  def message; end
end

# source://websocket-1.2.9/lib/websocket/error.rb:18
class WebSocket::Error::Frame::FragmentedControlFrame < ::WebSocket::Error::Frame
  # source://websocket-1.2.9/lib/websocket/error.rb:19
  def message; end
end

# source://websocket-1.2.9/lib/websocket/error.rb:24
class WebSocket::Error::Frame::Invalid < ::WebSocket::Error::Frame
  # source://websocket-1.2.9/lib/websocket/error.rb:25
  def message; end
end

# source://websocket-1.2.9/lib/websocket/error.rb:30
class WebSocket::Error::Frame::InvalidPayloadEncoding < ::WebSocket::Error::Frame
  # source://websocket-1.2.9/lib/websocket/error.rb:31
  def message; end
end

# source://websocket-1.2.9/lib/websocket/error.rb:36
class WebSocket::Error::Frame::MaskTooShort < ::WebSocket::Error::Frame
  # source://websocket-1.2.9/lib/websocket/error.rb:37
  def message; end
end

# source://websocket-1.2.9/lib/websocket/error.rb:42
class WebSocket::Error::Frame::ReservedBitUsed < ::WebSocket::Error::Frame
  # source://websocket-1.2.9/lib/websocket/error.rb:43
  def message; end
end

# source://websocket-1.2.9/lib/websocket/error.rb:48
class WebSocket::Error::Frame::TooLong < ::WebSocket::Error::Frame
  # source://websocket-1.2.9/lib/websocket/error.rb:49
  def message; end
end

# source://websocket-1.2.9/lib/websocket/error.rb:54
class WebSocket::Error::Frame::UnexpectedContinuationFrame < ::WebSocket::Error::Frame
  # source://websocket-1.2.9/lib/websocket/error.rb:55
  def message; end
end

# source://websocket-1.2.9/lib/websocket/error.rb:72
class WebSocket::Error::Frame::UnknownCloseCode < ::WebSocket::Error::Frame
  # source://websocket-1.2.9/lib/websocket/error.rb:73
  def message; end
end

# source://websocket-1.2.9/lib/websocket/error.rb:60
class WebSocket::Error::Frame::UnknownFrameType < ::WebSocket::Error::Frame
  # source://websocket-1.2.9/lib/websocket/error.rb:61
  def message; end
end

# source://websocket-1.2.9/lib/websocket/error.rb:66
class WebSocket::Error::Frame::UnknownOpcode < ::WebSocket::Error::Frame
  # source://websocket-1.2.9/lib/websocket/error.rb:67
  def message; end
end

# source://websocket-1.2.9/lib/websocket/error.rb:78
class WebSocket::Error::Frame::UnknownVersion < ::WebSocket::Error::Frame
  # source://websocket-1.2.9/lib/websocket/error.rb:79
  def message; end
end

# source://websocket-1.2.9/lib/websocket/error.rb:85
class WebSocket::Error::Handshake < ::WebSocket::Error; end

# source://websocket-1.2.9/lib/websocket/error.rb:86
class WebSocket::Error::Handshake::GetRequestRequired < ::WebSocket::Error::Handshake
  # source://websocket-1.2.9/lib/websocket/error.rb:87
  def message; end
end

# source://websocket-1.2.9/lib/websocket/error.rb:92
class WebSocket::Error::Handshake::InvalidAuthentication < ::WebSocket::Error::Handshake
  # source://websocket-1.2.9/lib/websocket/error.rb:93
  def message; end
end

# source://websocket-1.2.9/lib/websocket/error.rb:98
class WebSocket::Error::Handshake::InvalidHeader < ::WebSocket::Error::Handshake
  # source://websocket-1.2.9/lib/websocket/error.rb:99
  def message; end
end

# source://websocket-1.2.9/lib/websocket/error.rb:110
class WebSocket::Error::Handshake::InvalidStatusCode < ::WebSocket::Error::Handshake
  # source://websocket-1.2.9/lib/websocket/error.rb:111
  def message; end
end

# source://websocket-1.2.9/lib/websocket/error.rb:116
class WebSocket::Error::Handshake::NoHostProvided < ::WebSocket::Error::Handshake
  # source://websocket-1.2.9/lib/websocket/error.rb:117
  def message; end
end

# source://websocket-1.2.9/lib/websocket/error.rb:122
class WebSocket::Error::Handshake::UnknownVersion < ::WebSocket::Error::Handshake
  # source://websocket-1.2.9/lib/websocket/error.rb:123
  def message; end
end

# source://websocket-1.2.9/lib/websocket/error.rb:104
class WebSocket::Error::Handshake::UnsupportedProtocol < ::WebSocket::Error::Handshake
  # source://websocket-1.2.9/lib/websocket/error.rb:105
  def message; end
end

# source://websocket-1.2.9/lib/websocket/exception_handler.rb:4
module WebSocket::ExceptionHandler
  mixes_in_class_methods ::WebSocket::ExceptionHandler::ClassMethods

  # Returns the value of attribute error.
  #
  # source://websocket-1.2.9/lib/websocket/exception_handler.rb:5
  def error; end
  ...
  class << self
    # @private
    #
    # source://websocket-1.2.9/lib/websocket/exception_handler.rb:7
    def included(base); end
  end
end

# source://websocket-1.2.9/lib/websocket/exception_handler.rb:11
module WebSocket::ExceptionHandler::ClassMethods
  ...
  #
  # source://websocket-1.2.9/lib/websocket/exception_handler.rb:18
  def rescue_method(method_name, options = T.unsafe(nil)); end
end

# source://websocket-1.2.9/lib/websocket/frame.rb:4
module WebSocket::Frame; end

# @abstract Subclass and override to implement custom frames
#
# source://websocket-1.2.9/lib/websocket/frame/base.rb:6
class WebSocket::Frame::Base
  ...
  #
  # source://websocket-1.2.9/lib/websocket/exception_handler.rb:19
  def initialize(*args); end

  # Returns the value of attribute code.
  #
  # source://websocket-1.2.9/lib/websocket/frame/base.rb:11
  def code; end
  ...
  # Returns the value of attribute error.
  #
  # source://websocket-1.2.9/lib/websocket/frame/base.rb:10
  def error; end
  ...
  #
  # source://websocket-1.2.9/lib/websocket/frame/base.rb:31
  def error?; end
  ...
  # @return [Boolean]
  #
  # source://websocket-1.2.9/lib/websocket/frame/base.rb:36
  ...
  #
  # source://websocket-1.2.9/lib/websocket/frame/base.rb:41
  ...
  #
  # source://websocket-1.2.9/lib/websocket/frame/base.rb:49
  def include_version; end

  # source://websocket-1.2.9/lib/websocket/frame/base.rb:19
  def initialize_without_rescue(args = T.unsafe(nil)); end
end

# source://websocket-1.2.9/lib/websocket/frame/data.rb:5
class WebSocket::Frame::Data < ::String
  # @return [Data] a new instance of Data
  #
  # source://websocket-1.2.9/lib/websocket/frame/data.rb:6
  def initialize(*args); end

  # source://websocket-1.2.9/lib/websocket/frame/data.rb:11
  def <<(*args); end

  # Convert all arguments to ASCII-8BIT for easier traversing
  #
  # source://websocket-1.2.9/lib/websocket/frame/data.rb:16
  def convert_args(args); end

  # Extract `count` bytes starting from `start_index` and unmask it if needed.
  #
  # source://websocket-1.2.9/lib/websocket/frame/data.rb:32
  def getbytes(start_index, count); end

  # Mask whole payload using mask key
  #
  # source://websocket-1.2.9/lib/websocket/frame/data.rb:39
  ...
  #
  # source://websocket-1.2.9/lib/websocket/frame/data.rb:21
  def set_mask; end

  # Remove mask flag - it will still be present in payload
  #
  # source://websocket-1.2.9/lib/websocket/frame/data.rb:27
  def unset_mask; end
end

# source://websocket-1.2.9/lib/websocket/frame/handler.rb:5
module WebSocket::Frame::Handler; end

# source://websocket-1.2.9/lib/websocket/frame/handler/base.rb:6
class WebSocket::Frame::Handler::Base
  # @return [Base] a new instance of Base
  #
  # source://websocket-1.2.9/lib/websocket/frame/handler/base.rb:7
  ...
  #
  # source://websocket-1.2.9/lib/websocket/frame/handler/base.rb:19
  ...
  #
  # source://websocket-1.2.9/lib/websocket/frame/handler/base.rb:13
  ...
  #
  # source://websocket-1.2.9/lib/websocket/frame/handler/base.rb:28
  ...
  #
  # source://websocket-1.2.9/lib/websocket/frame/handler/base.rb:35
  def data_frame?(frame_type); end
end

# source://websocket-1.2.9/lib/websocket/frame/handler/handler03.rb:10
class WebSocket::Frame::Handler::Handler03 < ::WebSocket::Frame::Handler::Base
  # @return [Handler03] a new instance of Handler03
  #
  # source://websocket-1.2.9/lib/websocket/frame/handler/handler03.rb:23
  def initialize(frame); end

  # @see WebSocket::Frame::Handler::Base#decode_frame
  #
  # source://websocket-1.2.9/lib/websocket/frame/handler/handler03.rb:48
  def decode_frame; end

  # @see WebSocket::Frame::Handler::Base#encode_frame
  #
  # source://websocket-1.2.9/lib/websocket/frame/handler/handler03.rb:34
  def encode_frame; end
  ...
  # @return [Boolean]
  #
  # source://websocket-1.2.9/lib/websocket/frame/handler/handler03.rb:68
  def masking?; end

  # @see WebSocket::Frame::Base#supported_frames
  #
  # source://websocket-1.2.9/lib/websocket/frame/handler/handler03.rb:29
  def supported_frames; end
  ...
  # @return [Boolean]
  #
  # source://websocket-1.2.9/lib/websocket/frame/handler/handler03.rb:138
  def buffer_exists?(buffer_number); end

  # source://websocket-1.2.9/lib/websocket/frame/handler/handler03.rb:205
  def decode_continuation_frame(application_data, frame_type); end

  # @raise [WebSocket::Error::Frame::UnexpectedContinuationFrame]
  #
  # source://websocket-1.2.9/lib/websocket/frame/handler/handler03.rb:211
  def decode_finish_continuation_frame(application_data); end

  # @raise [WebSocket::Error::Frame::ReservedBitUsed]
  #
  # source://websocket-1.2.9/lib/websocket/frame/handler/handler03.rb:142
  def decode_first_byte; end

  # @raise [WebSocket::Error::Frame::TooLong]
  #
  # source://websocket-1.2.9/lib/websocket/frame/handler/handler03.rb:118
  def decode_header; end

  # source://websocket-1.2.9/lib/websocket/frame/handler/handler03.rb:188
  def decode_payload(payload_length, mask); end

  # source://websocket-1.2.9/lib/websocket/frame/handler/handler03.rb:169
  def decode_payload_length(length); end

  # @raise [WebSocket::Error::Frame::ControlFramePayloadTooLong]
  #
  # source://websocket-1.2.9/lib/websocket/frame/handler/handler03.rb:156
  def decode_second_byte(frame_type); end

  # source://websocket-1.2.9/lib/websocket/frame/handler/handler03.rb:95
  def encode_header; end

  # source://websocket-1.2.9/lib/websocket/frame/handler/handler03.rb:104
  def encode_payload_length(length, mask); end

  # This allows flipping the more bit to fin for draft 04
  #
  # source://websocket-1.2.9/lib/websocket/frame/handler/handler03.rb:75
  def fin; end
  ...
  #
  # source://websocket-1.2.9/lib/websocket/frame/handler/handler03.rb:91
  ...
  #
  # source://websocket-1.2.9/lib/websocket/frame/handler/handler03.rb:83
  def type_to_opcode(frame_type); end
end

# Hash of frame names and it's opcodes
#
# source://websocket-1.2.9/lib/websocket/frame/handler/handler03.rb:11
WebSocket::Frame::Handler::Handler03::FRAME_TYPES = T.let(T.unsafe(nil), Hash)

# Hash of frame opcodes and it's names
#
# source://websocket-1.2.9/lib/websocket/frame/handler/handler03.rb:21
WebSocket::Frame::Handler::Handler03::FRAME_TYPES_INVERSE = T.let(T.unsafe(nil), Hash)

# source://websocket-1.2.9/lib/websocket/frame/handler/handler04.rb:7
class WebSocket::Frame::Handler::Handler04 < ::WebSocket::Frame::Handler::Handler03
  ...
  #
  # source://websocket-1.2.9/lib/websocket/frame/handler/handler04.rb:12
  def fin; end
end

# source://websocket-1.2.9/lib/websocket/frame/handler/handler05.rb:8
class WebSocket::Frame::Handler::Handler05 < ::WebSocket::Frame::Handler::Handler04
  ...
  # @return [Boolean]
  #
  # source://websocket-1.2.9/lib/websocket/frame/handler/handler05.rb:9
  def masking?; end
end

# source://websocket-1.2.9/lib/websocket/frame/handler/handler07.rb:8
class WebSocket::Frame::Handler::Handler07 < ::WebSocket::Frame::Handler::Handler05
  # source://websocket-1.2.9/lib/websocket/frame/handler/handler07.rb:31
  def decode_frame; end

  # source://websocket-1.2.9/lib/websocket/frame/handler/handler07.rb:21
  def encode_frame; end
  ...
  # @return [Boolean]
  #
  # source://websocket-1.2.9/lib/websocket/frame/handler/handler07.rb:56
  ...
  # @return [Symbol] Frame type name or nil
  #
  # source://websocket-1.2.9/lib/websocket/frame/handler/handler07.rb:72
  def opcode_to_type(opcode); end
  ...
  # @return [Integer] opcode or nil
  #
  # source://websocket-1.2.9/lib/websocket/frame/handler/handler07.rb:64
  def type_to_opcode(frame_type); end

  # @return [Boolean]
  #
  # source://websocket-1.2.9/lib/websocket/frame/handler/handler07.rb:44
  def valid_code?(code); end

  # @return [Boolean]
  #
  # source://websocket-1.2.9/lib/websocket/frame/handler/handler07.rb:48
  def valid_encoding?(data); end
end

# Hash of frame names and it's opcodes
#
# source://websocket-1.2.9/lib/websocket/frame/handler/handler07.rb:9
WebSocket::Frame::Handler::Handler07::FRAME_TYPES = T.let(T.unsafe(nil), Hash)

# Hash of frame opcodes and it's names
#
# source://websocket-1.2.9/lib/websocket/frame/handler/handler07.rb:19
WebSocket::Frame::Handler::Handler07::FRAME_TYPES_INVERSE = T.let(T.unsafe(nil), Hash)

# source://websocket-1.2.9/lib/websocket/frame/handler/handler75.rb:8
class WebSocket::Frame::Handler::Handler75 < ::WebSocket::Frame::Handler::Base
  # @see WebSocket::Frame::Handler::Base#decode_frame
  #
  # source://websocket-1.2.9/lib/websocket/frame/handler/handler75.rb:26
  def decode_frame; end

  # @see WebSocket::Frame::Handler::Base#encode_frame
  #
  # source://websocket-1.2.9/lib/websocket/frame/handler/handler75.rb:14
  def encode_frame; end

  # @see WebSocket::Frame::Base#supported_frames
  #
  # source://websocket-1.2.9/lib/websocket/frame/handler/handler75.rb:9
  def supported_frames; end
end
...
#
# source://websocket-1.2.9/lib/websocket/frame/incoming.rb:13
class WebSocket::Frame::Incoming < ::WebSocket::Frame::Base
  # @return [Incoming] a new instance of Incoming
  #
  # source://websocket-1.2.9/lib/websocket/frame/incoming.rb:17
  ...
  #
  # source://websocket-1.2.9/lib/websocket/frame/incoming.rb:32
  def <<(data); end
  ...
  #
  # source://websocket-1.2.9/lib/websocket/frame/incoming.rb:26
  def decoded?; end
  ...
  # source://websocket-1.2.9/lib/websocket/frame/incoming.rb:40
  ...
  #
  # source://websocket-1.2.9/lib/websocket/frame/incoming.rb:47
  def to_s; end
end

# source://websocket-1.2.9/lib/websocket/frame/incoming/client.rb:6
class WebSocket::Frame::Incoming::Client < ::WebSocket::Frame::Incoming
  # @return [Boolean]
  #
  # source://websocket-1.2.9/lib/websocket/frame/incoming/client.rb:7
  def incoming_masking?; end

  # @return [Boolean]
  #
  # source://websocket-1.2.9/lib/websocket/frame/incoming/client.rb:11
  def outgoing_masking?; end
end

# source://websocket-1.2.9/lib/websocket/frame/incoming/server.rb:6
class WebSocket::Frame::Incoming::Server < ::WebSocket::Frame::Incoming
  # @return [Boolean]
  #
  # source://websocket-1.2.9/lib/websocket/frame/incoming/server.rb:7
  def incoming_masking?; end

  # @return [Boolean]
  #
  # source://websocket-1.2.9/lib/websocket/frame/incoming/server.rb:11
  def outgoing_masking?; end
end
...
# @note You should NEVER use this class directly - use Client or Server subclasses instead, as they contain additional frame options(i.e. Client-side masking in draft 04)
#
# source://websocket-1.2.9/lib/websocket/frame/outgoing.rb:11
class WebSocket::Frame::Outgoing < ::WebSocket::Frame::Base
  ...
  #
  # source://websocket-1.2.9/lib/websocket/frame/outgoing.rb:23
  ...
  #
  # source://websocket-1.2.9/lib/websocket/frame/outgoing.rb:17
  def supported?; end
  ...
  # source://websocket-1.2.9/lib/websocket/frame/outgoing.rb:28
  def to_s_without_rescue; end
end

# source://websocket-1.2.9/lib/websocket/frame/outgoing/client.rb:6
class WebSocket::Frame::Outgoing::Client < ::WebSocket::Frame::Outgoing
  # @return [Boolean]
  #
  # source://websocket-1.2.9/lib/websocket/frame/outgoing/client.rb:7
  def incoming_masking?; end

  # @return [Boolean]
  #
  # source://websocket-1.2.9/lib/websocket/frame/outgoing/client.rb:11
  def outgoing_masking?; end
end

# source://websocket-1.2.9/lib/websocket/frame/outgoing/server.rb:6
class WebSocket::Frame::Outgoing::Server < ::WebSocket::Frame::Outgoing
  # @return [Boolean]
  #
  # source://websocket-1.2.9/lib/websocket/frame/outgoing/server.rb:7
  def incoming_masking?; end

  # @return [Boolean]
  #
  # source://websocket-1.2.9/lib/websocket/frame/outgoing/server.rb:11
  def outgoing_masking?; end
end

# source://websocket-1.2.9/lib/websocket/handshake.rb:4
module WebSocket::Handshake; end

# @abstract Subclass and override to implement custom handshakes
#
# source://websocket-1.2.9/lib/websocket/handshake/base.rb:6
class WebSocket::Handshake::Base
  ...
  # @return [Base] a new instance of Base
  #
  # source://websocket-1.2.9/lib/websocket/handshake/base.rb:15
  def initialize(args = T.unsafe(nil)); end

  # @abstract Add data to handshake
  #
  # source://websocket-1.2.9/lib/websocket/handshake/base.rb:34
  def <<(data); end
  ...
  #
  # source://websocket-1.2.9/lib/websocket/handshake/base.rb:47
  def finished?; end

  # Returns the value of attribute headers.
  #
  # source://websocket-1.2.9/lib/websocket/handshake/base.rb:10
  def headers; end
  ...
  #
  # source://websocket-1.2.9/lib/websocket/handshake/base.rb:65
  def leftovers; end
  ...
  # @return [Boolean]
  #
  # source://websocket-1.2.9/lib/websocket/handshake/base.rb:59
  ...
  # source://websocket-1.2.9/lib/websocket/handshake/base.rb:40
  def to_s_without_rescue; end
  ...
  #
  # source://websocket-1.2.9/lib/websocket/handshake/base.rb:73
  def uri; end
  ...
  #
  # source://websocket-1.2.9/lib/websocket/handshake/base.rb:92
  ...
  #
  # source://websocket-1.2.9/lib/websocket/handshake/base.rb:101
  def parse_data; end
  ...
  #
  # source://websocket-1.2.9/lib/websocket/handshake/base.rb:86
  def reserved_leftover_lines; end
end

# source://websocket-1.2.9/lib/websocket/handshake/base.rb:97
...
#   @handshake.valid?
#
# source://websocket-1.2.9/lib/websocket/handshake/client.rb:36
class WebSocket::Handshake::Client < ::WebSocket::Handshake::Base
  ...
  # Returns the value of attribute headers.
  #
  # source://websocket-1.2.9/lib/websocket/handshake/client.rb:37
  def headers; end
  ...
  #
  # source://websocket-1.2.9/lib/websocket/handshake/client.rb:98
  def should_respond?; end
  ...
  # @return [Boolean] false if protocol number is unknown, otherwise true
  #
  # source://websocket-1.2.9/lib/websocket/handshake/client.rb:106
  def include_version; end

  # source://websocket-1.2.9/lib/websocket/handshake/client.rb:57
  def initialize_without_rescue(args = T.unsafe(nil)); end
  ...
  #
  # source://websocket-1.2.9/lib/websocket/handshake/client.rb:122
  def parse_first_line(line); end
end

# source://websocket-1.2.9/lib/websocket/handshake/client.rb:117
WebSocket::Handshake::Client::FIRST_LINE = T.let(T.unsafe(nil), Regexp)

# source://websocket-1.2.9/lib/websocket/handshake/handler.rb:5
...
#
# source://websocket-1.2.9/lib/websocket/handshake/handler/base.rb:7
class WebSocket::Handshake::Handler::Base
  # @return [Base] a new instance of Base
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/base.rb:8
  def initialize(handshake); end

  # @see WebSocket::Handshake::Base#to_s
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/base.rb:13
  def to_s; end

  # @return [Boolean]
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/base.rb:23
  def valid?; end
  ...
  # @return [String] data
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/base.rb:43
  ...
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/base.rb:37
  ...
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/base.rb:31
  def header_line; end
end

# source://websocket-1.2.9/lib/websocket/handshake/handler/client.rb:6
class WebSocket::Handshake::Handler::Client < ::WebSocket::Handshake::Handler::Base
  ...
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/client.rb:17
  def handshake_keys; end

  # @see WebSocket::Handshake::Handler::Base#header_line
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/client.rb:10
  def header_line; end
  ...
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/client.rb:23
  def verify_protocol; end
end

# source://websocket-1.2.9/lib/websocket/handshake/handler/client01.rb:8
class WebSocket::Handshake::Handler::Client01 < ::WebSocket::Handshake::Handler::Client76
  private

  # @see WebSocket::Handshake::Handler::Base#handshake_keys
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/client01.rb:12
  def handshake_keys; end
end

# source://websocket-1.2.9/lib/websocket/handshake/handler/client04.rb:10
class WebSocket::Handshake::Handler::Client04 < ::WebSocket::Handshake::Handler::Client
  # @return [Boolean]
  # @see WebSocket::Handshake::Base#valid?
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/client04.rb:11
  def valid?; end
  ...
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/client04.rb:42
  def accept; end

  # @see WebSocket::Handshake::Handler::Base#handshake_keys
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/client04.rb:18
  def handshake_keys; end
  ...
  # @return [String] key
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/client04.rb:36
  def key; end

  # source://websocket-1.2.9/lib/websocket/handshake/handler/client04.rb:57
  def provided_protocols; end

  # source://websocket-1.2.9/lib/websocket/handshake/handler/client04.rb:53
  ...
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/client04.rb:48
  def verify_accept; end
end

# source://websocket-1.2.9/lib/websocket/handshake/handler/client11.rb:6
class WebSocket::Handshake::Handler::Client11 < ::WebSocket::Handshake::Handler::Client04
  private

  # @see WebSocket::Handshake::Handler::Base#handshake_keys
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/client11.rb:10
  def handshake_keys; end
end

# source://websocket-1.2.9/lib/websocket/handshake/handler/client75.rb:7
class WebSocket::Handshake::Handler::Client75 < ::WebSocket::Handshake::Handler::Client
  # @return [Boolean]
  # @see WebSocket::Handshake::Base#valid?
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/client75.rb:8
  def valid?; end
  ...
  # @see WebSocket::Handshake::Handler::Base#handshake_keys
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/client75.rb:15
  def handshake_keys; end

  # source://websocket-1.2.9/lib/websocket/handshake/handler/client75.rb:33
  def provided_protocols; end

  # source://websocket-1.2.9/lib/websocket/handshake/handler/client75.rb:29
  def supported_protocols; end
end

# source://websocket-1.2.9/lib/websocket/handshake/handler/client76.rb:9
class WebSocket::Handshake::Handler::Client76 < ::WebSocket::Handshake::Handler::Client75
  # @return [Boolean]
  # @see WebSocket::Handshake::Base#valid?
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/client76.rb:10
  def valid?; end
  ...
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/client76.rb:54
  def challenge; end

  # @see WebSocket::Handshake::Handler::Base#finishing_line
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/client76.rb:30
  def finishing_line; end
  ...
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/client76.rb:76
  def generate_key(key); end

  # Generate third key
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/client76.rb:95
  def generate_key3; end

  # @see WebSocket::Handshake::Handler::Base#handshake_keys
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/client76.rb:22
  def handshake_keys; end
  ...
  # @return [String] key
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/client76.rb:36
  def key1; end
  ...
  # @return [String] key
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/client76.rb:42
  def key2; end
  ...
  # @return [String] key
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/client76.rb:48
  def key3; end

  # source://websocket-1.2.9/lib/websocket/handshake/handler/client76.rb:99
  def provided_protocols; end

  # @see WebSocket::Handshake::Base#reserved_leftover_lines
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/client76.rb:17
  def reserved_leftover_lines; end
  ...
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/client76.rb:66
  def verify_challenge; end
end

# source://websocket-1.2.9/lib/websocket/handshake/handler/client76.rb:71
WebSocket::Handshake::Handler::Client76::NOISE_CHARS = T.let(T.unsafe(nil), Array)

# source://websocket-1.2.9/lib/websocket/handshake/handler/server.rb:6
class WebSocket::Handshake::Handler::Server < ::WebSocket::Handshake::Handler::Base; end

# source://websocket-1.2.9/lib/websocket/handshake/handler/server04.rb:10
class WebSocket::Handshake::Handler::Server04 < ::WebSocket::Handshake::Handler::Server
  # @return [Boolean]
  # @see WebSocket::Handshake::Base#valid?
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/server04.rb:11
  def valid?; end
  ...
  # @see WebSocket::Handshake::Handler::Base#handshake_keys
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/server04.rb:23
  def handshake_keys; end

  # @see WebSocket::Handshake::Handler::Base#header_line
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/server04.rb:18
  def header_line; end

  # source://websocket-1.2.9/lib/websocket/handshake/handler/server04.rb:44
  def key; end

  # source://websocket-1.2.9/lib/websocket/handshake/handler/server04.rb:48
  def protocol; end
  ...
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/server04.rb:33
  def signature; end

  # @raise [WebSocket::Error::Handshake::InvalidAuthentication]
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/server04.rb:39
  def verify_key; end
end

# source://websocket-1.2.9/lib/websocket/handshake/handler/server75.rb:6
class WebSocket::Handshake::Handler::Server75 < ::WebSocket::Handshake::Handler::Server
  private

  # @see WebSocket::Handshake::Handler::Base#handshake_keys
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/server75.rb:23
  def handshake_keys; end

  # @see WebSocket::Handshake::Handler::Base#header_line
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/server75.rb:18
  def header_line; end

  # source://websocket-1.2.9/lib/websocket/handshake/handler/server75.rb:9
  def headers; end

  # source://websocket-1.2.9/lib/websocket/handshake/handler/server75.rb:32
  def protocol; end
end

# source://websocket-1.2.9/lib/websocket/handshake/handler/server76.rb:9
class WebSocket::Handshake::Handler::Server76 < ::WebSocket::Handshake::Handler::Server75
  # @return [Boolean]
  # @see WebSocket::Handshake::Base#valid?
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/server76.rb:10
  def valid?; end
  ...
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/server76.rb:41
  def challenge_response; end

  # @see WebSocket::Handshake::Handler::Base#finishing_line
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/server76.rb:35
  def finishing_line; end

  # @see WebSocket::Handshake::Handler::Base#header_line
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/server76.rb:30
  def header_line; end

  # source://websocket-1.2.9/lib/websocket/handshake/handler/server76.rb:16
  def headers; end
  ...
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/server76.rb:56
  def numbers_over_spaces(string); end

  # @see WebSocket::Handshake::Base#reserved_leftover_lines
  #
  # source://websocket-1.2.9/lib/websocket/handshake/handler/server76.rb:25
  def reserved_leftover_lines; end
end
...
#   # Sec-WebSocket-Accept: s3pPLMBiTxaQ9kYGzzhZRbK+xOo=
#
# source://websocket-1.2.9/lib/websocket/handshake/server.rb:43
class WebSocket::Handshake::Server < ::WebSocket::Handshake::Base
  ...
  #
  # source://websocket-1.2.9/lib/websocket/handshake/server.rb:44
  def initialize(args = T.unsafe(nil)); end
  ...
  #
  # source://websocket-1.2.9/lib/websocket/handshake/server.rb:113
  ...
  #
  # source://websocket-1.2.9/lib/websocket/handshake/server.rb:75
  ...
  # @return [String] host
  #
  # source://websocket-1.2.9/lib/websocket/handshake/server.rb:131
  def host; end
  ...
  # @return [String] port
  #
  # source://websocket-1.2.9/lib/websocket/handshake/server.rb:137
  def port; end
  ...
  # @return [Boolean] true
  #
  # source://websocket-1.2.9/lib/websocket/handshake/server.rb:125
  def should_respond?; end
  ...
  # @return [Boolean] false if protocol number is unknown, otherwise true
  #
  # source://websocket-1.2.9/lib/websocket/handshake/server.rb:154
  def include_version; end
  ...
  # @return [Boolean] True if parsed correctly. False otherwise
  #
  # source://websocket-1.2.9/lib/websocket/handshake/server.rb:168
  def parse_first_line(line); end

  # Set version of protocol basing on client requets. AFter cotting method calls include_version.
  #
  # source://websocket-1.2.9/lib/websocket/handshake/server.rb:144
  def set_version; end
end

# source://websocket-1.2.9/lib/websocket/handshake/server.rb:163
...
# source://websocket-1.2.9/lib/websocket/nice_inspect.rb:4
module WebSocket::NiceInspect
  # Recreate inspect as #to_s will be overwritten
  #
  # source://websocket-1.2.9/lib/websocket/nice_inspect.rb:6
  def inspect; end
end
