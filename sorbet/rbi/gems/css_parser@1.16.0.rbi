...
class CssParser::OffsetAwareRuleSet < ::CssParser::RuleSet
  ...
  # File offset range
  #
  # source://css_parser//lib/css_parser/rule_set.rb#656
  def offset; end
end
...
#
# source://css_parser//lib/css_parser/parser.rb#18
class CssParser::Parser
  ...
  #
  # source://css_parser//lib/css_parser/parser.rb#73
  ...
  #
  # source://css_parser//lib/css_parser/parser.rb#118
  ...
  #
  # source://css_parser//lib/css_parser/parser.rb#168
  ...
  # @raise [ArgumentError]
  #
  # source://css_parser//lib/css_parser/parser.rb#188
  ...
  # +media_types+ can be a symbol or an array of symbols.
  #
  # source://css_parser//lib/css_parser/parser.rb#213
  ...
  #
  # source://css_parser//lib/css_parser/parser.rb#249
  ...
  #
  # source://css_parser//lib/css_parser/parser.rb#83
  ...
  #
  # source://css_parser//lib/css_parser/parser.rb#30
  def loaded_uris; end

  # source://css_parser//lib/css_parser/parser.rb#310
  ...
  class << self
    ...
    #
    # source://css_parser//lib/css_parser/parser.rb#36
...
# Initial parsing
#
# source://css_parser//lib/css_parser/parser.rb#25
...
# source://css_parser//lib/css_parser/parser.rb#19
...
#
# source://css_parser//lib/css_parser/parser.rb#5
...
class CssParser::RuleSet
  ...
  #
  # source://css_parser//lib/css_parser/rule_set.rb#240
  def initialize(selectors, block, specificity = T.unsafe(nil)); end

  # Get the value of a property
  #
  # source://css_parser//lib/css_parser/rule_set.rb#248
  def [](property); end
  ...
  #
  # source://css_parser//lib/css_parser/rule_set.rb#498
  ...
  #
  # source://css_parser//lib/css_parser/rule_set.rb#537
  ...
  #
  # source://css_parser//lib/css_parser/rule_set.rb#561
  ...
  # Leaves properties declared !important alone.
  #
  # source://css_parser//lib/css_parser/rule_set.rb#588
  def create_list_style_shorthand!; end

  # Create shorthand declarations (e.g. +margin+ or +font+) whenever possible.
  #
  # source://css_parser//lib/css_parser/rule_set.rb#464
  def create_shorthand!; end

  # Combine several properties into a shorthand one
  #
  # source://css_parser//lib/css_parser/rule_set.rb#474
  def create_shorthand_properties!(properties, shorthand_property); end

  # Return all declarations as a string.
  #
  # source://css_parser//lib/css_parser/rule_set.rb#281
  ...
  #
  # source://css_parser//lib/css_parser/rule_set.rb#274
  ...
  #   end
  #
  # source://css_parser//lib/css_parser/rule_set.rb#264
  ...
  #
  # source://css_parser//lib/css_parser/rule_set.rb#304
  def expand_background_shorthand!; end

  # Split shorthand border declarations (e.g. <tt>border: 1px red;</tt>)
  # Additional splitting happens in expand_dimensions_shorthand!
  #
  # source://css_parser//lib/css_parser/rule_set.rb#334
  def expand_border_shorthand!; end

  # Split shorthand dimensional declarations (e.g. <tt>margin: 0px auto;</tt>)
  # into their constituent parts.  Handles margin, padding, border-color, border-style and border-width.
  #
  # source://css_parser//lib/css_parser/rule_set.rb#352
  def expand_dimensions_shorthand!; end

  # Convert shorthand font declarations (e.g. <tt>font: 300 italic 11px/14px verdana, helvetica, sans-serif;</tt>)
  # into their constituent parts.
  #
  # source://css_parser//lib/css_parser/rule_set.rb#389
  ...
  #
  # source://css_parser//lib/css_parser/rule_set.rb#444
  def expand_list_style_shorthand!; end

  # Split shorthand declarations (e.g. +margin+ or +font+) into their constituent parts.
  #
  # source://css_parser//lib/css_parser/rule_set.rb#291
  def expand_shorthand!; end

  # source://css_parser//lib/css_parser/rule_set.rb#326
  ...
  #
  # source://css_parser//lib/css_parser/rule_set.rb#227
  def selectors; end

  # Integer with the specificity to use for this RuleSet.
  #
  # source://css_parser//lib/css_parser/rule_set.rb#230
  def specificity; end
  ...
  #
  # source://css_parser//lib/css_parser/rule_set.rb#286
  def to_s; end

  private

  # source://css_parser//lib/css_parser/rule_set.rb#596
  def compute_dimensions_shorthand(values); end

  # Returns the value of attribute declarations.
  #
  # source://css_parser//lib/css_parser/rule_set.rb#594
  ...
  # source://css_parser//lib/css_parser/rule_set.rb#609
  ...
  # ++
  #
  # source://css_parser//lib/css_parser/rule_set.rb#632
  def parse_selectors!(selectors); end

  # source://css_parser//lib/css_parser/rule_set.rb#640
...
# source://css_parser//lib/css_parser/rule_set.rb#29
class CssParser::RuleSet::Declarations
  extend ::Forwardable

  # @return [Declarations] a new instance of Declarations
  #
  # source://css_parser//lib/css_parser/rule_set.rb#63
  def initialize(declarations = T.unsafe(nil)); end

  # source://css_parser//lib/css_parser/rule_set.rb#203
  def ==(other); end
  ...
  #
  # source://css_parser//lib/css_parser/rule_set.rb#86
  ...
  # @return [Boolean]
  #
  # source://css_parser//lib/css_parser/rule_set.rb#106
  ...
  # @raise [ArgumentError]
  #
  # source://css_parser//lib/css_parser/rule_set.rb#137
  def replace_declaration!(property, replacements, preserve_importance: T.unsafe(nil)); end

  # source://css_parser//lib/css_parser/rule_set.rb#110
  def size; end

  # source://css_parser//lib/css_parser/rule_set.rb#192
  ...
  # Returns the value of attribute declarations.
  #
  # source://css_parser//lib/css_parser/rule_set.rb#211
  def declarations; end
  ...
  # @param value the value to set the attribute declarations to.
  #
  # source://css_parser//lib/css_parser/rule_set.rb#215
  def declarations=(_arg0); end
...
class CssParser::RuleSet::Declarations::Value
  ...
  # source://css_parser//lib/css_parser/rule_set.rb#52
  def ==(other); end
  ...
  # source://css_parser//lib/css_parser/rule_set.rb#48
  def to_s; end
  ...
  # @raise [ArgumentError]
  #
  # source://css_parser//lib/css_parser/rule_set.rb#39
  def value=(value); end
end
