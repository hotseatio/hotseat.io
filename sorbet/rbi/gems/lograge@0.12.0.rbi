...
# source://lograge-0.12.0/lib/lograge/version.rb:3
module Lograge
...
# source://lograge-0.12.0/lib/lograge/formatters/helpers/method_and_path.rb:4
module Lograge::Formatters; end

# source://lograge-0.12.0/lib/lograge/formatters/cee.rb:5
class Lograge::Formatters::Cee
  # source://lograge-0.12.0/lib/lograge/formatters/cee.rb:6
  def call(data); end
end

# source://lograge-0.12.0/lib/lograge/formatters/graylog2.rb:5
class Lograge::Formatters::Graylog2
  include ::Lograge::Formatters::Helpers::MethodAndPath

  # source://lograge-0.12.0/lib/lograge/formatters/graylog2.rb:8
  def call(data); end

  # source://lograge-0.12.0/lib/lograge/formatters/graylog2.rb:19
  def short_message(data); end

  # source://lograge-0.12.0/lib/lograge/formatters/graylog2.rb:15
  def underscore_prefix(key); end
end

# source://lograge-0.12.0/lib/lograge/formatters/helpers/method_and_path.rb:5
module Lograge::Formatters::Helpers; end

# source://lograge-0.12.0/lib/lograge/formatters/helpers/method_and_path.rb:6
module Lograge::Formatters::Helpers::MethodAndPath
  # source://lograge-0.12.0/lib/lograge/formatters/helpers/method_and_path.rb:7
  def method_and_path_string(data); end
end

# source://lograge-0.12.0/lib/lograge/formatters/json.rb:6
class Lograge::Formatters::Json
  # source://lograge-0.12.0/lib/lograge/formatters/json.rb:7
  def call(data); end
end

# source://lograge-0.12.0/lib/lograge/formatters/key_value.rb:5
class Lograge::Formatters::KeyValue
  # source://lograge-0.12.0/lib/lograge/formatters/key_value.rb:6
  def call(data); end

  protected

  # source://lograge-0.12.0/lib/lograge/formatters/key_value.rb:14
  def fields_to_display(data); end

  # source://lograge-0.12.0/lib/lograge/formatters/key_value.rb:18
  def format(key, value); end

  # source://lograge-0.12.0/lib/lograge/formatters/key_value.rb:22
  def parse_value(key, value); end
end

# source://lograge-0.12.0/lib/lograge/formatters/l2met.rb:7
class Lograge::Formatters::L2met < ::Lograge::Formatters::KeyValue
  # source://lograge-0.12.0/lib/lograge/formatters/l2met.rb:26
  def call(data); end

  protected

  # source://lograge-0.12.0/lib/lograge/formatters/l2met.rb:36
  def additional_fields(data); end

  # source://lograge-0.12.0/lib/lograge/formatters/l2met.rb:32
  def fields_to_display(data); end

  # source://lograge-0.12.0/lib/lograge/formatters/l2met.rb:40
  def format(key, value); end

  # source://lograge-0.12.0/lib/lograge/formatters/l2met.rb:46
  def modify_payload(data); end

  # source://lograge-0.12.0/lib/lograge/formatters/l2met.rb:52
  def source_field(data); end
end

# source://lograge-0.12.0/lib/lograge/formatters/l2met.rb:8
Lograge::Formatters::L2met::L2MET_FIELDS = T.let(T.unsafe(nil), Array)

# source://lograge-0.12.0/lib/lograge/formatters/l2met.rb:21
Lograge::Formatters::L2met::UNWANTED_FIELDS = T.let(T.unsafe(nil), Array)

# source://lograge-0.12.0/lib/lograge/formatters/ltsv.rb:5
class Lograge::Formatters::LTSV
  # source://lograge-0.12.0/lib/lograge/formatters/ltsv.rb:6
  def call(data); end

  # source://lograge-0.12.0/lib/lograge/formatters/ltsv.rb:13
  def fields_to_display(data); end

  # source://lograge-0.12.0/lib/lograge/formatters/ltsv.rb:17
  def format(key, value); end

  private

  # source://lograge-0.12.0/lib/lograge/formatters/ltsv.rb:32
  def escape(string); end
end

# source://lograge-0.12.0/lib/lograge/formatters/lines.rb:5
class Lograge::Formatters::Lines
  # source://lograge-0.12.0/lib/lograge/formatters/lines.rb:6
  def call(data); end

  # source://lograge-0.12.0/lib/lograge/formatters/lines.rb:12
  def load_dependencies; end
end

# source://lograge-0.12.0/lib/lograge/formatters/logstash.rb:5
class Lograge::Formatters::Logstash
  include ::Lograge::Formatters::Helpers::MethodAndPath

  # source://lograge-0.12.0/lib/lograge/formatters/logstash.rb:8
  def call(data); end

  # source://lograge-0.12.0/lib/lograge/formatters/logstash.rb:16
  def load_dependencies; end
end

# source://lograge-0.12.0/lib/lograge/formatters/raw.rb:5
class Lograge::Formatters::Raw
  # source://lograge-0.12.0/lib/lograge/formatters/raw.rb:6
  def call(data); end
end

# source://lograge-0.12.0/lib/lograge/log_subscribers/base.rb:11
module Lograge::LogSubscribers; end

# source://lograge-0.12.0/lib/lograge/log_subscribers/action_cable.rb:5
class Lograge::LogSubscribers::ActionCable < ::Lograge::LogSubscribers::Base
  # source://lograge-0.12.0/lib/lograge/log_subscribers/action_cable.rb:7
  ...
  # source://lograge-0.12.0/lib/lograge/log_subscribers/action_cable.rb:25
  def default_status; end

  # source://lograge-0.12.0/lib/lograge/log_subscribers/action_cable.rb:29
  def extract_runtimes(event, _payload); end

  # source://lograge-0.12.0/lib/lograge/log_subscribers/action_cable.rb:14
  def initial_data(payload); end
end

# source://lograge-0.12.0/lib/lograge/log_subscribers/action_controller.rb:5
class Lograge::LogSubscribers::ActionController < ::Lograge::LogSubscribers::Base
  # source://lograge-0.12.0/lib/lograge/log_subscribers/action_controller.rb:6
  def process_action(event); end

  # source://lograge-0.12.0/lib/lograge/log_subscribers/action_controller.rb:10
  def redirect_to(event); end

  # source://lograge-0.12.0/lib/lograge/log_subscribers/action_controller.rb:14
  def unpermitted_parameters(event); end

  private

  # source://lograge-0.12.0/lib/lograge/log_subscribers/action_controller.rb:46
  def extract_format(payload); end

  # source://lograge-0.12.0/lib/lograge/log_subscribers/action_controller.rb:58
  def extract_location; end

  # source://lograge-0.12.0/lib/lograge/log_subscribers/action_controller.rb:31
  def extract_path(payload); end

  # source://lograge-0.12.0/lib/lograge/log_subscribers/action_controller.rb:51
  def extract_runtimes(event, payload); end

  # source://lograge-0.12.0/lib/lograge/log_subscribers/action_controller.rb:66
  def extract_unpermitted_params; end

  # source://lograge-0.12.0/lib/lograge/log_subscribers/action_controller.rb:21
  def initial_data(payload); end

  # source://lograge-0.12.0/lib/lograge/log_subscribers/action_controller.rb:36
  def strip_query_string(path); end
end

# source://lograge-0.12.0/lib/lograge/log_subscribers/base.rb:12
class Lograge::LogSubscribers::Base < ::ActiveSupport::LogSubscriber
  # source://lograge-0.12.0/lib/lograge/log_subscribers/base.rb:13
  def logger; end

  private

  # source://lograge-0.12.0/lib/lograge/log_subscribers/base.rb:67
  def before_format(data, payload); end

  # source://lograge-0.12.0/lib/lograge/log_subscribers/base.rb:62
  def custom_options(event); end

  # source://lograge-0.12.0/lib/lograge/log_subscribers/base.rb:54
  def default_status; end

  # source://lograge-0.12.0/lib/lograge/log_subscribers/base.rb:40
  def extract_location(*_arg); end

  # source://lograge-0.12.0/lib/lograge/log_subscribers/base.rb:29
  def extract_request(event, payload); end

  # source://lograge-0.12.0/lib/lograge/log_subscribers/base.rb:40
  def extract_runtimes(*_arg); end

  # source://lograge-0.12.0/lib/lograge/log_subscribers/base.rb:43
  def extract_status(payload); end

  # source://lograge-0.12.0/lib/lograge/log_subscribers/base.rb:40
  def extract_unpermitted_params(*_arg); end

  # source://lograge-0.12.0/lib/lograge/log_subscribers/base.rb:58
  def get_error_status_code(exception_class_name); end

  # source://lograge-0.12.0/lib/lograge/log_subscribers/base.rb:40
  def initial_data(*_arg); end

  # source://lograge-0.12.0/lib/lograge/log_subscribers/base.rb:19
  def process_main_event(event); end
end

# source://lograge-0.12.0/lib/lograge/ordered_options.rb:7
class Lograge::OrderedOptions < ::ActiveSupport::OrderedOptions
  # source://lograge-0.12.0/lib/lograge/ordered_options.rb:8
  def custom_payload(&block); end
end

# source://lograge-0.12.0/lib/lograge/railtie.rb:8
class Lograge::Railtie < ::Rails::Railtie; end

# source://lograge-0.12.0/lib/lograge/silent_logger.rb:6
class Lograge::SilentLogger < ::SimpleDelegator
  # source://lograge-0.12.0/lib/lograge/silent_logger.rb:9
  def debug(*_args); end
