...
# source://chartkick//lib/chartkick/helper.rb#4
module Chartkick
  class << self
    # Returns the value of attribute content_for.
    #
    # source://chartkick//lib/chartkick.rb#18
    def content_for; end
    ...
    #
    # source://chartkick//lib/chartkick.rb#19
    def options; end
...
# source://chartkick//lib/chartkick/helper.rb#5
module Chartkick::Helper
  # source://chartkick//lib/chartkick/helper.rb#22
  def area_chart(data_source, **options); end

  # source://chartkick//lib/chartkick/helper.rb#18
  def bar_chart(data_source, **options); end

  # source://chartkick//lib/chartkick/helper.rb#14
  def column_chart(data_source, **options); end

  # source://chartkick//lib/chartkick/helper.rb#30
  def geo_chart(data_source, **options); end

  # source://chartkick//lib/chartkick/helper.rb#6
  def line_chart(data_source, **options); end

  # source://chartkick//lib/chartkick/helper.rb#10
  def pie_chart(data_source, **options); end

  # source://chartkick//lib/chartkick/helper.rb#26
  def scatter_chart(data_source, **options); end

  # source://chartkick//lib/chartkick/helper.rb#34
  ...
  #
  # source://chartkick//lib/chartkick/helper.rb#41
  ...
  #
  # source://chartkick//lib/chartkick/helper.rb#142
  def chartkick_deep_merge(hash_a, hash_b); end

  # source://chartkick//lib/chartkick/helper.rb#154
...
#
# source://chartkick//lib/chartkick/helper.rb#152
Chartkick::Helper::JSON_ESCAPE = T.let(T.unsafe(nil), Hash)

# source://chartkick//lib/chartkick/helper.rb#153
...
#
# source://chartkick//lib/chartkick/enumerable.rb#3
module Enumerable
  extend ::ActiveSupport::EnumerableCoreExt::Constants

  # source://chartkick//lib/chartkick/enumerable.rb#4
  def chart_json; end
end
