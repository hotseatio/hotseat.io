...
# source://i18n-1.12.0/lib/i18n/backend/key_value.rb:9
class I18n::JSON
  class << self
    # source://i18n-1.12.0/lib/i18n/backend/key_value.rb:14
    def decode(value); end

    # source://i18n-1.12.0/lib/i18n/backend/key_value.rb:11
