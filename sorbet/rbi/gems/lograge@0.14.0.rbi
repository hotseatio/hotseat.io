...
module Lograge
  ...
  # source://lograge//lib/lograge.rb#157
  def attach_to_action_cable; end

  # source://lograge//lib/lograge.rb#153
  def attach_to_action_controller; end

  # source://lograge//lib/lograge.rb#53
  ...
  # source://lograge//lib/lograge.rb#176
  def extend_base_class(klass); end

  # source://lograge//lib/lograge.rb#86
  def ignore(test); end

  # source://lograge//lib/lograge.rb#94
  ...
  #
  # source://lograge//lib/lograge.rb#71
  ...
  # source://lograge//lib/lograge.rb#149
  def set_formatter; end

  # source://lograge//lib/lograge.rb#144
  def set_ignores; end

  # source://lograge//lib/lograge.rb#186
  def set_lograge_log_options; end

  # source://lograge//lib/lograge.rb#129
  def setup(app); end

  # source://lograge//lib/lograge.rb#164
  def setup_custom_payload; end

  # TODO: Remove with version 1.0
  #
  # source://lograge//lib/lograge.rb#214
  def support_deprecated_config; end

  # source://lograge//lib/lograge.rb#120
...
# source://lograge//lib/lograge/formatters/key_value_deep.rb#5
class Lograge::Formatters::KeyValueDeep < ::Lograge::Formatters::KeyValue
  # source://lograge//lib/lograge/formatters/key_value_deep.rb#6
  def call(data); end

  protected

  # source://lograge//lib/lograge/formatters/key_value_deep.rb#12
  def flatten_keys(data, prefix = T.unsafe(nil)); end

  # source://lograge//lib/lograge/formatters/key_value_deep.rb#18
  def flatten_object(data, prefix); end

  # source://lograge//lib/lograge/formatters/key_value_deep.rb#31
...
class Lograge::LogSubscribers::Base < ::ActiveSupport::LogSubscriber
  ...
  # source://lograge//lib/lograge/log_subscribers/base.rb#76
  def before_format(data, payload); end

  # source://lograge//lib/lograge/log_subscribers/base.rb#71
  def custom_options(event); end

  # source://lograge//lib/lograge/log_subscribers/base.rb#55
  def default_status; end

  # source://lograge//lib/lograge/log_subscribers/base.rb#63
  ...
  # source://lograge//lib/lograge/log_subscribers/base.rb#59
