...
class Excon::Connection
  ...
  #
  # source://excon//lib/excon/connection.rb#347
  ...
  # source://excon//lib/excon/connection.rb#106
  ...
  #
  # source://excon//lib/excon/connection.rb#227
  def request(params = T.unsafe(nil), &block); end

  # source://excon//lib/excon/connection.rb#112
  ...
  # source://excon//lib/excon/connection.rb#492
  def raise_socket_error(error); end

  # source://excon//lib/excon/connection.rb#455
  def response(datum = T.unsafe(nil)); end

  # source://excon//lib/excon/connection.rb#541
  def setup_proxy; end
  ...
  # source://excon//lib/excon/connection.rb#429
...
#
# source://excon//lib/excon/constants.rb#134
...
# source://excon//lib/excon/constants.rb#110
...
class Excon::Response
  ...
  #
  # source://excon//lib/excon/response.rb#200
  def initialize(params = T.unsafe(nil)); end

  # source://excon//lib/excon/response.rb#214
  def [](key); end
  ...
  #
  # source://excon//lib/excon/response.rb#229
  ...
  # source://excon//lib/excon/response.rb#218
  def params; end
  ...
  # source://excon//lib/excon/response.rb#223
  def pp; end
  ...
  class << self
    # source://excon//lib/excon/response.rb#60
    def parse(socket, datum); end

    # source://excon//lib/excon/response.rb#180
...
class Excon::SSLSocket < ::Excon::Socket
  ...
  # source://excon//lib/excon/ssl_socket.rb#163
  def client_cert_data; end

  # source://excon//lib/excon/ssl_socket.rb#180
  def client_key_data; end

  # source://excon//lib/excon/ssl_socket.rb#191
  def client_key_pass; end

  # source://excon//lib/excon/ssl_socket.rb#174
  def connect; end
end
...
class Excon::Socket
  ...
  # @return [Socket] a new instance of Socket
  #
  # source://excon//lib/excon/socket.rb#43
  def initialize(data = T.unsafe(nil)); end
  ...
  # source://excon//lib/excon/socket.rb#86
  def local_address; end

  # source://excon//lib/excon/socket.rb#90
  def local_port; end
  ...
  # source://excon//lib/excon/socket.rb#52
  def read(max_length = T.unsafe(nil)); end

  # source://excon//lib/excon/socket.rb#62
  def readline; end
  ...
  # source://excon//lib/excon/socket.rb#78
  def write(data); end

  private

  # source://excon//lib/excon/socket.rb#96
  def connect; end

  # source://excon//lib/excon/socket.rb#213
  def read_block(max_length); end

  # source://excon//lib/excon/socket.rb#175
  def read_nonblock(max_length); end

  # source://excon//lib/excon/socket.rb#274
  def select_with_timeout(socket, type); end

  # source://excon//lib/excon/socket.rb#288
  def unpacked_sockaddr; end

  # source://excon//lib/excon/socket.rb#264
  def write_block(data); end

  # source://excon//lib/excon/socket.rb#229
