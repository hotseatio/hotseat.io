...
# source://pdf-reader-2.10.0/lib/pdf/reader.rb:33
# typed: strong
module PDF; end
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader.rb:95
class PDF::Reader
  ...
  # always present.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader.rb:134
  sig { returns(T.nilable(T::Hash[T.untyped, T.untyped])) }
  def metadata; end

  # lowlevel hash-like access to all objects in the underlying PDF
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader.rb:98
  def objects; end
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader.rb:216
  def page(num); end

  # To number of pages in this PDF
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader.rb:147
  sig { returns(Integer) }
  def page_count; end
  ...
  # methods available on each page
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader.rb:192
  sig { returns(T::Array[PDF::Reader::Page]) }
  def pages; end

  # The PDF version this file uses
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader.rb:157
  sig { returns(Float) }
  def pdf_version; end
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader.rb:228
  def doc_strings_to_utf8(obj); end

  # @return [Boolean]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader.rb:249
  def has_utf16_bom?(str); end

  # TODO find a PDF I can use to spec this behaviour
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader.rb:259
  def pdfdoc_to_utf8(obj); end

  # source://pdf-reader-2.10.0/lib/pdf/reader.rb:274
  ...
  # String#encode
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader.rb:267
  ...
  class << self
    ...
    #
    # source://pdf-reader-2.10.0/lib/pdf/reader.rb:174
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/aes_v2_security_handler.rb:12
class PDF::Reader::AesV2SecurityHandler
  # @return [AesV2SecurityHandler] a new instance of AesV2SecurityHandler
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/aes_v2_security_handler.rb:14
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/aes_v2_security_handler.rb:27
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/aes_v3_security_handler.rb:13
class PDF::Reader::AesV3SecurityHandler
  # @return [AesV3SecurityHandler] a new instance of AesV3SecurityHandler
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/aes_v3_security_handler.rb:15
  def initialize(key); end
  ...
  # ref - a PDF::Reader::Reference for the object to decrypt
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/aes_v3_security_handler.rb:29
  def decrypt(buf, ref); end
end
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/bounding_rectangle_runs_filter.rb:9
class PDF::Reader::BoundingRectangleRunsFilter
  class << self
    # source://pdf-reader-2.10.0/lib/pdf/reader/bounding_rectangle_runs_filter.rb:11
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/buffer.rb:40
class PDF::Reader::Buffer
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/buffer.rb:79
  ...
  # @return [Boolean]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/buffer.rb:90
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/buffer.rb:144
  sig { returns(Integer) }
  def find_first_xref_offset; end

  # Returns the value of attribute pos.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/buffer.rb:65
  def pos; end
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/buffer.rb:108
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/buffer.rb:133
  sig { returns(T.any(NilClass, String, PDF::Reader::Reference)) }
  def token; end

  private

  # source://pdf-reader-2.10.0/lib/pdf/reader/buffer.rb:167
  sig { void }
  ...
  # @return [Boolean]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/buffer.rb:176
  sig { returns(T::Boolean) }
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/buffer.rb:239
  sig { void }
  ...
  # untouched
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/buffer.rb:439
  ...
  # we find a closing >
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/buffer.rb:302
  sig { void }
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/buffer.rb:256
  sig { void }
  ...
  # problem.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/buffer.rb:332
  sig { void }
  ...
  # to read up on it.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/buffer.rb:362
  sig { void }
  def prepare_regular_token; end

  # attempt to prime the buffer with the next few tokens.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/buffer.rb:195
  sig { void }
  def prepare_tokens; end

  # Some bastard moved our IO stream cursor. Restore it.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/buffer.rb:182
  sig { void }
  def reset_pos; end
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/buffer.rb:189
  sig { void }
  def save_pos; end
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/buffer.rb:211
  sig { returns(Symbol) }
  def state; end
end

# source://pdf-reader-2.10.0/lib/pdf/reader/buffer.rb:52
PDF::Reader::Buffer::CR = T.let(T.unsafe(nil), String)

# source://pdf-reader-2.10.0/lib/pdf/reader/buffer.rb:54
PDF::Reader::Buffer::CRLF = T.let(T.unsafe(nil), String)

# must match whole tokens
#
# source://pdf-reader-2.10.0/lib/pdf/reader/buffer.rb:63
PDF::Reader::Buffer::DIGITS_ONLY = T.let(T.unsafe(nil), Regexp)

# source://pdf-reader-2.10.0/lib/pdf/reader/buffer.rb:50
PDF::Reader::Buffer::FWD_SLASH = T.let(T.unsafe(nil), String)

# source://pdf-reader-2.10.0/lib/pdf/reader/buffer.rb:49
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/buffer.rb:46
PDF::Reader::Buffer::LEFT_PAREN = T.let(T.unsafe(nil), String)

# source://pdf-reader-2.10.0/lib/pdf/reader/buffer.rb:47
PDF::Reader::Buffer::LESS_THAN = T.let(T.unsafe(nil), String)

# source://pdf-reader-2.10.0/lib/pdf/reader/buffer.rb:53
PDF::Reader::Buffer::LF = T.let(T.unsafe(nil), String)

# source://pdf-reader-2.10.0/lib/pdf/reader/buffer.rb:51
PDF::Reader::Buffer::NULL_BYTE = T.let(T.unsafe(nil), String)

# source://pdf-reader-2.10.0/lib/pdf/reader/buffer.rb:48
PDF::Reader::Buffer::STREAM = T.let(T.unsafe(nil), String)

# source://pdf-reader-2.10.0/lib/pdf/reader/buffer.rb:42
PDF::Reader::Buffer::TOKEN_DELIMITER = T.let(T.unsafe(nil), Array)

# source://pdf-reader-2.10.0/lib/pdf/reader/buffer.rb:41
...
# Allow for this here
#
# source://pdf-reader-2.10.0/lib/pdf/reader/buffer.rb:60
PDF::Reader::Buffer::TRAILING_BYTECOUNT = T.let(T.unsafe(nil), Integer)

# source://pdf-reader-2.10.0/lib/pdf/reader/buffer.rb:55
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/cmap.rb:35
class PDF::Reader::CMap
  # @return [CMap] a new instance of CMap
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/cmap.rb:51
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/cmap.rb:64
  def decode(c); end

  # Returns the value of attribute map.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/cmap.rb:49
  def map; end

  # source://pdf-reader-2.10.0/lib/pdf/reader/cmap.rb:56
  sig { returns(Integer) }
  def size; end

  private

  # source://pdf-reader-2.10.0/lib/pdf/reader/cmap.rb:158
  def bfrange_type_one(start_code, end_code, dst); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/cmap.rb:171
  def bfrange_type_two(start_code, end_code, dst); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/cmap.rb:99
  def build_parser(instructions); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/cmap.rb:136
  def process_bfchar_instructions(instructions); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/cmap.rb:146
  def process_bfrange_instructions(instructions); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/cmap.rb:70
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/cmap.rb:112
  def str_to_int(str); end
end

# source://pdf-reader-2.10.0/lib/pdf/reader/cmap.rb:37
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/cid_widths.rb:15
class PDF::Reader::CidWidths
  extend ::Forwardable

  # @return [CidWidths] a new instance of CidWidths
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/cid_widths.rb:21
  ...
  # source://pdf-reader-2.10.0/lib/pdf/reader/cid_widths.rb:27
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/cid_widths.rb:46
  ...
  # @raise [MalformedPDFError]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/cid_widths.rb:54
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/encoding.rb:33
class PDF::Reader::Encoding
  # @return [Encoding] a new instance of Encoding
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/encoding.rb:40
  def initialize(enc); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/encoding.rb:88
  ...
  #   [25, :A, :B]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/encoding.rb:71
  ...
  #     => [:A]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/encoding.rb:121
  def int_to_name(glyph_code); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/encoding.rb:112
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/encoding.rb:104
  def to_utf8(str); end

  # Returns the value of attribute unpack.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/encoding.rb:38
  def unpack; end

  private

  # source://pdf-reader-2.10.0/lib/pdf/reader/encoding.rb:169
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/encoding.rb:140
  sig { returns(T.untyped) }
  def default_mapping; end

  # source://pdf-reader-2.10.0/lib/pdf/reader/encoding.rb:184
  def get_mapping_file(enc); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/encoding.rb:175
  def get_unpack(enc); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/encoding.rb:205
  sig { returns(T.untyped) }
  def glyphlist; end

  # source://pdf-reader-2.10.0/lib/pdf/reader/encoding.rb:150
  def internal_int_to_utf8_string(glyph_code); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/encoding.rb:162
  def little_boxes(times); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/encoding.rb:209
  def load_mapping(file); end

  # @return [Boolean]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/encoding.rb:158
  sig { returns(T.untyped) }
  def utf8_conversion_impossible?; end
end

# source://pdf-reader-2.10.0/lib/pdf/reader/encoding.rb:34
PDF::Reader::Encoding::CONTROL_CHARS = T.let(T.unsafe(nil), Array)

# ▯
#
# source://pdf-reader-2.10.0/lib/pdf/reader/encoding.rb:36
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/error.rb:84
...
# are valid
#
# source://pdf-reader-2.10.0/lib/pdf/reader/error.rb:32
class PDF::Reader::Error
  class << self
    # @raise [MalformedPDFError]
    #
    # source://pdf-reader-2.10.0/lib/pdf/reader/error.rb:46
    def assert_equal(lvalue, rvalue); end

    # @raise [MalformedPDFError]
    #
    # source://pdf-reader-2.10.0/lib/pdf/reader/error.rb:34
    def str_assert(lvalue, rvalue, chars = T.unsafe(nil)); end

    # @raise [MalformedPDFError]
    #
    # source://pdf-reader-2.10.0/lib/pdf/reader/error.rb:40
    def str_assert_not(lvalue, rvalue, chars = T.unsafe(nil)); end

    # @raise [ArgumentError]
    #
    # source://pdf-reader-2.10.0/lib/pdf/reader/error.rb:58
    def validate_not_nil(object, name); end

    # @raise [ArgumentError]
    #
    # source://pdf-reader-2.10.0/lib/pdf/reader/error.rb:50
    def validate_type(object, name, klass); end

    # @raise [MalformedPDFError]
    #
    # source://pdf-reader-2.10.0/lib/pdf/reader/error.rb:54
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/overlapping_runs_filter.rb:56
class PDF::Reader::EventPoint
  # @return [EventPoint] a new instance of EventPoint
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/overlapping_runs_filter.rb:62
  def initialize(x, run); end

  # Returns the value of attribute run.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/overlapping_runs_filter.rb:60
  def run; end

  # @return [Boolean]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/overlapping_runs_filter.rb:67
  sig { returns(T::Boolean) }
  def start?; end

  # Returns the value of attribute x.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/overlapping_runs_filter.rb:58
  def x; end
end
...
# content.
#
# source://pdf-reader-2.10.0/lib/pdf/reader/filter.rb:36
module PDF::Reader::Filter
  class << self
    ...
    #
    # source://pdf-reader-2.10.0/lib/pdf/reader/filter.rb:44
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/filter/ascii85.rb:10
class PDF::Reader::Filter::Ascii85
  # @return [Ascii85] a new instance of Ascii85
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/filter/ascii85.rb:12
  def initialize(options = T.unsafe(nil)); end

  # Decode the specified data using the Ascii85 algorithm. Relies on the AScii85
  # rubygem.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/filter/ascii85.rb:20
  def filter(data); end
end

# implementation of the AsciiHex stream filter
#
# source://pdf-reader-2.10.0/lib/pdf/reader/filter/ascii_hex.rb:9
class PDF::Reader::Filter::AsciiHex
  # @return [AsciiHex] a new instance of AsciiHex
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/filter/ascii_hex.rb:11
  def initialize(options = T.unsafe(nil)); end

  # Decode the specified data using the AsciiHex algorithm.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/filter/ascii_hex.rb:18
  def filter(data); end
end
...
# improve compression
#
# source://pdf-reader-2.10.0/lib/pdf/reader/filter/depredict.rb:9
class PDF::Reader::Filter::Depredict
  # @return [Depredict] a new instance of Depredict
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/filter/depredict.rb:11
  def initialize(options = T.unsafe(nil)); end

  # Streams can be preprocessed to improve compression. This reverses the
  # preprocessing
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/filter/depredict.rb:19
  def filter(data); end

  private

  # source://pdf-reader-2.10.0/lib/pdf/reader/filter/depredict.rb:63
  def png_depredict(data); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/filter/depredict.rb:37
  def tiff_depredict(data); end
end

# implementation of the Flate (zlib) stream filter
#
# source://pdf-reader-2.10.0/lib/pdf/reader/filter/flate.rb:11
class PDF::Reader::Filter::Flate
  # @return [Flate] a new instance of Flate
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/filter/flate.rb:16
  def initialize(options = T.unsafe(nil)); end

  # Decode the specified data with the Zlib compression algorithm
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/filter/flate.rb:22
  def filter(data); end

  private

  # source://pdf-reader-2.10.0/lib/pdf/reader/filter/flate.rb:34
  def zlib_inflate(data); end
end

# Zlib::MAX_WBITS + 32
#
# source://pdf-reader-2.10.0/lib/pdf/reader/filter/flate.rb:13
PDF::Reader::Filter::Flate::ZLIB_AUTO_DETECT_ZLIB_OR_GZIP = T.let(T.unsafe(nil), Integer)

# Zlib::MAX_WBITS * -1
#
# source://pdf-reader-2.10.0/lib/pdf/reader/filter/flate.rb:14
PDF::Reader::Filter::Flate::ZLIB_RAW_DEFLATE = T.let(T.unsafe(nil), Integer)

# implementation of the LZW stream filter
#
# source://pdf-reader-2.10.0/lib/pdf/reader/filter/lzw.rb:9
class PDF::Reader::Filter::Lzw
  # @return [Lzw] a new instance of Lzw
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/filter/lzw.rb:11
  def initialize(options = T.unsafe(nil)); end

  # Decode the specified data with the LZW compression algorithm
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/filter/lzw.rb:17
  def filter(data); end
end

# implementation of the null stream filter
#
# source://pdf-reader-2.10.0/lib/pdf/reader/filter/null.rb:8
class PDF::Reader::Filter::Null
  # @return [Null] a new instance of Null
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/filter/null.rb:9
  def initialize(options = T.unsafe(nil)); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/filter/null.rb:13
  def filter(data); end
end

# implementation of the run length stream filter
#
# source://pdf-reader-2.10.0/lib/pdf/reader/filter/run_length.rb:9
class PDF::Reader::Filter::RunLength
  # @return [RunLength] a new instance of RunLength
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/filter/run_length.rb:11
  def initialize(options = T.unsafe(nil)); end

  # Decode the specified data with the RunLengthDecode compression algorithm
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/filter/run_length.rb:17
  def filter(data); end
end
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/font.rb:36
class PDF::Reader::Font
  # @return [Font] a new instance of Font
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/font.rb:41
  def initialize(ohash, obj); end

  # Returns the value of attribute basefont.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/font.rb:38
  def basefont; end
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/font.rb:37
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/font.rb:68
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/font.rb:81
  ...
  # source://pdf-reader-2.10.0/lib/pdf/reader/font.rb:54
  ...
  # source://pdf-reader-2.10.0/lib/pdf/reader/font.rb:62
  def unpack(data); end
  ...
  # source://pdf-reader-2.10.0/lib/pdf/reader/font.rb:152
  def build_encoding(obj); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/font.rb:126
  sig do
  ...
  # source://pdf-reader-2.10.0/lib/pdf/reader/font.rb:115
  def default_encoding(font_name); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/font.rb:166
  def extract_base_info(obj); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/font.rb:207
  def extract_descendants(obj); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/font.rb:196
  def extract_descriptor(obj); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/font.rb:188
  def extract_type3_info(obj); end

  # Only valid for Type3 fonts
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/font.rb:96
  def font_matrix_transform(x, y); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/font.rb:221
  def to_utf8_via_cmap(params); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/font.rb:236
  def to_utf8_via_encoding(params); end
end

# Font descriptors are outlined in Section 9.8, PDF 32000-1:2008, pp 281-288
#
# source://pdf-reader-2.10.0/lib/pdf/reader/font_descriptor.rb:10
class PDF::Reader::FontDescriptor
  # @return [FontDescriptor] a new instance of FontDescriptor
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/font_descriptor.rb:17
  def initialize(ohash, fd_hash); end

  # Returns the value of attribute ascent.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/font_descriptor.rb:12
  def ascent; end
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/font_descriptor.rb:68
  sig { returns(Numeric) }
  def glyph_to_pdf_scale_factor; end

  # source://pdf-reader-2.10.0/lib/pdf/reader/font_descriptor.rb:50
  ...
  # source://pdf-reader-2.10.0/lib/pdf/reader/font_descriptor.rb:79
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/form_xobject.rb:17
class PDF::Reader::FormXObject
  extend ::Forwardable

  # @return [FormXObject] a new instance of FormXObject
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/form_xobject.rb:31
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/form_xobject.rb:45
  sig { returns(T.untyped) }
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/form_xobject.rb:67
  sig { returns(T.untyped) }
  def raw_content; end
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/form_xobject.rb:57
  sig { params(receivers: T.untyped).returns(T.untyped) }
  def walk(*receivers); end

  # Returns the value of attribute xobject.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/form_xobject.rb:20
  def xobject; end
  ...
  # source://pdf-reader-2.10.0/lib/pdf/reader/form_xobject.rb:89
  sig { returns(T.untyped) }
  def cached_tokens_key; end

  # source://pdf-reader-2.10.0/lib/pdf/reader/form_xobject.rb:79
  def callback(receivers, name, params = T.unsafe(nil)); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/form_xobject.rb:105
  def content_stream(receivers, instructions); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/form_xobject.rb:85
  sig { returns(T.untyped) }
  def content_stream_md5; end

  # Returns the resources that accompany this form.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/form_xobject.rb:75
  sig { returns(T.untyped) }
  def resources; end

  # source://pdf-reader-2.10.0/lib/pdf/reader/form_xobject.rb:93
  sig { returns(T.untyped) }
  def tokens; end
end
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/glyph_hash.rb:34
class PDF::Reader::GlyphHash
  # @return [GlyphHash] a new instance of GlyphHash
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/glyph_hash.rb:35
  sig { void }
  def initialize; end
  ...
  #   => 34
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/glyph_hash.rb:62
  ...
  #   => [:34]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/glyph_hash.rb:99
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/glyph_hash.rb:108
  sig { returns(T.untyped) }
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/error.rb:74
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/error.rb:70
...
# * Version 5 (AESV3)
#
# source://pdf-reader-2.10.0/lib/pdf/reader/key_builder_v5.rb:17
class PDF::Reader::KeyBuilderV5
  # @return [KeyBuilderV5] a new instance of KeyBuilderV5
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/key_builder_v5.rb:19
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/key_builder_v5.rb:41
  def key(pass); end
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/key_builder_v5.rb:61
  def auth_owner_pass(password); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/key_builder_v5.rb:83
  def auth_owner_pass_r6(password); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/key_builder_v5.rb:72
  def auth_user_pass(password); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/key_builder_v5.rb:94
  def auth_user_pass_r6(password); end

  # PDF 2.0 spec, 7.6.4.3.4
  # Algorithm 2.B: Computing a hash (revision 6 and later)
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/key_builder_v5.rb:107
  def r6_digest(password, salt, user_key = T.unsafe(nil)); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/key_builder_v5.rb:131
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/lzw.rb:20
class PDF::Reader::LZW
  class << self
    # Decompresses a LZW compressed string.
    #
    # source://pdf-reader-2.10.0/lib/pdf/reader/lzw.rb:91
    def decode(data); end
    ...
    # @raise [MalformedPDFError]
    #
    # source://pdf-reader-2.10.0/lib/pdf/reader/lzw.rb:128
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/lzw.rb:23
class PDF::Reader::LZW::BitStream
  # @return [BitStream] a new instance of BitStream
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/lzw.rb:25
  def initialize(data, bits_in_chunk); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/lzw.rb:39
  sig { returns(Integer) }
  def read; end

  # @raise [MalformedPDFError]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/lzw.rb:33
  def set_bits_in_chunk(bits_in_chunk); end
end

# clear table
#
# source://pdf-reader-2.10.0/lib/pdf/reader/lzw.rb:63
PDF::Reader::LZW::CODE_CLEAR_TABLE = T.let(T.unsafe(nil), Integer)

# end of data
#
# source://pdf-reader-2.10.0/lib/pdf/reader/lzw.rb:62
PDF::Reader::LZW::CODE_EOD = T.let(T.unsafe(nil), Integer)

# stores de pairs code => string
#
# source://pdf-reader-2.10.0/lib/pdf/reader/lzw.rb:66
class PDF::Reader::LZW::StringTable
  # @return [StringTable] a new instance of StringTable
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/lzw.rb:69
  sig { void }
  def initialize; end

  # if code less than 258 return fixed string
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/lzw.rb:75
  def [](key); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/lzw.rb:83
  def add(string); end

  # Returns the value of attribute string_table_pos.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/lzw.rb:67
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/error.rb:66
class PDF::Reader::MalformedPDFError < ::RuntimeError; end

# A null object security handler. Used when a PDF is unencrypted.
#
# source://pdf-reader-2.10.0/lib/pdf/reader/null_security_handler.rb:8
class PDF::Reader::NullSecurityHandler
  # source://pdf-reader-2.10.0/lib/pdf/reader/null_security_handler.rb:10
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/object_cache.rb:13
class PDF::Reader::ObjectCache
  # @return [ObjectCache] a new instance of ObjectCache
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_cache.rb:22
  def initialize(lru_size = T.unsafe(nil)); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/object_cache.rb:29
  def [](key); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/object_cache.rb:34
  def []=(key, value); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/object_cache.rb:47
  sig { params(block: T.untyped).returns(T.untyped) }
  def each(&block); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/object_cache.rb:53
  sig { params(block: T.untyped).returns(T.untyped) }
  ...
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_cache.rb:58
  sig { params(block: T.untyped).returns(T.untyped) }
  def each_value(&block); end

  # @return [Boolean]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_cache.rb:68
  sig { returns(T.untyped) }
  def empty?; end

  # source://pdf-reader-2.10.0/lib/pdf/reader/object_cache.rb:42
  def fetch(key, local_default = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_cache.rb:72
  def has_key?(key); end

  # @return [Boolean]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_cache.rb:79
  def has_value?(value); end

  # Returns the value of attribute hits.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_cache.rb:20
  def hits; end
  ...
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_cache.rb:87
  sig { returns(T.untyped) }
  def keys; end

  # source://pdf-reader-2.10.0/lib/pdf/reader/object_cache.rb:63
  def length; end
  ...
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_cache.rb:83
  sig { returns(T.untyped) }
  def to_s; end

  # source://pdf-reader-2.10.0/lib/pdf/reader/object_cache.rb:91
  sig { returns(T.untyped) }
  def values; end
  ...
  # @return [Boolean]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_cache.rb:105
  def cacheable?(obj); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/object_cache.rb:97
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/object_cache.rb:18
...
#     => 3469
#
# source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:30
class PDF::Reader::ObjectHash
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:44
  def initialize(input, opts = T.unsafe(nil)); end
  ...
  # can be specified.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:79
  def [](key); end

  # Returns the value of attribute default.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:33
  def default; end
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:105
  def deref_array(key); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:318
  def deref_array!(key); end
  ...
  # @raise [MalformedPDFError]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:123
  ...
  # expecting an Array and no other type will do.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:149
  def deref_hash(key); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:326
  def deref_hash!(key); end
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:191
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:167
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:281
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:215
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:239
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:299
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:259
  def deref_string(key); end

  # iterate over each key, value. Just like a ruby hash.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:359
  sig { params(block: T.untyped).returns(T.untyped) }
  def each(&block); end

  # iterate over each key. Just like a ruby hash.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:368
  sig { params(block: T.untyped).returns(T.untyped) }
  def each_key(&block); end
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:376
  sig { params(block: T.untyped).returns(T.untyped) }
  def each_value(&block); end
  ...
  # @return [Boolean]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:391
  sig { returns(T::Boolean) }
  def empty?; end

  # @return [Boolean]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:474
  sig { returns(T::Boolean) }
  def encrypted?; end
  ...
  # exist.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:346
  def fetch(key, local_default = T.unsafe(nil)); end
  ...
  # @return [Boolean]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:398
  ...
  # @return [Boolean]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:415
  def has_value?(value); end
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:430
  ...
  # is counted once.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:384
  def length; end
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:59
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:466
  sig { returns(T::Array[PDF::Reader::Reference]) }
  def page_references; end

  # Returns the value of attribute pdf_version.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:34
  def pdf_version; end

  # Returns the value of attribute sec_handler.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:35
  def sec_handler; end

  # @return [Boolean]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:478
  sig { returns(T::Boolean) }
  def sec_handler?; end
  ...
  # @return [Boolean]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:66
  def stream?(ref); end

  # return an array of arrays. Each sub array contains a key/value pair.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:452
  sig { returns(T.untyped) }
  def to_a; end

  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:424
  sig { returns(String) }
  def to_s; end
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:438
  sig { returns(T.untyped) }
  def values; end

  # return an array of all values from the specified keys
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:446
  sig { params(ids: T.untyped).returns(T.untyped) }
  def values_at(*ids); end

  private

  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:539
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:510
  def deref_internal!(key, seen); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:599
  def extract_io_from(input); end

  # parse a traditional object from the PDF, starting from the byte offset indicated
  # in the xref table
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:487
  def fetch_object(key); end

  # parse a object that's embedded in an object stream in the PDF
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:496
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:575
  def get_page_objects(obj); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:560
  def new_buffer(offset = T.unsafe(nil)); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:568
  sig { returns(T.untyped) }
  def object_streams; end

  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:609
  def read_as_binary(input); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:592
  sig { returns(Float) }
  def read_version; end

  # source://pdf-reader-2.10.0/lib/pdf/reader/object_hash.rb:564
  sig { returns(T.untyped) }
  def xref; end
end
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/object_stream.rb:10
class PDF::Reader::ObjectStream
  # @return [ObjectStream] a new instance of ObjectStream
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/object_stream.rb:11
  def initialize(stream); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/object_stream.rb:16
  def [](objid); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/object_stream.rb:26
  sig { returns(Integer) }
  def size; end

  private

  # source://pdf-reader-2.10.0/lib/pdf/reader/object_stream.rb:46
  sig { returns(PDF::Reader::Buffer) }
  def buffer; end

  # source://pdf-reader-2.10.0/lib/pdf/reader/object_stream.rb:42
  sig { returns(Integer) }
  def first; end

  # source://pdf-reader-2.10.0/lib/pdf/reader/object_stream.rb:32
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/overlapping_runs_filter.rb:8
class PDF::Reader::OverlappingRunsFilter
  class << self
    # source://pdf-reader-2.10.0/lib/pdf/reader/overlapping_runs_filter.rb:41
    def detect_intersection(sweep_line_status, event_point); end

    # source://pdf-reader-2.10.0/lib/pdf/reader/overlapping_runs_filter.rb:14
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/overlapping_runs_filter.rb:12
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/page.rb:16
class PDF::Reader::Page
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page.rb:44
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page.rb:69
  sig { returns(T::Hash[Symbol, T.untyped]) }
  def attributes; end
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page.rb:191
  ...
  # operations
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page.rb:28
  def cache; end
  ...
  # source://pdf-reader-2.10.0/lib/pdf/reader/page.rb:81
  sig { returns(Numeric) }
  def height; end

  # return a friendly string representation of this page
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page.rb:62
  sig { returns(String) }
  def inspect; end

  # return the number of this page within the full document
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page.rb:56
  sig { returns(Integer) }
  def number; end

  # lowlevel hash-like access to all objects in the underlying PDF
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page.rb:20
  def objects; end

  # Convenience method to identify the page's orientation.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page.rb:102
  sig { returns(String) }
  def orientation; end

  # source://pdf-reader-2.10.0/lib/pdf/reader/page.rb:93
  sig { returns(T::Array[Numeric]) }
  def origin; end

  # the raw PDF object that defines this page
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page.rb:23
  def page_object; end
  ...
  # see here unless you're a PDF nerd like me.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page.rb:165
  sig { returns(String) }
  def raw_content; end
  ...
  # values are defaulted according to section 7.7.3.3 of the PDF Spec 1.7
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page.rb:199
  sig { returns(T::Hash[Symbol, PDF::Reader::Rectangle]) }
  def rectangles; end

  # returns the angle to rotate the page clockwise. Always 0, 90, 180 or 270
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page.rb:176
  sig { returns(Integer) }
  def rotate; end

  # source://pdf-reader-2.10.0/lib/pdf/reader/page.rb:125
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page.rb:113
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page.rb:154
  sig { params(receivers: T.untyped).void }
  def walk(*receivers); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/page.rb:87
  sig { returns(Numeric) }
  def width; end
  ...
  # source://pdf-reader-2.10.0/lib/pdf/reader/page.rb:276
  def ancestors(origin = T.unsafe(nil)); end

  # calls the name callback method on each receiver object with params as the arguments
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page.rb:266
  def callback(receivers, name, params = T.unsafe(nil)); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/page.rb:247
  def content_stream(receivers, instructions); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/page.rb:272
  sig { returns(T.untyped) }
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page.rb:243
  sig { returns(PDF::Reader::Resources) }
  def resources; end

  # source://pdf-reader-2.10.0/lib/pdf/reader/page.rb:236
  sig { returns(T::Hash[Symbol, T.untyped]) }
  def root; end
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page.rb:291
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/page_layout.rb:15
class PDF::Reader::PageLayout
  # @return [PageLayout] a new instance of PageLayout
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page_layout.rb:19
  ...
  # source://pdf-reader-2.10.0/lib/pdf/reader/page_layout.rb:34
  sig { returns(String) }
  def to_s; end

  private

  # source://pdf-reader-2.10.0/lib/pdf/reader/page_layout.rb:80
  sig { returns(T.untyped) }
  def col_count; end

  # source://pdf-reader-2.10.0/lib/pdf/reader/page_layout.rb:88
  sig { returns(T.untyped) }
  ...
  #   => [ "one", "two" ]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page_layout.rb:65
  def interesting_rows(rows); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/page_layout.rb:108
  def local_string_insert(haystack, needle, index); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/page_layout.rb:92
  def mean(collection); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/page_layout.rb:100
  def median(collection); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/page_layout.rb:55
  def page_height; end

  # source://pdf-reader-2.10.0/lib/pdf/reader/page_layout.rb:51
  def page_width; end

  # source://pdf-reader-2.10.0/lib/pdf/reader/page_layout.rb:112
  def process_mediabox(mediabox); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/page_layout.rb:76
  sig { returns(T.untyped) }
  def row_count; end

  # source://pdf-reader-2.10.0/lib/pdf/reader/page_layout.rb:84
  sig { returns(T.untyped) }
  def row_multiplier; end
end

# source://pdf-reader-2.10.0/lib/pdf/reader/page_layout.rb:17
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/page_state.rb:11
class PDF::Reader::PageState
  # starting a new page
  #
  # @return [PageState] a new instance of PageState
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page_state.rb:26
  def initialize(page); end

  # Text Object Operators
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page_state.rb:90
  sig { returns(T.untyped) }
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page_state.rb:291
  sig { returns(T.untyped) }
  def clone_state; end
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page_state.rb:72
  def concatenate_matrix(a, b, c, d, e, f); end

  # transform x and y co-ordinates from the current user space to the
  # underlying device space.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page_state.rb:227
  def ctm_transform(x, y); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/page_state.rb:252
  sig { returns(T.untyped) }
  def current_font; end

  # source://pdf-reader-2.10.0/lib/pdf/reader/page_state.rb:96
  sig { returns(T.untyped) }
  def end_text_object; end

  # source://pdf-reader-2.10.0/lib/pdf/reader/page_state.rb:263
  def find_color_space(label); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/page_state.rb:256
  def find_font(label); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/page_state.rb:270
  def find_xobject(label); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/page_state.rb:117
  sig { returns(T.untyped) }
  def font_size; end
  ...
  # @raise [MalformedPDFError]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page_state.rb:198
  def invoke_xobject(label); end

  # Text Positioning Operators
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page_state.rb:145
  def move_text_position(x, y); end

  # TD
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page_state.rb:158
  def move_text_position_and_set_leading(x, y); end

  # '
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page_state.rb:185
  def move_to_next_line_and_show_text(str); end

  # T*
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page_state.rb:173
  sig { returns(T.untyped) }
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page_state.rb:321
  def process_glyph_displacement(w0, tj, word_boundary); end

  # Restore the state to the previous value on the stack.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page_state.rb:57
  sig { returns(T.untyped) }
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page_state.rb:51
  sig { returns(T.untyped) }
  def save_graphics_state; end

  # Text State Operators
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page_state.rb:104
  def set_character_spacing(char_spacing); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/page_state.rb:108
  def set_horizontal_text_scaling(h_scaling); end

  # "
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page_state.rb:189
  def set_spacing_next_line_show_text(aw, ac, string); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/page_state.rb:112
  def set_text_font_and_size(label, size); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/page_state.rb:125
  def set_text_leading(leading); end

  # Tm
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page_state.rb:163
  def set_text_matrix_and_text_line_matrix(a, b, c, d, e, f); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/page_state.rb:129
  def set_text_rendering_mode(mode); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/page_state.rb:133
  def set_text_rise(rise); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/page_state.rb:137
  def set_word_spacing(word_spacing); end

  # Text Showing Operators
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page_state.rb:181
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page_state.rb:281
  sig { returns(T.untyped) }
  def stack_depth; end
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page_state.rb:240
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page_state.rb:391
  def build_fonts(raw_fonts); end

  # return the current transformation matrix
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page_state.rb:381
  sig { returns(T.untyped) }
  def ctm; end
  ...
  #   g h i
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page_state.rb:410
  sig { returns(T.untyped) }
  def identity_matrix; end

  # source://pdf-reader-2.10.0/lib/pdf/reader/page_state.rb:385
  sig { returns(T.untyped) }
  def state; end
  ...
  # text, so memoize it
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page_state.rb:359
  sig { returns(T.untyped) }
  def text_rendering_matrix; end
end

# source://pdf-reader-2.10.0/lib/pdf/reader/page_state.rb:13
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/page_text_receiver.rb:14
class PDF::Reader::PageTextReceiver
  ...
  # deprecated
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page_text_receiver.rb:73
  sig { returns(T.untyped) }
  def content; end
  ...
  # XObjects
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page_text_receiver.rb:112
  def invoke_xobject(label); end
  ...
  # '
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page_text_receiver.rb:98
  def move_to_next_line_and_show_text(str); end
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page_text_receiver.rb:19
  def options; end

  # starting a new page
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page_text_receiver.rb:43
  def page=(page); end

  # source://RUBY_ROOT/forwardable.rb:229
  def restore_graphics_state(*args, **_arg1, &block); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/page_text_receiver.rb:50
  def runs(opts = T.unsafe(nil)); end
  ...
  # "
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page_text_receiver.rb:103
  def set_spacing_next_line_show_text(aw, ac, string); end
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page_text_receiver.rb:82
  def show_text(string); end

  # TJ [(A) 120 (WA) 20 (Y)]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page_text_receiver.rb:86
  def show_text_with_positioning(params); end
  ...
  # source://pdf-reader-2.10.0/lib/pdf/reader/page_text_receiver.rb:148
  def apply_rotation(x, y); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/page_text_receiver.rb:174
  def group_chars_into_runs(chars); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/page_text_receiver.rb:123
  def internal_show_text(string); end

  # take a collection of TextRun objects and merge any that are in close
  # proximity
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/page_text_receiver.rb:166
  def merge_runs(runs); end
end

# source://pdf-reader-2.10.0/lib/pdf/reader/page_text_receiver.rb:17
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/pages_strategy.rb:108
class PDF::Reader::PagesStrategy; end

# source://pdf-reader-2.10.0/lib/pdf/reader/pages_strategy.rb:109
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/parser.rb:34
class PDF::Reader::Parser
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/parser.rb:65
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/parser.rb:98
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/parser.rb:74
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/parser.rb:150
  sig { returns(T::Array[T.untyped]) }
  def array; end

  # reads a PDF dict from the buffer and converts it to a Ruby Hash.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/parser.rb:123
  sig { returns(T::Hash[Symbol, T.untyped]) }
  def dictionary; end

  # Reads a PDF hex string from the buffer and converts it to a Ruby String
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/parser.rb:164
  sig { returns(String) }
  def hex_string; end

  # reads a PDF name from the buffer and converts it to a Ruby Symbol
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/parser.rb:141
  sig { returns(Symbol) }
  def pdf_name; end
  ...
  # @raise [MalformedPDFError]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/parser.rb:215
  def stream(dict); end

  # Reads a PDF String from the buffer and converts it to a Ruby String
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/parser.rb:182
  sig { returns(String) }
  def string; end
end

# source://pdf-reader-2.10.0/lib/pdf/reader/parser.rb:197
PDF::Reader::Parser::MAPPING = T.let(T.unsafe(nil), Hash)

# source://pdf-reader-2.10.0/lib/pdf/reader/parser.rb:38
PDF::Reader::Parser::STRATEGIES = T.let(T.unsafe(nil), Hash)

# source://pdf-reader-2.10.0/lib/pdf/reader/parser.rb:36
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/point.rb:11
class PDF::Reader::Point
  # @return [Point] a new instance of Point
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/point.rb:15
  def initialize(x, y); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/point.rb:19
  def ==(other); end

  # Returns the value of attribute x.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/point.rb:13
  sig { returns(Numeric) }
  def x; end
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/print_receiver.rb:9
class PDF::Reader::PrintReceiver
  # @return [PrintReceiver] a new instance of PrintReceiver
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/print_receiver.rb:13
  sig { void }
  def initialize; end

  # Returns the value of attribute callbacks.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/print_receiver.rb:11
  def callbacks; end
  ...
  # source://pdf-reader-2.10.0/lib/pdf/reader/print_receiver.rb:21
  def method_missing(methodname, *args); end

  # @return [Boolean]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/print_receiver.rb:17
...
# a decryption key, which is usually generated by PDF::Reader::StandardKeyBuilder
#
# source://pdf-reader-2.10.0/lib/pdf/reader/rc4_security_handler.rb:13
class PDF::Reader::Rc4SecurityHandler
  # @return [Rc4SecurityHandler] a new instance of Rc4SecurityHandler
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/rc4_security_handler.rb:15
  def initialize(key); end
  ...
  # ref - a PDF::Reader::Reference for the object to decrypt
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/rc4_security_handler.rb:28
  def decrypt(buf, ref); end
end
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/rectangle.rb:21
class PDF::Reader::Rectangle
  # @return [Rectangle] a new instance of Rectangle
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/rectangle.rb:25
  def initialize(x1, y1, x2, y2); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/rectangle.rb:42
  def ==(other); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/rectangle.rb:69
  def apply_rotation(degrees); end

  # Returns the value of attribute bottom_left.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/rectangle.rb:23
  ...
  # @return [Boolean]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/rectangle.rb:54
  def contains?(point); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/rectangle.rb:46
  sig { returns(Numeric) }
  def height; end

  # A pdf-style 4-number array
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/rectangle.rb:60
  sig { returns(T::Array[Numeric]) }
  def to_a; end
  ...
  # source://pdf-reader-2.10.0/lib/pdf/reader/rectangle.rb:50
  sig { returns(Numeric) }
  def width; end

  private

  # source://pdf-reader-2.10.0/lib/pdf/reader/rectangle.rb:93
  def set_corners(x1, y1, x2, y2); end

  class << self
    # source://pdf-reader-2.10.0/lib/pdf/reader/rectangle.rb:29
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/reference.rb:33
class PDF::Reader::Reference
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/reference.rb:37
  def initialize(id, gen); end

  # returns true if the provided object points to the same PDF Object as the
  # current object
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/reference.rb:53
  def ==(obj); end
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/reference.rb:34
  def gen; end
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/reference.rb:63
  sig { returns(T.untyped) }
  def hash; end
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/reference.rb:42
  sig { returns(T.untyped) }
  def to_a; end

  # returns the ID of this reference. Use with caution, ignores the generation id
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/reference.rb:47
  sig { returns(T.untyped) }
  def to_i; end
end
...
#     end
#
# source://pdf-reader-2.10.0/lib/pdf/reader/register_receiver.rb:23
class PDF::Reader::RegisterReceiver
  # @return [RegisterReceiver] a new instance of RegisterReceiver
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/register_receiver.rb:27
  sig { void }
  def initialize; end

  # return the details for every time the specified callback was fired
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/register_receiver.rb:45
  def all(methodname); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/register_receiver.rb:49
  def all_args(methodname); end

  # Returns the value of attribute callbacks.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/register_receiver.rb:25
  def callbacks; end
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/register_receiver.rb:40
  def count(methodname); end

  # return the details for the final time the specified callback was fired
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/register_receiver.rb:59
  def final_occurance_of(methodname); end

  # return the details for the first time the specified callback was fired
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/register_receiver.rb:54
  def first_occurance_of(methodname); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/register_receiver.rb:35
  def method_missing(methodname, *args); end

  # @return [Boolean]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/register_receiver.rb:31
  def respond_to?(meth); end

  # return the first occurance of a particular series of callbacks
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/register_receiver.rb:64
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/resources.rb:10
class PDF::Reader::Resources
  # @return [Resources] a new instance of Resources
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/resources.rb:12
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/resources.rb:23
  sig { returns(T::Hash[Symbol, T.untyped]) }
  ...
  #       of calling it over and over.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/resources.rb:33
  sig { returns(T::Hash[Symbol, T.untyped]) }
  def fonts; end
  ...
  #       of calling it over and over.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/resources.rb:44
  sig { returns(T::Hash[Symbol, T.untyped]) }
  ...
  #       of calling it over and over.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/resources.rb:54
  sig { returns(T::Hash[Symbol, T.untyped]) }
  def patterns; end
  ...
  #       of calling it over and over.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/resources.rb:64
  ...
  #       of calling it over and over.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/resources.rb:74
  sig { returns(T::Hash[Symbol, T.untyped]) }
  def properties; end
  ...
  #       of calling it over and over.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/resources.rb:84
  sig { returns(T::Hash[Symbol, T.untyped]) }
  def shadings; end
  ...
  #       of calling it over and over.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/resources.rb:94
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/security_handler_factory.rb:8
class PDF::Reader::SecurityHandlerFactory
  class << self
    # source://pdf-reader-2.10.0/lib/pdf/reader/security_handler_factory.rb:10
    def build(encrypt, doc_id, password); end

    # source://pdf-reader-2.10.0/lib/pdf/reader/security_handler_factory.rb:25
    def build_standard_handler(encrypt, doc_id, password); end

    # source://pdf-reader-2.10.0/lib/pdf/reader/security_handler_factory.rb:44
    ...
    # @return [Boolean]
    #
    # source://pdf-reader-2.10.0/lib/pdf/reader/security_handler_factory.rb:55
    ...
    # @return [Boolean]
    #
    # source://pdf-reader-2.10.0/lib/pdf/reader/security_handler_factory.rb:68
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/standard_key_builder.rb:16
class PDF::Reader::StandardKeyBuilder
  # @return [StandardKeyBuilder] a new instance of StandardKeyBuilder
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/standard_key_builder.rb:28
  def initialize(opts = T.unsafe(nil)); end
  ...
  # @raise [PDF::Reader::EncryptedPDFError]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/standard_key_builder.rb:50
  def key(pass); end
  ...
  # then it returns nil
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/standard_key_builder.rb:87
  ...
  # then it returns nil
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/standard_key_builder.rb:113
  def auth_user_pass(pass); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/standard_key_builder.rb:127
  def make_file_key(user_pass); end

  # Pads supplied password to 32bytes using PassPadBytes as specified on
  # pp61 of spec
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/standard_key_builder.rb:63
  def pad_pass(p = T.unsafe(nil)); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/standard_key_builder.rb:71
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/standard_key_builder.rb:23
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/stream.rb:36
class PDF::Reader::Stream
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/stream.rb:42
  def initialize(hash, data); end

  # Returns the value of attribute data.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/stream.rb:37
  def data; end
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/stream.rb:49
  sig { returns(String) }
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/synchronized_cache.rb:22
class PDF::Reader::SynchronizedCache
  # @return [SynchronizedCache] a new instance of SynchronizedCache
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/synchronized_cache.rb:23
  sig { void }
  def initialize; end

  # source://pdf-reader-2.10.0/lib/pdf/reader/synchronized_cache.rb:27
  def [](key); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/synchronized_cache.rb:30
  def []=(key, value); end
end

# A value object that represents one or more consecutive characters on a page.
#
# source://pdf-reader-2.10.0/lib/pdf/reader/text_run.rb:7
class PDF::Reader::TextRun
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/text_run.rb:14
  def initialize(x, y, width, font_size, text); end

  # @raise [ArgumentError]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/text_run.rb:61
  def +(other); end
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/text_run.rb:23
  def <=>(other); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/text_run.rb:45
  sig { returns(T.untyped) }
  def endx; end

  # source://pdf-reader-2.10.0/lib/pdf/reader/text_run.rb:49
  sig { returns(T.untyped) }
  def endy; end

  # Returns the value of attribute font_size.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/text_run.rb:10
  def font_size; end

  # source://pdf-reader-2.10.0/lib/pdf/reader/text_run.rb:71
  sig { returns(T.untyped) }
  def inspect; end

  # @return [Boolean]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/text_run.rb:75
  def intersect?(other_run); end

  # return what percentage of this text run is overlapped by another run
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/text_run.rb:81
  def intersection_area_percent(other_run); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/text_run.rb:53
  sig { returns(T.untyped) }
  def mean_character_width; end

  # @return [Boolean]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/text_run.rb:57
  ...
  # source://pdf-reader-2.10.0/lib/pdf/reader/text_run.rb:37
  def x; end

  # source://pdf-reader-2.10.0/lib/pdf/reader/text_run.rb:41
  def y; end

  private

  # source://pdf-reader-2.10.0/lib/pdf/reader/text_run.rb:93
  sig { returns(T.untyped) }
  def area; end
  ...
  # character count
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/text_run.rb:103
  sig { returns(T.untyped) }
  def character_count; end

  # source://pdf-reader-2.10.0/lib/pdf/reader/text_run.rb:97
  sig { returns(T.untyped) }
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/token.rb:37
class PDF::Reader::Token < ::String
  # Creates a new token with the specified value
  #
  # @return [Token] a new instance of Token
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/token.rb:38
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/transformation_matrix.rb:16
class PDF::Reader::TransformationMatrix
  # @return [TransformationMatrix] a new instance of TransformationMatrix
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/transformation_matrix.rb:19
  def initialize(a, b, c, d, e, f); end

  # Returns the value of attribute a.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/transformation_matrix.rb:17
  def a; end
  ...
  #   [ 5 6 1 ]   [ e2 0 1 ]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/transformation_matrix.rb:93
  def horizontal_displacement_multiply!(e2); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/transformation_matrix.rb:23
  sig { returns(T.untyped) }
  def inspect; end
  ...
  #       writing systems
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/transformation_matrix.rb:54
  def multiply!(a, b = T.unsafe(nil), c = T.unsafe(nil), d = T.unsafe(nil), e = T.unsafe(nil), f = T.unsafe(nil)); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/transformation_matrix.rb:27
  sig { returns(T.untyped) }
  def to_a; end
  ...
  #   [ e f 1 ]   [ e f 1 ]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/transformation_matrix.rb:186
  ...
  #   [ 5 0 1 ]   [ 5 6 1 ]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/transformation_matrix.rb:108
  ...
  #   [ e f 1 ]   [ e f 1 ]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/transformation_matrix.rb:166
  ...
  #   [ 5 6 1 ]   [ 0 0 1 ]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/transformation_matrix.rb:127
  ...
  #   [ 0 0 1 ]   [ 5 6 1 ]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/transformation_matrix.rb:146
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/type_check.rb:10
class PDF::Reader::TypeCheck
  class << self
    # source://pdf-reader-2.10.0/lib/pdf/reader/type_check.rb:12
    def cast_to_int!(obj); end

    # source://pdf-reader-2.10.0/lib/pdf/reader/type_check.rb:24
    def cast_to_numeric!(obj); end

    # source://pdf-reader-2.10.0/lib/pdf/reader/type_check.rb:71
    def cast_to_pdf_dict!(obj); end

    # source://pdf-reader-2.10.0/lib/pdf/reader/type_check.rb:81
    def cast_to_pdf_dict_with_stream_values!(obj); end

    # source://pdf-reader-2.10.0/lib/pdf/reader/type_check.rb:38
    def cast_to_string!(string); end

    # source://pdf-reader-2.10.0/lib/pdf/reader/type_check.rb:50
    def cast_to_symbol(obj); end

    # source://pdf-reader-2.10.0/lib/pdf/reader/type_check.rb:62
    def cast_to_symbol!(obj); end
  end
end
...
# used in a PDF.
#
# source://pdf-reader-2.10.0/lib/pdf/reader/unimplemented_security_handler.rb:9
class PDF::Reader::UnimplementedSecurityHandler
  # @raise [PDF::Reader::EncryptedPDFError]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/unimplemented_security_handler.rb:14
  def decrypt(buf, ref); end

  class << self
    # @return [Boolean]
    #
    # source://pdf-reader-2.10.0/lib/pdf/reader/unimplemented_security_handler.rb:10
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/error.rb:79
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/validating_receiver.rb:17
class PDF::Reader::ValidatingReceiver
  # @return [ValidatingReceiver] a new instance of ValidatingReceiver
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/validating_receiver.rb:19
  def initialize(wrapped); end

  # Inline Image Operators
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/validating_receiver.rb:224
  sig { params(args: T.untyped).void }
  def begin_inline_image(*args); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/validating_receiver.rb:228
  sig { params(args: T.untyped).void }
  def begin_inline_image_data(*args); end

  # Text Object Operators
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/validating_receiver.rb:59
  sig { params(args: T.untyped).void }
  def begin_text_object(*args); end

  # Matrix Operators
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/validating_receiver.rb:42
  sig { params(args: T.untyped).void }
  def concatenate_matrix(*args); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/validating_receiver.rb:234
  sig { params(args: T.untyped).void }
  def end_inline_image(*args); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/validating_receiver.rb:63
  sig { params(args: T.untyped).void }
  def end_text_object(*args); end

  # Form XObject Operators
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/validating_receiver.rb:211
  sig { params(args: T.untyped).void }
  def invoke_xobject(*args); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/validating_receiver.rb:251
  def method_missing(methodname, *args); end

  # Text Positioning Operators
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/validating_receiver.rb:131
  sig { params(args: T.untyped).void }
  def move_text_position(*args); end

  # TD
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/validating_receiver.rb:140
  sig { params(args: T.untyped).void }
  def move_text_position_and_set_leading(*args); end

  # '
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/validating_receiver.rb:189
  sig { params(args: T.untyped).void }
  def move_to_next_line_and_show_text(*args); end

  # T*
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/validating_receiver.rb:162
  sig { params(args: T.untyped).void }
  def move_to_start_of_next_line(*args); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/validating_receiver.rb:23
  def page=(page); end
  ...
  # @return [Boolean]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/validating_receiver.rb:247
  def respond_to?(meth); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/validating_receiver.rb:34
  sig { params(args: T.untyped).void }
  def restore_graphics_state(*args); end

  # Graphics State Operators
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/validating_receiver.rb:30
  sig { params(args: T.untyped).void }
  def save_graphics_state(*args); end

  # Text State Operators
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/validating_receiver.rb:70
  sig { params(args: T.untyped).void }
  def set_character_spacing(*args); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/validating_receiver.rb:78
  sig { params(args: T.untyped).void }
  def set_horizontal_text_scaling(*args); end

  # "
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/validating_receiver.rb:197
  sig { params(args: T.untyped).void }
  def set_spacing_next_line_show_text(*args); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/validating_receiver.rb:86
  sig { params(args: T.untyped).void }
  def set_text_font_and_size(*args); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/validating_receiver.rb:95
  sig { params(args: T.untyped).void }
  def set_text_leading(*args); end

  # Tm
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/validating_receiver.rb:149
  sig { params(args: T.untyped).void }
  def set_text_matrix_and_text_line_matrix(*args); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/validating_receiver.rb:103
  sig { params(args: T.untyped).void }
  def set_text_rendering_mode(*args); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/validating_receiver.rb:111
  sig { params(args: T.untyped).void }
  def set_text_rise(*args); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/validating_receiver.rb:119
  sig { params(args: T.untyped).void }
  def set_word_spacing(*args); end

  # Text Showing Operators
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/validating_receiver.rb:169
  sig { params(args: T.untyped).void }
  def show_text(*args); end

  # TJ [(A) 120 (WA) 20 (Y)]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/validating_receiver.rb:177
  sig { params(args: T.untyped).void }
  def show_text_with_positioning(*args); end

  private

  # source://pdf-reader-2.10.0/lib/pdf/reader/validating_receiver.rb:257
  def call_wrapped(methodname, *args); end
end

# source://pdf-reader-2.10.0/lib/pdf/reader/width_calculator/built_in.rb:9
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/width_calculator/built_in.rb:14
class PDF::Reader::WidthCalculator::BuiltIn
  # @return [BuiltIn] a new instance of BuiltIn
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/width_calculator/built_in.rb:24
  def initialize(font); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/width_calculator/built_in.rb:38
  def glyph_width(code_point); end
  ...
  # @return [Boolean]
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/width_calculator/built_in.rb:55
  def control_character?(code_point); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/width_calculator/built_in.rb:60
  def extract_basefont(font_name); end
end

# source://pdf-reader-2.10.0/lib/pdf/reader/width_calculator/built_in.rb:16
...
#
# source://pdf-reader-2.10.0/lib/pdf/reader/width_calculator/composite.rb:13
class PDF::Reader::WidthCalculator::Composite
  # @return [Composite] a new instance of Composite
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/width_calculator/composite.rb:15
  def initialize(font); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/width_calculator/composite.rb:20
  def glyph_width(code_point); end
end

# Calculates the width of a glyph in a TrueType font
#
# source://pdf-reader-2.10.0/lib/pdf/reader/width_calculator/true_type.rb:8
class PDF::Reader::WidthCalculator::TrueType
  # @return [TrueType] a new instance of TrueType
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/width_calculator/true_type.rb:10
  def initialize(font); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/width_calculator/true_type.rb:20
  def glyph_width(code_point); end

  private

  # source://pdf-reader-2.10.0/lib/pdf/reader/width_calculator/true_type.rb:41
  def glyph_width_from_descriptor(code_point); end

  # TODO convert Type3 units 1000 units => 1 text space unit
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/width_calculator/true_type.rb:28
  def glyph_width_from_font(code_point); end
end

# Calculates the width of a glyph in a Type One or Type Three
#
# source://pdf-reader-2.10.0/lib/pdf/reader/width_calculator/type_one_or_three.rb:8
class PDF::Reader::WidthCalculator::TypeOneOrThree
  # @return [TypeOneOrThree] a new instance of TypeOneOrThree
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/width_calculator/type_one_or_three.rb:10
  def initialize(font); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/width_calculator/type_one_or_three.rb:20
  def glyph_width(code_point); end
end
...
# the descendant font
#
# source://pdf-reader-2.10.0/lib/pdf/reader/width_calculator/type_zero.rb:12
class PDF::Reader::WidthCalculator::TypeZero
  # @return [TypeZero] a new instance of TypeZero
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/width_calculator/type_zero.rb:14
  def initialize(font); end

  # source://pdf-reader-2.10.0/lib/pdf/reader/width_calculator/type_zero.rb:18
  def glyph_width(code_point); end
end
...
# is read only.
#
# source://pdf-reader-2.10.0/lib/pdf/reader/xref.rb:49
class PDF::Reader::XRef
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/xref.rb:58
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/xref.rb:75
  def [](ref); end

  # iterate over each object in the xref table
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/xref.rb:82
  sig { params(block: T.untyped).returns(T.untyped) }
  def each(&block); end
  ...
  # only counter once.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/xref.rb:68
  sig { returns(T.untyped) }
  def size; end

  # Returns the value of attribute trailer.
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/xref.rb:51
  def trailer; end
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/xref.rb:261
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/xref.rb:100
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/xref.rb:172
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/xref.rb:129
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/xref.rb:242
  def new_buffer(offset = T.unsafe(nil)); end

  # Stores an offset value for a particular PDF object ID and revision number
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/xref.rb:248
  ...
  #
  # source://pdf-reader-2.10.0/lib/pdf/reader/xref.rb:219
  def unpack_bytes(bytes); end
end

# There's no point rendering zero-width characters
#
# source://pdf-reader-2.10.0/lib/pdf/reader/zero_width_runs_filter.rb:7
class PDF::Reader::ZeroWidthRunsFilter
  class << self
    # source://pdf-reader-2.10.0/lib/pdf/reader/zero_width_runs_filter.rb:9
