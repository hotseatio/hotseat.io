...
#   conn.get '/'
#
# source://faraday-net_http-1.0.1/lib/faraday/adapter/net_http.rb:12
module Faraday
  class << self
...
#
# source://faraday-net_http-1.0.1/lib/faraday/adapter/net_http.rb:13
...
# source://faraday-net_http-1.0.1/lib/faraday/adapter/net_http.rb:14
class Faraday::Adapter::NetHttp < ::Faraday::Adapter
  # @return [NetHttp] a new instance of NetHttp
  #
  # source://faraday-net_http-1.0.1/lib/faraday/adapter/net_http.rb:37
  def initialize(app = T.unsafe(nil), opts = T.unsafe(nil), &block); end

  # source://faraday-net_http-1.0.1/lib/faraday/adapter/net_http.rb:42
  def build_connection(env); end

  # source://faraday-net_http-1.0.1/lib/faraday/adapter/net_http.rb:62
  def call(env); end

  # source://faraday-net_http-1.0.1/lib/faraday/adapter/net_http.rb:50
  def net_http_connection(env); end

  private

  # source://faraday-net_http-1.0.1/lib/faraday/adapter/net_http.rb:173
  def configure_request(http, req); end

  # source://faraday-net_http-1.0.1/lib/faraday/adapter/net_http.rb:157
  def configure_ssl(http, ssl); end

  # source://faraday-net_http-1.0.1/lib/faraday/adapter/net_http.rb:89
  def create_request(env); end

  # source://faraday-net_http-1.0.1/lib/faraday/adapter/net_http.rb:105
  def perform_request(http, env); end

  # source://faraday-net_http-1.0.1/lib/faraday/adapter/net_http.rb:135
  def request_via_get_method(http, env, &block); end

  # source://faraday-net_http-1.0.1/lib/faraday/adapter/net_http.rb:143
  def request_via_request_method(http, env, &block); end

  # source://faraday-net_http-1.0.1/lib/faraday/adapter/net_http.rb:126
  def request_with_wrapped_block(http, env, &block); end

  # source://faraday-net_http-1.0.1/lib/faraday/adapter/net_http.rb:193
  def ssl_cert_store(ssl); end

  # source://faraday-net_http-1.0.1/lib/faraday/adapter/net_http.rb:202
  def ssl_verify_mode(ssl); end
end

# source://faraday-net_http-1.0.1/lib/faraday/adapter/net_http.rb:35
...
# source://faraday-net_http-1.0.1/lib/faraday/net_http/version.rb:4
