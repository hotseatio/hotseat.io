...
module Datadog::CI::Ext::Environment
  ...
  # source://ddtrace//lib/datadog/ci/ext/environment.rb#493
  def branch_or_tag(branch_or_tag); end

  # source://ddtrace//lib/datadog/ci/ext/environment.rb#457
  def exec_git_command(cmd); end

  # CI providers
  #
  # source://ddtrace//lib/datadog/ci/ext/environment.rb#89
  def extract_appveyor(env); end

  # source://ddtrace//lib/datadog/ci/ext/environment.rb#123
  def extract_azure_pipelines(env); end

  # source://ddtrace//lib/datadog/ci/ext/environment.rb#163
  def extract_bitbucket(env); end

  # source://ddtrace//lib/datadog/ci/ext/environment.rb#331
  def extract_bitrise(env); end

  # source://ddtrace//lib/datadog/ci/ext/environment.rb#184
  def extract_buildkite(env); end

  # source://ddtrace//lib/datadog/ci/ext/environment.rb#203
  def extract_circle_ci(env); end

  # source://ddtrace//lib/datadog/ci/ext/environment.rb#222
  def extract_github_actions(env); end

  # source://ddtrace//lib/datadog/ci/ext/environment.rb#248
  def extract_gitlab(env); end

  # source://ddtrace//lib/datadog/ci/ext/environment.rb#273
  def extract_jenkins(env); end

  # source://ddtrace//lib/datadog/ci/ext/environment.rb#469
  def extract_local_git; end

  # source://ddtrace//lib/datadog/ci/ext/environment.rb#504
  def extract_name_email(name_and_email); end

  # source://ddtrace//lib/datadog/ci/ext/environment.rb#297
  def extract_teamcity(env); end

  # source://ddtrace//lib/datadog/ci/ext/environment.rb#314
  def extract_travis(env); end

  # source://ddtrace//lib/datadog/ci/ext/environment.rb#361
  def extract_user_defined_git(env); end

  # source://ddtrace//lib/datadog/ci/ext/environment.rb#83
  def filter_sensitive_info(url); end

  # source://ddtrace//lib/datadog/ci/ext/environment.rb#448
  def git_base_directory; end

  # source://ddtrace//lib/datadog/ci/ext/environment.rb#421
  def git_branch; end

  # source://ddtrace//lib/datadog/ci/ext/environment.rb#412
  def git_commit_message; end

  # source://ddtrace//lib/datadog/ci/ext/environment.rb#430
  def git_commit_sha; end

  # source://ddtrace//lib/datadog/ci/ext/environment.rb#377
  def git_commit_users; end

  # source://ddtrace//lib/datadog/ci/ext/environment.rb#403
  def git_repository_url; end

  # source://ddtrace//lib/datadog/ci/ext/environment.rb#439
  def git_tag; end

  # source://ddtrace//lib/datadog/ci/ext/environment.rb#76
  def normalize_ref(name); end

  # source://ddtrace//lib/datadog/ci/ext/environment.rb#42
  def tags(env); end
...
module Datadog::Core::Configuration::Base::InstanceMethods
  ...
  # @raise [ArgumentError]
  #
  # source://ddtrace//lib/datadog/core/configuration/base.rb#83
  def dig(*options); end

  # source://ddtrace//lib/datadog/core/configuration/base.rb#91
  def reset!; end
...
class Datadog::Core::Configuration::Components
  ...
  #
  # source://ddtrace//lib/datadog/core/configuration/components.rb#344
  def health_metrics; end
  ...
  #
  # source://ddtrace//lib/datadog/core/configuration/components.rb#393
  def shutdown!(replacement = T.unsafe(nil)); end

  # Starts up components
  #
  # source://ddtrace//lib/datadog/core/configuration/components.rb#375
  ...
  class << self
    ...
    # source://ddtrace//lib/datadog/core/configuration/components.rb#302
    def build_profiler_old_recorder(settings); end

    # source://ddtrace//lib/datadog/core/configuration/components.rb#313
    ...
    # source://ddtrace//lib/datadog/core/configuration/components.rb#282
    def build_test_mode_trace_flush(settings); end

    # source://ddtrace//lib/datadog/core/configuration/components.rb#296
    def build_test_mode_writer(settings, agent_settings); end

    # source://ddtrace//lib/datadog/core/configuration/components.rb#275
...
class Datadog::Core::Configuration::DependencyResolver
  ...
  # source://tsort/0.1.0/tsort.rb#149
  def call; end
...
class Datadog::Core::Configuration::Settings
  ...
  # source://ddtrace//lib/datadog/core/configuration/settings.rb#293
...
module Datadog::Core::Telemetry::Collector
  ...
  # source://ddtrace//lib/datadog/core/telemetry/collector.rb#184
  def agent_transport; end

  # source://ddtrace//lib/datadog/core/telemetry/collector.rb#180
  def appsec; end

  # Manual implementation of hash.compact used because it is unsupported by older Ruby versions (<2.4)
  #
  # source://ddtrace//lib/datadog/core/telemetry/collector.rb#152
  def compact_hash(hash); end

  # source://ddtrace//lib/datadog/core/telemetry/collector.rb#156
  def env; end

  # source://ddtrace//lib/datadog/core/telemetry/collector.rb#141
  def format_configuration_value(value); end

  # @return [Boolean]
  #
  # source://ddtrace//lib/datadog/core/telemetry/collector.rb#197
  def instrumented?(integration); end

  # source://ddtrace//lib/datadog/core/telemetry/collector.rb#193
  def instrumented_integrations; end

  # @return [Boolean]
  #
  # source://ddtrace//lib/datadog/core/telemetry/collector.rb#205
  def integration_auto_instrument?(integration); end

  # @return [Boolean]
  #
  # source://ddtrace//lib/datadog/core/telemetry/collector.rb#209
  def integration_compatible?(integration); end

  # source://ddtrace//lib/datadog/core/telemetry/collector.rb#213
  def integration_version(integration); end

  # source://ddtrace//lib/datadog/core/telemetry/collector.rb#168
  def library_version; end

  # source://ddtrace//lib/datadog/core/telemetry/collector.rb#217
  def patch_error(integration); end

  # @return [Boolean]
  #
  # source://ddtrace//lib/datadog/core/telemetry/collector.rb#201
  def patched?(integration); end

  # source://ddtrace//lib/datadog/core/telemetry/collector.rb#172
  def products; end

  # source://ddtrace//lib/datadog/core/telemetry/collector.rb#176
  def profiler; end

  # source://ddtrace//lib/datadog/core/telemetry/collector.rb#160
  def service_name; end

  # source://ddtrace//lib/datadog/core/telemetry/collector.rb#164
...
module Datadog::Tracing::ClientIp
  class << self
    # source://ddtrace//lib/datadog/tracing/client_ip.rb#148
    def configuration; end

    # source://ddtrace//lib/datadog/tracing/client_ip.rb#139
    ...
    # @return [Boolean]
    #
    # source://ddtrace//lib/datadog/tracing/client_ip.rb#118
    ...
    #
    # source://ddtrace//lib/datadog/tracing/client_ip.rb#72
    ...
    #
    # source://ddtrace//lib/datadog/tracing/client_ip.rb#89
    def strip_decorations(address); end

    # source://ddtrace//lib/datadog/tracing/client_ip.rb#101
    def strip_ipv4_port(ip); end

    # source://ddtrace//lib/datadog/tracing/client_ip.rb#105
    def strip_ipv6_port(ip); end

    # source://ddtrace//lib/datadog/tracing/client_ip.rb#97
    ...
    # @return [Boolean]
    #
    # source://ddtrace//lib/datadog/tracing/client_ip.rb#126
    def valid_ip?(ip); end
  end
end
...
# source://ddtrace//lib/datadog/tracing/client_ip.rb#54
...
# source://ddtrace//lib/datadog/tracing/configuration/ext.rb#56
...
# source://ddtrace//lib/datadog/tracing/configuration/ext.rb#50
...
module Datadog::Tracing::Contrib::Dalli::Instrumentation::InstanceMethods
  ...
  # source://ddtrace//lib/datadog/tracing/contrib/dalli/instrumentation.rb#49
  def datadog_configuration; end
end
...
#
# source://ddtrace//lib/datadog/tracing/contrib/elasticsearch/patcher.rb#14
module Datadog::Tracing::Contrib::Elasticsearch::Patcher
  ...
  # source://ddtrace//lib/datadog/tracing/contrib/elasticsearch/patcher.rb#23
  def patch; end

  # source://ddtrace//lib/datadog/tracing/contrib/elasticsearch/patcher.rb#37
  def patch_elasticsearch_transport_client; end

  # source://ddtrace//lib/datadog/tracing/contrib/elasticsearch/patcher.rb#19
  def target_version; end
  ...
  #
  # source://ddtrace//lib/datadog/tracing/contrib/elasticsearch/patcher.rb#139
...
# source://ddtrace//lib/datadog/tracing/contrib/elasticsearch/patcher.rb#31
...
#
# source://ddtrace//lib/datadog/tracing/contrib/http/circuit_breaker.rb#8
...
module Datadog::Tracing::Contrib::HTTP::Instrumentation::InstanceMethods
  ...
  # source://ddtrace//lib/datadog/tracing/contrib/http/instrumentation.rb#102
  ...
  # source://ddtrace//lib/datadog/tracing/contrib/http/instrumentation.rb#91
  ...
  # source://ddtrace//lib/datadog/tracing/contrib/http/instrumentation.rb#106
  ...
  # @return [Boolean]
  #
  # source://ddtrace//lib/datadog/tracing/contrib/http/instrumentation.rb#126
  def analytics_enabled?(request_options); end

  # source://ddtrace//lib/datadog/tracing/contrib/http/instrumentation.rb#130
  def analytics_sample_rate(request_options); end

  # source://ddtrace//lib/datadog/tracing/contrib/http/instrumentation.rb#122
  def datadog_configuration(host = T.unsafe(nil)); end

  # source://ddtrace//lib/datadog/tracing/contrib/http/instrumentation.rb#114
...
module Datadog::Tracing::Contrib::Httpclient::Instrumentation::InstanceMethods
  ...
  # @return [Boolean]
  #
  # source://ddtrace//lib/datadog/tracing/contrib/httpclient/instrumentation.rb#92
  def analytics_enabled?(request_options); end
  ...
  # source://ddtrace//lib/datadog/tracing/contrib/httpclient/instrumentation.rb#73
  def annotate_span_with_response!(span, response); end

  # source://ddtrace//lib/datadog/tracing/contrib/httpclient/instrumentation.rb#88
  def datadog_configuration(host = T.unsafe(nil)); end

  # source://ddtrace//lib/datadog/tracing/contrib/httpclient/instrumentation.rb#96
  def logger; end
  ...
  # @return [Boolean]
  #
  # source://ddtrace//lib/datadog/tracing/contrib/httpclient/instrumentation.rb#100
  def should_skip_distributed_tracing?(client_config); end
end
...
module Datadog::Tracing::Contrib::Httprb::Instrumentation::InstanceMethods
  ...
  # @return [Boolean]
  #
  # source://ddtrace//lib/datadog/tracing/contrib/httprb/instrumentation.rb#103
  def analytics_enabled?(request_options); end

  # source://ddtrace//lib/datadog/tracing/contrib/httprb/instrumentation.rb#95
  def annotate_span_with_error!(span, error); end

  # source://ddtrace//lib/datadog/tracing/contrib/httprb/instrumentation.rb#53
  def annotate_span_with_request!(span, req, req_options); end

  # source://ddtrace//lib/datadog/tracing/contrib/httprb/instrumentation.rb#82
  def annotate_span_with_response!(span, response); end

  # source://ddtrace//lib/datadog/tracing/contrib/httprb/instrumentation.rb#99
  def datadog_configuration(host = T.unsafe(nil)); end

  # source://ddtrace//lib/datadog/tracing/contrib/httprb/instrumentation.rb#107
  def logger; end

  # source://ddtrace//lib/datadog/tracing/contrib/httprb/instrumentation.rb#117
  def set_analytics_sample_rate(span, request_options); end

  # @return [Boolean]
  #
  # source://ddtrace//lib/datadog/tracing/contrib/httprb/instrumentation.rb#111
  def should_skip_distributed_tracing?(client_config); end
end
...
#
# source://ddtrace//lib/datadog/tracing/contrib/mysql2/instrumentation.rb#12
...
#
# source://ddtrace//lib/datadog/tracing/contrib/mysql2/instrumentation.rb#18
module Datadog::Tracing::Contrib::Mysql2::Instrumentation::InstanceMethods
  ...
  # @return [Boolean]
  #
  # source://ddtrace//lib/datadog/tracing/contrib/mysql2/instrumentation.rb#49
  def analytics_enabled?; end

  # source://ddtrace//lib/datadog/tracing/contrib/mysql2/instrumentation.rb#53
  def analytics_sample_rate; end

  # source://ddtrace//lib/datadog/tracing/contrib/mysql2/instrumentation.rb#45
  def datadog_configuration; end
end
...
module Datadog::Tracing::Contrib::Patcher::CommonMethods
  ...
  # source://ddtrace//lib/datadog/tracing/contrib/patcher.rb#71
  def default_tags; end

  # source://ddtrace//lib/datadog/tracing/contrib/patcher.rb#77
...
# source://ddtrace//lib/datadog/tracing/contrib/pg/configuration/settings.rb#10
module Datadog::Tracing::Contrib::Pg::Configuration; end

# Custom settings for the Pg integration
#
# source://ddtrace//lib/datadog/tracing/contrib/pg/configuration/settings.rb#13
...
#
# source://ddtrace//lib/datadog/tracing/contrib/pg/instrumentation.rb#13
module Datadog::Tracing::Contrib::Pg::Instrumentation
  class << self
    # @private
    #
    # source://ddtrace//lib/datadog/tracing/contrib/pg/instrumentation.rb#14
    def included(base); end
  end
end
...
#
# source://ddtrace//lib/datadog/tracing/contrib/pg/instrumentation.rb#19
module Datadog::Tracing::Contrib::Pg::Instrumentation::InstanceMethods
  # source://ddtrace//lib/datadog/tracing/contrib/pg/instrumentation.rb#38
  def async_exec(sql, *args); end

  # source://ddtrace//lib/datadog/tracing/contrib/pg/instrumentation.rb#44
  def async_exec_params(sql, params, *args); end

  # source://ddtrace//lib/datadog/tracing/contrib/pg/instrumentation.rb#50
  def async_exec_prepared(statement_name, params, *args); end

  # source://ddtrace//lib/datadog/tracing/contrib/pg/instrumentation.rb#20
  def exec(sql, *args); end

  # source://ddtrace//lib/datadog/tracing/contrib/pg/instrumentation.rb#26
  def exec_params(sql, params, *args); end

  # source://ddtrace//lib/datadog/tracing/contrib/pg/instrumentation.rb#32
  ...
  # @return [Boolean]
  #
  # source://ddtrace//lib/datadog/tracing/contrib/pg/instrumentation.rb#117
  def analytics_enabled?; end

  # source://ddtrace//lib/datadog/tracing/contrib/pg/instrumentation.rb#121
  def analytics_sample_rate; end

  # source://ddtrace//lib/datadog/tracing/contrib/pg/instrumentation.rb#88
  def annotate_span_with_query!(span, service); end

  # source://ddtrace//lib/datadog/tracing/contrib/pg/instrumentation.rb#109
  def annotate_span_with_result!(span, result); end

  # source://ddtrace//lib/datadog/tracing/contrib/pg/instrumentation.rb#113
  def datadog_configuration; end

  # source://ddtrace//lib/datadog/tracing/contrib/pg/instrumentation.rb#76
...
#
# source://ddtrace//lib/datadog/tracing/contrib/rack/header_collection.rb#11
...
class Datadog::Tracing::Contrib::Rack::TraceMiddleware
  ...
  # source://ddtrace//lib/datadog/tracing/contrib/rack/middlewares.rb#55
  def call(env); end

  # source://ddtrace//lib/datadog/tracing/contrib/rack/middlewares.rb#31
  def compute_queue_time(env); end

  # source://ddtrace//lib/datadog/tracing/contrib/rack/middlewares.rb#125
  def set_request_tags!(trace, request_span, env, status, headers, response, original_env); end

  private

  # source://ddtrace//lib/datadog/tracing/contrib/rack/middlewares.rb#233
  def configuration; end

  # source://ddtrace//lib/datadog/tracing/contrib/rack/middlewares.rb#281
  def parse_request_headers(headers); end

  # source://ddtrace//lib/datadog/tracing/contrib/rack/middlewares.rb#292
  def parse_response_headers(headers); end

  # source://ddtrace//lib/datadog/tracing/contrib/rack/middlewares.rb#237
  def parse_url(env, original_env); end

  # source://ddtrace//lib/datadog/tracing/contrib/rack/middlewares.rb#277
...
class Datadog::Tracing::Contrib::Sneakers::Tracer
  ...
  # source://ddtrace//lib/datadog/tracing/contrib/sneakers/tracer.rb#50
  def configuration; end
end
...
module Datadog::Tracing::Contrib::Utils::Quantization::HTTP
  ...
  #
  # source://ddtrace//lib/datadog/tracing/contrib/utils/quantization/http.rb#87
  ...
  #
  # source://ddtrace//lib/datadog/tracing/contrib/utils/quantization/http.rb#115
  def obfuscate_query(query, options = T.unsafe(nil)); end

  # source://ddtrace//lib/datadog/tracing/contrib/utils/quantization/http.rb#54
  def query(query, options = T.unsafe(nil)); end

  # source://ddtrace//lib/datadog/tracing/contrib/utils/quantization/http.rb#60
  def query!(query, options = T.unsafe(nil)); end
...
# source://ddtrace//lib/datadog/tracing/contrib/utils/quantization/http.rb#128
Datadog::Tracing::Contrib::Utils::Quantization::HTTP::OBFUSCATOR_REGEX = T.let(T.unsafe(nil), Regexp)

# source://ddtrace//lib/datadog/tracing/contrib/utils/quantization/http.rb#125
...
# source://ddtrace//lib/datadog/tracing/distributed/headers/parser.rb#8
...
#
# source://ddtrace//lib/datadog/tracing/distributed/headers/parser.rb#10
class Datadog::Tracing::Distributed::Headers::Parser
  # @return [Parser] a new instance of Parser
  #
  # source://ddtrace//lib/datadog/tracing/distributed/headers/parser.rb#11
  def initialize(env); end

  # TODO: Don't assume Rack format.
  #       Make distributed tracing headers apathetic.
  #
  # source://ddtrace//lib/datadog/tracing/distributed/headers/parser.rb#17
  def header(name); end

  # source://ddtrace//lib/datadog/tracing/distributed/headers/parser.rb#26
  def id(hdr, base = T.unsafe(nil)); end

  # source://ddtrace//lib/datadog/tracing/distributed/headers/parser.rb#30
...
module Datadog::Tracing::Distributed::Helpers
  class << self
    ...
    # source://ddtrace//lib/datadog/tracing/distributed/helpers.rb#42
    def value_to_id(value, base = T.unsafe(nil)); end

    # source://ddtrace//lib/datadog/tracing/distributed/helpers.rb#54
...
#
# source://ddtrace//lib/datadog/tracing/flush.rb#60
...
# Spans consumed are removed from +trace_op+ as a side effect.
#
# source://ddtrace//lib/datadog/tracing/flush.rb#77
...
# Request headers
#
# source://ddtrace//lib/datadog/tracing/metadata/ext.rb#107
module Datadog::Tracing::Metadata::Ext::HTTP::RequestHeaders
  private

  # source://ddtrace//lib/datadog/tracing/metadata/ext.rb#112
  def to_tag(name); end
...
# source://ddtrace//lib/datadog/tracing/metadata/ext.rb#108
Datadog::Tracing::Metadata::Ext::HTTP::RequestHeaders::PREFIX = T.let(T.unsafe(nil), String)

# Response headers
#
# source://ddtrace//lib/datadog/tracing/metadata/ext.rb#118
...
# source://ddtrace//lib/datadog/tracing/metadata/ext.rb#119
...
# source://ddtrace//lib/datadog/tracing/metadata/ext.rb#67
Datadog::Tracing::Metadata::Ext::HTTP::TAG_URL = T.let(T.unsafe(nil), String)

# source://ddtrace//lib/datadog/tracing/metadata/ext.rb#66
...
# source://ddtrace//lib/datadog/tracing/metadata/ext.rb#135
...
# source://ddtrace//lib/datadog/tracing/metadata/ext.rb#132
Datadog::Tracing::Metadata::Ext::NET::TAG_TARGET_HOST = T.let(T.unsafe(nil), String)

# source://ddtrace//lib/datadog/tracing/metadata/ext.rb#133
Datadog::Tracing::Metadata::Ext::NET::TAG_TARGET_PORT = T.let(T.unsafe(nil), String)

# source://ddtrace//lib/datadog/tracing/metadata/ext.rb#154
...
# source://ddtrace//lib/datadog/tracing/metadata/ext.rb#155
...
# source://ddtrace//lib/datadog/tracing/metadata/ext.rb#160
...
# source://ddtrace//lib/datadog/tracing/metadata/ext.rb#165
...
# source://ddtrace//lib/datadog/tracing/metadata/ext.rb#161
...
class Datadog::Tracing::Sampling::RateSampler < ::Datadog::Tracing::Sampling::Sampler
  ...
  # source://ddtrace//lib/datadog/tracing/sampling/rate_sampler.rb#57
  def sample!(trace); end

  # @return [Boolean]
  #
  # source://ddtrace//lib/datadog/tracing/sampling/rate_sampler.rb#53
  def sample?(trace); end

  # source://ddtrace//lib/datadog/tracing/sampling/rate_sampler.rb#44
  def sample_rate(*_); end

  # source://ddtrace//lib/datadog/tracing/sampling/rate_sampler.rb#48
...
#
# source://ddtrace//lib/datadog/tracing/sampling/span/ext.rb#24
Datadog::Tracing::Sampling::Span::Ext::MECHANISM_SPAN_SAMPLING_RATE = T.let(T.unsafe(nil), Integer)
...
# with no limits.
#
# source://ddtrace//lib/datadog/tracing/sampling/rate_limiter.rb#176
...
class Datadog::Tracing::Span
  ...
  #
  # source://ddtrace//lib/datadog/tracing/span.rb#71
  ...
  #
  # source://ddtrace//lib/datadog/tracing/span.rb#140
  def ==(other); end

  # source://ddtrace//lib/datadog/tracing/span.rb#129
  def duration; end
  ...
  #
  # source://ddtrace//lib/datadog/tracing/span.rb#52
  def duration=(_arg0); end

  # Returns the value of attribute end_time.
  #
  # source://ddtrace//lib/datadog/tracing/span.rb#38
  def end_time; end
  ...
  #
  # source://ddtrace//lib/datadog/tracing/span.rb#176
  ...
  # source://ddtrace//lib/datadog/tracing/span.rb#134
  def set_error(e); end
  ...
  #
  # source://ddtrace//lib/datadog/tracing/span.rb#153
  def to_hash; end

  # Return a string representation of the span.
  #
  # source://ddtrace//lib/datadog/tracing/span.rb#146
  def to_s; end
  ...
  #
  # source://ddtrace//lib/datadog/tracing/span.rb#217
  ...
  #
  # source://ddtrace//lib/datadog/tracing/span.rb#227
...
#
# source://ddtrace//lib/datadog/tracing/span.rb#32
...
#
# source://ddtrace//lib/datadog/tracing/span_operation.rb#22
class Datadog::Tracing::SpanOperation
  ...
  #
  # source://ddtrace//lib/datadog/tracing/span_operation.rb#41
  ...
  # source://ddtrace//lib/datadog/tracing/span_operation.rb#265
  def duration; end

  # Span attributes
  # NOTE: In the future, we should drop the me
  #
  # source://ddtrace//lib/datadog/tracing/span_operation.rb#27
  def end_time; end

  # for backwards compatibility
  #
  # source://ddtrace//lib/datadog/tracing/span_operation.rb#240
  def end_time=(time); end

  # source://ddtrace//lib/datadog/tracing/span_operation.rb#244
  def finish(end_time = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://ddtrace//lib/datadog/tracing/span_operation.rb#261
  def finished?; end
  ...
  # @raise [ArgumentError]
  #
  # source://ddtrace//lib/datadog/tracing/span_operation.rb#132
  def measure; end
  ...
  # @return [String]
  #
  # source://ddtrace//lib/datadog/tracing/span_operation.rb#105
  def name=(name); end
  ...
  # Return a human readable version of the span
  #
  # source://ddtrace//lib/datadog/tracing/span_operation.rb#304
  def pretty_print(q); end
  ...
  # @return [String] String
  #
  # source://ddtrace//lib/datadog/tracing/span_operation.rb#128
  ...
  # @return [String] String
  #
  # source://ddtrace//lib/datadog/tracing/span_operation.rb#121
  def service=(service); end

  # source://ddtrace//lib/datadog/tracing/span_operation.rb#270
  def set_error(e); end
  ...
  # @return [String] String
  #
  # source://ddtrace//lib/datadog/tracing/span_operation.rb#114
  def span_type=(type); end

  # source://ddtrace//lib/datadog/tracing/span_operation.rb#186
  ...
  # for backwards compatibility
  #
  # source://ddtrace//lib/datadog/tracing/span_operation.rb#235
  ...
  # @return [Boolean]
  #
  # source://ddtrace//lib/datadog/tracing/span_operation.rb#225
  def started?; end

  # Returns the value of attribute status.
  #
  # source://ddtrace//lib/datadog/tracing/span_operation.rb#38
  def status; end
  ...
  #
  # source://ddtrace//lib/datadog/tracing/span_operation.rb#201
  ...
  # @return [Boolean]
  #
  # source://ddtrace//lib/datadog/tracing/span_operation.rb#230
  def stopped?; end

  # Return the hash representation of the current span.
  #
  # source://ddtrace//lib/datadog/tracing/span_operation.rb#281
  def to_hash; end

  # Return a string representation of the span.
  #
  # source://ddtrace//lib/datadog/tracing/span_operation.rb#276
  def to_s; end
  ...
  #
  # source://ddtrace//lib/datadog/tracing/span_operation.rb#456
  def build_span; end
  ...
  #
  # source://ddtrace//lib/datadog/tracing/span_operation.rb#434
  def events; end
...
# Callback behavior
#
# source://ddtrace//lib/datadog/tracing/span_operation.rb#336
class Datadog::Tracing::SpanOperation::Events
  ...
  #
  # source://ddtrace//lib/datadog/tracing/span_operation.rb#346
  def initialize(on_error: T.unsafe(nil)); end

  # Returns the value of attribute after_finish.
  #
  # source://ddtrace//lib/datadog/tracing/span_operation.rb#341
  ...
  #
  # source://ddtrace//lib/datadog/tracing/span_operation.rb#354
  def on_error; end
end
...
# source://ddtrace//lib/datadog/tracing/span_operation.rb#339
...
class Datadog::Tracing::SpanOperation::Events::OnError
  ...
  # source://ddtrace//lib/datadog/tracing/span_operation.rb#408
  def publish(*args); end
  ...
  #
  # source://ddtrace//lib/datadog/tracing/span_operation.rb#391
...
#
# source://ddtrace//lib/datadog/tracing/trace_operation.rb#26
class Datadog::Tracing::TraceOperation
  ...
  #
  # source://ddtrace//lib/datadog/tracing/trace_operation.rb#40
  def active_span; end
  ...
  #
  # source://ddtrace//lib/datadog/tracing/trace_operation.rb#31
  ...
  # source://ddtrace//lib/datadog/tracing/trace_operation.rb#194
  ...
  # @return [Boolean]
  #
  # source://ddtrace//lib/datadog/tracing/trace_operation.rb#111
  def finished?; end

  # source://ddtrace//lib/datadog/tracing/trace_operation.rb#107
  ...
  #
  # source://ddtrace//lib/datadog/tracing/trace_operation.rb#254
  def flush!; end

  # Returns a copy of this trace suitable for forks (w/o spans.)
  # Used for continuation of traces across forks.
  #
  # source://ddtrace//lib/datadog/tracing/trace_operation.rb#295
  def fork_clone; end

  # @return [Boolean]
  #
  # source://ddtrace//lib/datadog/tracing/trace_operation.rb#103
  def full?; end
  ...
  # source://ddtrace//lib/datadog/tracing/trace_operation.rb#133
  def keep!; end
  ...
  # source://ddtrace//lib/datadog/tracing/trace_operation.rb#143
  def name; end
  ...
  # source://ddtrace//lib/datadog/tracing/trace_operation.rb#147
  def resource; end
  ...
  # @return [Boolean]
  #
  # source://ddtrace//lib/datadog/tracing/trace_operation.rb#154
  ...
  # @return [Boolean]
  #
  # source://ddtrace//lib/datadog/tracing/trace_operation.rb#123
  def sampled?; end
  ...
  # source://ddtrace//lib/datadog/tracing/trace_operation.rb#158
  def service; end
  ...
  #
  # source://ddtrace//lib/datadog/tracing/trace_operation.rb#270
  def to_digest; end
  ...
  # source://ddtrace//lib/datadog/tracing/trace_operation.rb#433
  def build_trace(spans, partial = T.unsafe(nil)); end

  # source://ddtrace//lib/datadog/tracing/trace_operation.rb#380
  ...
  # source://ddtrace//lib/datadog/tracing/trace_operation.rb#402
  ...
  # Track the root span
  #
  # source://ddtrace//lib/datadog/tracing/trace_operation.rb#427
  def set_root_span!(span); end

  # source://ddtrace//lib/datadog/tracing/trace_operation.rb#388
...
# Callback behavior
#
# source://ddtrace//lib/datadog/tracing/trace_operation.rb#318
...
#
# source://ddtrace//lib/datadog/tracing/trace_operation.rb#333
...
#
# source://ddtrace//lib/datadog/tracing/trace_operation.rb#340
class Datadog::Tracing::TraceOperation::Events::SpanFinished < ::Datadog::Tracing::Event
  ...
  #
  # source://ddtrace//lib/datadog/tracing/trace_operation.rb#341
  def initialize; end
end
...
class Datadog::Tracing::TraceOperation::Events::TraceFinished < ::Datadog::Tracing::Event
  ...
  #
  # source://ddtrace//lib/datadog/tracing/trace_operation.rb#348
  def initialize; end
...
class Datadog::Tracing::Tracer
  ...
  # source://ddtrace//lib/datadog/tracing/tracer.rb#338
  def bind_trace_events!(trace_op); end

  # source://ddtrace//lib/datadog/tracing/tracer.rb#409
  ...
  #
  # source://ddtrace//lib/datadog/tracing/tracer.rb#491
  def flush_trace(trace_op); end

  # Manually activate and deactivate the trace, when the span completes.
  #
  # source://ddtrace//lib/datadog/tracing/tracer.rb#432
  def manual_trace_activation!(context, trace); end

  # source://ddtrace//lib/datadog/tracing/tracer.rb#420
  ...
  #
  # source://ddtrace//lib/datadog/tracing/tracer.rb#464
  def sample_trace(trace_op); end

  # TODO: Make these dummy objects singletons to preserve memory.
  #
  # source://ddtrace//lib/datadog/tracing/tracer.rb#519
  def skip_trace(name); end

  # source://ddtrace//lib/datadog/tracing/tracer.rb#364
