...
class ActionMailer::Base < ::AbstractController::Base
  ...
  # source://actionmailer/7.0.6/lib/action_mailer/base.rb#632
  def initialize; end
  ...
  # source://actionmailer/7.0.6/lib/action_mailer/base.rb#749
  def attachments; end
  ...
  # source://actionmailer/7.0.6/lib/action_mailer/delivery_methods.rb#15
  def deliver_later_queue_name; end

  # source://actionmailer/7.0.6/lib/action_mailer/delivery_methods.rb#15
  def deliver_later_queue_name=(val); end

  # source://actionmailer/7.0.6/lib/action_mailer/base.rb#489
  ...
  # source://actionmailer/7.0.6/lib/action_mailer/delivery_methods.rb#18
  ...
  # source://actionmailer/7.0.6/lib/action_mailer/delivery_methods.rb#17
  ...
  # source://actionmailer/7.0.6/lib/action_mailer/base.rb#673
  ...
  # source://actionmailer/7.0.6/lib/action_mailer/delivery_methods.rb#51
  ...
  # source://actionmailer/7.0.6/lib/action_mailer/base.rb#711
  ...
  # source://actionmailer/7.0.6/lib/action_mailer/base.rb#858
  def mail(headers = T.unsafe(nil), &block); end

  # source://actionmailer/7.0.6/lib/action_mailer/base.rb#666
  def mailer_name; end
  ...
  # source://actionmailer/7.0.6/lib/action_mailer/parameterized.rb#91
  def params; end
  ...
  # source://actionmailer/7.0.6/lib/action_mailer/delivery_methods.rb#14
  def perform_deliveries; end

  # source://actionmailer/7.0.6/lib/action_mailer/delivery_methods.rb#14
  def perform_deliveries=(val); end

  # source://actionmailer/7.0.6/lib/action_mailer/preview.rb#25
  def preview_interceptors; end

  # source://actionmailer/7.0.6/lib/action_mailer/preview.rb#14
  def preview_path; end

  # source://actionmailer/7.0.6/lib/action_mailer/base.rb#638
  def process(method_name, *args, **_arg2); end

  # source://actionmailer/7.0.6/lib/action_mailer/delivery_methods.rb#13
  ...
  # source://actionmailer/7.0.6/lib/action_mailer/preview.rb#22
  ...
  # source://actionmailer/7.0.6/lib/action_mailer/base.rb#1059
  def _protected_ivars; end

  # source://actionmailer/7.0.6/lib/action_mailer/base.rb#935
  def apply_defaults(headers); end

  # source://actionmailer/7.0.6/lib/action_mailer/base.rb#955
  def assign_headers_to_message(message, headers); end

  # source://actionmailer/7.0.6/lib/action_mailer/base.rb#961
  def collect_responses(headers, &block); end

  # source://actionmailer/7.0.6/lib/action_mailer/base.rb#971
  def collect_responses_from_block(headers); end

  # source://actionmailer/7.0.6/lib/action_mailer/base.rb#985
  def collect_responses_from_templates(headers); end

  # source://actionmailer/7.0.6/lib/action_mailer/base.rb#978
  def collect_responses_from_text(headers); end

  # source://actionmailer/7.0.6/lib/action_mailer/base.rb#945
  def compute_default(value); end

  # source://actionmailer/7.0.6/lib/action_mailer/base.rb#1028
  def create_parts_from_responses(m, responses); end

  # source://actionmailer/7.0.6/lib/action_mailer/base.rb#925
  def default_i18n_subject(interpolations = T.unsafe(nil)); end

  # source://actionmailer/7.0.6/lib/action_mailer/base.rb#1041
  def insert_part(container, response, charset); end

  # source://actionmailer/7.0.6/lib/action_mailer/base.rb#1055
  def instrument_name; end

  # source://actionmailer/7.0.6/lib/action_mailer/base.rb#1048
  def instrument_payload(key); end

  # source://actionmailer/7.0.6/lib/action_mailer/base.rb#998
  def original_each_template(paths, name, &block); end

  # source://actionmailer/7.0.6/lib/action_mailer/base.rb#903
  def set_content_type(m, user_content_type, class_default); end

  # source://actionmailer/7.0.6/lib/action_mailer/base.rb#1007
  ...
  class << self
    ...
    # source://actionmailer/7.0.6/lib/action_mailer/base.rb#558
    def controller_path; end

    # source://actionmailer/7.0.6/lib/action_mailer/base.rb#570
    ...
    # source://actionmailer/7.0.6/lib/action_mailer/base.rb#585
    ...
    # source://actionmailer/7.0.6/lib/action_mailer/base.rb#595
    def email_address_with_name(address, name); end
    ...
    # source://actionmailer/7.0.6/lib/action_mailer/base.rb#562
    ...
    # source://actionmailer/7.0.6/lib/action_mailer/base.rb#535
    def register_interceptor(interceptor); end

    # source://actionmailer/7.0.6/lib/action_mailer/base.rb#509
    def register_interceptors(*interceptors); end

    # source://actionmailer/7.0.6/lib/action_mailer/base.rb#521
    def register_observer(observer); end

    # source://actionmailer/7.0.6/lib/action_mailer/base.rb#499
    ...
    # source://actionmailer/7.0.6/lib/action_mailer/base.rb#931
    ...
    # source://actionmailer/7.0.6/lib/action_mailer/base.rb#542
    def unregister_interceptor(interceptor); end

    # source://actionmailer/7.0.6/lib/action_mailer/base.rb#514
    def unregister_interceptors(*interceptors); end

    # source://actionmailer/7.0.6/lib/action_mailer/base.rb#528
    def unregister_observer(observer); end

    # source://actionmailer/7.0.6/lib/action_mailer/base.rb#504
    def unregister_observers(*observers); end

    private

    # source://actionmailer/7.0.6/lib/action_mailer/base.rb#616
    def method_missing(method_name, *args, **_arg2); end

    # source://actionmailer/7.0.6/lib/action_mailer/base.rb#546
    def observer_class_for(value); end

    # source://actionmailer/7.0.6/lib/action_mailer/base.rb#625
    def respond_to_missing?(method, include_all = T.unsafe(nil)); end

    # source://actionmailer/7.0.6/lib/action_mailer/base.rb#603
