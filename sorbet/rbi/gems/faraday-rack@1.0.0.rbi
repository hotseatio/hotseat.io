...
#   conn.get '/'
#
# source://faraday-rack-1.0.0/lib/faraday/adapter/rack.rb:3
module Faraday
  class << self
...
#
# source://faraday-rack-1.0.0/lib/faraday/adapter/rack.rb:4
...
#   end
#
# source://faraday-rack-1.0.0/lib/faraday/adapter/rack.rb:18
class Faraday::Adapter::Rack < ::Faraday::Adapter
  # @return [Rack] a new instance of Rack
  #
  # source://faraday-rack-1.0.0/lib/faraday/adapter/rack.rb:24
  def initialize(faraday_app, rack_app); end

  # source://faraday-rack-1.0.0/lib/faraday/adapter/rack.rb:30
  def call(env); end

  private

  # source://faraday-rack-1.0.0/lib/faraday/adapter/rack.rb:66
  def build_rack_env(env); end

  # source://faraday-rack-1.0.0/lib/faraday/adapter/rack.rb:62
  def execute_request(env, rack_env); end
end

# not prefixed with "HTTP_"
#
# source://faraday-rack-1.0.0/lib/faraday/adapter/rack.rb:22
...
#
# source://faraday-rack-1.0.0/lib/faraday/rack/version.rb:4
