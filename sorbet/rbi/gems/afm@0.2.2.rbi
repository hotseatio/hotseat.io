...
class AFM::Font
  ...
  #
  # source://afm-0.2.2/lib/afm.rb:96
  def metrics_for(char); end

  class << self
    # alias for new()
    #
    # source://afm-0.2.2/lib/afm.rb:82
    def from_file(file); end
  end
end

# source://afm-0.2.2/lib/afm.rb:3
