...
# source://omniauth-2.1.0/lib/omniauth.rb:5
module OmniAuth
  class << self
...
# key).
#
# source://omniauth-2.1.0/lib/omniauth/auth_hash.rb:8
class OmniAuth::AuthHash < ::OmniAuth::KeyStore
  # source://omniauth-2.1.0/lib/omniauth/auth_hash.rb:22
  ...
  # @return [Boolean]
  #
  # source://omniauth-2.1.0/lib/omniauth/auth_hash.rb:18
  def valid?; end

  class << self
    # source://omniauth-2.1.0/lib/omniauth/auth_hash.rb:9
    def subkey_class; end
  end
end

# source://omniauth-2.1.0/lib/omniauth/auth_hash.rb:27
class OmniAuth::AuthHash::InfoHash < ::OmniAuth::KeyStore
  # source://omniauth-2.1.0/lib/omniauth/auth_hash.rb:32
  def name; end

  # @return [Boolean]
  #
  # source://omniauth-2.1.0/lib/omniauth/auth_hash.rb:41
  def name?; end

  # source://omniauth-2.1.0/lib/omniauth/auth_hash.rb:46
  def to_hash; end
  ...
  class << self
    # source://omniauth-2.1.0/lib/omniauth/auth_hash.rb:28
    def subkey_class; end
  end
end

# source://omniauth-2.1.0/lib/omniauth/authenticity_token_protection.rb:4
class OmniAuth::AuthenticityError < ::StandardError; end

# source://omniauth-2.1.0/lib/omniauth/authenticity_token_protection.rb:5
class OmniAuth::AuthenticityTokenProtection < ::Rack::Protection::AuthenticityToken
  ...
  #
  # source://omniauth-2.1.0/lib/omniauth/authenticity_token_protection.rb:6
  def initialize(options = T.unsafe(nil)); end

  # source://omniauth-2.1.0/lib/omniauth/authenticity_token_protection.rb:14
  def call(env); end
  ...
  #
  # source://omniauth-2.1.0/lib/omniauth/authenticity_token_protection.rb:25
  ...
  class << self
    # source://omniauth-2.1.0/lib/omniauth/authenticity_token_protection.rb:10
    def call(env); end
  end
end

# source://omniauth-2.1.0/lib/omniauth/builder.rb:2
class OmniAuth::Builder < ::Rack::Builder
  # source://omniauth-2.1.0/lib/omniauth/builder.rb:15
  def before_callback_phase(&block); end

  # source://omniauth-2.1.0/lib/omniauth/builder.rb:7
  def before_options_phase(&block); end

  # source://omniauth-2.1.0/lib/omniauth/builder.rb:11
  def before_request_phase(&block); end

  # source://omniauth-2.1.0/lib/omniauth/builder.rb:43
  def call(env); end

  # source://omniauth-2.1.0/lib/omniauth/builder.rb:19
  def configure(&block); end

  # source://omniauth-2.1.0/lib/omniauth/builder.rb:3
  def on_failure(&block); end

  # source://omniauth-2.1.0/lib/omniauth/builder.rb:23
  def options(options = T.unsafe(nil)); end

  # source://omniauth-2.1.0/lib/omniauth/builder.rb:29
  def provider(klass, *args, **opts, &block); end
end

# source://omniauth-2.1.0/lib/omniauth.rb:24
class OmniAuth::Configuration
  ...
  #
  # source://omniauth-2.1.0/lib/omniauth.rb:52
  def initialize; end
  ...
  # source://omniauth-2.1.0/lib/omniauth.rb:64
  def before_callback_phase(&block); end
  ...
  #
  # source://omniauth-2.1.0/lib/omniauth.rb:125
  def before_callback_phase=(_arg0); end

  # source://omniauth-2.1.0/lib/omniauth.rb:72
  def before_options_phase(&block); end
  ...
  # source://omniauth-2.1.0/lib/omniauth.rb:88
  def before_request_phase(&block); end
  ...
  # source://omniauth-2.1.0/lib/omniauth.rb:56
  def on_failure(&block); end
  ...
  # source://omniauth-2.1.0/lib/omniauth.rb:80
  ...
  class << self
    # source://omniauth-2.1.0/lib/omniauth.rb:27
    def default_logger; end

    # source://omniauth-2.1.0/lib/omniauth.rb:33
    def defaults; end
  end
end

# source://omniauth-2.1.0/lib/omniauth.rb:6
...
# be raised.
#
# source://omniauth-2.1.0/lib/omniauth/failure_endpoint.rb:8
class OmniAuth::FailureEndpoint
  # @return [FailureEndpoint] a new instance of FailureEndpoint
  #
  # source://omniauth-2.1.0/lib/omniauth/failure_endpoint.rb:15
  def initialize(env); end

  # source://omniauth-2.1.0/lib/omniauth/failure_endpoint.rb:19
  def call; end

  # Returns the value of attribute env.
  #
  # source://omniauth-2.1.0/lib/omniauth/failure_endpoint.rb:9
  def env; end

  # source://omniauth-2.1.0/lib/omniauth/failure_endpoint.rb:49
  def origin_query_param; end

  # source://omniauth-2.1.0/lib/omniauth/failure_endpoint.rb:24
  def raise_out!; end

  # source://omniauth-2.1.0/lib/omniauth/failure_endpoint.rb:28
  def redirect_to_failure; end

  # source://omniauth-2.1.0/lib/omniauth/failure_endpoint.rb:43
  def strategy_name_query_param; end

  # source://omniauth-2.1.0/lib/omniauth/failure_endpoint.rb:35
  def strategy_path_prefix; end

  class << self
    # source://omniauth-2.1.0/lib/omniauth/failure_endpoint.rb:11
    def call(env); end
  end
end

# source://omniauth-2.1.0/lib/omniauth/form.rb:2
class OmniAuth::Form
  # @return [Form] a new instance of Form
  #
  # source://omniauth-2.1.0/lib/omniauth/form.rb:7
  def initialize(options = T.unsafe(nil)); end

  # source://omniauth-2.1.0/lib/omniauth/form.rb:50
  def button(text); end

  # source://omniauth-2.1.0/lib/omniauth/form.rb:59
  def fieldset(legend, options = T.unsafe(nil), &block); end

  # source://omniauth-2.1.0/lib/omniauth/form.rb:83
  def footer; end

  # source://omniauth-2.1.0/lib/omniauth/form.rb:66
  def header(title, header_info); end

  # source://omniauth-2.1.0/lib/omniauth/form.rb:55
  def html(html); end

  # source://omniauth-2.1.0/lib/omniauth/form.rb:33
  def input_field(type, name); end

  # source://omniauth-2.1.0/lib/omniauth/form.rb:28
  def label_field(text, target); end

  # Returns the value of attribute options.
  #
  # source://omniauth-2.1.0/lib/omniauth/form.rb:5
  def options; end
  ...
  # source://omniauth-2.1.0/lib/omniauth/form.rb:44
  def password_field(label, name); end

  # source://omniauth-2.1.0/lib/omniauth/form.rb:38
  def text_field(label, name); end

  # source://omniauth-2.1.0/lib/omniauth/form.rb:96
  def to_html; end

  # source://omniauth-2.1.0/lib/omniauth/form.rb:101
  def to_response; end

  protected

  # source://omniauth-2.1.0/lib/omniauth/form.rb:108
  def css; end

  class << self
    # source://omniauth-2.1.0/lib/omniauth/form.rb:18
    def build(options = T.unsafe(nil), &block); end
  end
end

# source://omniauth-2.1.0/lib/omniauth/form.rb:3
OmniAuth::Form::DEFAULT_CSS = T.let(T.unsafe(nil), String)

# Generic helper hash that allows method access on deeply nested keys.
#
# source://omniauth-2.1.0/lib/omniauth/key_store.rb:6
class OmniAuth::KeyStore < ::Hashie::Mash
  class << self
    # Disables warnings on Hashie 3.5.0+ for overwritten keys
    #
    # source://omniauth-2.1.0/lib/omniauth/key_store.rb:7
    def override_logging; end
  end
end

# source://omniauth-2.1.0/lib/omniauth/strategy.rb:4
class OmniAuth::NoSessionError < ::StandardError; end

# source://omniauth-2.1.0/lib/omniauth.rb:8
...
#   end
#
# source://omniauth-2.1.0/lib/omniauth/strategies/developer.rb:31
class OmniAuth::Strategies::Developer
  include ::OmniAuth::Strategy
  extend ::OmniAuth::Strategy::ClassMethods

  # source://omniauth-2.1.0/lib/omniauth/strategies/developer.rb:37
...
#
# source://omniauth-2.1.0/lib/omniauth/strategy.rb:9
module OmniAuth::Strategy
  ...
  #
  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:133
  def initialize(app, *args, &block); end

  # Returns the value of attribute app.
  #
  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:116
  def app; end

  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:390
  def auth_hash; end
  ...
  #
  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:168
  def call(env); end
  ...
  #
  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:177
  def call!(env); end

  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:469
  def call_app!(env = T.unsafe(nil)); end

  # Performs the steps necessary to run the callback phase of a strategy.
  #
  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:265
  def callback_call; end

  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:445
  def callback_path; end

  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:416
  def callback_phase; end

  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:496
  def callback_url; end

  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:382
  def credentials; end

  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:461
  def current_path; end

  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:425
  ...
  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:386
  def extra; end

  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:533
  def fail!(message_key, exception = T.unsafe(nil)); end

  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:476
  def full_host; end

  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:378
  def info; end

  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:153
  def inspect; end
  ...
  #
  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:162
  ...
  # in test mode.
  #
  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:304
  def mock_call!(*_arg0); end

  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:336
  def mock_callback_call; end

  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:317
  def mock_request_call; end

  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:512
  def name; end
  ...
  # @return [Boolean]
  #
  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:277
  def on_auth_path?; end

  # @return [Boolean]
  #
  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:289
  def on_callback_path?; end

  # @return [Boolean]
  #
  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:293
  def on_path?(path); end

  # @return [Boolean]
  #
  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:281
  ...
  #
  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:226
  def options_call; end

  # @return [Boolean]
  #
  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:297
  def options_request?; end

  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:421
  def path_prefix; end

  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:465
  def query_string; end

  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:516
  def redirect(uri); end

  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:508
  def request; end

  # Performs the steps necessary to run the request phase of a strategy.
  #
  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:233
  def request_call; end

  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:436
  ...
  #
  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:370
  def request_phase; end
  ...
  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:500
  def script_name; end

  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:504
  def session; end

  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:455
  def setup_path; end
  ...
  #
  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:356
  def setup_phase; end
  ...
  # @return [Boolean]
  #
  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:409
  def skip_info?; end

  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:374
  def uid; end

  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:529
  def user_info; end

  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:205
  def warn_if_using_get_on_request_path; end

  protected

  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:556
  def merge_stack(stack); end

  # @return [Boolean]
  #
  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:563
  def ssl?; end

  private

  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:551
  def initialize_copy(*args); end

  class << self
    # source://omniauth-2.1.0/lib/omniauth/strategy.rb:10
    def included(base); end
  end
end

# source://omniauth-2.1.0/lib/omniauth/strategy.rb:459
OmniAuth::Strategy::CURRENT_PATH_REGEX = T.let(T.unsafe(nil), Regexp)

# source://omniauth-2.1.0/lib/omniauth/strategy.rb:21
module OmniAuth::Strategy::ClassMethods
  ...
  #
  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:82
  def args(args = T.unsafe(nil)); end

  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:107
  ...
  #
  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:52
  def configure(options = T.unsafe(nil)); end

  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:96
  def credentials(&block); end

  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:101
  def credentials_stack(context); end

  # Returns an inherited set of default options set at the class-level
  # for each strategy.
  #
  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:24
  ...
  #
  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:75
  ...
  # source://omniauth-2.1.0/lib/omniauth/strategy.rb:93
...
# source://omniauth-2.1.0/lib/omniauth/strategy.rb:460
OmniAuth::Strategy::EMPTY_STRING = T.let(T.unsafe(nil), String)

# source://omniauth-2.1.0/lib/omniauth/strategy.rb:547
class OmniAuth::Strategy::Options < ::OmniAuth::KeyStore; end

# Support for testing OmniAuth strategies.
#
# source://omniauth-2.1.0/lib/omniauth/test.rb:3
module OmniAuth::Test; end

# source://omniauth-2.1.0/lib/omniauth/test/phony_session.rb:3
class OmniAuth::Test::PhonySession
  # @return [PhonySession] a new instance of PhonySession
  #
  # source://omniauth-2.1.0/lib/omniauth/test/phony_session.rb:4
  def initialize(app); end

  # source://omniauth-2.1.0/lib/omniauth/test/phony_session.rb:8
  def call(env); end
end

# source://omniauth-2.1.0/lib/omniauth/test/strategy_macros.rb:3
module OmniAuth::Test::StrategyMacros
  # source://omniauth-2.1.0/lib/omniauth/test/strategy_macros.rb:4
  def sets_an_auth_hash; end

  # source://omniauth-2.1.0/lib/omniauth/test/strategy_macros.rb:10
  def sets_provider_to(provider); end

  # source://omniauth-2.1.0/lib/omniauth/test/strategy_macros.rb:16
  def sets_uid_to(uid); end

  # source://omniauth-2.1.0/lib/omniauth/test/strategy_macros.rb:22
...
#   end
#
# source://omniauth-2.1.0/lib/omniauth/test/strategy_test_case.rb:19
module OmniAuth::Test::StrategyTestCase
  # source://omniauth-2.1.0/lib/omniauth/test/strategy_test_case.rb:20
  def app; end

  # source://omniauth-2.1.0/lib/omniauth/test/strategy_test_case.rb:30
  def app_response; end

  # source://omniauth-2.1.0/lib/omniauth/test/strategy_test_case.rb:34
  def session; end

  # source://omniauth-2.1.0/lib/omniauth/test/strategy_test_case.rb:38
  def strategy; end
end

# source://omniauth-2.1.0/lib/omniauth.rb:146
module OmniAuth::Utils
  private

  # source://omniauth-2.1.0/lib/omniauth.rb:168
  def camelize(word, first_letter_in_uppercase = T.unsafe(nil)); end

  # source://omniauth-2.1.0/lib/omniauth.rb:153
  def deep_merge(hash, other_hash); end

  # source://omniauth-2.1.0/lib/omniauth.rb:149
  def form_css; end
