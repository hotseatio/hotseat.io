...
# source://lisbn-0.3.2/lib/lisbn/cache_method.rb:1
class Lisbn < ::String
  extend ::Lisbn::CacheMethod

  # Returns a normalized ISBN form
  #
  # source://lisbn-0.3.2/lib/lisbn/cache_method.rb:6
  ...
  # source://lisbn-0.3.2/lib/lisbn/lisbn.rb:33
  ...
  # source://lisbn-0.3.2/lib/lisbn/lisbn.rb:43
  def isbn13_without_cache; end

  # source://lisbn-0.3.2/lib/lisbn/cache_method.rb:6
  def isbn_10_checksum(*args, &blk); end

  # source://lisbn-0.3.2/lib/lisbn/lisbn.rb:96
  def isbn_10_checksum_without_cache; end

  # source://lisbn-0.3.2/lib/lisbn/cache_method.rb:6
  def isbn_13_checksum(*args, &blk); end

  # source://lisbn-0.3.2/lib/lisbn/lisbn.rb:121
  def isbn_13_checksum_without_cache; end

  # source://lisbn-0.3.2/lib/lisbn/lisbn.rb:19
  def isbn_with_dash; end

  # source://lisbn-0.3.2/lib/lisbn/lisbn.rb:3
  ...
  # source://lisbn-0.3.2/lib/lisbn/lisbn.rb:61
  ...
  # @return [Boolean]
  #
  # source://lisbn-0.3.2/lib/lisbn/lisbn.rb:147
  def valid_isbn_10?; end

  # @return [Boolean]
  #
  # source://lisbn-0.3.2/lib/lisbn/lisbn.rb:152
  def valid_isbn_13?; end
end

# source://lisbn-0.3.2/lib/lisbn/cache_method.rb:2
module Lisbn::CacheMethod
  # source://lisbn-0.3.2/lib/lisbn/cache_method.rb:3
  def cache_method(*methods); end
end

# source://lisbn-0.3.2/lib/lisbn/lisbn.rb:157
Lisbn::RANGES = T.let(T.unsafe(nil), Hash)

# source://lisbn-0.3.2/lib/lisbn/ranges.rb:2
module Lisbn::Ranges
  class << self
    # source://lisbn-0.3.2/lib/lisbn/ranges.rb:25
    def save_to_yaml!; end

    # source://lisbn-0.3.2/lib/lisbn/ranges.rb:3
    def to_yaml; end
  end
end
