...
#
# source://groupdate-6.1.0/lib/groupdate/enumerable.rb:1
module Enumerable
  # source://groupdate-6.1.0/lib/groupdate/enumerable.rb:3
  ...
  # source://groupdate-6.1.0/lib/groupdate/enumerable.rb:15
...
# source://groupdate-6.1.0/lib/groupdate/magic.rb:3
module Groupdate
  # source://groupdate-6.1.0/lib/groupdate.rb:23
  def day_start; end
  ...
  class << self
    # source://groupdate-6.1.0/lib/groupdate.rb:35
    def adapters; end
    ...
    #
    # source://groupdate-6.1.0/lib/groupdate.rb:28
    def process_result(relation, result, **options); end

    # source://groupdate-6.1.0/lib/groupdate.rb:39
...
# source://groupdate-6.1.0/lib/groupdate/adapters/base_adapter.rb:2
module Groupdate::Adapters; end

# source://groupdate-6.1.0/lib/groupdate/adapters/base_adapter.rb:3
class Groupdate::Adapters::BaseAdapter
  # @return [BaseAdapter] a new instance of BaseAdapter
  #
  # source://groupdate-6.1.0/lib/groupdate/adapters/base_adapter.rb:6
  def initialize(relation, column:, period:, time_zone:, time_range:, week_start:, day_start:, n_seconds:); end

  # Returns the value of attribute column.
  #
  # source://groupdate-6.1.0/lib/groupdate/adapters/base_adapter.rb:4
  def column; end
  ...
  # source://groupdate-6.1.0/lib/groupdate/adapters/base_adapter.rb:27
  def generate; end
  ...
  # source://groupdate-6.1.0/lib/groupdate/adapters/base_adapter.rb:33
  def where_clause; end
end

# source://groupdate-6.1.0/lib/groupdate/adapters/mysql_adapter.rb:3
class Groupdate::Adapters::MySQLAdapter < ::Groupdate::Adapters::BaseAdapter
  # source://groupdate-6.1.0/lib/groupdate/adapters/mysql_adapter.rb:57
  def clean_group_clause(clause); end

  # source://groupdate-6.1.0/lib/groupdate/adapters/mysql_adapter.rb:4
  def group_clause; end
end

# source://groupdate-6.1.0/lib/groupdate/adapters/postgresql_adapter.rb:3
class Groupdate::Adapters::PostgreSQLAdapter < ::Groupdate::Adapters::BaseAdapter
  # source://groupdate-6.1.0/lib/groupdate/adapters/postgresql_adapter.rb:41
  def clean_group_clause(clause); end

  # source://groupdate-6.1.0/lib/groupdate/adapters/postgresql_adapter.rb:4
  def group_clause; end
end

# source://groupdate-6.1.0/lib/groupdate/adapters/sqlite_adapter.rb:3
class Groupdate::Adapters::SQLiteAdapter < ::Groupdate::Adapters::BaseAdapter
  # @raise [Groupdate::Error]
  #
  # source://groupdate-6.1.0/lib/groupdate/adapters/sqlite_adapter.rb:4
  def group_clause; end
end

# source://groupdate-6.1.0/lib/groupdate.rb:18
class Groupdate::Error < ::RuntimeError; end

# source://groupdate-6.1.0/lib/groupdate.rb:21
Groupdate::METHODS = T.let(T.unsafe(nil), Array)

# source://groupdate-6.1.0/lib/groupdate/magic.rb:4
class Groupdate::Magic
  # @return [Magic] a new instance of Magic
  #
  # source://groupdate-6.1.0/lib/groupdate/magic.rb:9
  def initialize(period:, **options); end

  # source://groupdate-6.1.0/lib/groupdate/magic.rb:68
  def day_start; end

  # Returns the value of attribute group_index.
  #
  # source://groupdate-6.1.0/lib/groupdate/magic.rb:7
  def group_index; end
  ...
  # source://groupdate-6.1.0/lib/groupdate/magic.rb:72
  def range; end

  # source://groupdate-6.1.0/lib/groupdate/magic.rb:84
  def series_builder; end

  # source://groupdate-6.1.0/lib/groupdate/magic.rb:97
  def time_range; end

  # source://groupdate-6.1.0/lib/groupdate/magic.rb:53
  def time_zone; end

  # @raise [ArgumentError]
  #
  # source://groupdate-6.1.0/lib/groupdate/magic.rb:46
  def validate_arguments; end

  # @raise [ArgumentError]
  #
  # source://groupdate-6.1.0/lib/groupdate/magic.rb:24
  def validate_keywords; end

  # source://groupdate-6.1.0/lib/groupdate/magic.rb:61
  def week_start; end

  class << self
    # @raise [ArgumentError]
    #
    # source://groupdate-6.1.0/lib/groupdate/magic.rb:101
    def validate_period(period, permit); end
  end
end

# source://groupdate-6.1.0/lib/groupdate/magic.rb:5
Groupdate::Magic::DAYS = T.let(T.unsafe(nil), Array)

# source://groupdate-6.1.0/lib/groupdate/magic.rb:106
class Groupdate::Magic::Enumerable < ::Groupdate::Magic
  # source://groupdate-6.1.0/lib/groupdate/magic.rb:107
  def group_by(enum, &_block); end

  class << self
    # source://groupdate-6.1.0/lib/groupdate/magic.rb:116
    def group_by(enum, period, options, &block); end
  end
end

# source://groupdate-6.1.0/lib/groupdate/magic.rb:121
class Groupdate::Magic::Relation < ::Groupdate::Magic
  # @return [Relation] a new instance of Relation
  #
  # source://groupdate-6.1.0/lib/groupdate/magic.rb:122
  def initialize(**options); end

  # source://groupdate-6.1.0/lib/groupdate/magic.rb:141
  def cast_method; end

  # source://groupdate-6.1.0/lib/groupdate/magic.rb:165
  def cast_result(result, multiple_groups); end

  # source://groupdate-6.1.0/lib/groupdate/magic.rb:188
  def check_nils(result, multiple_groups, relation); end

  # source://groupdate-6.1.0/lib/groupdate/magic.rb:127
  def perform(relation, result, default_value:); end

  # @return [Boolean]
  #
  # source://groupdate-6.1.0/lib/groupdate/magic.rb:178
  def time_zone_support?(relation); end

  class << self
    # @raise [Groupdate::Error]
    #
    # source://groupdate-6.1.0/lib/groupdate/magic.rb:199
    def generate_relation(relation, field:, **options); end

    # allow any options to keep flexible for future
    #
    # source://groupdate-6.1.0/lib/groupdate/magic.rb:255
    def process_result(relation, result, **options); end
    ...
    #
    # source://groupdate-6.1.0/lib/groupdate/magic.rb:247
    ...
    #
    # source://groupdate-6.1.0/lib/groupdate/magic.rb:234
    def validate_column(column); end
  end
end

# source://groupdate-6.1.0/lib/groupdate.rb:20
Groupdate::PERIODS = T.let(T.unsafe(nil), Array)

# source://groupdate-6.1.0/lib/groupdate/query_methods.rb:2
module Groupdate::QueryMethods
  # source://groupdate-6.1.0/lib/groupdate/query_methods.rb:4
  ...
  # source://groupdate-6.1.0/lib/groupdate/query_methods.rb:13
...
# source://groupdate-6.1.0/lib/groupdate/relation.rb:4
module Groupdate::Relation
  extend ::ActiveSupport::Concern

  # source://groupdate-6.1.0/lib/groupdate/relation.rb:11
  def calculate(*args, &block); end
end

# source://groupdate-6.1.0/lib/groupdate/series_builder.rb:2
class Groupdate::SeriesBuilder
  # @return [SeriesBuilder] a new instance of SeriesBuilder
  #
  # source://groupdate-6.1.0/lib/groupdate/series_builder.rb:5
  def initialize(period:, time_zone:, day_start:, week_start:, n_seconds:, **options); end

  # Returns the value of attribute day_start.
  #
  # source://groupdate-6.1.0/lib/groupdate/series_builder.rb:3
  def day_start; end

  # source://groupdate-6.1.0/lib/groupdate/series_builder.rb:15
  ...
  # source://groupdate-6.1.0/lib/groupdate/series_builder.rb:44
  def round_time(time); end

  # source://groupdate-6.1.0/lib/groupdate/series_builder.rb:99
  def time_range; end
  ...
  # @return [Boolean]
  #
  # source://groupdate-6.1.0/lib/groupdate/series_builder.rb:296
  def entire_series?(series_default); end

  # source://groupdate-6.1.0/lib/groupdate/series_builder.rb:163
  def generate_series(data, multiple_groups, group_index); end

  # source://groupdate-6.1.0/lib/groupdate/series_builder.rb:280
  def handle_multiple(data, series, multiple_groups, group_index); end

  # source://groupdate-6.1.0/lib/groupdate/series_builder.rb:237
  def key_format; end

  # source://groupdate-6.1.0/lib/groupdate/series_builder.rb:159
  def now; end

  # source://groupdate-6.1.0/lib/groupdate/series_builder.rb:270
  def step; end

  # source://groupdate-6.1.0/lib/groupdate/series_builder.rb:300
  def utc; end
end

# source://groupdate-6.1.0/lib/groupdate/version.rb:2
