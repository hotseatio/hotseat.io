...
#   conn.get '/'
#
# source://faraday-em_synchrony-1.0.0/lib/faraday/adapter/em_synchrony.rb:5
module Faraday
  class << self
...
#
# source://faraday-em_synchrony-1.0.0/lib/faraday/adapter/em_synchrony.rb:6
...
#
# source://faraday-em_synchrony-1.0.0/lib/faraday/adapter/em_synchrony.rb:8
class Faraday::Adapter::EMSynchrony < ::Faraday::Adapter
  include ::Faraday::Adapter::EMHttp::Options

  # source://faraday-em_synchrony-1.0.0/lib/faraday/adapter/em_synchrony.rb:40
  def call(env); end

  # source://faraday-em_synchrony-1.0.0/lib/faraday/adapter/em_synchrony.rb:82
  def create_request(env); end

  private

  # source://faraday-em_synchrony-1.0.0/lib/faraday/adapter/em_synchrony.rb:135
  def call_block(block); end

  # source://faraday-em_synchrony-1.0.0/lib/faraday/adapter/em_synchrony.rb:91
  def execute_parallel_request(env, request, http_method); end

  # source://faraday-em_synchrony-1.0.0/lib/faraday/adapter/em_synchrony.rb:112
  def execute_single_request(env, request, http_method); end

  class << self
    # @return [ParallelManager]
    #
    # source://faraday-em_synchrony-1.0.0/lib/faraday/adapter/em_synchrony.rb:36
...
#
# source://faraday-em_synchrony-1.0.0/lib/faraday/em_synchrony/version.rb:4
