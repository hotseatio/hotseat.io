...
# source://multi_xml-0.6.0/lib/multi_xml.rb:8
module MultiXml
  class << self
    ...
    # @raise [NoParserError]
    #
    # source://multi_xml-0.6.0/lib/multi_xml.rb:87
    ...
    #
    # source://multi_xml-0.6.0/lib/multi_xml.rb:133
    def parse(xml, options = T.unsafe(nil)); end

    # Get the current parser class.
    #
    # source://multi_xml-0.6.0/lib/multi_xml.rb:77
    def parser; end
    ...
    # * <tt>:oga</tt>
    #
    # source://multi_xml-0.6.0/lib/multi_xml.rb:112
    ...
    #
    # source://multi_xml-0.6.0/lib/multi_xml.rb:174
    def parse_binary(binary, entity); end

    # source://multi_xml-0.6.0/lib/multi_xml.rb:183
    def parse_file(file, entity); end

    # source://multi_xml-0.6.0/lib/multi_xml.rb:191
    def symbolize_keys(params); end

    # source://multi_xml-0.6.0/lib/multi_xml.rb:218
    def typecast_xml_value(value, disallowed_types = T.unsafe(nil)); end

    # source://multi_xml-0.6.0/lib/multi_xml.rb:204
    def undasherize_keys(params); end
  end
end

# source://multi_xml-0.6.0/lib/multi_xml.rb:27
MultiXml::CONTENT_ROOT = T.let(T.unsafe(nil), String)

# source://multi_xml-0.6.0/lib/multi_xml.rb:69
MultiXml::DEFAULT_OPTIONS = T.let(T.unsafe(nil), Hash)

# source://multi_xml-0.6.0/lib/multi_xml.rb:67
MultiXml::DISALLOWED_XML_TYPES = T.let(T.unsafe(nil), Array)

# source://multi_xml-0.6.0/lib/multi_xml.rb:11
class MultiXml::DisallowedTypeError < ::StandardError
  # @return [DisallowedTypeError] a new instance of DisallowedTypeError
  #
  # source://multi_xml-0.6.0/lib/multi_xml.rb:12
  def initialize(type); end
end

# source://multi_xml-0.6.0/lib/multi_xml.rb:10
class MultiXml::NoParserError < ::StandardError; end

# source://multi_xml-0.6.0/lib/multi_xml.rb:33
MultiXml::PARSING = T.let(T.unsafe(nil), Hash)

# source://multi_xml-0.6.0/lib/multi_xml.rb:9
class MultiXml::ParseError < ::StandardError; end

# source://multi_xml-0.6.0/lib/multi_xml.rb:18
MultiXml::REQUIREMENT_MAP = T.let(T.unsafe(nil), Array)

# source://multi_xml-0.6.0/lib/multi_xml.rb:52
