...
# source://aws-partitions-1.610.0/lib/aws-partitions/endpoint_provider.rb:3
module Aws
  class << self
...
#
# source://aws-partitions-1.610.0/lib/aws-partitions/endpoint_provider.rb:4
module Aws::Partitions
  ...
  class << self
    ...
    #
    # source://aws-partitions-1.610.0/lib/aws-partitions.rb:191
    def add(new_partitions); end

    # @api private For internal use only.
    #
    # source://aws-partitions-1.610.0/lib/aws-partitions.rb:199
    def clear; end

    # @api private
    # @return [PartitionList]
    #
    # source://aws-partitions-1.610.0/lib/aws-partitions.rb:206
    def default_partition_list; end

    # @api private
    # @return [Hash]
    #
    # source://aws-partitions-1.610.0/lib/aws-partitions.rb:212
    def defaults; end

    # @return [Enumerable<Partition>]
    #
    # source://aws-partitions-1.610.0/lib/aws-partitions.rb:136
    def each(&block); end
    ...
    # @return [Partition]
    #
    # source://aws-partitions-1.610.0/lib/aws-partitions.rb:163
    ...
    #   known partitions.
    #
    # source://aws-partitions-1.610.0/lib/aws-partitions.rb:185
    def partitions; end
    ...
    #
    # source://aws-partitions-1.610.0/lib/aws-partitions.rb:223
    def service_ids; end
  end
end
...
# @api private
#
# source://aws-partitions-1.610.0/lib/aws-partitions/endpoint_provider.rb:6
class Aws::Partitions::EndpointProvider
  ...
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/endpoint_provider.rb:31
  ...
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/endpoint_provider.rb:73
  ...
  # @param variants [Hash] Endpoint variants such as 'fips' or 'dualstack'
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/endpoint_provider.rb:46
  def resolve(region, service, sts_regional_endpoints, variants); end

  # @api private Use the static class methods instead.
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/endpoint_provider.rb:51
  def signing_region(region, service, sts_regional_endpoints); end

  # @api private Use the static class methods instead.
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/endpoint_provider.rb:57
  ...
  # @api private
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/endpoint_provider.rb:178
  def build_is_global_fn(sts_regional_endpoints = T.unsafe(nil)); end

  # @api private
  # @return [Boolean]
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/endpoint_provider.rb:83
  def configured_variants?(variants); end

  # @api private
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/endpoint_provider.rb:192
  def credential_scope(region, service, is_global_fn); end

  # @api private
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/endpoint_provider.rb:238
  def default_partition; end

  # @api private
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/endpoint_provider.rb:125
  def endpoint_for(region, service, is_global_fn, variants); end

  # @api private
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/endpoint_provider.rb:141
  def endpoint_no_variants_for(region, service, is_global_fn); end

  # @api private
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/endpoint_provider.rb:133
  def endpoint_with_variants_for(region, service, variants); end

  # @api private
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/endpoint_provider.rb:87
  def fetch_variant(cfg, tags); end

  # @api private
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/endpoint_provider.rb:212
  def get_partition(region_or_partition); end

  # @api private
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/endpoint_provider.rb:219
  def partition_containing_region(region); end

  # @api private
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/endpoint_provider.rb:234
  def partition_matching_name(partition_name); end

  # @api private
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/endpoint_provider.rb:225
  def partition_matching_region(region); end

  # @api private
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/endpoint_provider.rb:92
  def resolve_variant(region, service, config_variants); end

  # @api private
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/endpoint_provider.rb:117
  def validate_variant!(config_variants, resolved_variant); end

  # @api private
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/endpoint_provider.rb:171
  def warn_deprecation(service, region); end

  class << self
    # @api private
    #
    # source://aws-partitions-1.610.0/lib/aws-partitions/endpoint_provider.rb:256
    def dns_suffix_for(region, service = T.unsafe(nil), variants = T.unsafe(nil)); end

    # @api private
    #
    # source://aws-partitions-1.610.0/lib/aws-partitions/endpoint_provider.rb:244
    def resolve(region, service, sts_endpoint = T.unsafe(nil), variants = T.unsafe(nil)); end

    # @api private
    #
    # source://aws-partitions-1.610.0/lib/aws-partitions/endpoint_provider.rb:248
    def signing_region(region, service, sts_regional_endpoints = T.unsafe(nil)); end

    # @api private
    #
    # source://aws-partitions-1.610.0/lib/aws-partitions/endpoint_provider.rb:252
    def signing_service(region, service); end
    ...
    # @api private
    #
    # source://aws-partitions-1.610.0/lib/aws-partitions/endpoint_provider.rb:262
...
# @api private
#
# source://aws-partitions-1.610.0/lib/aws-partitions/endpoint_provider.rb:9
Aws::Partitions::EndpointProvider::STS_LEGACY_REGIONS = T.let(T.unsafe(nil), Array)

# source://aws-partitions-1.610.0/lib/aws-partitions/partition.rb:5
class Aws::Partitions::Partition
  ...
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/partition.rb:10
  def initialize(options = T.unsafe(nil)); end

  # @return [String] The partition name, e.g. "aws", "aws-cn", "aws-us-gov".
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/partition.rb:17
  def name; end
  ...
  # @return [Region]
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/partition.rb:22
  def region(region_name); end

  # @param region_name [String] The name of the region, e.g. "us-east-1".
  # @return [Boolean] true if the region is in the partition.
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/partition.rb:39
  def region?(region_name); end

  # @return [Array<Region>]
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/partition.rb:33
  def regions; end
  ...
  # @return [Service]
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/partition.rb:46
  def service(service_name); end

  # @param service_name [String] The service module name.
  # @return [Boolean] true if the service is in the partition.
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/partition.rb:63
  def service?(service_name); end

  # @return [Array<Service>]
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/partition.rb:57
  def services; end

  class << self
    # @api private
    #
    # source://aws-partitions-1.610.0/lib/aws-partitions/partition.rb:69
    ...
    #
    # source://aws-partitions-1.610.0/lib/aws-partitions/partition.rb:81
    def build_regions(partition); end

    # @param partition [Hash]
    # @return [Hash<String,Service>]
    #
    # source://aws-partitions-1.610.0/lib/aws-partitions/partition.rb:94
    def build_services(partition); end
  end
end

# source://aws-partitions-1.610.0/lib/aws-partitions/partition_list.rb:5
class Aws::Partitions::PartitionList
  include ::Enumerable

  # @return [PartitionList] a new instance of PartitionList
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/partition_list.rb:9
  def initialize; end

  # @api private
  # @param partition [Partition]
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/partition_list.rb:37
  ...
  # @api private
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/partition_list.rb:47
  def clear; end

  # @return [Enumerator<Partition>]
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/partition_list.rb:14
  def each(&block); end

  # @param partition_name [String]
  # @return [Partition]
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/partition_list.rb:20
  def partition(partition_name); end

  # @return [Array<Partition>]
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/partition_list.rb:31
  def partitions; end

  class << self
    # @api private
    #
    # source://aws-partitions-1.610.0/lib/aws-partitions/partition_list.rb:54
    def build(partitions); end
  end
end

# source://aws-partitions-1.610.0/lib/aws-partitions/region.rb:7
class Aws::Partitions::Region
  ...
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/region.rb:14
  def initialize(options = T.unsafe(nil)); end

  # @return [String] A short description of this region.
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/region.rb:25
  def description; end

  # @return [String] The name of this region, e.g. "us-east-1".
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/region.rb:22
  def name; end

  # @return [String] The partition this region exists in, e.g. "aws",
  #   "aws-cn", "aws-us-gov".
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/region.rb:29
  ...
  #   for Ruby.
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/region.rb:34
  def services; end

  class << self
    # @api private
    #
    # source://aws-partitions-1.610.0/lib/aws-partitions/region.rb:39
    def build(region_name, region, partition); end

    private

    # source://aws-partitions-1.610.0/lib/aws-partitions/region.rb:50
    def region_services(region_name, partition); end

    # @return [Boolean]
    #
    # source://aws-partitions-1.610.0/lib/aws-partitions/region.rb:61
    def service_in_region?(svc, region_name); end
  end
end

# source://aws-partitions-1.610.0/lib/aws-partitions/service.rb:7
class Aws::Partitions::Service
  ...
  # @return [Boolean]
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/service.rb:55
  def regionalized?; end

  # @return [Set<String>] The regions this service is available in.
  #   Regions are scoped to the partition.
  #
  # source://aws-partitions-1.610.0/lib/aws-partitions/service.rb:34
  def regions; end

  class << self
    # @api private
    #
    # source://aws-partitions-1.610.0/lib/aws-partitions/service.rb:62
    def build(service_name, service, partition); end

    private

    # source://aws-partitions-1.610.0/lib/aws-partitions/service.rb:97
    def partition_region(service); end

    # source://aws-partitions-1.610.0/lib/aws-partitions/service.rb:76
    def regions(service, partition); end

    # source://aws-partitions-1.610.0/lib/aws-partitions/service.rb:82
