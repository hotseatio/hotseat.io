...
# source://opensearch-ruby-2.0.2/lib/opensearch/version.rb:27
module OpenSearch; end

# source://opensearch-ruby-2.0.2/lib/opensearch.rb:35
class OpenSearch::Client
  ...
  #
  # source://opensearch-ruby-2.0.2/lib/opensearch.rb:40
  def initialize(arguments = T.unsafe(nil), &block); end

  # source://opensearch-ruby-2.0.2/lib/opensearch.rb:45
  def method_missing(name, *args, &block); end

  # Returns the value of attribute transport.
  #
  # source://opensearch-ruby-2.0.2/lib/opensearch.rb:37
  def transport; end
  ...
  # source://opensearch-ruby-2.0.2/lib/opensearch.rb:91
  def open_search_validation_request; end

  # source://opensearch-ruby-2.0.2/lib/opensearch.rb:56
  def verify_open_search; end

  # @raise [OpenSearch::UnsupportedProductError]
  #
  # source://opensearch-ruby-2.0.2/lib/opensearch.rb:77
...
# source://opensearch-ruby-2.0.2/lib/opensearch.rb:96
class OpenSearch::UnsupportedProductError < ::StandardError
  ...
  #
  # source://opensearch-ruby-2.0.2/lib/opensearch.rb:97
