...
#
# source://rack-attack-6.6.1/lib/rack/attack/cache.rb:3
module Rack
  class << self
...
# source://rack-attack-6.6.1/lib/rack/attack/cache.rb:4
class Rack::Attack
  # @return [Attack] a new instance of Attack
  #
  # source://rack-attack-6.6.1/lib/rack/attack.rb:97
  def initialize(app); end

  # source://rack-attack-6.6.1/lib/rack/attack.rb:102
  def call(env); end

  # Returns the value of attribute configuration.
  #
  # source://rack-attack-6.6.1/lib/rack/attack.rb:95
  ...
  class << self
    ...
    # source://rack-attack-6.6.1/lib/rack/attack.rb:47
    def cache; end

    # source://rack-attack-6.6.1/lib/rack/attack.rb:51
    def clear!; end
    ...
    # Returns the value of attribute configuration.
    #
    # source://rack-attack-6.6.1/lib/rack/attack.rb:35
    def configuration; end

    # Returns the value of attribute enabled.
    #
    # source://rack-attack-6.6.1/lib/rack/attack.rb:34
    def enabled; end
    ...
    # source://rack-attack-6.6.1/lib/rack/attack.rb:37
    ...
    # source://rack-attack-6.6.1/lib/rack/attack.rb:56
    def reset!; end
...
# source://rack-attack-6.6.1/lib/rack/attack/allow2ban.rb:5
class Rack::Attack::Allow2Ban < ::Rack::Attack::Fail2Ban
  class << self
    ...
    #
    # source://rack-attack-6.6.1/lib/rack/attack/allow2ban.rb:15
    def fail!(discriminator, bantime, findtime, maxretry); end

    # source://rack-attack-6.6.1/lib/rack/attack/allow2ban.rb:9
    def key_prefix; end
  end
end

# source://rack-attack-6.6.1/lib/rack/attack/base_proxy.rb:7
class Rack::Attack::BaseProxy < ::SimpleDelegator
  class << self
    # @raise [NotImplementedError]
    # @return [Boolean]
    #
    # source://rack-attack-6.6.1/lib/rack/attack/base_proxy.rb:21
    def handle?(_store); end

    # @private
    #
    # source://rack-attack-6.6.1/lib/rack/attack/base_proxy.rb:13
    def inherited(klass); end

    # source://rack-attack-6.6.1/lib/rack/attack/base_proxy.rb:17
    def lookup(store); end

    # source://rack-attack-6.6.1/lib/rack/attack/base_proxy.rb:9
    def proxies; end
  end
end

# source://rack-attack-6.6.1/lib/rack/attack/blocklist.rb:5
class Rack::Attack::Blocklist < ::Rack::Attack::Check
  # @return [Blocklist] a new instance of Blocklist
  #
  # source://rack-attack-6.6.1/lib/rack/attack/blocklist.rb:6
  def initialize(name = T.unsafe(nil), &block); end
end

# source://rack-attack-6.6.1/lib/rack/attack/cache.rb:5
class Rack::Attack::Cache
  # @return [Cache] a new instance of Cache
  #
  # source://rack-attack-6.6.1/lib/rack/attack/cache.rb:9
  def initialize; end

  # source://rack-attack-6.6.1/lib/rack/attack/cache.rb:25
  def count(unprefixed_key, period); end

  # source://rack-attack-6.6.1/lib/rack/attack/cache.rb:46
  def delete(unprefixed_key); end

  # Returns the value of attribute last_epoch_time.
  #
  # source://rack-attack-6.6.1/lib/rack/attack/cache.rb:7
  def last_epoch_time; end

  # Returns the value of attribute prefix.
  #
  # source://rack-attack-6.6.1/lib/rack/attack/cache.rb:6
  def prefix; end
  ...
  # source://rack-attack-6.6.1/lib/rack/attack/cache.rb:30
  def read(unprefixed_key); end

  # source://rack-attack-6.6.1/lib/rack/attack/cache.rb:50
  def reset!; end

  # source://rack-attack-6.6.1/lib/rack/attack/cache.rb:41
  def reset_count(unprefixed_key, period); end

  # Returns the value of attribute store.
  #
  # source://rack-attack-6.6.1/lib/rack/attack/cache.rb:14
  def store; end

  # source://rack-attack-6.6.1/lib/rack/attack/cache.rb:16
  def store=(store); end

  # source://rack-attack-6.6.1/lib/rack/attack/cache.rb:37
  def write(unprefixed_key, value, expires_in); end

  private

  # source://rack-attack-6.6.1/lib/rack/attack/cache.rb:70
  def do_count(key, expires_in); end

  # source://rack-attack-6.6.1/lib/rack/attack/cache.rb:91
  def enforce_store_method_presence!(method_name); end

  # source://rack-attack-6.6.1/lib/rack/attack/cache.rb:85
  def enforce_store_presence!; end

  # source://rack-attack-6.6.1/lib/rack/attack/cache.rb:63
  def key_and_expiry(unprefixed_key, period); end
end

# source://rack-attack-6.6.1/lib/rack/attack/check.rb:5
class Rack::Attack::Check
  # @return [Check] a new instance of Check
  #
  # source://rack-attack-6.6.1/lib/rack/attack/check.rb:8
  def initialize(name, options = T.unsafe(nil), &block); end

  # Returns the value of attribute block.
  #
  # source://rack-attack-6.6.1/lib/rack/attack/check.rb:6
  def block; end

  # @return [Boolean]
  #
  # source://rack-attack-6.6.1/lib/rack/attack/check.rb:14
...
# source://rack-attack-6.6.1/lib/rack/attack/configuration.rb:7
class Rack::Attack::Configuration
  # @return [Configuration] a new instance of Configuration
  #
  # source://rack-attack-6.6.1/lib/rack/attack/configuration.rb:39
  def initialize; end

  # Returns the value of attribute anonymous_blocklists.
  #
  # source://rack-attack-6.6.1/lib/rack/attack/configuration.rb:22
  ...
  # source://rack-attack-6.6.1/lib/rack/attack/configuration.rb:53
  def blocklist(name = T.unsafe(nil), &block); end

  # source://rack-attack-6.6.1/lib/rack/attack/configuration.rb:63
  def blocklist_ip(ip_address); end

  # @return [Boolean]
  #
  # source://rack-attack-6.6.1/lib/rack/attack/configuration.rb:84
  def blocklisted?(request); end

  # Returns the value of attribute blocklisted_responder.
  #
  # source://rack-attack-6.6.1/lib/rack/attack/configuration.rb:23
  ...
  #
  # source://rack-attack-6.6.1/lib/rack/attack/configuration.rb:25
  def blocklisted_response; end

  # source://rack-attack-6.6.1/lib/rack/attack/configuration.rb:27
  ...
  # source://rack-attack-6.6.1/lib/rack/attack/configuration.rb:101
  def clear_configuration; end

  # source://rack-attack-6.6.1/lib/rack/attack/configuration.rb:43
  def safelist(name = T.unsafe(nil), &block); end

  # source://rack-attack-6.6.1/lib/rack/attack/configuration.rb:67
  def safelist_ip(ip_address); end

  # @return [Boolean]
  #
  # source://rack-attack-6.6.1/lib/rack/attack/configuration.rb:79
  ...
  # source://rack-attack-6.6.1/lib/rack/attack/configuration.rb:71
  def throttle(name, options, &block); end

  # @return [Boolean]
  #
  # source://rack-attack-6.6.1/lib/rack/attack/configuration.rb:89
  ...
  # source://rack-attack-6.6.1/lib/rack/attack/configuration.rb:33
  ...
  # source://rack-attack-6.6.1/lib/rack/attack/configuration.rb:75
  def track(name, options = T.unsafe(nil), &block); end

  # @return [Boolean]
  #
  # source://rack-attack-6.6.1/lib/rack/attack/configuration.rb:95
  def tracked?(request); end

  private

  # source://rack-attack-6.6.1/lib/rack/attack/configuration.rb:107
  def set_defaults; end
end

# source://rack-attack-6.6.1/lib/rack/attack/configuration.rb:8
Rack::Attack::Configuration::DEFAULT_BLOCKLISTED_RESPONDER = T.let(T.unsafe(nil), Proc)

# source://rack-attack-6.6.1/lib/rack/attack/configuration.rb:10
Rack::Attack::Configuration::DEFAULT_THROTTLED_RESPONDER = T.let(T.unsafe(nil), Proc)

# source://rack-attack-6.6.1/lib/rack/attack.rb:20
class Rack::Attack::Error < ::StandardError; end

# source://rack-attack-6.6.1/lib/rack/attack/fail2ban.rb:5
class Rack::Attack::Fail2Ban
  class << self
    # @return [Boolean]
    #
    # source://rack-attack-6.6.1/lib/rack/attack/fail2ban.rb:27
    def banned?(discriminator); end

    # source://rack-attack-6.6.1/lib/rack/attack/fail2ban.rb:7
    def filter(discriminator, options); end

    # source://rack-attack-6.6.1/lib/rack/attack/fail2ban.rb:20
    def reset(discriminator, options); end

    protected

    # source://rack-attack-6.6.1/lib/rack/attack/fail2ban.rb:37
    def fail!(discriminator, bantime, findtime, maxretry); end

    # source://rack-attack-6.6.1/lib/rack/attack/fail2ban.rb:33
    def key_prefix; end

    private

    # source://rack-attack-6.6.1/lib/rack/attack/fail2ban.rb:48
    def ban!(discriminator, bantime); end

    # source://rack-attack-6.6.1/lib/rack/attack/fail2ban.rb:52
    def cache; end
  end
end
...
#
# source://rack-attack-6.6.1/lib/rack/attack/path_normalizer.rb:13
module Rack::Attack::FallbackPathNormalizer
  class << self
    # source://rack-attack-6.6.1/lib/rack/attack/path_normalizer.rb:14
    def normalize_path(path); end
  end
end

# source://rack-attack-6.6.1/lib/rack/attack.rb:23
class Rack::Attack::IncompatibleStoreError < ::Rack::Attack::Error; end

# source://rack-attack-6.6.1/lib/rack/attack.rb:21
class Rack::Attack::MisconfiguredStoreError < ::Rack::Attack::Error; end

# source://rack-attack-6.6.1/lib/rack/attack.rb:22
class Rack::Attack::MissingStoreError < ::Rack::Attack::Error; end

# source://rack-attack-6.6.1/lib/rack/attack/path_normalizer.rb:19
Rack::Attack::PathNormalizer = ActionDispatch::Journey::Router::Utils

# source://rack-attack-6.6.1/lib/rack/attack/railtie.rb:5
class Rack::Attack::Railtie < ::Rails::Railtie; end

# source://rack-attack-6.6.1/lib/rack/attack/request.rb:18
class Rack::Attack::Request < ::Rack::Request; end

# source://rack-attack-6.6.1/lib/rack/attack/safelist.rb:5
class Rack::Attack::Safelist < ::Rack::Attack::Check
  # @return [Safelist] a new instance of Safelist
  #
  # source://rack-attack-6.6.1/lib/rack/attack/safelist.rb:6
  def initialize(name = T.unsafe(nil), &block); end
end

# source://rack-attack-6.6.1/lib/rack/attack/store_proxy/dalli_proxy.rb:7
module Rack::Attack::StoreProxy; end

# source://rack-attack-6.6.1/lib/rack/attack/store_proxy/active_support_redis_store_proxy.rb:8
class Rack::Attack::StoreProxy::ActiveSupportRedisStoreProxy < ::Rack::Attack::BaseProxy
  # source://rack-attack-6.6.1/lib/rack/attack/store_proxy/active_support_redis_store_proxy.rb:15
  def increment(name, amount = T.unsafe(nil), options = T.unsafe(nil)); end

  # source://rack-attack-6.6.1/lib/rack/attack/store_proxy/active_support_redis_store_proxy.rb:29
  def read(name, options = T.unsafe(nil)); end

  # source://rack-attack-6.6.1/lib/rack/attack/store_proxy/active_support_redis_store_proxy.rb:33
  def write(name, value, options = T.unsafe(nil)); end

  class << self
    # @return [Boolean]
    #
    # source://rack-attack-6.6.1/lib/rack/attack/store_proxy/active_support_redis_store_proxy.rb:9
    def handle?(store); end
  end
end

# source://rack-attack-6.6.1/lib/rack/attack/store_proxy/dalli_proxy.rb:8
class Rack::Attack::StoreProxy::DalliProxy < ::Rack::Attack::BaseProxy
  # @return [DalliProxy] a new instance of DalliProxy
  #
  # source://rack-attack-6.6.1/lib/rack/attack/store_proxy/dalli_proxy.rb:21
  def initialize(client); end

  # source://rack-attack-6.6.1/lib/rack/attack/store_proxy/dalli_proxy.rb:50
  def delete(key); end

  # source://rack-attack-6.6.1/lib/rack/attack/store_proxy/dalli_proxy.rb:42
  def increment(key, amount, options = T.unsafe(nil)); end

  # source://rack-attack-6.6.1/lib/rack/attack/store_proxy/dalli_proxy.rb:26
  def read(key); end

  # source://rack-attack-6.6.1/lib/rack/attack/store_proxy/dalli_proxy.rb:34
  def write(key, value, options = T.unsafe(nil)); end

  private

  # source://rack-attack-6.6.1/lib/rack/attack/store_proxy/dalli_proxy.rb:70
  def rescuing; end

  # source://rack-attack-6.6.1/lib/rack/attack/store_proxy/dalli_proxy.rb:60
  def stub_with_if_missing; end

  class << self
    # @return [Boolean]
    #
    # source://rack-attack-6.6.1/lib/rack/attack/store_proxy/dalli_proxy.rb:9
    def handle?(store); end
  end
end

# source://rack-attack-6.6.1/lib/rack/attack/store_proxy/mem_cache_store_proxy.rb:8
class Rack::Attack::StoreProxy::MemCacheStoreProxy < ::Rack::Attack::BaseProxy
  # source://rack-attack-6.6.1/lib/rack/attack/store_proxy/mem_cache_store_proxy.rb:15
  def read(name, options = T.unsafe(nil)); end

  # source://rack-attack-6.6.1/lib/rack/attack/store_proxy/mem_cache_store_proxy.rb:19
  def write(name, value, options = T.unsafe(nil)); end

  class << self
    # @return [Boolean]
    #
    # source://rack-attack-6.6.1/lib/rack/attack/store_proxy/mem_cache_store_proxy.rb:9
    def handle?(store); end
  end
end

# source://rack-attack-6.6.1/lib/rack/attack/store_proxy/redis_cache_store_proxy.rb:8
class Rack::Attack::StoreProxy::RedisCacheStoreProxy < ::Rack::Attack::BaseProxy
  # source://rack-attack-6.6.1/lib/rack/attack/store_proxy/redis_cache_store_proxy.rb:13
  def increment(name, amount = T.unsafe(nil), **options); end

  # source://rack-attack-6.6.1/lib/rack/attack/store_proxy/redis_cache_store_proxy.rb:27
  def read(name, options = T.unsafe(nil)); end

  # source://rack-attack-6.6.1/lib/rack/attack/store_proxy/redis_cache_store_proxy.rb:31
  def write(name, value, options = T.unsafe(nil)); end

  class << self
    # @return [Boolean]
    #
    # source://rack-attack-6.6.1/lib/rack/attack/store_proxy/redis_cache_store_proxy.rb:9
    def handle?(store); end
  end
end

# source://rack-attack-6.6.1/lib/rack/attack/store_proxy/redis_proxy.rb:8
class Rack::Attack::StoreProxy::RedisProxy < ::Rack::Attack::BaseProxy
  # @return [RedisProxy] a new instance of RedisProxy
  #
  # source://rack-attack-6.6.1/lib/rack/attack/store_proxy/redis_proxy.rb:9
  def initialize(*args); end

  # source://rack-attack-6.6.1/lib/rack/attack/store_proxy/redis_proxy.rb:42
  def delete(key, _options = T.unsafe(nil)); end

  # source://rack-attack-6.6.1/lib/rack/attack/store_proxy/redis_proxy.rb:46
  def delete_matched(matcher, _options = T.unsafe(nil)); end

  # source://rack-attack-6.6.1/lib/rack/attack/store_proxy/redis_proxy.rb:33
  def increment(key, amount, options = T.unsafe(nil)); end

  # source://rack-attack-6.6.1/lib/rack/attack/store_proxy/redis_proxy.rb:21
  def read(key); end

  # source://rack-attack-6.6.1/lib/rack/attack/store_proxy/redis_proxy.rb:25
  def write(key, value, options = T.unsafe(nil)); end

  private

  # source://rack-attack-6.6.1/lib/rack/attack/store_proxy/redis_proxy.rb:61
  def rescuing; end

  class << self
    # @return [Boolean]
    #
    # source://rack-attack-6.6.1/lib/rack/attack/store_proxy/redis_proxy.rb:17
    def handle?(store); end
  end
end

# source://rack-attack-6.6.1/lib/rack/attack/store_proxy/redis_store_proxy.rb:8
class Rack::Attack::StoreProxy::RedisStoreProxy < ::Rack::Attack::StoreProxy::RedisProxy
  # source://rack-attack-6.6.1/lib/rack/attack/store_proxy/redis_store_proxy.rb:13
  def read(key); end

  # source://rack-attack-6.6.1/lib/rack/attack/store_proxy/redis_store_proxy.rb:17
  def write(key, value, options = T.unsafe(nil)); end

  class << self
    # @return [Boolean]
    #
    # source://rack-attack-6.6.1/lib/rack/attack/store_proxy/redis_store_proxy.rb:9
    def handle?(store); end
  end
end

# source://rack-attack-6.6.1/lib/rack/attack/throttle.rb:5
class Rack::Attack::Throttle
  # @return [Throttle] a new instance of Throttle
  #
  # source://rack-attack-6.6.1/lib/rack/attack/throttle.rb:10
  def initialize(name, options, &block); end

  # Returns the value of attribute block.
  #
  # source://rack-attack-6.6.1/lib/rack/attack/throttle.rb:8
  def block; end

  # source://rack-attack-6.6.1/lib/rack/attack/throttle.rb:21
  def cache; end
  ...
  # @return [Boolean]
  #
  # source://rack-attack-6.6.1/lib/rack/attack/throttle.rb:25
  def matched_by?(request); end
  ...
  # source://rack-attack-6.6.1/lib/rack/attack/throttle.rb:72
  def annotate_request_with_matched_data(request, data); end

  # source://rack-attack-6.6.1/lib/rack/attack/throttle.rb:68
  def annotate_request_with_throttle_data(request, data); end

  # source://rack-attack-6.6.1/lib/rack/attack/throttle.rb:52
  def discriminator_for(request); end

  # source://rack-attack-6.6.1/lib/rack/attack/throttle.rb:64
  def limit_for(request); end

  # source://rack-attack-6.6.1/lib/rack/attack/throttle.rb:60
  def period_for(request); end
end

# source://rack-attack-6.6.1/lib/rack/attack/throttle.rb:6
Rack::Attack::Throttle::MANDATORY_OPTIONS = T.let(T.unsafe(nil), Array)

# source://rack-attack-6.6.1/lib/rack/attack/track.rb:5
class Rack::Attack::Track
  # @return [Track] a new instance of Track
  #
  # source://rack-attack-6.6.1/lib/rack/attack/track.rb:8
  def initialize(name, options = T.unsafe(nil), &block); end

  # Returns the value of attribute filter.
  #
  # source://rack-attack-6.6.1/lib/rack/attack/track.rb:6
  def filter; end

  # @return [Boolean]
  #
  # source://rack-attack-6.6.1/lib/rack/attack/track.rb:19
  def matched_by?(request); end
end
