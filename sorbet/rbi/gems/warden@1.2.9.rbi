...
# source://warden-1.2.9/lib/warden/mixins/common.rb:3
module Warden
...
#
# source://warden-1.2.9/lib/warden/config.rb:20
class Warden::Config < ::Hash
  # @return [Config] a new instance of Config
  #
  # source://warden-1.2.9/lib/warden/config.rb:37
  def initialize(other = T.unsafe(nil)); end

  # source://warden-1.2.9/lib/warden/config.rb:24
  def default_scope; end

  # source://warden-1.2.9/lib/warden/config.rb:28
  def default_scope=(value); end

  # Set the default strategies to use.
  # :api: public
  #
  # source://warden-1.2.9/lib/warden/config.rb:63
...
module Warden::Hooks
  ...
  # :api: public
  #
  # source://warden-1.2.9/lib/warden/hooks.rb:76
  ...
  # @raise [BlockNotGiven]
  #
  # source://warden-1.2.9/lib/warden/hooks.rb:138
  ...
  # :api: public
  #
  # source://warden-1.2.9/lib/warden/hooks.rb:85
  ...
  # @raise [BlockNotGiven]
  #
  # source://warden-1.2.9/lib/warden/hooks.rb:53
  ...
  # @raise [BlockNotGiven]
  #
  # source://warden-1.2.9/lib/warden/hooks.rb:110
  ...
  # @raise [BlockNotGiven]
  #
  # source://warden-1.2.9/lib/warden/hooks.rb:166
  ...
  # @raise [BlockNotGiven]
  #
  # source://warden-1.2.9/lib/warden/hooks.rb:191
  def on_request(options = T.unsafe(nil), method = T.unsafe(nil), &block); end

  # source://warden-1.2.9/lib/warden/hooks.rb:206
...
#
# source://warden-1.2.9/lib/warden/manager.rb:11
class Warden::Manager
  ...
  # @yield [@config]
  #
  # source://warden-1.2.9/lib/warden/manager.rb:19
  def initialize(app, options = T.unsafe(nil)); end

  # :api: private
  #
  # source://warden-1.2.9/lib/warden/manager.rb:51
  ...
  # :api: private
  #
  # source://warden-1.2.9/lib/warden/manager.rb:30
  def call(env); end

  # Returns the value of attribute config.
  #
  # source://warden-1.2.9/lib/warden/manager.rb:14
  def config; end
  ...
  # :api: private
  #
  # source://warden-1.2.9/lib/warden/manager.rb:136
  def call_failure_app(env, options = T.unsafe(nil)); end

  # source://warden-1.2.9/lib/warden/manager.rb:97
  def handle_chain_result(status, result, env); end

  # @return [Boolean]
  #
  # source://warden-1.2.9/lib/warden/manager.rb:105
  ...
  # :api: private
  #
  # source://warden-1.2.9/lib/warden/manager.rb:112
  ...
  class << self
    ...
    # :api: public
    #
    # source://warden-1.2.9/lib/warden/manager.rb:84
    ...
    # :api: public
    #
    # source://warden-1.2.9/lib/warden/manager.rb:69
    def serialize_into_session(scope = T.unsafe(nil), &block); end
  end
end

# source://warden-1.2.9/lib/warden/mixins/common.rb:4
module Warden::Mixins; end

# source://warden-1.2.9/lib/warden/mixins/common.rb:5
...
# source://warden-1.2.9/lib/warden.rb:14
class Warden::NotAuthenticated < ::StandardError; end

# source://warden-1.2.9/lib/warden/proxy.rb:7
class Warden::Proxy
  ...
  #
  # source://warden-1.2.9/lib/warden/proxy.rb:28
  ...
  # @return [Boolean]
  #
  # source://warden-1.2.9/lib/warden/proxy.rb:314
  ...
  # :api: public
  #
  # source://warden-1.2.9/lib/warden/proxy.rb:109
  ...
  # :api: public
  #
  # source://warden-1.2.9/lib/warden/proxy.rb:132
  def authenticate!(*args); end
  ...
  # @return [Boolean]
  #
  # source://warden-1.2.9/lib/warden/proxy.rb:119
  def authenticate?(*args); end
  ...
  # @return [Boolean]
  #
  # source://warden-1.2.9/lib/warden/proxy.rb:149
  ...
  # :api: public
  #
  # source://warden-1.2.9/lib/warden/proxy.rb:298
  ...
  # @return [Boolean]
  #
  # source://warden-1.2.9/lib/warden/proxy.rb:304
  def custom_failure?; end
  ...
  # :api: public
  #
  # source://warden-1.2.9/lib/warden/proxy.rb:42
  def errors; end

  # source://RUBY_ROOT/forwardable.rb:229
  def headers(*args, **_arg1, &block); end

  # source://warden-1.2.9/lib/warden/proxy.rb:318
  ...
  # :api: public
  #
  # source://warden-1.2.9/lib/warden/proxy.rb:92
  def lock!; end
  ...
  # :api: public
  #
  # source://warden-1.2.9/lib/warden/proxy.rb:266
  ...
  # :api: public
  #
  # source://warden-1.2.9/lib/warden/proxy.rb:291
  def message; end

  # Run the on_request callbacks
  # :api: private
  #
  # source://warden-1.2.9/lib/warden/proxy.rb:36
  def on_request; end

  # proxy methods through to the winning strategy
  # :api: private
  #
  # source://warden-1.2.9/lib/warden/proxy.rb:285
  def result; end
  ...
  #
  # source://warden-1.2.9/lib/warden/proxy.rb:244
  ...
  # :api: public
  #
  # source://warden-1.2.9/lib/warden/proxy.rb:50
  ...
  # :api: public
  #
  # source://warden-1.2.9/lib/warden/proxy.rb:170
  def set_user(user, opts = T.unsafe(nil)); end

  # source://RUBY_ROOT/forwardable.rb:229
  def status(*args, **_arg1, &block); end

  # source://warden-1.2.9/lib/warden/proxy.rb:322
  def to_s(*args); end
  ...
  # @return [Boolean]
  #
  # source://warden-1.2.9/lib/warden/proxy.rb:157
  ...
  # :api: public
  #
  # source://warden-1.2.9/lib/warden/proxy.rb:217
  ...
  # :api: private
  #
  # source://warden-1.2.9/lib/warden/proxy.rb:10
...
# @since DM 0.9
#
# source://warden-1.2.9/lib/warden/errors.rb:8
class Warden::Proxy::Errors
  ...
  # @since DM 0.9
  #
  # source://warden-1.2.9/lib/warden/errors.rb:22
  ...
  # @since DM 0.9
  #
  # source://warden-1.2.9/lib/warden/errors.rb:13
  def clear!; end

  # @since DM 0.9
  #
  # source://warden-1.2.9/lib/warden/errors.rb:41
  def each; end

  # @return [Boolean]
  # @since DM 0.9
  #
  # source://warden-1.2.9/lib/warden/errors.rb:48
  def empty?; end
  ...
  # @since DM 0.9
  #
  # source://warden-1.2.9/lib/warden/errors.rb:27
  def full_messages; end

  # @since DM 0.9
  #
  # source://warden-1.2.9/lib/warden/errors.rb:52
  ...
  # @since DM 0.9
  #
  # source://warden-1.2.9/lib/warden/errors.rb:36
  ...
  # @since DM 0.9
  #
  # source://warden-1.2.9/lib/warden/errors.rb:61
  def blank?(thing); end

  # @since DM 0.9
  #
  # source://warden-1.2.9/lib/warden/errors.rb:57
  def errors; end
end

# source://warden-1.2.9/lib/warden/session_serializer.rb:4
class Warden::SessionSerializer
  # @return [SessionSerializer] a new instance of SessionSerializer
  #
  # source://warden-1.2.9/lib/warden/session_serializer.rb:7
  def initialize(env); end

  # source://warden-1.2.9/lib/warden/session_serializer.rb:44
  def delete(scope, user = T.unsafe(nil)); end

  # source://warden-1.2.9/lib/warden/session_serializer.rb:19
  def deserialize(key); end

  # Returns the value of attribute env.
  #
  # source://warden-1.2.9/lib/warden/session_serializer.rb:5
  def env; end

  # source://warden-1.2.9/lib/warden/session_serializer.rb:30
  def fetch(scope); end

  # source://warden-1.2.9/lib/warden/session_serializer.rb:11
  def key_for(scope); end

  # source://warden-1.2.9/lib/warden/session_serializer.rb:15
  def serialize(user); end

  # We can't cache this result because the session can be lazy loaded
  #
  # source://warden-1.2.9/lib/warden/session_serializer.rb:49
  def session; end

  # source://warden-1.2.9/lib/warden/session_serializer.rb:23
  def store(user, scope); end

  # @return [Boolean]
  #
  # source://warden-1.2.9/lib/warden/session_serializer.rb:40
  def stored?(scope); end
end

# source://warden-1.2.9/lib/warden/strategies.rb:4
module Warden::Strategies
  class << self
    # Provides access to strategies by label
    # :api: public
    #
    # source://warden-1.2.9/lib/warden/strategies.rb:32
    def [](label); end

    # :api: private
    #
    # source://warden-1.2.9/lib/warden/strategies.rb:43
    def _strategies; end

    # Add a strategy and store it in a hash.
    #
    # source://warden-1.2.9/lib/warden/strategies.rb:7
    def add(label, strategy = T.unsafe(nil), &block); end

    # Clears all declared.
    # :api: public
    #
    # source://warden-1.2.9/lib/warden/strategies.rb:38
    def clear!; end

    # Update a previously given strategy.
    #
    # source://warden-1.2.9/lib/warden/strategies.rb:24
...
#
# source://warden-1.2.9/lib/warden/strategies/base.rb:31
class Warden::Strategies::Base
  ...
  #
  # source://warden-1.2.9/lib/warden/strategies/base.rb:44
  ...
  # :api: private
  #
  # source://warden-1.2.9/lib/warden/strategies/base.rb:53
  def _run!; end

  # Marks this strategy as not performed.
  # :api: private
  #
  # source://warden-1.2.9/lib/warden/strategies/base.rb:67
  def clear!; end

  # Return a custom rack array.  You must throw an :warden symbol to activate this
  # :api: public
  #
  # source://warden-1.2.9/lib/warden/strategies/base.rb:174
  def custom!(response); end

  # :api: private
  #
  # source://warden-1.2.9/lib/warden/strategies/base.rb:36
  ...
  # :api: public
  #
  # source://warden-1.2.9/lib/warden/strategies/base.rb:39
  def env; end

  # Access to the errors object.
  # :api: public
  #
  # source://warden-1.2.9/lib/warden/strategies/base.rb:87
  def errors; end
  ...
  # :api: public
  #
  # source://warden-1.2.9/lib/warden/strategies/base.rb:145
  ...
  # :api: public
  #
  # source://warden-1.2.9/lib/warden/strategies/base.rb:137
  def fail!(message = T.unsafe(nil)); end

  # Cause the processing of the strategies to stop and cascade no further
  # :api: public
  #
  # source://warden-1.2.9/lib/warden/strategies/base.rb:93
  def halt!; end
  ...
  # @return [Boolean]
  #
  # source://warden-1.2.9/lib/warden/strategies/base.rb:99
  def halted?; end

  # Provides access to the headers hash for setting custom headers
  # :api: public
  #
  # source://warden-1.2.9/lib/warden/strategies/base.rb:79
  def headers(header = T.unsafe(nil)); end

  # :api: public
  #
  # source://warden-1.2.9/lib/warden/strategies/base.rb:33
  def message; end
  ...
  # :api: public
  #
  # source://warden-1.2.9/lib/warden/strategies/base.rb:111
  def pass; end
  ...
  # @return [Boolean]
  #
  # source://warden-1.2.9/lib/warden/strategies/base.rb:61
  def performed?; end
  ...
  # :api: public
  #
  # source://warden-1.2.9/lib/warden/strategies/base.rb:159
  ...
  # @return [Boolean]
  #
  # source://warden-1.2.9/lib/warden/strategies/base.rb:105
  def store?; end
  ...
  # :api: public
  #
  # source://warden-1.2.9/lib/warden/strategies/base.rb:126
  ...
  # @return [Boolean]
  #
  # source://warden-1.2.9/lib/warden/strategies/base.rb:114
  def successful?; end
  ...
  # @return [Boolean]
  #
  # source://warden-1.2.9/lib/warden/strategies/base.rb:75
  def valid?; end
end

# source://warden-1.2.9/lib/warden.rb:16
...
#
# source://warden-1.2.9/lib/warden/test/helpers.rb:9
module Warden::Test::Helpers
  ...
  #
  # source://warden-1.2.9/lib/warden/test/helpers.rb:18
  ...
  #
  # source://warden-1.2.9/lib/warden/test/helpers.rb:30
  def logout(*scopes); end

  class << self
    # @private
    #
    # source://warden-1.2.9/lib/warden/test/helpers.rb:10
...
# Note: During the teardown phase of your specs you should include: Warden.test_reset!
#
# source://warden-1.2.9/lib/warden/test/mock.rb:10
module Warden::Test::Mock
  # A helper method that provides the warden object by mocking the env variable.
  #
  # @api public
  #
  # source://warden-1.2.9/lib/warden/test/mock.rb:17
  def warden; end

  private

  # source://warden-1.2.9/lib/warden/test/mock.rb:37
  def app; end

  # source://warden-1.2.9/lib/warden/test/mock.rb:25
  def env; end

  class << self
    # @private
    #
    # source://warden-1.2.9/lib/warden/test/mock.rb:11
    def included(_base); end
  end
end

# source://warden-1.2.9/lib/warden/test/mock.rb:56
class Warden::Test::Mock::Session
  # @return [Session] a new instance of Session
  #
  # source://warden-1.2.9/lib/warden/test/mock.rb:58
  def initialize(app, _configs = T.unsafe(nil)); end

  # Returns the value of attribute app.
  #
  # source://warden-1.2.9/lib/warden/test/mock.rb:57
  def app; end
  ...
  # source://warden-1.2.9/lib/warden/test/mock.rb:62
  def call(e); end
end

# source://warden-1.2.9/lib/warden/test/warden_helpers.rb:7
module Warden::Test::WardenHelpers
  # A container for the on_next_request items.
  #
  # @api private
  #
  # source://warden-1.2.9/lib/warden/test/warden_helpers.rb:38
  ...
  #
  # source://warden-1.2.9/lib/warden/test/warden_helpers.rb:11
  def asset_paths; end
  ...
  # @see Warden::Proxy#asset_request?
  #
  # source://warden-1.2.9/lib/warden/test/warden_helpers.rb:18
  ...
  # @api public
  #
  # source://warden-1.2.9/lib/warden/test/warden_helpers.rb:25
  ...
  # @api public
  #
  # source://warden-1.2.9/lib/warden/test/warden_helpers.rb:32
  def test_reset!; end
end

# source://warden-1.2.9/lib/warden/proxy.rb:5
