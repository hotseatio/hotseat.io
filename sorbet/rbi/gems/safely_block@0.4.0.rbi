...
# source://safely_block//lib/safely/services.rb#1
module Safely
  extend ::Safely::Methods

  class << self
    # source://safely_block//lib/safely/core.rb#29
    def env; end
    ...
    #
    # source://safely_block//lib/safely/core.rb#11
    def env=(_arg0); end
    ...
    # source://safely_block//lib/safely/core.rb#13
    ...
    # @return [Boolean]
    #
    # source://safely_block//lib/safely/core.rb#33
    def throttled?(e, options); end
  end
end

# source://safely_block//lib/safely/services.rb#2
Safely::DEFAULT_EXCEPTION_METHOD = T.let(T.unsafe(nil), Proc)

# source://safely_block//lib/safely/core.rb#47
