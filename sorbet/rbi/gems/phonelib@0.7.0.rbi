...
#   end
#
# source://phonelib-0.7.0/lib/validators/phone_validator3.rb:55
class PhoneValidator < ::ActiveModel::EachValidator
  include ::Phonelib::Core

  # Validation method
  #
  # source://phonelib-0.7.0/lib/validators/phone_validator3.rb:59
  ...
  # @private
  #
  # source://phonelib-0.7.0/lib/validators/phone_validator3.rb:126
  def countries; end

  # source://phonelib-0.7.0/lib/validators/phone_validator3.rb:70
  def message; end

  # @private
  #
  # source://phonelib-0.7.0/lib/validators/phone_validator3.rb:114
  def phone_countries; end

  # @private
  #
  # source://phonelib-0.7.0/lib/validators/phone_validator3.rb:104
  def phone_types; end

  # @return [Boolean]
  #
  # source://phonelib-0.7.0/lib/validators/phone_validator3.rb:74
  def phone_valid?; end

  # source://phonelib-0.7.0/lib/validators/phone_validator3.rb:93
  def specified_country(record); end

  # @private
  #
  # source://phonelib-0.7.0/lib/validators/phone_validator3.rb:120
  def types; end

  # @return [Boolean]
  #
  # source://phonelib-0.7.0/lib/validators/phone_validator3.rb:83
  def valid_country?; end

  # @return [Boolean]
  #
  # source://phonelib-0.7.0/lib/validators/phone_validator3.rb:88
  def valid_extensions?; end

  # @return [Boolean]
  #
  # source://phonelib-0.7.0/lib/validators/phone_validator3.rb:78
  def valid_types?; end
end

# main Phonelib module definition
#
# source://phonelib-0.7.0/lib/phonelib.rb:2
module Phonelib
...
#
# source://phonelib-0.7.0/lib/phonelib/core.rb:3
module Phonelib::Core
  # source://phonelib-0.7.0/lib/phonelib/core.rb:163
  def add_additional_regex(country, type, national_regex); end

  # source://phonelib-0.7.0/lib/phonelib/core.rb:184
  def additional_regexes; end

  # setter for data file to use
  #
  # source://phonelib-0.7.0/lib/phonelib/core.rb:154
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/core.rb:34
  ...
  # @return [String|nil] Default country set for parsing or nil
  #
  # source://phonelib-0.7.0/lib/phonelib/core.rb:41
  def default_country=(country); end

  # source://phonelib-0.7.0/lib/phonelib/core.rb:172
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/core.rb:66
  ...
  # @return [String] Default extension separator symbols used for parsing
  #
  # source://phonelib-0.7.0/lib/phonelib/core.rb:73
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/core.rb:50
  ...
  # @return [String] Default extension separator used for formatting
  #
  # source://phonelib-0.7.0/lib/phonelib/core.rb:57
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/core.rb:402
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/core.rb:388
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/core.rb:418
  def invalid_for_country?(phone_number, country); end

  # source://phonelib-0.7.0/lib/phonelib/core.rb:148
  def override_phone_data; end

  # setter for data file to use
  #
  # source://phonelib-0.7.0/lib/phonelib/core.rb:144
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/core.rb:374
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/core.rb:83
  ...
  # @return [Boolean] Flag defines whether to parse special phone types
  #
  # source://phonelib-0.7.0/lib/phonelib/core.rb:90
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/core.rb:9
  def phone_data; end

  # @private getter for extended phone data
  #
  # source://phonelib-0.7.0/lib/phonelib/core.rb:25
  def phone_ext_data; end

  # @private getter for phone regexp cache (internal use only)
  #
  # source://phonelib-0.7.0/lib/phonelib/core.rb:17
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/core.rb:395
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/core.rb:115
  ...
  # @return [String] regex of symbols to wipe from parsed number
  #
  # source://phonelib-0.7.0/lib/phonelib/core.rb:122
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/core.rb:99
  ...
  # @return [Boolean] Flag defines whether to do strict parsing check
  #
  # source://phonelib-0.7.0/lib/phonelib/core.rb:106
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/core.rb:131
  ...
  # @return [Boolean] Flag defines whether to do strict double prefix parsing check
  #
  # source://phonelib-0.7.0/lib/phonelib/core.rb:138
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/core.rb:381
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/core.rb:410
  def valid_for_country?(phone_number, country); end

  # source://phonelib-0.7.0/lib/phonelib/core.rb:194
  def vanity_conversion; end

  # setter for vanity phone numbers chars replacement
  #
  # source://phonelib-0.7.0/lib/phonelib/core.rb:190
...
#
# source://phonelib-0.7.0/lib/phonelib/core.rb:228
...
class Phonelib::Phone
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone.rb:25
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone.rb:46
  def ==(other); end
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone.rb:93
  def countries; end
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone.rb:113
  def country; end

  # @return [String] phone extension passed for parsing after a number
  #
  # source://phonelib-0.7.0/lib/phonelib/phone.rb:9
  def extension; end
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone.rb:87
  def human_type; end
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone.rb:81
  def human_types; end
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone.rb:137
  def impossible?; end
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone.rb:125
  def invalid?; end
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone.rb:173
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone.rb:143
  def local_number; end

  # @return [String] phone national number
  #
  # source://phonelib-0.7.0/lib/phonelib/phone.rb:12
  def national_number; end

  # @return [String] original phone number passed for parsing
  #
  # source://phonelib-0.7.0/lib/phonelib/phone.rb:6
  def original; end
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone.rb:131
  def possible?; end
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone.rb:69
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone.rb:54
  def sanitized; end

  # method returns string representation of parsed phone
  #
  # source://phonelib-0.7.0/lib/phonelib/phone.rb:39
  def to_s; end
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone.rb:75
  def type; end
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone.rb:63
  def types; end
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone.rb:119
  def valid?; end
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone.rb:99
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone.rb:107
  def valid_country; end
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone.rb:160
...
module Phonelib::PhoneAnalyzer
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_analyzer.rb:18
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_analyzer.rb:184
  def all_number_types(phone, data, not_valid = T.unsafe(nil)); end

  # source://phonelib-0.7.0/lib/phonelib/phone_analyzer.rb:43
  def analyze_single_country(phone, country, passed_country); end

  # method checks which result is better to return
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_analyzer.rb:59
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_analyzer.rb:144
  ...
  # * +phone+ - phone number for parsing
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_analyzer.rb:126
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_analyzer.rb:219
  ...
  # * +not_valid+ - specifies that number is not valid by general desc pattern
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_analyzer.rb:165
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_analyzer.rb:205
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_analyzer.rb:89
...
module Phonelib::PhoneAnalyzerHelper
  ...
  # @return [Boolean]
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_analyzer_helper.rb:56
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_analyzer_helper.rb:99
  def country_or_default_country(country); end

  # returns country prefix for provided country or nil
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_analyzer_helper.rb:44
  def country_prefix(country); end

  # caches regular expression, reusing it for later lookups
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_analyzer_helper.rb:51
  def cr(regexp); end

  # source://phonelib-0.7.0/lib/phonelib/phone_analyzer_helper.rb:6
  ...
  # @return [Boolean]
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_analyzer_helper.rb:82
  ...
  # * +data+  - country data
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_analyzer_helper.rb:184
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_analyzer_helper.rb:115
  ...
  # @return [Boolean]
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_analyzer_helper.rb:215
  ...
  # @return [Boolean]
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_analyzer_helper.rb:200
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_analyzer_helper.rb:90
  def original_s; end

  # @return [Boolean]
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_analyzer_helper.rb:14
  def original_starts_with_plus?; end

  # defines if to validate against single country or not
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_analyzer_helper.rb:33
  ...
  # @return [Boolean]
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_analyzer_helper.rb:146
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_analyzer_helper.rb:157
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_analyzer_helper.rb:132
  ...
  # * +data+  - country data hash
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_analyzer_helper.rb:172
  def types_for_check(data); end

  # converts symbols in phone to numbers
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_analyzer_helper.rb:19
  def vanity_converted(phone); end
end

# module provides extended data methods for parsed phone
#
# source://phonelib-0.7.0/lib/phonelib/phone_extended_data.rb:3
module Phonelib::PhoneExtendedData
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_extended_data.rb:30
  def carrier; end
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_extended_data.rb:14
  def geo_name; end
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_extended_data.rb:22
  def timezone; end

  # returns valid country name
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_extended_data.rb:36
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_extended_data.rb:80
  def default_ext_data; end

  # @private returns extended data ids for current number
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_extended_data.rb:60
  def ext_data; end
...
module Phonelib::PhoneFormatter
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_formatter.rb:34
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_formatter.rb:82
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_formatter.rb:75
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_formatter.rb:68
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_formatter.rb:61
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_formatter.rb:43
  def international(formatted = T.unsafe(nil), prefix = T.unsafe(nil)); end

  # source://phonelib-0.7.0/lib/phonelib/phone_formatter.rb:101
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_formatter.rb:7
  ...
  #
  # source://phonelib-0.7.0/lib/phonelib/phone_formatter.rb:21
