...
# source://aws-eventstream-1.2.0/lib/aws-eventstream/decoder.rb:7
module Aws
  class << self
...
# source://aws-eventstream-1.2.0/lib/aws-eventstream/decoder.rb:8
...
#
# source://aws-eventstream-1.2.0/lib/aws-eventstream/decoder.rb:63
class Aws::EventStream::Decoder
  ...
  #
  # source://aws-eventstream-1.2.0/lib/aws-eventstream/decoder.rb:83
  ...
  #
  # source://aws-eventstream-1.2.0/lib/aws-eventstream/decoder.rb:96
  ...
  #
  # source://aws-eventstream-1.2.0/lib/aws-eventstream/decoder.rb:114
  def decode_chunk(chunk = T.unsafe(nil)); end

  private

  # source://aws-eventstream-1.2.0/lib/aws-eventstream/decoder.rb:163
  def decode_context(content, header_length); end

  # source://aws-eventstream-1.2.0/lib/aws-eventstream/decoder.rb:130
  def decode_message(raw_message); end

  # @raise [Errors::PreludeChecksumError]
  #
  # source://aws-eventstream-1.2.0/lib/aws-eventstream/decoder.rb:155
  def decode_prelude(prelude); end

  # source://aws-eventstream-1.2.0/lib/aws-eventstream/decoder.rb:171
  def extract_headers(buffer); end

  # source://aws-eventstream-1.2.0/lib/aws-eventstream/decoder.rb:201
  def extract_payload(encoded); end

  # exposed via object.send for testing
  #
  # source://aws-eventstream-1.2.0/lib/aws-eventstream/decoder.rb:122
  def message_buffer; end

  # source://aws-eventstream-1.2.0/lib/aws-eventstream/decoder.rb:207
  def payload_stringio(encoded); end

  # source://aws-eventstream-1.2.0/lib/aws-eventstream/decoder.rb:211
  def payload_tempfile(encoded); end

  # source://aws-eventstream-1.2.0/lib/aws-eventstream/decoder.rb:124
  def wrap_as_enumerator(decoded_message); end
end

# 4 bytes message crc checksum
#
# source://aws-eventstream-1.2.0/lib/aws-eventstream/decoder.rb:76
Aws::EventStream::Decoder::CRC32_LENGTH = T.let(T.unsafe(nil), Integer)

# source://aws-eventstream-1.2.0/lib/aws-eventstream/decoder.rb:67
...
#
# source://aws-eventstream-1.2.0/lib/aws-eventstream/decoder.rb:72
...
#   # => true
#
# source://aws-eventstream-1.2.0/lib/aws-eventstream/encoder.rb:38
class Aws::EventStream::Encoder
  ...
  #   returned.
  #
  # source://aws-eventstream-1.2.0/lib/aws-eventstream/encoder.rb:63
  ...
  # @return [String]
  #
  # source://aws-eventstream-1.2.0/lib/aws-eventstream/encoder.rb:110
  ...
  # @return [String]
  #
  # source://aws-eventstream-1.2.0/lib/aws-eventstream/encoder.rb:79
  def encode_message(message); end

  private

  # source://aws-eventstream-1.2.0/lib/aws-eventstream/encoder.rb:135
  def encode_prelude(total_length, headers_length); end
end

# Maximum header length allowed (after encode) 128kb
#
# source://aws-eventstream-1.2.0/lib/aws-eventstream/encoder.rb:45
Aws::EventStream::Encoder::MAX_HEADERS_LENGTH = T.let(T.unsafe(nil), Integer)

# Maximum payload length allowed (after encode) 16mb
#
# source://aws-eventstream-1.2.0/lib/aws-eventstream/encoder.rb:48
...
#
# source://aws-eventstream-1.2.0/lib/aws-eventstream/encoder.rb:42
Aws::EventStream::Encoder::OVERHEAD_LENGTH = T.let(T.unsafe(nil), Integer)

# source://aws-eventstream-1.2.0/lib/aws-eventstream/errors.rb:5
module Aws::EventStream::Errors; end

# source://aws-eventstream-1.2.0/lib/aws-eventstream/errors.rb:41
class Aws::EventStream::Errors::EventHeadersLengthExceedError < ::RuntimeError
  ...
  #
  # source://aws-eventstream-1.2.0/lib/aws-eventstream/errors.rb:42
  def initialize(*args); end
end

# source://aws-eventstream-1.2.0/lib/aws-eventstream/errors.rb:35
class Aws::EventStream::Errors::EventPayloadLengthExceedError < ::RuntimeError
  ...
  #
  # source://aws-eventstream-1.2.0/lib/aws-eventstream/errors.rb:36
  def initialize(*args); end
end

# Raise when insufficient bytes of a message is received
#
# source://aws-eventstream-1.2.0/lib/aws-eventstream/errors.rb:17
class Aws::EventStream::Errors::IncompleteMessageError < ::RuntimeError
  ...
  #
  # source://aws-eventstream-1.2.0/lib/aws-eventstream/errors.rb:18
  def initialize(*args); end
end

# source://aws-eventstream-1.2.0/lib/aws-eventstream/errors.rb:29
class Aws::EventStream::Errors::MessageChecksumError < ::RuntimeError
  ...
  #
  # source://aws-eventstream-1.2.0/lib/aws-eventstream/errors.rb:30
  def initialize(*args); end
end

# source://aws-eventstream-1.2.0/lib/aws-eventstream/errors.rb:23
class Aws::EventStream::Errors::PreludeChecksumError < ::RuntimeError
  ...
  #
  # source://aws-eventstream-1.2.0/lib/aws-eventstream/errors.rb:24
  def initialize(*args); end
end

# Raised when reading bytes exceed buffer total bytes
#
# source://aws-eventstream-1.2.0/lib/aws-eventstream/errors.rb:8
class Aws::EventStream::Errors::ReadBytesExceedLengthError < ::RuntimeError
  ...
  #
  # source://aws-eventstream-1.2.0/lib/aws-eventstream/errors.rb:9
  def initialize(target_byte, total_len); end
end

# source://aws-eventstream-1.2.0/lib/aws-eventstream/header_value.rb:6
class Aws::EventStream::HeaderValue
  # @return [HeaderValue] a new instance of HeaderValue
  #
  # source://aws-eventstream-1.2.0/lib/aws-eventstream/header_value.rb:8
  def initialize(options); end

  # @return [String] type of the header value
  #   complete type list see Aws::EventStream::Types
  #
  # source://aws-eventstream-1.2.0/lib/aws-eventstream/header_value.rb:19
  def type; end

  # Returns the value of attribute value.
  #
  # source://aws-eventstream-1.2.0/lib/aws-eventstream/header_value.rb:15
  def value; end

  private

  # source://aws-eventstream-1.2.0/lib/aws-eventstream/header_value.rb:40
  def format_timestamp(value); end

  # source://aws-eventstream-1.2.0/lib/aws-eventstream/header_value.rb:32
  def format_uuid(value); end

  # source://aws-eventstream-1.2.0/lib/aws-eventstream/header_value.rb:23
  def format_value(value); end
end

# source://aws-eventstream-1.2.0/lib/aws-eventstream/message.rb:5
class Aws::EventStream::Message
  # @return [Message] a new instance of Message
  #
  # source://aws-eventstream-1.2.0/lib/aws-eventstream/message.rb:7
  def initialize(options); end

  # @return [Hash] headers of a message
  #
  # source://aws-eventstream-1.2.0/lib/aws-eventstream/message.rb:13
  def headers; end
  ...
  #
  # source://aws-eventstream-1.2.0/lib/aws-eventstream/message.rb:18
  def payload; end
end

# Message Header Value Types
#
# source://aws-eventstream-1.2.0/lib/aws-eventstream/types.rb:7
module Aws::EventStream::Types
  class << self
    # pack/unpack pattern, byte size, type idx
    #
    # source://aws-eventstream-1.2.0/lib/aws-eventstream/types.rb:25
    def pattern; end

    # source://aws-eventstream-1.2.0/lib/aws-eventstream/types.rb:9
    def types; end
  end
end
