...
# source://kaminari-core-1.2.2/lib/kaminari/core.rb:3
module Kaminari
  class << self
...
# source://kaminari-core-1.2.2/lib/kaminari/config.rb:18
class Kaminari::Config
  # @return [Config] a new instance of Config
  #
  # source://kaminari-core-1.2.2/lib/kaminari/config.rb:22
  def initialize; end

  # Returns the value of attribute default_per_page.
  #
  # source://kaminari-core-1.2.2/lib/kaminari/config.rb:19
  ...
  #
  # source://kaminari-core-1.2.2/lib/kaminari/config.rb:36
  def param_name; end
  ...
  #
  # source://kaminari-core-1.2.2/lib/kaminari/config.rb:20
...
# source://kaminari-core-1.2.2/lib/kaminari/models/configuration_methods.rb:6
...
# source://kaminari-core-1.2.2/lib/kaminari/models/configuration_methods.rb:8
module Kaminari::ConfigurationMethods::ClassMethods
  ...
  #
  # source://kaminari-core-1.2.2/lib/kaminari/models/configuration_methods.rb:19
  def default_per_page; end
  ...
  #
  # source://kaminari-core-1.2.2/lib/kaminari/models/configuration_methods.rb:44
  def max_pages(val = T.unsafe(nil)); end

  # source://kaminari-core-1.2.2/lib/kaminari/models/configuration_methods.rb:54
  ...
  #   end
  #
  # source://kaminari-core-1.2.2/lib/kaminari/models/configuration_methods.rb:27
  ...
  #
  # source://kaminari-core-1.2.2/lib/kaminari/models/configuration_methods.rb:33
  def max_per_page; end
  ...
  #   end
  #
  # source://kaminari-core-1.2.2/lib/kaminari/models/configuration_methods.rb:13
  def paginates_per(val); end
end

# source://kaminari-core-1.2.2/lib/kaminari/engine.rb:4
class Kaminari::Engine < ::Rails::Engine; end

# source://kaminari-core-1.2.2/lib/kaminari/helpers/tags.rb:4
module Kaminari::Helpers; end

# Link with page number that appears at the leftmost
#
# source://kaminari-core-1.2.2/lib/kaminari/helpers/tags.rb:103
class Kaminari::Helpers::FirstPage < ::Kaminari::Helpers::Tag
  include ::Kaminari::Helpers::Link

  # source://kaminari-core-1.2.2/lib/kaminari/helpers/tags.rb:105
  def page; end
end

# Non-link tag that stands for skipped pages...
#
# source://kaminari-core-1.2.2/lib/kaminari/helpers/tags.rb:161
class Kaminari::Helpers::Gap < ::Kaminari::Helpers::Tag; end

# source://kaminari-core-1.2.2/lib/kaminari/helpers/helper_methods.rb:98
module Kaminari::Helpers::HelperMethods
  ...
  #   <% end %>
  #
  # source://kaminari-core-1.2.2/lib/kaminari/helpers/helper_methods.rb:172
  ...
  #   <% end %>
  #
  # source://kaminari-core-1.2.2/lib/kaminari/helpers/helper_methods.rb:141
  ...
  #
  # source://kaminari-core-1.2.2/lib/kaminari/helpers/helper_methods.rb:201
  ...
  #
  # source://kaminari-core-1.2.2/lib/kaminari/helpers/helper_methods.rb:116
  ...
  #
  # source://kaminari-core-1.2.2/lib/kaminari/helpers/helper_methods.rb:236
  def rel_next_prev_link_tags(scope, options = T.unsafe(nil)); end
end

# Link with page number that appears at the rightmost
#
# source://kaminari-core-1.2.2/lib/kaminari/helpers/tags.rb:111
class Kaminari::Helpers::LastPage < ::Kaminari::Helpers::Tag
  include ::Kaminari::Helpers::Link

  # source://kaminari-core-1.2.2/lib/kaminari/helpers/tags.rb:113
  def page; end
end

# Tag that contains a link
#
# source://kaminari-core-1.2.2/lib/kaminari/helpers/tags.rb:74
module Kaminari::Helpers::Link
  # target page number
  #
  # source://kaminari-core-1.2.2/lib/kaminari/helpers/tags.rb:76
  def page; end

  # source://kaminari-core-1.2.2/lib/kaminari/helpers/tags.rb:83
  def to_s(locals = T.unsafe(nil)); end

  # the link's href
  #
  # source://kaminari-core-1.2.2/lib/kaminari/helpers/tags.rb:80
  def url; end
end

# The "next" page of the current page
#
# source://kaminari-core-1.2.2/lib/kaminari/helpers/tags.rb:140
class Kaminari::Helpers::NextPage < ::Kaminari::Helpers::Tag
  ...
  #
  # source://kaminari-core-1.2.2/lib/kaminari/helpers/tags.rb:144
  ...
  # source://kaminari-core-1.2.2/lib/kaminari/helpers/tags.rb:155
  def page; end
end

# source://kaminari-core-1.2.2/lib/kaminari/helpers/tags.rb:5
Kaminari::Helpers::PARAM_KEY_EXCEPT_LIST = T.let(T.unsafe(nil), Array)

# A page
#
# source://kaminari-core-1.2.2/lib/kaminari/helpers/tags.rb:90
class Kaminari::Helpers::Page < ::Kaminari::Helpers::Tag
  include ::Kaminari::Helpers::Link

  # target page number
  #
  # source://kaminari-core-1.2.2/lib/kaminari/helpers/tags.rb:93
  def page; end

  # source://kaminari-core-1.2.2/lib/kaminari/helpers/tags.rb:96
  def to_s(locals = T.unsafe(nil)); end
end

# The main container tag
#
# source://kaminari-core-1.2.2/lib/kaminari/helpers/paginator.rb:9
class Kaminari::Helpers::Paginator < ::Kaminari::Helpers::Tag
  # @return [Paginator] a new instance of Paginator
  #
  # source://kaminari-core-1.2.2/lib/kaminari/helpers/paginator.rb:10
  ...
  #
  # source://kaminari-core-1.2.2/lib/kaminari/helpers/paginator.rb:43
  def each_page; end
  ...
  # source://kaminari-core-1.2.2/lib/kaminari/helpers/paginator.rb:67
  ...
  # source://kaminari-core-1.2.2/lib/kaminari/helpers/paginator.rb:61
  ...
  #
  # source://kaminari-core-1.2.2/lib/kaminari/helpers/paginator.rb:28
  def render(&block); end

  # source://kaminari-core-1.2.2/lib/kaminari/helpers/paginator.rb:73
  def to_s; end
  ...
  #
  # source://kaminari-core-1.2.2/lib/kaminari/helpers/paginator.rb:81
  def method_missing(name, *args, &block); end

  # source://kaminari-core-1.2.2/lib/kaminari/helpers/paginator.rb:52
  def relevant_pages(options); end
end

# Wraps a "page number" and provides some utility methods
#
# source://kaminari-core-1.2.2/lib/kaminari/helpers/paginator.rb:87
class Kaminari::Helpers::Paginator::PageProxy
  include ::Comparable

  # @return [PageProxy] a new instance of PageProxy
  #
  # source://kaminari-core-1.2.2/lib/kaminari/helpers/paginator.rb:90
  def initialize(options, page, last); end

  # source://kaminari-core-1.2.2/lib/kaminari/helpers/paginator.rb:177
  def +(other); end

  # source://kaminari-core-1.2.2/lib/kaminari/helpers/paginator.rb:181
  def -(other); end

  # source://kaminari-core-1.2.2/lib/kaminari/helpers/paginator.rb:185
  def <=>(other); end
  ...
  # @return [Boolean]
  #
  # source://kaminari-core-1.2.2/lib/kaminari/helpers/paginator.rb:100
  def current?; end
  ...
  # @return [Boolean]
  #
  # source://kaminari-core-1.2.2/lib/kaminari/helpers/paginator.rb:165
  def display_tag?; end
  ...
  # @return [Boolean]
  #
  # source://kaminari-core-1.2.2/lib/kaminari/helpers/paginator.rb:105
  def first?; end
  ...
  # @return [Boolean]
  #
  # source://kaminari-core-1.2.2/lib/kaminari/helpers/paginator.rb:144
  ...
  # @return [Boolean]
  #
  # source://kaminari-core-1.2.2/lib/kaminari/helpers/paginator.rb:110
  def last?; end
  ...
  # @return [Boolean]
  #
  # source://kaminari-core-1.2.2/lib/kaminari/helpers/paginator.rb:134
  def left_outer?; end
  ...
  # @return [Boolean]
  #
  # source://kaminari-core-1.2.2/lib/kaminari/helpers/paginator.rb:120
  def next?; end

  # the page number
  #
  # source://kaminari-core-1.2.2/lib/kaminari/helpers/paginator.rb:95
  def number; end
  ...
  # @return [Boolean]
  #
  # source://kaminari-core-1.2.2/lib/kaminari/helpers/paginator.rb:155
  ...
  # @return [Boolean]
  #
  # source://kaminari-core-1.2.2/lib/kaminari/helpers/paginator.rb:115
  def prev?; end

  # relationship with the current page
  #
  # source://kaminari-core-1.2.2/lib/kaminari/helpers/paginator.rb:125
  def rel; end
  ...
  # @return [Boolean]
  #
  # source://kaminari-core-1.2.2/lib/kaminari/helpers/paginator.rb:139
  def right_outer?; end
  ...
  # @return [Boolean]
  #
  # source://kaminari-core-1.2.2/lib/kaminari/helpers/paginator.rb:149
  def single_gap?; end

  # source://kaminari-core-1.2.2/lib/kaminari/helpers/paginator.rb:169
  def to_i; end

  # source://kaminari-core-1.2.2/lib/kaminari/helpers/paginator.rb:173
  def to_s; end
  ...
  # @return [Boolean]
  #
  # source://kaminari-core-1.2.2/lib/kaminari/helpers/paginator.rb:160
  def was_truncated?; end
end

# The "previous" page of the current page
#
# source://kaminari-core-1.2.2/lib/kaminari/helpers/tags.rb:119
class Kaminari::Helpers::PrevPage < ::Kaminari::Helpers::Tag
  ...
  #
  # source://kaminari-core-1.2.2/lib/kaminari/helpers/tags.rb:123
  def initialize(template, params: T.unsafe(nil), param_name: T.unsafe(nil), theme: T.unsafe(nil), views_prefix: T.unsafe(nil), **options); end

  # source://kaminari-core-1.2.2/lib/kaminari/helpers/tags.rb:134
  def page; end
end
...
#
# source://kaminari-core-1.2.2/lib/kaminari/helpers/tags.rb:19
class Kaminari::Helpers::Tag
  # @return [Tag] a new instance of Tag
  #
  # source://kaminari-core-1.2.2/lib/kaminari/helpers/tags.rb:20
  def initialize(template, params: T.unsafe(nil), param_name: T.unsafe(nil), theme: T.unsafe(nil), views_prefix: T.unsafe(nil), **options); end

  # source://kaminari-core-1.2.2/lib/kaminari/helpers/tags.rb:36
  def page_url_for(page); end

  # source://kaminari-core-1.2.2/lib/kaminari/helpers/tags.rb:31
  def to_s(locals = T.unsafe(nil)); end

  private

  # source://kaminari-core-1.2.2/lib/kaminari/helpers/tags.rb:44
  def params_for(page); end

  # source://kaminari-core-1.2.2/lib/kaminari/helpers/tags.rb:63
...
#   end
#
# source://kaminari-core-1.2.2/lib/kaminari/helpers/helper_methods.rb:30
module Kaminari::Helpers::UrlHelper
  ...
  #
  # source://kaminari-core-1.2.2/lib/kaminari/helpers/helper_methods.rb:76
  ...
  # It will return `nil` if there is no next page.
  #
  # source://kaminari-core-1.2.2/lib/kaminari/helpers/helper_methods.rb:41
  ...
  # source://kaminari-core-1.2.2/lib/kaminari/helpers/helper_methods.rb:46
  ...
  #
  # source://kaminari-core-1.2.2/lib/kaminari/helpers/helper_methods.rb:90
  ...
  # It will return `nil` if there is no previous page.
  #
  # source://kaminari-core-1.2.2/lib/kaminari/helpers/helper_methods.rb:60
...
# source://kaminari-core-1.2.2/lib/kaminari/models/page_scope_methods.rb:4
module Kaminari::PageScopeMethods
  # Current page number
  #
  # source://kaminari-core-1.2.2/lib/kaminari/models/page_scope_methods.rb:47
  def current_page; end

  # Current per-page number
  #
  # source://kaminari-core-1.2.2/lib/kaminari/models/page_scope_methods.rb:58
  ...
  # @return [Boolean]
  #
  # source://kaminari-core-1.2.2/lib/kaminari/models/page_scope_methods.rb:77
  def first_page?; end
  ...
  # @return [Boolean]
  #
  # source://kaminari-core-1.2.2/lib/kaminari/models/page_scope_methods.rb:82
  def last_page?; end

  # source://kaminari-core-1.2.2/lib/kaminari/models/page_scope_methods.rb:21
  def max_paginates_per(new_max_per_page); end

  # Next page number in the collection
  #
  # source://kaminari-core-1.2.2/lib/kaminari/models/page_scope_methods.rb:67
  def next_page; end
  ...
  # @return [Boolean]
  #
  # source://kaminari-core-1.2.2/lib/kaminari/models/page_scope_methods.rb:87
  def out_of_range?; end

  # @raise [ArgumentError]
  #
  # source://kaminari-core-1.2.2/lib/kaminari/models/page_scope_methods.rb:27
  def padding(num); end

  # Specify the <tt>per_page</tt> value for the preceding <tt>page</tt> scope
  #   Model.page(3).per(10)
  #
  # source://kaminari-core-1.2.2/lib/kaminari/models/page_scope_methods.rb:7
  def per(num, max_per_page: T.unsafe(nil)); end

  # Previous page number in the collection
  #
  # source://kaminari-core-1.2.2/lib/kaminari/models/page_scope_methods.rb:72
  def prev_page; end

  # Total number of pages
  #
  # source://kaminari-core-1.2.2/lib/kaminari/models/page_scope_methods.rb:35
  def total_pages; end
end

# Kind of Array that can paginate
#
# source://kaminari-core-1.2.2/lib/kaminari/models/array_extension.rb:6
class Kaminari::PaginatableArray < ::Array
  ...
  #
  # source://kaminari-core-1.2.2/lib/kaminari/models/array_extension.rb:18
  ...
  #
  # source://kaminari-core-1.2.2/lib/kaminari/models/array_extension.rb:37
  def entry_name(options = T.unsafe(nil)); end

  # returns another chunk of the original array
  #
  # source://kaminari-core-1.2.2/lib/kaminari/models/array_extension.rb:49
  def limit(num); end
  ...
  # returns another chunk of the original array
  #
  # source://kaminari-core-1.2.2/lib/kaminari/models/array_extension.rb:59
  def offset(num); end
  ...
  # source://kaminari-core-1.2.2/lib/kaminari/models/array_extension.rb:43
  def page(num = T.unsafe(nil)); end

  # total item numbers of the original array
  #
  # source://kaminari-core-1.2.2/lib/kaminari/models/array_extension.rb:54
  def total_count; end
end

# source://kaminari-core-1.2.2/lib/kaminari/models/array_extension.rb:9
Kaminari::PaginatableArray::ENTRY = T.let(T.unsafe(nil), String)

# source://kaminari-core-1.2.2/lib/kaminari/railtie.rb:5
class Kaminari::Railtie < ::Rails::Railtie; end

# source://kaminari-core-1.2.2/lib/kaminari/exceptions.rb:4
