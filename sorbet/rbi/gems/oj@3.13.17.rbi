...
module Oj
  ...
  class << self
    ...
    #
    # source://oj-3.13.17/lib/oj/mimic.rb:81
...
#
# source://oj-3.13.17/lib/oj/bag.rb:10
class Oj::Bag
  ...
  #
  # source://oj-3.13.17/lib/oj/bag.rb:17
  ...
  #
  # source://oj-3.13.17/lib/oj/bag.rb:48
  def ==(other); end
  ...
  #
  # source://oj-3.13.17/lib/oj/bag.rb:38
  ...
  #
  # source://oj-3.13.17/lib/oj/bag.rb:27
  ...
  class << self
    ...
    #
    # source://oj-3.13.17/lib/oj/bag.rb:64
...
# the compat mode.
#
# source://oj-3.13.17/lib/oj/mimic.rb:15
...
#
# source://oj-3.13.17/lib/oj/error.rb:14
...
# that match the keys.
#
# source://oj-3.13.17/lib/oj/easy_hash.rb:7
class Oj::EasyHash < ::Hash
  # Initializes the instance to an empty Hash.
  #
  # @return [EasyHash] a new instance of EasyHash
  #
  # source://oj-3.13.17/lib/oj/easy_hash.rb:10
  def initialize; end

  # source://oj-3.13.17/lib/oj/easy_hash.rb:25
  def [](key); end
  ...
  # @return [Boolean] the value of the specified instance variable.
  #
  # source://oj-3.13.17/lib/oj/easy_hash.rb:36
  def method_missing(m, *args, &block); end
...
#   end
#
# source://oj-3.13.17/lib/oj/saj.rb:51
class Oj::Saj
  # Create a new instance of the Saj handler class.
  #
  # @return [Saj] a new instance of Saj
  #
  # source://oj-3.13.17/lib/oj/saj.rb:53
  def initialize; end

  private

  # source://oj-3.13.17/lib/oj/saj.rb:73
  def add_value(value, key); end

  # source://oj-3.13.17/lib/oj/saj.rb:70
  def array_end(key); end

  # source://oj-3.13.17/lib/oj/saj.rb:67
  def array_start(key); end

  # source://oj-3.13.17/lib/oj/saj.rb:76
  def error(message, line, column); end

  # source://oj-3.13.17/lib/oj/saj.rb:64
  def hash_end(key); end

  # source://oj-3.13.17/lib/oj/saj.rb:61
  def hash_start(key); end
end
...
#   end
#
# source://oj-3.13.17/lib/oj/schandler.rb:106
class Oj::ScHandler
  # Create a new instance of the ScHandler class.
  #
  # @return [ScHandler] a new instance of ScHandler
  #
  # source://oj-3.13.17/lib/oj/schandler.rb:108
  def initialize; end

  private

  # source://oj-3.13.17/lib/oj/schandler.rb:135
  def add_value(value); end

  # source://oj-3.13.17/lib/oj/schandler.rb:138
  def array_append(a, value); end

  # source://oj-3.13.17/lib/oj/schandler.rb:132
  def array_end; end

  # source://oj-3.13.17/lib/oj/schandler.rb:129
  def array_start; end

  # source://oj-3.13.17/lib/oj/schandler.rb:119
  def hash_end; end

  # source://oj-3.13.17/lib/oj/schandler.rb:122
  def hash_key(key); end

  # source://oj-3.13.17/lib/oj/schandler.rb:126
  def hash_set(h, key, value); end

  # source://oj-3.13.17/lib/oj/schandler.rb:116
  def hash_start; end
end
...
#
# source://oj-3.13.17/lib/oj/version.rb:4
Oj::VERSION = T.let(T.unsafe(nil), String)

# More monkey patches.
#
# source://oj-3.13.17/lib/oj/mimic.rb:282
class String
  include ::Comparable

  # source://oj-3.13.17/lib/oj/mimic.rb:289
  def to_json_raw(*_arg0); end

  # source://oj-3.13.17/lib/oj/mimic.rb:283
  def to_json_raw_object; end

  class << self
    # source://oj-3.13.17/lib/oj/mimic.rb:292
