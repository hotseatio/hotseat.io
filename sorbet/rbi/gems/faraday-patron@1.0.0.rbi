...
#   conn.get '/'
#
# source://faraday-patron-1.0.0/lib/faraday/adapter/patron.rb:3
module Faraday
  class << self
...
#
# source://faraday-patron-1.0.0/lib/faraday/adapter/patron.rb:4
...
# Patron adapter
#
# source://faraday-patron-1.0.0/lib/faraday/adapter/patron.rb:6
class Faraday::Adapter::Patron < ::Faraday::Adapter
  # source://faraday-patron-1.0.0/lib/faraday/adapter/patron.rb:9
  def build_connection(env); end

  # source://faraday-patron-1.0.0/lib/faraday/adapter/patron.rb:24
  def call(env); end

  # source://faraday-patron-1.0.0/lib/faraday/adapter/patron.rb:101
  def configure_proxy(session, proxy); end

  # source://faraday-patron-1.0.0/lib/faraday/adapter/patron.rb:81
  def configure_ssl(session, ssl); end

  # source://faraday-patron-1.0.0/lib/faraday/adapter/patron.rb:89
  ...
  # @return [Boolean]
  #
  # source://faraday-patron-1.0.0/lib/faraday/adapter/patron.rb:125
  def connection_timed_out_message?(message); end
end

# source://faraday-patron-1.0.0/lib/faraday/adapter/patron.rb:114
...
#
# source://faraday-patron-1.0.0/lib/faraday/patron/version.rb:4
