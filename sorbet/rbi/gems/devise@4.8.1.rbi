...
#
# source://devise-4.8.1/lib/devise/rails/routes.rb:28
...
# source://devise-4.8.1/lib/devise/rails/routes.rb:35
...
# source://devise-4.8.1/lib/devise/rails/routes.rb:29
...
# source://devise-4.8.1/lib/devise.rb:23
module Devise::Controllers; end

# Those helpers are convenience methods added to ApplicationController.
#
# source://devise-4.8.1/lib/devise/controllers/helpers.rb:6
module Devise::Controllers::Helpers
  ...
  #   end
  #
  # source://devise-4.8.1/lib/devise/controllers/helpers.rb:215
  ...
  #
  # source://devise-4.8.1/lib/devise/controllers/helpers.rb:225
  def after_sign_out_path_for(resource_or_scope); end

  # Tell warden that params authentication is allowed for that specific page.
  #
  # source://devise-4.8.1/lib/devise/controllers/helpers.rb:163
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/controllers/helpers.rb:151
  ...
  #
  # source://devise-4.8.1/lib/devise/controllers/helpers.rb:158
  def devise_parameter_sanitizer; end

  # Overwrite Rails' handle unverified request to sign out all scopes,
  # clear run strategies and remove cached variables.
  #
  # source://devise-4.8.1/lib/devise/controllers/helpers.rb:254
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/controllers/helpers.rb:270
  def is_flashing_format?; end

  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/controllers/helpers.rb:264
  def is_navigational_format?; end

  # source://devise-4.8.1/lib/devise/controllers/helpers.rb:260
  ...
  #
  # source://devise-4.8.1/lib/devise/controllers/helpers.rb:235
  def sign_in_and_redirect(resource_or_scope, *args); end

  # Sign out a user and tries to redirect to the url specified by
  # after_sign_out_path_for.
  #
  # source://devise-4.8.1/lib/devise/controllers/helpers.rb:245
  ...
  #
  # source://devise-4.8.1/lib/devise/controllers/helpers.rb:169
  def signed_in_root_path(resource_or_scope); end

  # The main accessor for the warden proxy instance
  #
  # source://devise-4.8.1/lib/devise/controllers/helpers.rb:142
  def warden; end

  private

  # source://devise-4.8.1/lib/devise/controllers/helpers.rb:276
  ...
  class << self
    ...
    #
    # source://devise-4.8.1/lib/devise/controllers/helpers.rb:112
    def define_helpers(mapping); end
  end
end

# source://devise-4.8.1/lib/devise/controllers/helpers.rb:17
module Devise::Controllers::Helpers::ClassMethods
  ...
  #
  # source://devise-4.8.1/lib/devise/controllers/helpers.rb:39
  def devise_group(group_name, opts = T.unsafe(nil)); end

  # source://devise-4.8.1/lib/devise/controllers/helpers.rb:82
...
#
# source://devise-4.8.1/lib/devise/controllers/rememberable.rb:8
module Devise::Controllers::Rememberable
  # Forgets the given resource by deleting a cookie
  #
  # source://devise-4.8.1/lib/devise/controllers/rememberable.rb:30
  def forget_me(resource); end

  # Remembers the given resource by setting up a cookie
  #
  # source://devise-4.8.1/lib/devise/controllers/rememberable.rb:22
  def remember_me(resource); end

  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/controllers/rememberable.rb:14
  def remember_me_is_active?(resource); end

  protected

  # source://devise-4.8.1/lib/devise/controllers/rememberable.rb:38
  def forget_cookie_values(resource); end

  # source://devise-4.8.1/lib/devise/controllers/rememberable.rb:42
  def remember_cookie_values(resource); end

  # source://devise-4.8.1/lib/devise/controllers/rememberable.rb:51
  def remember_key(resource, scope); end

  class << self
    # Return default cookie values retrieved from session options.
    #
    # source://devise-4.8.1/lib/devise/controllers/rememberable.rb:10
    def cookie_values; end
  end
end

# source://devise-4.8.1/lib/devise/controllers/scoped_views.rb:5
...
# source://devise-4.8.1/lib/devise/controllers/scoped_views.rb:8
module Devise::Controllers::ScopedViews::ClassMethods
  # source://devise-4.8.1/lib/devise/controllers/scoped_views.rb:13
  def scoped_views=(value); end

  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/controllers/scoped_views.rb:9
  def scoped_views?; end
end
...
#
# source://devise-4.8.1/lib/devise/controllers/sign_in_out.rb:7
module Devise::Controllers::SignInOut
  ...
  #   bypass_sign_in @user
  #
  # source://devise-4.8.1/lib/devise/controllers/sign_in_out.rb:65
  ...
  #
  # source://devise-4.8.1/lib/devise/controllers/sign_in_out.rb:33
  ...
  #
  # source://devise-4.8.1/lib/devise/controllers/sign_in_out.rb:80
  ...
  #
  # source://devise-4.8.1/lib/devise/controllers/sign_in_out.rb:95
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/controllers/sign_in_out.rb:13
  def signed_in?(scope = T.unsafe(nil)); end

  private

  # source://devise-4.8.1/lib/devise/controllers/sign_in_out.rb:108
...
# Included by default in all controllers.
#
# source://devise-4.8.1/lib/devise/controllers/store_location.rb:10
module Devise::Controllers::StoreLocation
  ...
  #
  # source://devise-4.8.1/lib/devise/controllers/store_location.rb:36
  ...
  #
  # source://devise-4.8.1/lib/devise/controllers/store_location.rb:18
  def stored_location_for(resource_or_scope); end

  private

  # source://devise-4.8.1/lib/devise/controllers/store_location.rb:71
  def add_fragment_back_to_path(uri, path); end

  # source://devise-4.8.1/lib/devise/controllers/store_location.rb:56
  def extract_path_from_location(location); end

  # source://devise-4.8.1/lib/devise/controllers/store_location.rb:45
  def parse_uri(location); end

  # source://devise-4.8.1/lib/devise/controllers/store_location.rb:67
  def remove_domain_from_uri(uri); end

  # source://devise-4.8.1/lib/devise/controllers/store_location.rb:51
...
#
# source://devise-4.8.1/lib/devise/controllers/url_helpers.rb:30
module Devise::Controllers::UrlHelpers
  # source://devise-4.8.1/lib/devise/controllers/url_helpers.rb:49
  ...
  # source://devise-4.8.1/lib/devise/controllers/url_helpers.rb:64
  def _devise_route_context; end

  class << self
    # source://devise-4.8.1/lib/devise/controllers/url_helpers.rb:37
    def generate_helpers!(routes = T.unsafe(nil)); end

    # source://devise-4.8.1/lib/devise/controllers/url_helpers.rb:31
...
#
# source://devise-4.8.1/lib/devise/delegator.rb:5
class Devise::Delegator
  # source://devise-4.8.1/lib/devise/delegator.rb:6
  def call(env); end

  # source://devise-4.8.1/lib/devise/delegator.rb:10
...
# source://devise-4.8.1/lib/devise/encryptor.rb:6
module Devise::Encryptor
  class << self
    # source://devise-4.8.1/lib/devise/encryptor.rb:14
    def compare(klass, hashed_password, password); end

    # source://devise-4.8.1/lib/devise/encryptor.rb:7
    def digest(klass, password); end
  end
end

# source://devise-4.8.1/lib/devise/rails.rb:7
...
#
# source://devise-4.8.1/lib/devise/failure_app.rb:10
class Devise::FailureApp < ::ActionController::Metal
  ...
  # source://devise-4.8.1/lib/devise/failure_app.rb:19
  def flash(*_arg0, **_arg1, &_arg2); end

  # source://devise-4.8.1/lib/devise/failure_app.rb:47
  def http_auth; end
  ...
  # source://devise-4.8.1/lib/devise/failure_app.rb:54
  def recall; end

  # source://devise-4.8.1/lib/devise/failure_app.rb:77
  def redirect; end

  # source://devise-4.8.1/lib/devise/failure_app.rb:37
  def respond; end

  protected

  # source://devise-4.8.1/lib/devise/failure_app.rb:234
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/failure_app.rb:181
  def http_auth?; end

  # source://devise-4.8.1/lib/devise/failure_app.rb:195
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/failure_app.rb:191
  def http_auth_header?; end

  # source://devise-4.8.1/lib/devise/failure_app.rb:96
  def i18n_message(default = T.unsafe(nil)); end

  # source://devise-4.8.1/lib/devise/failure_app.rb:92
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/failure_app.rb:252
  def is_flashing_format?; end

  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/failure_app.rb:246
  def is_navigational_format?; end

  # source://devise-4.8.1/lib/devise/failure_app.rb:207
  def recall_app(app); end

  # source://devise-4.8.1/lib/devise/failure_app.rb:115
  def redirect_url; end

  # source://devise-4.8.1/lib/devise/failure_app.rb:260
  def relative_url_root; end

  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/failure_app.rb:268
  def relative_url_root?; end

  # source://devise-4.8.1/lib/devise/failure_app.rb:256
  def request_format; end

  # source://devise-4.8.1/lib/devise/failure_app.rb:131
  def route(scope); end

  # source://devise-4.8.1/lib/devise/failure_app.rb:226
  def scope; end

  # source://devise-4.8.1/lib/devise/failure_app.rb:230
  def scope_class; end

  # source://devise-4.8.1/lib/devise/failure_app.rb:135
  def scope_url; end

  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/failure_app.rb:169
  def skip_format?; end
  ...
  #
  # source://devise-4.8.1/lib/devise/failure_app.rb:242
  def store_location!; end

  # source://devise-4.8.1/lib/devise/failure_app.rb:214
  def warden; end

  # source://devise-4.8.1/lib/devise/failure_app.rb:222
  def warden_message; end

  # source://devise-4.8.1/lib/devise/failure_app.rb:218
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/failure_app.rb:280
  def rails_51_and_up?; end

  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/failure_app.rb:276
  ...
  class << self
    ...
    # source://devise-4.8.1/lib/devise/failure_app.rb:21
    def call(env); end
    ...
    #
    # source://devise-4.8.1/lib/devise/failure_app.rb:29
...
# source://devise-4.8.1/lib/devise.rb:310
class Devise::Getter
  # @return [Getter] a new instance of Getter
  #
  # source://devise-4.8.1/lib/devise.rb:311
  def initialize(name); end

  # source://devise-4.8.1/lib/devise.rb:315
  def get; end
end

# source://devise-4.8.1/lib/devise.rb:32
module Devise::Hooks; end

# A small warden proxy so we can remember, forget and
# sign out users from hooks.
#
# source://devise-4.8.1/lib/devise/hooks/proxy.rb:7
class Devise::Hooks::Proxy
  ...
  #
  # source://devise-4.8.1/lib/devise/hooks/proxy.rb:14
  def initialize(warden); end

  # source://devise-4.8.1/lib/devise/hooks/proxy.rb:12
  def cookies(*_arg0, **_arg1, &_arg2); end

  # source://devise-4.8.1/lib/devise/hooks/proxy.rb:12
  def request(*_arg0, **_arg1, &_arg2); end

  # source://devise-4.8.1/lib/devise/hooks/proxy.rb:18
  def session; end

  # Returns the value of attribute warden.
  #
  # source://devise-4.8.1/lib/devise/hooks/proxy.rb:11
  def warden; end
end

# source://devise-4.8.1/app/mailers/devise/mailer.rb:4
class Devise::Mailer < ::ActionMailer::Base
  include ::Devise::Mailers::Helpers
  include ::Devise::Controllers::ScopedViews
  extend ::Devise::Controllers::ScopedViews::ClassMethods

  # source://devise-4.8.1/app/mailers/devise/mailer.rb:7
  def confirmation_instructions(record, token, opts = T.unsafe(nil)); end

  # source://devise-4.8.1/app/mailers/devise/mailer.rb:22
  def email_changed(record, opts = T.unsafe(nil)); end

  # source://devise-4.8.1/app/mailers/devise/mailer.rb:26
  def password_change(record, opts = T.unsafe(nil)); end

  # source://devise-4.8.1/app/mailers/devise/mailer.rb:12
  def reset_password_instructions(record, token, opts = T.unsafe(nil)); end

  # source://devise-4.8.1/app/mailers/devise/mailer.rb:17
...
# source://devise-4.8.1/lib/devise.rb:36
module Devise::Mailers; end

# source://devise-4.8.1/lib/devise/mailers/helpers.rb:5
module Devise::Mailers::Helpers
  ...
  #
  # source://devise-4.8.1/lib/devise/mailers/helpers.rb:17
  def devise_mail(record, action, opts = T.unsafe(nil), &block); end

  # source://devise-4.8.1/lib/devise/mailers/helpers.rb:27
  def devise_mapping; end

  # source://devise-4.8.1/lib/devise/mailers/helpers.rb:31
  def headers_for(action, opts); end

  # source://devise-4.8.1/lib/devise/mailers/helpers.rb:22
  def initialize_from_record(record); end

  # source://devise-4.8.1/lib/devise/mailers/helpers.rb:49
  def mailer_from(mapping); end

  # source://devise-4.8.1/lib/devise/mailers/helpers.rb:45
  def mailer_reply_to(mapping); end

  # source://devise-4.8.1/lib/devise/mailers/helpers.rb:53
  def mailer_sender(mapping, sender = T.unsafe(nil)); end

  # Returns the value of attribute resource.
  #
  # source://devise-4.8.1/lib/devise/mailers/helpers.rb:14
  def resource; end
  ...
  #           subject: '...'
  #
  # source://devise-4.8.1/lib/devise/mailers/helpers.rb:87
  def subject_for(key); end

  # source://devise-4.8.1/lib/devise/mailers/helpers.rb:64
...
#
# source://devise-4.8.1/lib/devise/mapping.rb:26
class Devise::Mapping
  ...
  # source://devise-4.8.1/lib/devise/mapping.rb:131
...
# source://devise-4.8.1/lib/devise/controllers/helpers.rb:283
class Devise::MissingWarden < ::StandardError
  # @return [MissingWarden] a new instance of MissingWarden
  #
  # source://devise-4.8.1/lib/devise/controllers/helpers.rb:284
  def initialize; end
end

# source://devise-4.8.1/lib/devise/models.rb:4
...
#   end
#
# source://devise-4.8.1/lib/devise/models/authenticatable.rb:56
...
# source://devise-4.8.1/lib/devise/models/authenticatable.rb:232
module Devise::Models::Authenticatable::ClassMethods
  ...
  # source://devise-4.8.1/lib/devise/models/authenticatable.rb:279
  ...
  # is not called.
  #
  # source://devise-4.8.1/lib/devise/models/authenticatable.rb:275
  def find_for_authentication(tainted_conditions); end

  # Find or initialize a record setting an error if it can't be found.
  #
  # source://devise-4.8.1/lib/devise/models/authenticatable.rb:284
  def find_or_initialize_with_error_by(attribute, value, error = T.unsafe(nil)); end

  # Find or initialize a record with group of attributes based on a list of required attributes.
  #
  # source://devise-4.8.1/lib/devise/models/authenticatable.rb:289
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/models/authenticatable.rb:251
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/models/authenticatable.rb:246
  ...
  # source://devise-4.8.1/lib/devise/models/authenticatable.rb:241
  def serialize_from_session(key, salt); end

  # source://devise-4.8.1/lib/devise/models/authenticatable.rb:237
  ...
  # source://devise-4.8.1/lib/devise/models/authenticatable.rb:308
...
#
# source://devise-4.8.1/lib/devise/models/confirmable.rb:45
module Devise::Models::Confirmable
  extend ::ActiveSupport::Concern

  mixes_in_class_methods ::Devise::Models::Confirmable::ClassMethods

  # source://devise-4.8.1/lib/devise/models/confirmable.rb:61
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/models/confirmable.rb:144
  def active_for_authentication?; end
  ...
  # add errors
  #
  # source://devise-4.8.1/lib/devise/models/confirmable.rb:79
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/models/confirmable.rb:106
  def confirmed?; end

  # The message to be shown if the account is inactive.
  #
  # source://devise-4.8.1/lib/devise/models/confirmable.rb:149
  def inactive_message; end

  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/models/confirmable.rb:110
  def pending_reconfirmation?; end

  # Resend confirmation token.
  # Regenerates the token if the period is expired.
  #
  # source://devise-4.8.1/lib/devise/models/confirmable.rb:134
  def resend_confirmation_instructions; end

  # Send confirmation instructions by email
  #
  # source://devise-4.8.1/lib/devise/models/confirmable.rb:115
  def send_confirmation_instructions; end

  # source://devise-4.8.1/lib/devise/models/confirmable.rb:124
  def send_reconfirmation_instructions; end

  # If you don't want confirmation to be sent on create, neither a code
  # to be generated, call skip_confirmation!
  #
  # source://devise-4.8.1/lib/devise/models/confirmable.rb:155
  def skip_confirmation!; end

  # Skips sending the confirmation/reconfirmation notification email after_create/after_update. Unlike
  # #skip_confirmation!, record still requires confirmation.
  #
  # source://devise-4.8.1/lib/devise/models/confirmable.rb:161
  def skip_confirmation_notification!; end

  # If you don't want reconfirmation to be sent, neither a code
  # to be generated, call skip_reconfirmation!
  #
  # source://devise-4.8.1/lib/devise/models/confirmable.rb:167
  ...
  #   end
  #
  # source://devise-4.8.1/lib/devise/models/confirmable.rb:329
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/models/confirmable.rb:232
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/models/confirmable.rb:213
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/models/confirmable.rb:187
  def confirmation_required?; end

  # Generates a new random token for confirmation, and stores
  # the time this token is being generated in confirmation_sent_at
  #
  # source://devise-4.8.1/lib/devise/models/confirmable.rb:248
  def generate_confirmation_token; end

  # source://devise-4.8.1/lib/devise/models/confirmable.rb:257
  def generate_confirmation_token!; end

  # Checks whether the record requires any confirmation.
  #
  # source://devise-4.8.1/lib/devise/models/confirmable.rb:237
  def pending_any_confirmation; end

  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/models/confirmable.rb:280
  def postpone_email_change?; end

  # source://devise-4.8.1/lib/devise/models/confirmable.rb:262
  def postpone_email_change_until_confirmation_and_regenerate_confirmation_token; end

  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/models/confirmable.rb:301
  def reconfirmation_required?; end

  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/models/confirmable.rb:305
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/models/confirmable.rb:311
  def send_email_changed_notification?; end
  ...
  #
  # source://devise-4.8.1/lib/devise/models/confirmable.rb:182
  def send_on_create_confirmation_instructions; end

  # To not require reconfirmation after creating with #save called in a
  # callback call skip_create_confirmation!
  #
  # source://devise-4.8.1/lib/devise/models/confirmable.rb:175
  def skip_reconfirmation_in_callback!; end

  class << self
    # source://devise-4.8.1/lib/devise/models/confirmable.rb:70
    def required_fields(klass); end
  end
end

# source://devise-4.8.1/lib/devise/models/confirmable.rb:332
module Devise::Models::Confirmable::ClassMethods
  ...
  #
  # source://devise-4.8.1/lib/devise/models/confirmable.rb:350
  ...
  #
  # source://devise-4.8.1/lib/devise/models/confirmable.rb:378
  ...
  #
  # source://devise-4.8.1/lib/devise/models/confirmable.rb:337
...
#
# source://devise-4.8.1/lib/devise/models/database_authenticatable.rb:31
module Devise::Models::DatabaseAuthenticatable
  extend ::ActiveSupport::Concern

  mixes_in_class_methods ::Devise::Models::DatabaseAuthenticatable::ClassMethods

  # source://devise-4.8.1/lib/devise/models/database_authenticatable.rb:42
  def initialize(*args, &block); end
  ...
  #   end
  #
  # source://devise-4.8.1/lib/devise/models/database_authenticatable.rb:172
  def after_database_authentication; end

  # A reliable way to expose the salt regardless of the implementation.
  #
  # source://devise-4.8.1/lib/devise/models/database_authenticatable.rb:176
  def authenticatable_salt; end

  # Set password and password confirmation to nil
  #
  # source://devise-4.8.1/lib/devise/models/database_authenticatable.rb:76
  ...
  #
  # source://devise-4.8.1/lib/devise/models/database_authenticatable.rb:150
  ...
  # the hashed password.
  #
  # source://devise-4.8.1/lib/devise/models/database_authenticatable.rb:65
  def password=(new_password); end

  # Send notification to user when email changes.
  #
  # source://devise-4.8.1/lib/devise/models/database_authenticatable.rb:182
  def send_email_changed_notification; end

  # Send notification to user when password changes.
  #
  # source://devise-4.8.1/lib/devise/models/database_authenticatable.rb:193
  def send_password_change_notification; end

  # Skips sending the email changed notification after_update
  #
  # source://devise-4.8.1/lib/devise/models/database_authenticatable.rb:49
  def skip_email_changed_notification!; end

  # Skips sending the password change notification after_update
  #
  # source://devise-4.8.1/lib/devise/models/database_authenticatable.rb:54
  ...
  #
  # source://devise-4.8.1/lib/devise/models/database_authenticatable.rb:87
  ...
  #   end
  #
  # source://devise-4.8.1/lib/devise/models/database_authenticatable.rb:129
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/models/database_authenticatable.rb:71
  ...
  #
  # source://devise-4.8.1/lib/devise/models/database_authenticatable.rb:204
  def password_digest(password); end

  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/models/database_authenticatable.rb:209
  def send_email_changed_notification?; end

  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/models/database_authenticatable.rb:219
  def send_password_change_notification?; end

  class << self
    # source://devise-4.8.1/lib/devise/models/database_authenticatable.rb:58
    def required_fields(klass); end
  end
end

# source://devise-4.8.1/lib/devise/models/database_authenticatable.rb:228
module Devise::Models::DatabaseAuthenticatable::ClassMethods
  ...
  # the proper fields.
  #
  # source://devise-4.8.1/lib/devise/models/database_authenticatable.rb:235
...
#
# source://devise-4.8.1/lib/devise/models/lockable.rb:24
module Devise::Models::Lockable
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/models/lockable.rb:69
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/models/lockable.rb:89
  def active_for_authentication?; end

  # Overwrites invalid_message from Devise::Models::Authenticatable to define
  # the correct reason for blocking the sign in.
  #
  # source://devise-4.8.1/lib/devise/models/lockable.rb:95
  def inactive_message; end

  # source://devise-4.8.1/lib/devise/models/lockable.rb:122
  ...
  #
  # source://devise-4.8.1/lib/devise/models/lockable.rb:42
  def lock_access!(opts = T.unsafe(nil)); end

  # source://devise-4.8.1/lib/devise/models/lockable.rb:27
  def lock_strategy_enabled?(*_arg0, **_arg1, &_arg2); end

  # Resend the unlock instructions if the user is locked.
  #
  # source://devise-4.8.1/lib/devise/models/lockable.rb:83
  def resend_unlock_instructions; end

  # Resets failed attempts counter to 0.
  #
  # source://devise-4.8.1/lib/devise/models/lockable.rb:61
  def reset_failed_attempts!; end

  # Send unlock instructions by email
  #
  # source://devise-4.8.1/lib/devise/models/lockable.rb:74
  def send_unlock_instructions; end

  # source://devise-4.8.1/lib/devise/models/lockable.rb:127
  def unauthenticated_message; end

  # Unlock a user by cleaning locked_at and failed_attempts.
  #
  # source://devise-4.8.1/lib/devise/models/lockable.rb:53
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/models/lockable.rb:102
  def valid_for_authentication?; end
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/models/lockable.rb:143
  def attempts_exceeded?; end

  # Checks whether the record is locked or not, yielding to the block
  # if it's locked, otherwise adds an error to email.
  #
  # source://devise-4.8.1/lib/devise/models/lockable.rb:162
  def if_access_locked; end

  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/models/lockable.rb:147
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/models/lockable.rb:152
  def lock_expired?; end

  class << self
    # source://devise-4.8.1/lib/devise/models/lockable.rb:29
    def required_fields(klass); end
  end
end

# source://devise-4.8.1/lib/devise/models/lockable.rb:171
module Devise::Models::Lockable::ClassMethods
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/models/lockable.rb:206
  ...
  #
  # source://devise-4.8.1/lib/devise/models/lockable.rb:179
  ...
  #
  # source://devise-4.8.1/lib/devise/models/lockable.rb:189
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/models/lockable.rb:200
...
#
# source://devise-4.8.1/lib/devise/models/omniauthable.rb:17
module Devise::Models::Omniauthable
  ...
  class << self
    # source://devise-4.8.1/lib/devise/models/omniauthable.rb:20
    def required_fields(klass); end
  end
end

# source://devise-4.8.1/lib/devise/models/omniauthable.rb:24
...
#
# source://devise-4.8.1/lib/devise/models/recoverable.rb:24
module Devise::Models::Recoverable
  ...
  #
  # source://devise-4.8.1/lib/devise/models/recoverable.rb:37
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/models/recoverable.rb:77
  def reset_password_period_valid?; end

  # Resets reset password token and send reset password instructions by email.
  # Returns the token sent in the e-mail.
  #
  # source://devise-4.8.1/lib/devise/models/recoverable.rb:50
  ...
  #
  # source://devise-4.8.1/lib/devise/models/recoverable.rb:84
  def clear_reset_password_token; end

  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/models/recoverable.rb:103
  def clear_reset_password_token?; end

  # source://devise-4.8.1/lib/devise/models/recoverable.rb:98
  def send_reset_password_instructions_notification(token); end

  # source://devise-4.8.1/lib/devise/models/recoverable.rb:89
  def set_reset_password_token; end

  class << self
    # source://devise-4.8.1/lib/devise/models/recoverable.rb:27
    def required_fields(klass); end
  end
end

# source://devise-4.8.1/lib/devise/models/recoverable.rb:122
module Devise::Models::Recoverable::ClassMethods
  ...
  #
  # source://devise-4.8.1/lib/devise/models/recoverable.rb:145
  ...
  #
  # source://devise-4.8.1/lib/devise/models/recoverable.rb:134
  ...
  #
  # source://devise-4.8.1/lib/devise/models/recoverable.rb:125
...
#
# source://devise-4.8.1/lib/devise/models/registerable.rb:7
module Devise::Models::Registerable
  ...
  class << self
    # source://devise-4.8.1/lib/devise/models/registerable.rb:10
    def required_fields(klass); end
  end
end

# source://devise-4.8.1/lib/devise/models/registerable.rb:14
module Devise::Models::Registerable::ClassMethods
  ...
  # new with params.
  #
  # source://devise-4.8.1/lib/devise/models/registerable.rb:21
...
#
# source://devise-4.8.1/lib/devise/models/rememberable.rb:41
module Devise::Models::Rememberable
  ...
  #   end
  #
  # source://devise-4.8.1/lib/devise/models/rememberable.rb:100
  def after_remembered; end

  # source://devise-4.8.1/lib/devise/models/rememberable.rb:69
  def extend_remember_period; end

  # If the record is persisted, remove the remember token (but only if
  # it exists), and save the record without validations.
  #
  # source://devise-4.8.1/lib/devise/models/rememberable.rb:58
  def forget_me!; end

  # source://devise-4.8.1/lib/devise/models/rememberable.rb:65
  def remember_expires_at; end

  # Returns the value of attribute remember_me.
  #
  # source://devise-4.8.1/lib/devise/models/rememberable.rb:44
  def remember_me; end

  # source://devise-4.8.1/lib/devise/models/rememberable.rb:50
  def remember_me!; end
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/models/rememberable.rb:103
  def remember_me?(token, generated_at); end

  # source://devise-4.8.1/lib/devise/models/rememberable.rb:86
  def rememberable_options; end

  # source://devise-4.8.1/lib/devise/models/rememberable.rb:73
  def rememberable_value; end

  private

  # source://devise-4.8.1/lib/devise/models/rememberable.rb:124
  def time_from_json(value); end

  class << self
    # source://devise-4.8.1/lib/devise/models/rememberable.rb:46
    def required_fields(klass); end
  end
end

# source://devise-4.8.1/lib/devise/models/rememberable.rb:132
module Devise::Models::Rememberable::ClassMethods
  ...
  #
  # source://devise-4.8.1/lib/devise/models/rememberable.rb:147
  ...
  #
  # source://devise-4.8.1/lib/devise/models/rememberable.rb:139
  def serialize_from_cookie(*args); end

  # Create the cookie key using the record id and remember_token
  #
  # source://devise-4.8.1/lib/devise/models/rememberable.rb:134
...
#
# source://devise-4.8.1/lib/devise/models/timeoutable.rb:22
module Devise::Models::Timeoutable
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/models/timeoutable.rb:30
  def timedout?(last_access); end

  # source://devise-4.8.1/lib/devise/models/timeoutable.rb:34
  def timeout_in; end

  class << self
    # source://devise-4.8.1/lib/devise/models/timeoutable.rb:25
    def required_fields(klass); end
  end
end

# source://devise-4.8.1/lib/devise/models/timeoutable.rb:40
...
#
# source://devise-4.8.1/lib/devise/models/trackable.rb:15
module Devise::Models::Trackable
  # source://devise-4.8.1/lib/devise/models/trackable.rb:20
  def update_tracked_fields(request); end

  # source://devise-4.8.1/lib/devise/models/trackable.rb:33
  def update_tracked_fields!(request); end

  protected

  # source://devise-4.8.1/lib/devise/models/trackable.rb:45
  def extract_ip_from(request); end

  class << self
    # source://devise-4.8.1/lib/devise/models/trackable.rb:16
    def required_fields(klass); end
  end
end
...
#
# source://devise-4.8.1/lib/devise/models/validatable.rb:17
module Devise::Models::Validatable
  protected

  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/models/validatable.rb:64
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/models/validatable.rb:60
  def password_required?; end

  class << self
    # source://devise-4.8.1/lib/devise/models/validatable.rb:46
    def assert_validations_api!(base); end

    # @private
    #
    # source://devise-4.8.1/lib/devise/models/validatable.rb:26
    def included(base); end

    # source://devise-4.8.1/lib/devise/models/validatable.rb:22
    def required_fields(klass); end
  end
end

# source://devise-4.8.1/lib/devise/models/validatable.rb:68
...
#
# source://devise-4.8.1/lib/devise/models/validatable.rb:19
...
# source://devise-4.8.1/lib/devise/omniauth.rb:23
module Devise::OmniAuth; end

# source://devise-4.8.1/lib/devise/omniauth/config.rb:13
class Devise::OmniAuth::Config
  # @return [Config] a new instance of Config
  #
  # source://devise-4.8.1/lib/devise/omniauth/config.rb:17
  def initialize(provider, args); end

  # Returns the value of attribute args.
  #
  # source://devise-4.8.1/lib/devise/omniauth/config.rb:15
  def args; end

  # source://devise-4.8.1/lib/devise/omniauth/config.rb:37
  def autoload_strategy; end

  # source://devise-4.8.1/lib/devise/omniauth/config.rb:30
  ...
  #
  # source://devise-4.8.1/lib/devise/omniauth/config.rb:14
  def strategy; end
  ...
  # source://devise-4.8.1/lib/devise/omniauth/config.rb:26
...
class Devise::ParameterFilter
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/parameter_filter.rb:40
...
#    end
#
# source://devise-4.8.1/lib/devise/parameter_sanitizer.rb:37
class Devise::ParameterSanitizer
  # @return [ParameterSanitizer] a new instance of ParameterSanitizer
  #
  # source://devise-4.8.1/lib/devise/parameter_sanitizer.rb:44
...
# source://devise-4.8.1/lib/devise/rails/routes.rb:7
...
# source://devise-4.8.1/lib/devise/secret_key_finder.rb:4
class Devise::SecretKeyFinder
  # @return [SecretKeyFinder] a new instance of SecretKeyFinder
  #
  # source://devise-4.8.1/lib/devise/secret_key_finder.rb:5
  def initialize(application); end

  # source://devise-4.8.1/lib/devise/secret_key_finder.rb:9
  def find; end
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/secret_key_finder.rb:23
  def key_exists?(object); end
end

# source://devise-4.8.1/lib/devise.rb:40
...
# for an example.
#
# source://devise-4.8.1/lib/devise/strategies/authenticatable.rb:10
class Devise::Strategies::Authenticatable < ::Devise::Strategies::Base
  # Returns the value of attribute authentication_hash.
  #
  # source://devise-4.8.1/lib/devise/strategies/authenticatable.rb:11
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/strategies/authenticatable.rb:24
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/strategies/authenticatable.rb:13
  def store?; end

  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/strategies/authenticatable.rb:17
  def valid?; end
  ...
  #
  # source://devise-4.8.1/lib/devise/strategies/authenticatable.rb:171
  def authenticatable_name; end

  # source://devise-4.8.1/lib/devise/strategies/authenticatable.rb:136
  def authentication_keys; end

  # Helper to decode credentials from HTTP.
  #
  # source://devise-4.8.1/lib/devise/strategies/authenticatable.rb:122
  def decode_credentials; end

  # Extract a hash with attributes:values from the http params.
  #
  # source://devise-4.8.1/lib/devise/strategies/authenticatable.rb:98
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/strategies/authenticatable.rb:83
  def http_authenticatable?; end

  # source://devise-4.8.1/lib/devise/strategies/authenticatable.rb:140
  def http_authentication_key; end

  # Extract the appropriate subhash for authentication from params.
  #
  # source://devise-4.8.1/lib/devise/strategies/authenticatable.rb:93
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/strategies/authenticatable.rb:88
  def params_authenticatable?; end

  # source://devise-4.8.1/lib/devise/strategies/authenticatable.rb:157
  def parse_authentication_key_values(hash, keys); end

  # Get values from params and set in the resource.
  #
  # source://devise-4.8.1/lib/devise/strategies/authenticatable.rb:51
  def remember_me(resource); end
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/strategies/authenticatable.rb:56
  def remember_me?; end

  # source://devise-4.8.1/lib/devise/strategies/authenticatable.rb:147
  def request_keys; end

  # source://devise-4.8.1/lib/devise/strategies/authenticatable.rb:151
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/strategies/authenticatable.rb:66
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/strategies/authenticatable.rb:77
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/strategies/authenticatable.rb:109
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/strategies/authenticatable.rb:104
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/strategies/authenticatable.rb:117
  ...
  #
  # source://devise-4.8.1/lib/devise/strategies/authenticatable.rb:37
  def validate(resource, &block); end

  # Sets the authentication hash and the password from params_auth_hash or http_auth_hash.
  #
  # source://devise-4.8.1/lib/devise/strategies/authenticatable.rb:128
  def with_authentication_hash(auth_type, auth_values); end
end

# Base strategy for Devise. Responsible for verifying correct scope and mapping.
#
# source://devise-4.8.1/lib/devise/strategies/base.rb:7
class Devise::Strategies::Base < ::Warden::Strategies::Base
  # Checks if a valid scope was given for devise and find mapping based on this scope.
  #
  # source://devise-4.8.1/lib/devise/strategies/base.rb:13
  def mapping; end
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/strategies/base.rb:8
  def store?; end
end

# Default strategy for signing in a user, based on their email and password in the database.
#
# source://devise-4.8.1/lib/devise/strategies/database_authenticatable.rb:8
class Devise::Strategies::DatabaseAuthenticatable < ::Devise::Strategies::Authenticatable
  # source://devise-4.8.1/lib/devise/strategies/database_authenticatable.rb:9
...
# authenticatable.
#
# source://devise-4.8.1/lib/devise/strategies/rememberable.rb:12
class Devise::Strategies::Rememberable < ::Devise::Strategies::Authenticatable
  # To authenticate a user we deserialize the cookie and attempt finding
  # the record in the database. If the attempt fails, we pass to another
  # strategy handle the authentication.
  #
  # source://devise-4.8.1/lib/devise/strategies/rememberable.rb:21
  def authenticate!; end
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/strategies/rememberable.rb:41
  def clean_up_csrf?; end
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/strategies/rememberable.rb:13
  def valid?; end
  ...
  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/strategies/rememberable.rb:47
  def extend_remember_me?(resource); end

  # source://devise-4.8.1/lib/devise/strategies/rememberable.rb:59
  def remember_cookie; end

  # source://devise-4.8.1/lib/devise/strategies/rememberable.rb:55
  def remember_key; end

  # @return [Boolean]
  #
  # source://devise-4.8.1/lib/devise/strategies/rememberable.rb:51
  def remember_me?; end
end
...
#  end
#
# source://devise-4.8.1/lib/devise.rb:45
...
#
# source://devise-4.8.1/lib/devise/test/controller_helpers.rb:26
module Devise::Test::ControllerHelpers
  extend ::ActiveSupport::Concern

  # Override process to consider warden.
  #
  # source://devise-4.8.1/lib/devise/test/controller_helpers.rb:34
  def process(*_arg0, **_arg1); end

  # We need to set up the environment variables and the response in the controller.
  #
  # source://devise-4.8.1/lib/devise/test/controller_helpers.rb:43
  ...
  #
  # source://devise-4.8.1/lib/devise/test/controller_helpers.rb:67
  ...
  #   sign_out @user     # sign_out(resource)
  #
  # source://devise-4.8.1/lib/devise/test/controller_helpers.rb:92
  def sign_out(resource_or_scope); end

  # Quick access to Warden::Proxy.
  #
  # source://devise-4.8.1/lib/devise/test/controller_helpers.rb:48
  def warden; end
  ...
  #
  # source://devise-4.8.1/lib/devise/test/controller_helpers.rb:103
  def _catch_warden(&block); end

  # source://devise-4.8.1/lib/devise/test/controller_helpers.rb:126
  def _process_unauthenticated(env, options = T.unsafe(nil)); end
end

# source://devise-4.8.1/lib/devise/test/integration_helpers.rb:21
module Devise::Test::IntegrationHelpers
  ...
  #                should be signed in with.
  #
  # source://devise-4.8.1/lib/devise/test/integration_helpers.rb:37
  ...
  #
  # source://devise-4.8.1/lib/devise/test/integration_helpers.rb:46
  def sign_out(resource_or_scope); end

  protected

  # source://devise-4.8.1/lib/devise/test/integration_helpers.rb:54
  def setup_integration_for_devise; end

  # source://devise-4.8.1/lib/devise/test/integration_helpers.rb:58
  def teardown_integration_for_devise; end

  class << self
    # @private
    #
    # source://devise-4.8.1/lib/devise/test/integration_helpers.rb:22
    def included(base); end
  end
end

# source://devise-4.8.1/lib/devise/test_helpers.rb:4
module Devise::TestHelpers
  ...
  class << self
    # @private
    #
    # source://devise-4.8.1/lib/devise/test_helpers.rb:5
    def included(base); end
  end
end

# source://devise-4.8.1/lib/devise/time_inflector.rb:6
class Devise::TimeInflector
  ...
  class << self
    ...
    #
    # source://devise-4.8.1/lib/devise/time_inflector.rb:10
    def instance; end

    # source://devise-4.8.1/lib/devise/time_inflector.rb:11
    def time_ago_in_words(*_arg0, **_arg1, &_arg2); end
  end
end

# source://devise-4.8.1/lib/devise/token_generator.rb:6
class Devise::TokenGenerator
  # @return [TokenGenerator] a new instance of TokenGenerator
  #
  # source://devise-4.8.1/lib/devise/token_generator.rb:7
  def initialize(key_generator, digest = T.unsafe(nil)); end

  # source://devise-4.8.1/lib/devise/token_generator.rb:12
  def digest(klass, column, value); end

  # source://devise-4.8.1/lib/devise/token_generator.rb:16
  def generate(klass, column); end

  private

  # source://devise-4.8.1/lib/devise/token_generator.rb:28
...
# source://devise-4.8.1/app/helpers/devise_helper.rb:3
module DeviseHelper
  # source://devise-4.8.1/app/helpers/devise_helper.rb:6
  def devise_error_messages!; end
end

module Warden::Mixins; end

# source://devise-4.8.1/lib/devise/rails/warden_compat.rb:3
