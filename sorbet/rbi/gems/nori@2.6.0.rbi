...
# source://nori-2.6.0/lib/nori/version.rb:1
class Nori
  # @return [Nori] a new instance of Nori
  #
  # source://nori-2.6.0/lib/nori.rb:16
  def initialize(options = T.unsafe(nil)); end

  # source://nori-2.6.0/lib/nori.rb:32
  def find(hash, *path); end

  # source://nori-2.6.0/lib/nori.rb:42
  def parse(xml); end
  ...
  #
  # source://nori-2.6.0/lib/nori.rb:58
  def convert_tags_to(reset = T.unsafe(nil), &block); end

  # source://nori-2.6.0/lib/nori.rb:71
  def find_value(hash, key); end

  # source://nori-2.6.0/lib/nori.rb:51
  def load_parser(parser); end

  # source://nori-2.6.0/lib/nori.rb:62
  def validate_options!(available_options, options); end

  class << self
    # source://nori-2.6.0/lib/nori.rb:7
    def hash_key(name, options = T.unsafe(nil)); end
  end
end

# source://nori-2.6.0/lib/nori/core_ext/object.rb:2
module Nori::CoreExt; end

# source://nori-2.6.0/lib/nori/core_ext/hash.rb:5
module Nori::CoreExt::Hash
  ...
  #
  # source://nori-2.6.0/lib/nori/core_ext/hash.rb:13
  ...
  #
  # source://nori-2.6.0/lib/nori/core_ext/hash.rb:28
  def to_xml_attributes; end

  private

  # source://nori-2.6.0/lib/nori/core_ext/hash.rb:52
  def encode_simple_value(value); end

  # source://nori-2.6.0/lib/nori/core_ext/hash.rb:40
  def normalize_array_params(key, array); end

  # source://nori-2.6.0/lib/nori/core_ext/hash.rb:46
  def normalize_hash_params(key, hash); end

  # source://nori-2.6.0/lib/nori/core_ext/hash.rb:36
  def normalize_simple_type_params(key, value); end
end

# source://nori-2.6.0/lib/nori/core_ext/object.rb:3
module Nori::CoreExt::Object
  # @return [Boolean]
  #
  # source://nori-2.6.0/lib/nori/core_ext/object.rb:5
  def blank?; end
end

# source://nori-2.6.0/lib/nori/core_ext/string.rb:3
module Nori::CoreExt::String
  # Returns the String in snake_case.
  #
  # source://nori-2.6.0/lib/nori/core_ext/string.rb:6
  def snakecase; end
end

# source://nori-2.6.0/lib/nori.rb:14
Nori::PARSERS = T.let(T.unsafe(nil), Hash)

# source://nori-2.6.0/lib/nori/string_io_file.rb:2
class Nori::StringIOFile < ::StringIO
  # Returns the value of attribute content_type.
  #
  # source://nori-2.6.0/lib/nori/string_io_file.rb:4
...
# source://nori-2.6.0/lib/nori/string_with_attributes.rb:2
class Nori::StringWithAttributes < ::String
  # Returns the value of attribute attributes.
  #
  # source://nori-2.6.0/lib/nori/string_with_attributes.rb:4
  def attributes; end
...
# source://nori-2.6.0/lib/nori/version.rb:2
...
# underlying parser.
#
# source://nori-2.6.0/lib/nori/xml_utility_node.rb:18
class Nori::XMLUtilityNode
  # @return [XMLUtilityNode] a new instance of XMLUtilityNode
  #
  # source://nori-2.6.0/lib/nori/xml_utility_node.rb:86
  def initialize(options, name, attributes = T.unsafe(nil)); end

  # source://nori-2.6.0/lib/nori/xml_utility_node.rb:125
  def add_node(node); end

  # source://nori-2.6.0/lib/nori/xml_utility_node.rb:214
  def advanced_typecasting(value); end

  # Returns the value of attribute attributes.
  #
  # source://nori-2.6.0/lib/nori/xml_utility_node.rb:111
  def attributes; end
  ...
  #
  # source://nori-2.6.0/lib/nori/xml_utility_node.rb:237
  def inner_html; end
  ...
  # source://nori-2.6.0/lib/nori/xml_utility_node.rb:120
  def prefixed_attribute_name(attribute); end

  # source://nori-2.6.0/lib/nori/xml_utility_node.rb:113
  def prefixed_attributes; end

  # source://nori-2.6.0/lib/nori/xml_utility_node.rb:130
  def to_hash; end
  ...
  #
  # source://nori-2.6.0/lib/nori/xml_utility_node.rb:244
  def to_html; end
  ...
  #
  # source://nori-2.6.0/lib/nori/xml_utility_node.rb:208
  def typecast_value(value); end

  # Take keys of the form foo-bar and convert them to foo_bar
  #
  # source://nori-2.6.0/lib/nori/xml_utility_node.rb:229
  def undasherize_keys(params); end

  private

  # source://nori-2.6.0/lib/nori/xml_utility_node.rb:257
  def strip_namespace(string); end

  # source://nori-2.6.0/lib/nori/xml_utility_node.rb:251
  def try_to_convert(value, &block); end

  class << self
    # source://nori-2.6.0/lib/nori/xml_utility_node.rb:64
    def available_typecasts; end

    # source://nori-2.6.0/lib/nori/xml_utility_node.rb:68
    def available_typecasts=(obj); end

    # source://nori-2.6.0/lib/nori/xml_utility_node.rb:56
    def typecasts; end

    # source://nori-2.6.0/lib/nori/xml_utility_node.rb:60
...
#
# source://nori-2.6.0/lib/nori/xml_utility_node.rb:42
...
#
# source://nori-2.6.0/lib/nori/xml_utility_node.rb:54
...
# 24:00:00          midnight
#
# source://nori-2.6.0/lib/nori/xml_utility_node.rb:31
