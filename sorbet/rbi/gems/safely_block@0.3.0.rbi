...
# source://safely_block-0.3.0/lib/safely/version.rb:1
module Safely
  extend ::Safely::Methods

  class << self
    # source://safely_block-0.3.0/lib/safely/core.rb:26
    def env; end
    ...
    #
    # source://safely_block-0.3.0/lib/safely/core.rb:8
    def env=(_arg0); end

    # Returns the value of attribute raise_envs.
    #
    # source://safely_block-0.3.0/lib/safely/core.rb:7
    def raise_envs; end
    ...
    # source://safely_block-0.3.0/lib/safely/core.rb:10
    ...
    # @return [Boolean]
    #
    # source://safely_block-0.3.0/lib/safely/core.rb:30
    def throttled?(e, options); end
  end
end

# source://safely_block-0.3.0/lib/safely/core.rb:38
Safely::DEFAULT_EXCEPTION_METHOD = T.let(T.unsafe(nil), Proc)

# source://safely_block-0.3.0/lib/safely/core.rb:48
module Safely::Methods
  # source://safely_block-0.3.0/lib/safely/core.rb:49
...
# source://safely_block-0.3.0/lib/safely/version.rb:2
