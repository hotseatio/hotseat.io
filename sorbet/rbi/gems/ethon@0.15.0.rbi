...
#
# source://ethon-0.15.0/lib/ethon/libc.rb:2
module Ethon
...
# @api private
#
# source://ethon-0.15.0/lib/ethon/curl.rb:14
module Ethon::Curl
  extend ::FFI::Library
  ...
  class << self
    ...
    # @api private
    #
    # source://ethon-0.15.0/lib/ethon/curl.rb:78
    def cleanup; end
    ...
    #
    # source://ethon-0.15.0/lib/ethon/curl.rb:58
    def init; end
    ...
    # @return [Boolean]
    #
    # source://ethon-0.15.0/lib/ethon/curl.rb:23
    def windows?; end
  end
end
...
# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/constants.rb:28
Ethon::Curl::DebugInfoType = T.let(T.unsafe(nil), FFI::Enum)

# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/constants.rb:17
Ethon::Curl::EasyCode = T.let(T.unsafe(nil), FFI::Enum)

# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/constants.rb:22
Ethon::Curl::EasyOption = T.let(T.unsafe(nil), FFI::Enum)

# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/classes.rb:27
class Ethon::Curl::FDSet < ::FFI::Struct
  # @api private
  #
  # source://ethon-0.15.0/lib/ethon/curls/classes.rb:40
  def clear; end
end
...
# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/classes.rb:36
...
# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/constants.rb:39
...
# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/constants.rb:12
...
# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/constants.rb:14
...
# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/constants.rb:8
...
# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/constants.rb:10
...
# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/constants.rb:35
Ethon::Curl::Info = T.let(T.unsafe(nil), FFI::Enum)

# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/constants.rb:31
Ethon::Curl::InfoType = T.let(T.unsafe(nil), FFI::Enum)

# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/classes.rb:10
class Ethon::Curl::Msg < ::FFI::Struct; end

# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/constants.rb:42
Ethon::Curl::MsgCode = T.let(T.unsafe(nil), FFI::Enum)

# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/classes.rb:5
class Ethon::Curl::MsgData < ::FFI::Union; end

# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/constants.rb:19
Ethon::Curl::MultiCode = T.let(T.unsafe(nil), FFI::Enum)

# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/constants.rb:24
Ethon::Curl::MultiOption = T.let(T.unsafe(nil), FFI::Enum)

# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/constants.rb:66
Ethon::Curl::PollAction = T.let(T.unsafe(nil), FFI::Enum)

# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/constants.rb:63
Ethon::Curl::SOCKET_BAD = T.let(T.unsafe(nil), Integer)

# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/constants.rb:64
Ethon::Curl::SOCKET_TIMEOUT = T.let(T.unsafe(nil), Integer)

# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/constants.rb:74
Ethon::Curl::SocketReadiness = T.let(T.unsafe(nil), FFI::Bitmask)

# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/classes.rb:45
...
# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/constants.rb:51
...
# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/constants.rb:56
...
# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/constants.rb:57
...
# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/constants.rb:50
...
# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/constants.rb:61
...
# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/constants.rb:49
...
# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/constants.rb:60
...
# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/constants.rb:54
...
# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/constants.rb:44
...
# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/constants.rb:45
...
# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/constants.rb:53
...
# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/constants.rb:47
Ethon::Curl::VERSION_LIBZ = T.let(T.unsafe(nil), Integer)

# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/constants.rb:5
...
# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/constants.rb:48
...
# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/constants.rb:59
...
# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/constants.rb:52
...
# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/constants.rb:46
...
# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/constants.rb:55
...
# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/constants.rb:58
Ethon::Curl::VERSION_TLSAUTH_SRP = T.let(T.unsafe(nil), Integer)

# @api private
#
# source://ethon-0.15.0/lib/ethon/curls/classes.rb:14
class Ethon::Curl::VersionInfoData < ::FFI::Struct; end

# source://ethon-0.15.0/lib/ethon/curls/codes.rb:3
module Ethon::Curls; end

# This module contains all easy and
# multi return codes.
#
# source://ethon-0.15.0/lib/ethon/curls/codes.rb:7
module Ethon::Curls::Codes
  ...
  #
  # source://ethon-0.15.0/lib/ethon/curls/codes.rb:11
  def easy_codes; end

  # Curl-Multi socket error codes, refer
  # https://github.com/bagder/curl/blob/master/include/curl/multi.h for details
  #
  # source://ethon-0.15.0/lib/ethon/curls/codes.rb:107
  def multi_codes; end
end

# This module contains the available options for forms.
#
# source://ethon-0.15.0/lib/ethon/curls/form_options.rb:6
module Ethon::Curls::FormOptions
  # Form options, used by FormAdd for temporary storage, refer
  # https://github.com/bagder/curl/blob/master/lib/formdata.h#L51 for details
  #
  # source://ethon-0.15.0/lib/ethon/curls/form_options.rb:10
...
# libcurl.
#
# source://ethon-0.15.0/lib/ethon/curls/functions.rb:7
module Ethon::Curls::Functions
  class << self
    # source://ethon-0.15.0/lib/ethon/curls/functions.rb:10
...
#
# source://ethon-0.15.0/lib/ethon/curls/infos.rb:7
module Ethon::Curls::Infos
  ...
  #
  # source://ethon-0.15.0/lib/ethon/curls/infos.rb:31
  ...
  #
  # source://ethon-0.15.0/lib/ethon/curls/infos.rb:142
  ...
  #
  # source://ethon-0.15.0/lib/ethon/curls/infos.rb:125
  ...
  #
  # source://ethon-0.15.0/lib/ethon/curls/infos.rb:107
  ...
  #
  # source://ethon-0.15.0/lib/ethon/curls/infos.rb:15
  def info_types; end
  ...
  #
  # source://ethon-0.15.0/lib/ethon/curls/infos.rb:50
  def infos; end
end

# This module contains available message codes.
#
# source://ethon-0.15.0/lib/ethon/curls/messages.rb:6
module Ethon::Curls::Messages
  ...
  #
  # source://ethon-0.15.0/lib/ethon/curls/messages.rb:14
  def msg_codes; end
end
...
#
# source://ethon-0.15.0/lib/ethon/curls/options.rb:7
module Ethon::Curls::Options
  # source://ethon-0.15.0/lib/ethon/curls/options.rb:208
...
# @see initialize
#
# source://ethon-0.15.0/lib/ethon/easy/informations.rb:3
class Ethon::Easy
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy.rb:218
  def initialize(options = T.unsafe(nil)); end

  # source://ethon-0.15.0/lib/ethon/easy/callbacks.rb:13
  def debug_info; end
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy.rb:265
  def dup; end
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy.rb:285
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy.rb:311
  def log_inspect; end

  # source://ethon-0.15.0/lib/ethon/easy.rb:301
  def mirror; end
  ...
  #   easy.reset
  #
  # source://ethon-0.15.0/lib/ethon/easy.rb:249
  def reset; end
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy.rb:201
  def return_code; end
  ...
  # @see initialize
  #
  # source://ethon-0.15.0/lib/ethon/easy.rb:234
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy.rb:296
  def to_hash; end
end
...
# @api private
#
# source://ethon-0.15.0/lib/ethon/easy/callbacks.rb:9
module Ethon::Easy::Callbacks
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy/callbacks.rb:38
  ...
  # @return [Proc] The callback.
  #
  # source://ethon-0.15.0/lib/ethon/easy/callbacks.rb:67
  ...
  # @return [Proc] The callback.
  #
  # source://ethon-0.15.0/lib/ethon/easy/callbacks.rb:53
  ...
  # @return [Proc] The callback.
  #
  # source://ethon-0.15.0/lib/ethon/easy/callbacks.rb:90
  ...
  # @return [Proc] The callback.
  #
  # source://ethon-0.15.0/lib/ethon/easy/callbacks.rb:143
  ...
  #   easy.set_callbacks
  #
  # source://ethon-0.15.0/lib/ethon/easy/callbacks.rb:22
  def set_callbacks; end

  # @api private
  #
  # source://ethon-0.15.0/lib/ethon/easy/callbacks.rb:76
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy/callbacks.rb:104
  def set_read_callback(body); end

  class << self
    # @api private
    #
    # source://ethon-0.15.0/lib/ethon/easy/callbacks.rb:12
...
# @api private
#
# source://ethon-0.15.0/lib/ethon/easy/debug_info.rb:9
class Ethon::Easy::DebugInfo
  # @api private
  # @return [DebugInfo] a new instance of DebugInfo
  #
  # source://ethon-0.15.0/lib/ethon/easy/debug_info.rb:22
  def initialize; end

  # @api private
  #
  # source://ethon-0.15.0/lib/ethon/easy/debug_info.rb:26
  ...
  # @api private
  #
  # source://ethon-0.15.0/lib/ethon/easy/debug_info.rb:30
  ...
  # @api private
  #
  # source://ethon-0.15.0/lib/ethon/easy/debug_info.rb:38
  def to_a; end

  # @api private
  #
  # source://ethon-0.15.0/lib/ethon/easy/debug_info.rb:42
  def to_h; end
end

# @api private
#
# source://ethon-0.15.0/lib/ethon/easy/debug_info.rb:11
Ethon::Easy::DebugInfo::MESSAGE_TYPES = T.let(T.unsafe(nil), Array)

# @api private
#
# source://ethon-0.15.0/lib/ethon/easy/debug_info.rb:13
class Ethon::Easy::DebugInfo::Message
  # @api private
  # @return [Message] a new instance of Message
  #
  # source://ethon-0.15.0/lib/ethon/easy/debug_info.rb:16
  def initialize(type, message); end

  # @api private
  #
  # source://ethon-0.15.0/lib/ethon/easy/debug_info.rb:14
  def message; end
...
#
# source://ethon-0.15.0/lib/ethon/easy/features.rb:6
module Ethon::Easy::Features
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy/features.rb:23
  ...
  # @return [Boolean] True if supported, else false.
  #
  # source://ethon-0.15.0/lib/ethon/easy/features.rb:13
...
# @api private
#
# source://ethon-0.15.0/lib/ethon/easy/form.rb:13
class Ethon::Easy::Form
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy/form.rb:25
  def initialize(easy, params, multipart = T.unsafe(nil)); end

  # source://ethon-0.15.0/lib/ethon/easy/queryable.rb:11
  def escape; end
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy/form.rb:37
  def first; end
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy/form.rb:47
  def last; end
  ...
  #   form.materialize
  #
  # source://ethon-0.15.0/lib/ethon/easy/form.rb:67
  def materialize; end
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy/form.rb:58
  def multipart?; end

  # source://ethon-0.15.0/lib/ethon/easy/queryable.rb:12
  ...
  # @api private
  #
  # source://ethon-0.15.0/lib/ethon/easy/form.rb:73
  def form_add(name, content); end

  # @api private
  #
  # source://ethon-0.15.0/lib/ethon/easy/form.rb:97
...
# @api private
#
# source://ethon-0.15.0/lib/ethon/easy/header.rb:7
module Ethon::Easy::Header
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy/header.rb:56
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy/header.rb:41
  def header_list; end
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy/header.rb:14
  def headers; end
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy/header.rb:24
  def headers=(headers); end
end

# This module contains logic about making valid HTTP requests.
#
# source://ethon-0.15.0/lib/ethon/easy/http/putable.rb:4
module Ethon::Easy::Http
  ...
  # @see Ethon::Easy::Options
  #
  # source://ethon-0.15.0/lib/ethon/easy/http.rb:39
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy/http.rb:56
...
#
# source://ethon-0.15.0/lib/ethon/easy/http/actionable.rb:10
module Ethon::Easy::Http::Actionable
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy/http/actionable.rb:23
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy/http/actionable.rb:74
  def form; end
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy/http/actionable.rb:44
  def options; end
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy/http/actionable.rb:64
  def params; end
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy/http/actionable.rb:84
  def params_encoding; end
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy/http/actionable.rb:54
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy/http/actionable.rb:136
  ...
  # @param easy [Easy] The easy to setup.
  #
  # source://ethon-0.15.0/lib/ethon/easy/http/actionable.rb:117
  ...
  # @param easy [easy] the easy to setup.
  #
  # source://ethon-0.15.0/lib/ethon/easy/http/actionable.rb:94
  def setup(easy); end
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy/http/actionable.rb:34
  def url; end

  private

  # source://ethon-0.15.0/lib/ethon/easy/http/actionable.rb:141
  def parse_options(options); end
end

# source://ethon-0.15.0/lib/ethon/easy/http/actionable.rb:12
...
#
# source://ethon-0.15.0/lib/ethon/easy/http/custom.rb:7
class Ethon::Easy::Http::Custom
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy/http/custom.rb:11
  ...
  # @param easy [Easy] The easy to setup.
  #
  # source://ethon-0.15.0/lib/ethon/easy/http/custom.rb:22
  def setup(easy); end
end

# This class knows everything about making DELETE requests.
#
# source://ethon-0.15.0/lib/ethon/easy/http/delete.rb:7
class Ethon::Easy::Http::Delete
  ...
  # @param easy [Easy] The easy to setup.
  #
  # source://ethon-0.15.0/lib/ethon/easy/http/delete.rb:17
  def setup(easy); end
end

# This class knows everything about making GET requests.
#
# source://ethon-0.15.0/lib/ethon/easy/http/get.rb:7
class Ethon::Easy::Http::Get
  ...
  # @param easy [Easy] The easy to setup.
  #
  # source://ethon-0.15.0/lib/ethon/easy/http/get.rb:17
  def setup(easy); end
end

# This class knows everything about making HEAD requests.
#
# source://ethon-0.15.0/lib/ethon/easy/http/head.rb:7
class Ethon::Easy::Http::Head
  ...
  # @param easy [Easy] The easy to setup.
  #
  # source://ethon-0.15.0/lib/ethon/easy/http/head.rb:17
  def setup(easy); end
end

# This class knows everything about making OPTIONS requests.
#
# source://ethon-0.15.0/lib/ethon/easy/http/options.rb:7
class Ethon::Easy::Http::Options
  ...
  # @param easy [Easy] The easy to setup.
  #
  # source://ethon-0.15.0/lib/ethon/easy/http/options.rb:17
  def setup(easy); end
end

# This class knows everything about making PATCH requests.
#
# source://ethon-0.15.0/lib/ethon/easy/http/patch.rb:7
class Ethon::Easy::Http::Patch
  ...
  # @param easy [Easy] The easy to setup.
  #
  # source://ethon-0.15.0/lib/ethon/easy/http/patch.rb:17
  def setup(easy); end
end

# This class knows everything about making POST requests.
#
# source://ethon-0.15.0/lib/ethon/easy/http/post.rb:6
class Ethon::Easy::Http::Post
  ...
  # @param easy [Easy] The easy to setup.
  #
  # source://ethon-0.15.0/lib/ethon/easy/http/post.rb:16
  def setup(easy); end
end

# This module contains logic for setting up a [multipart] POST body.
#
# source://ethon-0.15.0/lib/ethon/easy/http/postable.rb:7
module Ethon::Easy::Http::Postable
  ...
  # @param easy [Easy] The easy to setup.
  #
  # source://ethon-0.15.0/lib/ethon/easy/http/postable.rb:16
  def set_form(easy); end
end

# This class knows everything about making PUT requests.
#
# source://ethon-0.15.0/lib/ethon/easy/http/put.rb:7
class Ethon::Easy::Http::Put
  ...
  # @param easy [Easy] The easy to setup.
  #
  # source://ethon-0.15.0/lib/ethon/easy/http/put.rb:17
  def setup(easy); end
end

# This module contains logic about setting up a PUT body.
#
# source://ethon-0.15.0/lib/ethon/easy/http/putable.rb:7
module Ethon::Easy::Http::Putable
  ...
  # @param easy [Easy] The easy to setup.
  #
  # source://ethon-0.15.0/lib/ethon/easy/http/putable.rb:15
  def set_form(easy); end
end
...
#
# source://ethon-0.15.0/lib/ethon/easy/informations.rb:8
module Ethon::Easy::Informations
  ...
  # @return [Boolean] True if supported, else false.
  #
  # source://ethon-0.15.0/lib/ethon/easy/informations.rb:106
  def supports_zlib?; end
...
#
# source://ethon-0.15.0/lib/ethon/easy/informations.rb:12
Ethon::Easy::Informations::AVAILABLE_INFORMATIONS = T.let(T.unsafe(nil), Hash)

# source://ethon-0.15.0/lib/ethon/easy/mirror.rb:4
class Ethon::Easy::Mirror
  # @return [Mirror] a new instance of Mirror
  #
  # source://ethon-0.15.0/lib/ethon/easy/mirror.rb:21
  def initialize(options = T.unsafe(nil)); end
  ...
  # source://ethon-0.15.0/lib/ethon/easy/mirror.rb:25
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy/mirror.rb:5
  def options; end
...
module Ethon::Easy::Operations
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy/operations.rb:44
  def cleanup; end
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy/operations.rb:13
  def handle; end
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy/operations.rb:19
  def handle=(h); end
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy/operations.rb:29
  def perform; end
  ...
  #   easy.prepare
  #
  # source://ethon-0.15.0/lib/ethon/easy/operations.rb:55
  def prepare; end
end
...
#
# source://ethon-0.15.0/lib/ethon/easy/options.rb:7
module Ethon::Easy::Options
  # source://ethon-0.15.0/lib/ethon/easy/options.rb:35
  ...
  # source://ethon-0.15.0/lib/ethon/easy/options.rb:41
  ...
  # source://ethon-0.15.0/lib/ethon/easy/options.rb:15
  def escape=(b); end

  # @return [Boolean]
  #
  # source://ethon-0.15.0/lib/ethon/easy/options.rb:19
  def escape?; end
  ...
  # source://ethon-0.15.0/lib/ethon/easy/options.rb:24
  def multipart=(b); end

  # @return [Boolean]
  #
  # source://ethon-0.15.0/lib/ethon/easy/options.rb:28
  def multipart?; end
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy/options.rb:8
  def url; end

  # source://ethon-0.15.0/lib/ethon/easy/options.rb:10
  def url=(value); end
...
# @api private
#
# source://ethon-0.15.0/lib/ethon/easy/params.rb:11
class Ethon::Easy::Params
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy/params.rb:23
...
#
# source://ethon-0.15.0/lib/ethon/easy/queryable.rb:7
module Ethon::Easy::Queryable
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy/queryable.rb:62
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy/queryable.rb:21
  def empty?; end
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy/queryable.rb:78
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy/queryable.rb:49
  def query_pairs; end
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy/queryable.rb:31
  def to_s; end

  private

  # source://ethon-0.15.0/lib/ethon/easy/queryable.rb:114
  def encode_hash_pairs(h, prefix, pairs); end

  # source://ethon-0.15.0/lib/ethon/easy/queryable.rb:121
  def encode_indexed_array_pairs(h, prefix, pairs); end

  # source://ethon-0.15.0/lib/ethon/easy/queryable.rb:135
  def encode_multi_array_pairs(h, prefix, pairs); end

  # source://ethon-0.15.0/lib/ethon/easy/queryable.rb:128
  def encode_rack_array_pairs(h, prefix, pairs); end

  # source://ethon-0.15.0/lib/ethon/easy/queryable.rb:89
  def mime_type(filename); end

  # source://ethon-0.15.0/lib/ethon/easy/queryable.rb:142
  def pairs_for(v, key, pairs); end

  # source://ethon-0.15.0/lib/ethon/easy/queryable.rb:97
  def recursively_generate_pairs(h, prefix, pairs); end

  class << self
    # source://ethon-0.15.0/lib/ethon/easy/queryable.rb:10
    def included(base); end
  end
end
...
#   #=> []
#
# source://ethon-0.15.0/lib/ethon/easy/response_callbacks.rb:24
module Ethon::Easy::ResponseCallbacks
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy/response_callbacks.rb:117
  def body(chunk); end
  ...
  #   request.complete
  #
  # source://ethon-0.15.0/lib/ethon/easy/response_callbacks.rb:66
  def complete; end
  ...
  #   request.headers
  #
  # source://ethon-0.15.0/lib/ethon/easy/response_callbacks.rb:42
  def headers; end
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy/response_callbacks.rb:105
  ...
  # @param block [Block] The block to execute.
  #
  # source://ethon-0.15.0/lib/ethon/easy/response_callbacks.rb:56
  ...
  # @param block [Block] The block to execute.
  #
  # source://ethon-0.15.0/lib/ethon/easy/response_callbacks.rb:32
  ...
  # @param block [Block] The block to execute.
  #
  # source://ethon-0.15.0/lib/ethon/easy/response_callbacks.rb:79
  ...
  #
  # source://ethon-0.15.0/lib/ethon/easy/response_callbacks.rb:93
...
# @api private
#
# source://ethon-0.15.0/lib/ethon/easy/util.rb:8
...
# @api private
#
# source://ethon-0.15.0/lib/ethon/libc.rb:7
module Ethon::Libc
  extend ::FFI::Library
  ...
  class << self
    ...
    # @return [Boolean]
    #
    # source://ethon-0.15.0/lib/ethon/libc.rb:12
    def windows?; end
  end
end
...
#
# source://ethon-0.15.0/lib/ethon/loggable.rb:6
module Ethon::Loggable
  ...
  #
  # source://ethon-0.15.0/lib/ethon/loggable.rb:17
  def logger; end
  ...
  #
  # source://ethon-0.15.0/lib/ethon/loggable.rb:30
  ...
  #
  # source://ethon-0.15.0/lib/ethon/loggable.rb:42
  ...
  #
  # source://ethon-0.15.0/lib/ethon/loggable.rb:54
  def rails_logger; end
end

# This class represents libcurl multi.
#
# source://ethon-0.15.0/lib/ethon/multi/stack.rb:3
class Ethon::Multi
  ...
  #
  # source://ethon-0.15.0/lib/ethon/multi.rb:89
  def initialize(options = T.unsafe(nil)); end
  ...
  # @see initialize
  #
  # source://ethon-0.15.0/lib/ethon/multi.rb:106
  def set_attributes(options); end
  ...
  # @raise ArgumentError
  #
  # source://ethon-0.15.0/lib/ethon/multi.rb:122
  def ensure_execution_mode(expected_mode); end
end

# This module contains logic to run a multi.
#
# source://ethon-0.15.0/lib/ethon/multi/operations.rb:5
module Ethon::Multi::Operations
  ...
  #
  # source://ethon-0.15.0/lib/ethon/multi/operations.rb:16
  def handle; end
  ...
  # @return [void]
  #
  # source://ethon-0.15.0/lib/ethon/multi/operations.rb:26
  def init_vars; end
  ...
  #
  # source://ethon-0.15.0/lib/ethon/multi/operations.rb:113
  def ongoing?; end
  ...
  # @return [nil]
  #
  # source://ethon-0.15.0/lib/ethon/multi/operations.rb:45
  def perform; end
  ...
  # @return [nil]
  #
  # source://ethon-0.15.0/lib/ethon/multi/operations.rb:68
  def prepare; end
  ...
  #
  # source://ethon-0.15.0/lib/ethon/multi/operations.rb:88
  ...
  # @return [void]
  #
  # source://ethon-0.15.0/lib/ethon/multi/operations.rb:179
  def check; end
  ...
  #
  # source://ethon-0.15.0/lib/ethon/multi/operations.rb:127
  def get_timeout; end
  ...
  # @return [void]
  #
  # source://ethon-0.15.0/lib/ethon/multi/operations.rb:141
  def reset_fds; end
  ...
  # @return [void]
  #
  # source://ethon-0.15.0/lib/ethon/multi/operations.rb:199
  def run; end
  ...
  #
  # source://ethon-0.15.0/lib/ethon/multi/operations.rb:223
  ...
  # @return [void]
  #
  # source://ethon-0.15.0/lib/ethon/multi/operations.rb:156
  ...
  #
  # source://ethon-0.15.0/lib/ethon/multi/operations.rb:211
  def trigger(running_count_pointer); end
end

# source://ethon-0.15.0/lib/ethon/multi/operations.rb:7
Ethon::Multi::Operations::PERFORMED_MULTI = T.let(T.unsafe(nil), String)

# source://ethon-0.15.0/lib/ethon/multi/operations.rb:6
Ethon::Multi::Operations::STARTED_MULTI = T.let(T.unsafe(nil), String)

# This module contains the logic and knowledge about the
# available options on multi.
#
# source://ethon-0.15.0/lib/ethon/multi/options.rb:7
module Ethon::Multi::Options
  ...
  # @return [void]
  #
  # source://ethon-0.15.0/lib/ethon/multi/options.rb:17
  ...
  # @return [void]
  #
  # source://ethon-0.15.0/lib/ethon/multi/options.rb:29
  def maxconnects=(value); end
  ...
  # @return [void]
  #
  # source://ethon-0.15.0/lib/ethon/multi/options.rb:41
  ...
  # @return [void]
  #
  # source://ethon-0.15.0/lib/ethon/multi/options.rb:53
  ...
  # @return [void]
  #
  # source://ethon-0.15.0/lib/ethon/multi/options.rb:65
  ...
  # @return [void]
  #
  # source://ethon-0.15.0/lib/ethon/multi/options.rb:77
  ...
  # @return [void]
  #
  # source://ethon-0.15.0/lib/ethon/multi/options.rb:89
  ...
  #
  # source://ethon-0.15.0/lib/ethon/multi/options.rb:102
  def value_for(value, type, option = T.unsafe(nil)); end
end

# This module provides the multi stack behaviour.
#
# source://ethon-0.15.0/lib/ethon/multi/stack.rb:6
module Ethon::Multi::Stack
  ...
  #
  # source://ethon-0.15.0/lib/ethon/multi/stack.rb:26
  def add(easy); end
  ...
  #
  # source://ethon-0.15.0/lib/ethon/multi/stack.rb:41
  def delete(easy); end
  ...
  #
  # source://ethon-0.15.0/lib/ethon/multi/stack.rb:14
  def easy_handles; end
end

# Ethon version.
#
# source://ethon-0.15.0/lib/ethon/version.rb:5
