...
class Propshaft::Asset
  ...
  # source://propshaft//lib/propshaft/asset.rb#40
  def ==(other_asset); end
...
Propshaft::Asset::PREDIGESTED_REGEX = T.let(T.unsafe(nil), Regexp)
...
class Propshaft::Compilers::CssAssetUrls
  ...
  # source://propshaft//lib/propshaft/compilers/css_asset_urls.rb#13
  ...
  # source://propshaft//lib/propshaft/compilers/css_asset_urls.rb#28
  def asset_url(resolved_path, logical_path, fingerprint, pattern); end

  # source://propshaft//lib/propshaft/compilers/css_asset_urls.rb#18
