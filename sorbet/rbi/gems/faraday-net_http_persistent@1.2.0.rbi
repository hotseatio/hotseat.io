...
#   conn.get '/'
#
# source://faraday-net_http_persistent-1.2.0/lib/faraday/adapter/net_http_persistent.rb:3
module Faraday
  class << self
...
#
# source://faraday-net_http_persistent-1.2.0/lib/faraday/adapter/net_http_persistent.rb:4
...
#
# source://faraday-net_http_persistent-1.2.0/lib/faraday/adapter/net_http_persistent.rb:6
class Faraday::Adapter::NetHttpPersistent < ::Faraday::Adapter::NetHttp
  private

  # source://faraday-net_http_persistent-1.2.0/lib/faraday/adapter/net_http_persistent.rb:94
  def configure_ssl(http, ssl); end

  # source://faraday-net_http_persistent-1.2.0/lib/faraday/adapter/net_http_persistent.rb:105
  def http_set(http, attr, value); end

  # source://faraday-net_http_persistent-1.2.0/lib/faraday/adapter/net_http_persistent.rb:11
  def net_http_connection(env); end

  # source://faraday-net_http_persistent-1.2.0/lib/faraday/adapter/net_http_persistent.rb:52
  def perform_request(http, env); end

  # source://faraday-net_http_persistent-1.2.0/lib/faraday/adapter/net_http_persistent.rb:31
  def proxy_uri(env); end
end

# source://faraday-net_http_persistent-1.2.0/lib/faraday/adapter/net_http_persistent.rb:85
...
# source://faraday-net_http_persistent-1.2.0/lib/faraday/net_http_persistent/version.rb:4
