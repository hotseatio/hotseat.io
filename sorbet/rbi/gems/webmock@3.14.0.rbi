...
# source://webmock-3.14.0/lib/webmock/http_lib_adapters/excon_adapter.rb:13
class WebMock::HttpLibAdapters::ExconAdapter < ::WebMock::HttpLibAdapter
  class << self
    # source://webmock-3.14.0/lib/webmock/http_lib_adapters/excon_adapter.rb:35
    def add_excon_stub; end

    # source://webmock-3.14.0/lib/webmock/http_lib_adapters/excon_adapter.rb:118
    def body_from(params); end

    # source://webmock-3.14.0/lib/webmock/http_lib_adapters/excon_adapter.rb:108
    def build_request(params); end

    # source://webmock-3.14.0/lib/webmock/http_lib_adapters/excon_adapter.rb:79
    def connection_params_from(hash); end

    # source://webmock-3.14.0/lib/webmock/http_lib_adapters/excon_adapter.rb:31
    def disable!; end

    # source://webmock-3.14.0/lib/webmock/http_lib_adapters/excon_adapter.rb:27
    def enable!; end

    # source://webmock-3.14.0/lib/webmock/http_lib_adapters/excon_adapter.rb:52
    def handle_request(params); end

    # source://webmock-3.14.0/lib/webmock/http_lib_adapters/excon_adapter.rb:138
    def mock_response(real); end

    # source://webmock-3.14.0/lib/webmock/http_lib_adapters/excon_adapter.rb:72
    def new_excon_connection(params); end

    # source://webmock-3.14.0/lib/webmock/http_lib_adapters/excon_adapter.rb:146
    def perform_callbacks(request, response, options = T.unsafe(nil)); end

    # @raise [Excon::Errors::Timeout]
    #
    # source://webmock-3.14.0/lib/webmock/http_lib_adapters/excon_adapter.rb:127
    def real_response(mock); end

    # source://webmock-3.14.0/lib/webmock/http_lib_adapters/excon_adapter.rb:45
    def remove_excon_stub; end

    # source://webmock-3.14.0/lib/webmock/http_lib_adapters/excon_adapter.rb:85
    def request_params_from(hash); end

    # source://webmock-3.14.0/lib/webmock/http_lib_adapters/excon_adapter.rb:94
    def to_query(hash); end
  end
end

# source://webmock-3.14.0/lib/webmock/http_lib_adapters/excon_adapter.rb:14
...
# source://webmock-3.14.0/lib/webmock/http_lib_adapters/typhoeus_hydra_adapter.rb:12
class WebMock::HttpLibAdapters::TyphoeusAdapter < ::WebMock::HttpLibAdapter
  class << self
    # source://webmock-3.14.0/lib/webmock/http_lib_adapters/typhoeus_hydra_adapter.rb:43
    def add_after_request_callback; end

    # source://webmock-3.14.0/lib/webmock/http_lib_adapters/typhoeus_hydra_adapter.rb:33
    def add_before_callback; end

    # source://webmock-3.14.0/lib/webmock/http_lib_adapters/typhoeus_hydra_adapter.rb:53
    def build_request_signature(req); end

    # source://webmock-3.14.0/lib/webmock/http_lib_adapters/typhoeus_hydra_adapter.rb:82
    def build_webmock_response(typhoeus_response); end

    # source://webmock-3.14.0/lib/webmock/http_lib_adapters/typhoeus_hydra_adapter.rb:22
    def disable!; end

    # @return [Boolean]
    #
    # source://webmock-3.14.0/lib/webmock/http_lib_adapters/typhoeus_hydra_adapter.rb:29
    def disabled?; end

    # source://webmock-3.14.0/lib/webmock/http_lib_adapters/typhoeus_hydra_adapter.rb:15
    def enable!; end

    # source://webmock-3.14.0/lib/webmock/http_lib_adapters/typhoeus_hydra_adapter.rb:90
    def generate_typhoeus_response(request_signature, webmock_response); end

    # source://webmock-3.14.0/lib/webmock/http_lib_adapters/typhoeus_hydra_adapter.rb:49
    def remove_after_request_callback; end

    # source://webmock-3.14.0/lib/webmock/http_lib_adapters/typhoeus_hydra_adapter.rb:39
    def remove_before_callback; end

    # source://webmock-3.14.0/lib/webmock/http_lib_adapters/typhoeus_hydra_adapter.rb:112
    def request_hash(request_signature); end
  end
end

# source://webmock-3.14.0/lib/webmock/http_lib_adapters/typhoeus_hydra_adapter.rb:121
WebMock::HttpLibAdapters::TyphoeusAdapter::AFTER_REQUEST_CALLBACK = T.let(T.unsafe(nil), Proc)

# source://webmock-3.14.0/lib/webmock/http_lib_adapters/typhoeus_hydra_adapter.rb:142
WebMock::HttpLibAdapters::TyphoeusAdapter::BEFORE_CALLBACK = T.let(T.unsafe(nil), Proc)
