...
#
# source://excon-0.92.4/lib/excon/version.rb:2
module Excon
  class << self
...
# source://excon-0.92.4/lib/excon/connection.rb:5
class Excon::Connection
  ...
  #
  # source://excon-0.92.4/lib/excon/connection.rb:64
  ...
  #
  # source://excon-0.92.4/lib/excon/connection.rb:347
  def batch_requests(pipeline_params, limit = T.unsafe(nil)); end

  # source://excon-0.92.4/lib/excon/connection.rb:368
  def connect(params = T.unsafe(nil), &block); end

  # source://excon-0.92.4/lib/excon/connection.rb:10
  def connection; end

  # source://excon-0.92.4/lib/excon/connection.rb:14
  def connection=(new_params); end

  # Returns the value of attribute data.
  #
  # source://excon-0.92.4/lib/excon/connection.rb:8
  def data; end

  # source://excon-0.92.4/lib/excon/connection.rb:368
  def delete(params = T.unsafe(nil), &block); end

  # source://excon-0.92.4/lib/excon/connection.rb:106
  ...
  # source://excon-0.92.4/lib/excon/connection.rb:384
  def inspect; end

  # source://excon-0.92.4/lib/excon/connection.rb:37
  def logger; end

  # source://excon-0.92.4/lib/excon/connection.rb:42
  def logger=(logger); end

  # source://excon-0.92.4/lib/excon/connection.rb:368
  def options(params = T.unsafe(nil), &block); end

  # source://excon-0.92.4/lib/excon/connection.rb:19
  def params; end

  # source://excon-0.92.4/lib/excon/connection.rb:23
  ...
  # source://excon-0.92.4/lib/excon/connection.rb:28
  def proxy; end

  # source://excon-0.92.4/lib/excon/connection.rb:32
  ...
  #
  # source://excon-0.92.4/lib/excon/connection.rb:227
  def request(params = T.unsafe(nil), &block); end

  # source://excon-0.92.4/lib/excon/connection.rb:112
  ...
  # @param pipeline_params [Array<Hash>] An array of one or more optional params, override defaults set in Connection.new, see #request for details
  #
  # source://excon-0.92.4/lib/excon/connection.rb:320
  def requests(pipeline_params); end

  # source://excon-0.92.4/lib/excon/connection.rb:358
  def reset; end

  # source://excon-0.92.4/lib/excon/connection.rb:206
  def response_call(datum); end

  # source://excon-0.92.4/lib/excon/connection.rb:379
  def retry_limit; end

  # source://excon-0.92.4/lib/excon/connection.rb:374
  def retry_limit=(new_retry_limit); end

  # source://excon-0.92.4/lib/excon/connection.rb:368
  def trace(params = T.unsafe(nil), &block); end

  # source://excon-0.92.4/lib/excon/connection.rb:398
  def valid_request_keys(middlewares); end

  private

  # source://excon-0.92.4/lib/excon/connection.rb:404
  def detect_content_length(body); end

  # source://excon-0.92.4/lib/excon/connection.rb:513
  def proxy_from_env; end

  # source://excon-0.92.4/lib/excon/connection.rb:500
  def proxy_match_host_port(host, port); end

  # source://excon-0.92.4/lib/excon/connection.rb:492
  def raise_socket_error(error); end

  # source://excon-0.92.4/lib/excon/connection.rb:455
  def response(datum = T.unsafe(nil)); end

  # source://excon-0.92.4/lib/excon/connection.rb:541
  def setup_proxy; end

  # source://excon-0.92.4/lib/excon/connection.rb:466
  def socket(datum = T.unsafe(nil)); end

  # source://excon-0.92.4/lib/excon/connection.rb:477
  def sockets; end

  # source://excon-0.92.4/lib/excon/connection.rb:416
  def valid_middleware_keys(middlewares); end

  # source://excon-0.92.4/lib/excon/connection.rb:429
  def validate_params(validation, params, middlewares); end

  class << self
    # source://webmock-3.14.0/lib/webmock/http_lib_adapters/excon_adapter.rb:155
...
#
# source://excon-0.92.4/lib/excon/error.rb:4
class Excon::Error < ::StandardError
  class << self
    # Messages for nicer exceptions, from rfc2616
    #
    # source://excon-0.92.4/lib/excon/error.rb:174
    def status_error(request, response); end

    # source://excon-0.92.4/lib/excon/error.rb:127
...
# source://excon-0.92.4/lib/excon/error.rb:200
...
# source://excon-0.92.4/lib/excon/headers.rb:3
class Excon::Headers < ::Hash
  # @return [Headers] a new instance of Headers
  #
  # source://excon-0.92.4/lib/excon/headers.rb:24
  def initialize; end

  # source://excon-0.92.4/lib/excon/headers.rb:29
  def [](key); end

  # source://excon-0.92.4/lib/excon/headers.rb:33
  def []=(key, value); end

  # source://excon-0.92.4/lib/excon/headers.rb:40
  def assoc(obj); end

  # source://excon-0.92.4/lib/excon/headers.rb:45
  def delete(key, &proc); end

  # source://excon-0.92.4/lib/excon/headers.rb:50
  def fetch(key, default = T.unsafe(nil), &proc); end

  # @return [Boolean]
  #
  # source://excon-0.92.4/lib/excon/headers.rb:58
  def has_key?(key); end
  ...
  # source://excon-0.92.4/lib/excon/headers.rb:64
  def merge(other_hash); end

  # source://excon-0.92.4/lib/excon/headers.rb:68
  def merge!(other_hash); end
  ...
  # source://excon-0.92.4/lib/excon/headers.rb:75
  def rehash; end

  # source://excon-0.92.4/lib/excon/headers.rb:33
  def store(key, value); end

  # source://excon-0.92.4/lib/excon/headers.rb:80
  def values_at(*keys); end
end

# source://excon-0.92.4/lib/excon/headers.rb:5
Excon::Headers::SENTINEL = T.let(T.unsafe(nil), Hash)

# source://excon-0.92.4/lib/excon/instrumentors/logging_instrumentor.rb:4
class Excon::LoggingInstrumentor
  class << self
    # source://excon-0.92.4/lib/excon/instrumentors/logging_instrumentor.rb:6
    def instrument(name, params = T.unsafe(nil)); end
  end
end

# source://excon-0.92.4/lib/excon/middlewares/base.rb:3
module Excon::Middleware; end

# source://excon-0.92.4/lib/excon/middlewares/base.rb:4
class Excon::Middleware::Base
  # @return [Base] a new instance of Base
  #
  # source://excon-0.92.4/lib/excon/middlewares/base.rb:11
  def initialize(stack); end

  # source://excon-0.92.4/lib/excon/middlewares/base.rb:15
  def error_call(datum); end

  # source://excon-0.92.4/lib/excon/middlewares/base.rb:20
  def request_call(datum); end

  # source://excon-0.92.4/lib/excon/middlewares/base.rb:25
  def response_call(datum); end
  ...
  class << self
    ...
    #
    # source://excon-0.92.4/lib/excon/middlewares/base.rb:7
    def valid_parameter_keys; end
  end
end

# source://excon-0.92.4/lib/excon/middlewares/capture_cookies.rb:4
class Excon::Middleware::CaptureCookies < ::Excon::Middleware::Base
  # source://excon-0.92.4/lib/excon/middlewares/capture_cookies.rb:6
  def extract_cookies_from_set_cookie(set_cookie); end

  # source://excon-0.92.4/lib/excon/middlewares/capture_cookies.rb:10
  def get_header(datum, header); end

  # source://excon-0.92.4/lib/excon/middlewares/capture_cookies.rb:17
  def response_call(datum); end
end

# source://excon-0.92.4/lib/excon/middlewares/decompress.rb:4
class Excon::Middleware::Decompress < ::Excon::Middleware::Base
  # source://excon-0.92.4/lib/excon/middlewares/decompress.rb:9
  def request_call(datum); end

  # source://excon-0.92.4/lib/excon/middlewares/decompress.rb:19
  def response_call(datum); end
end

# Zlib::MAX_WBITS * -1
#
# source://excon-0.92.4/lib/excon/middlewares/decompress.rb:7
Excon::Middleware::Decompress::INFLATE_RAW = T.let(T.unsafe(nil), Integer)

# Zlib::MAX_WBITS + 32
#
# source://excon-0.92.4/lib/excon/middlewares/decompress.rb:6
Excon::Middleware::Decompress::INFLATE_ZLIB_OR_GZIP = T.let(T.unsafe(nil), Integer)

# source://excon-0.92.4/lib/excon/middlewares/escape_path.rb:4
class Excon::Middleware::EscapePath < ::Excon::Middleware::Base
  # source://excon-0.92.4/lib/excon/middlewares/escape_path.rb:5
  def request_call(datum); end
end

# source://excon-0.92.4/lib/excon/middlewares/expects.rb:4
class Excon::Middleware::Expects < ::Excon::Middleware::Base
  # source://excon-0.92.4/lib/excon/middlewares/expects.rb:11
  def response_call(datum); end

  class << self
    # source://excon-0.92.4/lib/excon/middlewares/expects.rb:5
    def valid_parameter_keys; end
  end
end

# source://excon-0.92.4/lib/excon/middlewares/idempotent.rb:6
class Excon::Middleware::Idempotent < ::Excon::Middleware::Base
  # source://excon-0.92.4/lib/excon/middlewares/idempotent.rb:22
  def error_call(datum); end

  # source://excon-0.92.4/lib/excon/middlewares/idempotent.rb:17
  def request_call(datum); end

  class << self
    # source://excon-0.92.4/lib/excon/middlewares/idempotent.rb:7
    def valid_parameter_keys; end
  end
end

# source://excon-0.92.4/lib/excon/middlewares/instrumentor.rb:4
class Excon::Middleware::Instrumentor < ::Excon::Middleware::Base
  # source://excon-0.92.4/lib/excon/middlewares/instrumentor.rb:13
  def error_call(datum); end

  # source://excon-0.92.4/lib/excon/middlewares/instrumentor.rb:23
  def request_call(datum); end

  # source://excon-0.92.4/lib/excon/middlewares/instrumentor.rb:38
  def response_call(datum); end

  class << self
    # source://excon-0.92.4/lib/excon/middlewares/instrumentor.rb:5
    def valid_parameter_keys; end
  end
end

# source://excon-0.92.4/lib/excon/middlewares/mock.rb:4
class Excon::Middleware::Mock < ::Excon::Middleware::Base
  # source://excon-0.92.4/lib/excon/middlewares/mock.rb:13
  def request_call(datum); end

  class << self
    # source://excon-0.92.4/lib/excon/middlewares/mock.rb:5
    def valid_parameter_keys; end
  end
end

# source://excon-0.92.4/lib/excon/middlewares/redirect_follower.rb:4
class Excon::Middleware::RedirectFollower < ::Excon::Middleware::Base
  # source://excon-0.92.4/lib/excon/middlewares/redirect_follower.rb:18
  def get_header(datum, header); end

  # source://excon-0.92.4/lib/excon/middlewares/redirect_follower.rb:12
  def request_call(datum); end

  # source://excon-0.92.4/lib/excon/middlewares/redirect_follower.rb:25
  def response_call(datum); end

  class << self
    # source://excon-0.92.4/lib/excon/middlewares/redirect_follower.rb:5
    def valid_parameter_keys; end
  end
end

# source://excon-0.92.4/lib/excon/middlewares/response_parser.rb:4
class Excon::Middleware::ResponseParser < ::Excon::Middleware::Base
  # source://excon-0.92.4/lib/excon/middlewares/response_parser.rb:5
  def response_call(datum); end
end
...
# source://excon-0.92.4/lib/excon/pretty_printer.rb:3
class Excon::PrettyPrinter
  class << self
    # source://excon-0.92.4/lib/excon/pretty_printer.rb:4
...
# source://excon-0.92.4/lib/excon/response.rb:3
class Excon::Response
  # @return [Response] a new instance of Response
  #
  # source://excon-0.92.4/lib/excon/response.rb:200
  def initialize(params = T.unsafe(nil)); end

  # source://excon-0.92.4/lib/excon/response.rb:214
  def [](key); end

  # source://excon-0.92.4/lib/excon/response.rb:11
  def body; end

  # backwards compatability reader/writers
  #
  # source://excon-0.92.4/lib/excon/response.rb:8
  def body=(new_body); end

  # Returns the value of attribute data.
  #
  # source://excon-0.92.4/lib/excon/response.rb:5
  def data; end
  ...
  #
  # source://excon-0.92.4/lib/excon/response.rb:229
  def get_header(name); end

  # source://excon-0.92.4/lib/excon/response.rb:17
  def headers; end

  # source://excon-0.92.4/lib/excon/response.rb:14
  def headers=(new_headers); end

  # source://excon-0.92.4/lib/excon/response.rb:20
  def host; end

  # source://excon-0.92.4/lib/excon/response.rb:23
  def local_address; end

  # source://excon-0.92.4/lib/excon/response.rb:26
  def local_port; end

  # source://excon-0.92.4/lib/excon/response.rb:218
  def params; end

  # source://excon-0.92.4/lib/excon/response.rb:29
  def path; end

  # source://excon-0.92.4/lib/excon/response.rb:32
  def port; end

  # source://excon-0.92.4/lib/excon/response.rb:223
  def pp; end

  # source://excon-0.92.4/lib/excon/response.rb:38
  def reason_phrase; end

  # source://excon-0.92.4/lib/excon/response.rb:35
  def reason_phrase=(new_reason_phrase); end

  # source://excon-0.92.4/lib/excon/response.rb:44
  def remote_ip; end

  # source://excon-0.92.4/lib/excon/response.rb:41
  def remote_ip=(new_remote_ip); end

  # source://excon-0.92.4/lib/excon/response.rb:50
  def status; end

  # source://excon-0.92.4/lib/excon/response.rb:47
  def status=(new_status); end

  # source://excon-0.92.4/lib/excon/response.rb:53
  def status_line; end

  # source://excon-0.92.4/lib/excon/response.rb:56
  def status_line=(new_status_line); end

  class << self
    # source://excon-0.92.4/lib/excon/response.rb:60
    def parse(socket, datum); end

    # source://excon-0.92.4/lib/excon/response.rb:180
    def parse_headers(socket, datum); end
  end
end

# source://excon-0.92.4/lib/excon/ssl_socket.rb:3
class Excon::SSLSocket < ::Excon::Socket
  # @return [SSLSocket] a new instance of SSLSocket
  #
  # source://excon-0.92.4/lib/excon/ssl_socket.rb:8
  def initialize(data = T.unsafe(nil)); end

  private

  # source://excon-0.92.4/lib/excon/ssl_socket.rb:163
  def client_cert_data; end

  # source://excon-0.92.4/lib/excon/ssl_socket.rb:180
  def client_key_data; end

  # source://excon-0.92.4/lib/excon/ssl_socket.rb:191
  def client_key_pass; end

  # source://excon-0.92.4/lib/excon/ssl_socket.rb:174
  def connect; end
end

# source://excon-0.92.4/lib/excon/ssl_socket.rb:4
Excon::SSLSocket::HAVE_NONBLOCK = T.let(T.unsafe(nil), TrueClass)

# source://excon-0.92.4/lib/excon/socket.rb:5
class Excon::Socket
  include ::Excon::Utils
  extend ::Forwardable
  ...
  # @return [Socket] a new instance of Socket
  #
  # source://excon-0.92.4/lib/excon/socket.rb:43
  def initialize(data = T.unsafe(nil)); end
  ...
  # Returns the value of attribute data.
  #
  # source://excon-0.92.4/lib/excon/socket.rb:10
  def data; end
  ...
  # source://excon-0.92.4/lib/excon/socket.rb:86
  def local_address; end

  # source://excon-0.92.4/lib/excon/socket.rb:90
  def local_port; end

  # source://excon-0.92.4/lib/excon/socket.rb:29
  def params; end

  # source://excon-0.92.4/lib/excon/socket.rb:34
  def params=(new_params); end

  # source://excon-0.92.4/lib/excon/socket.rb:52
  def read(max_length = T.unsafe(nil)); end

  # source://excon-0.92.4/lib/excon/socket.rb:62
  def readline; end

  # Returns the value of attribute remote_ip.
  #
  # source://excon-0.92.4/lib/excon/socket.rb:39
  def remote_ip; end

  # source://excon-0.92.4/lib/excon/socket.rb:78
  def write(data); end

  private

  # source://excon-0.92.4/lib/excon/socket.rb:96
  def connect; end

  # source://excon-0.92.4/lib/excon/socket.rb:213
  def read_block(max_length); end

  # source://excon-0.92.4/lib/excon/socket.rb:175
  def read_nonblock(max_length); end

  # source://excon-0.92.4/lib/excon/socket.rb:274
  def select_with_timeout(socket, type); end

  # source://excon-0.92.4/lib/excon/socket.rb:288
  def unpacked_sockaddr; end

  # source://excon-0.92.4/lib/excon/socket.rb:264
  def write_block(data); end

  # source://excon-0.92.4/lib/excon/socket.rb:229
...
#
# source://excon-0.92.4/lib/excon/socket.rb:13
Excon::Socket::CONNECT_RETRY_EXCEPTION_CLASSES = T.let(T.unsafe(nil), Array)

# Ruby >= 2.1
#
# source://excon-0.92.4/lib/excon/socket.rb:18
Excon::Socket::READ_RETRY_EXCEPTION_CLASSES = T.let(T.unsafe(nil), Array)

# Ruby >= 2.1
#
# source://excon-0.92.4/lib/excon/socket.rb:23
Excon::Socket::WRITE_RETRY_EXCEPTION_CLASSES = T.let(T.unsafe(nil), Array)

# source://excon-0.92.4/lib/excon/instrumentors/standard_instrumentor.rb:3
class Excon::StandardInstrumentor
  class << self
    # source://excon-0.92.4/lib/excon/instrumentors/standard_instrumentor.rb:4
    def instrument(name, params = T.unsafe(nil)); end
  end
end
...
# source://excon-0.92.4/lib/excon/unix_socket.rb:3
class Excon::UnixSocket < ::Excon::Socket
  private

  # source://excon-0.92.4/lib/excon/unix_socket.rb:7
  def connect; end
end

# source://excon-0.92.4/lib/excon/utils.rb:3
module Excon::Utils
  extend ::Excon::Utils

  # source://excon-0.92.4/lib/excon/utils.rb:13
  def binary_encode(string); end

  # source://excon-0.92.4/lib/excon/utils.rb:25
  def connection_uri(datum = T.unsafe(nil)); end

  # Escapes HTTP reserved and unwise characters in +str+
  #
  # source://excon-0.92.4/lib/excon/utils.rb:104
  def escape_uri(str); end

  # Performs validation on the passed header hash and returns a string representation of the headers
  #
  # source://excon-0.92.4/lib/excon/utils.rb:126
  def headers_hash_to_s(headers); end

  # source://excon-0.92.4/lib/excon/utils.rb:64
  def port_string(datum); end

  # source://excon-0.92.4/lib/excon/utils.rb:72
  def query_string(datum); end

  # Redact sensitive info from provided data
  #
  # source://excon-0.92.4/lib/excon/utils.rb:37
  def redact(datum); end

  # source://excon-0.92.4/lib/excon/utils.rb:60
  def request_uri(datum); end

  # Splits a header value +str+ according to HTTP specification.
  #
  # source://excon-0.92.4/lib/excon/utils.rb:95
  def split_header_value(str); end

  # Unescape form encoded values in +str+
  #
  # source://excon-0.92.4/lib/excon/utils.rb:118
  def unescape_form(str); end

  # Unescapes HTTP reserved and unwise characters in +str+
  #
  # source://excon-0.92.4/lib/excon/utils.rb:111
  def unescape_uri(str); end
end

# source://excon-0.92.4/lib/excon/utils.rb:6
Excon::Utils::CONTROL = T.let(T.unsafe(nil), String)

# source://excon-0.92.4/lib/excon/utils.rb:7
Excon::Utils::DELIMS = T.let(T.unsafe(nil), String)

# source://excon-0.92.4/lib/excon/utils.rb:11
Excon::Utils::ESCAPED = T.let(T.unsafe(nil), Regexp)

# source://excon-0.92.4/lib/excon/utils.rb:9
Excon::Utils::NONASCII = T.let(T.unsafe(nil), String)

# source://excon-0.92.4/lib/excon/utils.rb:10
Excon::Utils::UNESCAPED = T.let(T.unsafe(nil), Regexp)

# source://excon-0.92.4/lib/excon/utils.rb:8
