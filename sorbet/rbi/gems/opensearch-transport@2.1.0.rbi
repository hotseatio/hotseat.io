...
# source://opensearch-transport//lib/opensearch/transport/transport/loggable.rb#27
...
# @since 7.0.0
#
# source://opensearch-transport//lib/opensearch/transport/transport/loggable.rb#32
module OpenSearch::Loggable
  ...
  # @since 7.0.0
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/loggable.rb#42
  ...
  # @since 7.0.0
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/loggable.rb#54
  ...
  # @since 7.0.0
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/loggable.rb#66
  ...
  # @since 7.0.0
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/loggable.rb#78
  ...
  # @since 7.0.0
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/loggable.rb#90
...
# source://opensearch-transport//lib/opensearch/transport/transport/serializer/multi_json.rb#28
...
#
# source://opensearch-transport//lib/opensearch/transport/client.rb#35
class OpenSearch::Transport::Client
  ...
  #
  # source://opensearch-transport//lib/opensearch/transport/client.rb#137
  def initialize(arguments = T.unsafe(nil), &block); end

  # Performs a request through delegation to {#transport}.
  #
  # source://opensearch-transport//lib/opensearch/transport/client.rb#186
  ...
  #
  # source://opensearch-transport//lib/opensearch/transport/client.rb#75
  def transport; end
  ...
  # @return [Symbol]
  #
  # source://opensearch-transport//lib/opensearch/transport/client.rb#332
  def __auto_detect_adapter; end

  # Encode credentials for the Authorization Header
  # Credentials is the base64 encoding of id and api_key joined by a colon
  #
  # source://opensearch-transport//lib/opensearch/transport/client.rb#358
  ...
  # @return [Array<Hash>]
  #
  # source://opensearch-transport//lib/opensearch/transport/client.rb#260
  def __extract_hosts(hosts_config); end

  # source://opensearch-transport//lib/opensearch/transport/client.rb#276
  def __parse_host(host); end

  # source://opensearch-transport//lib/opensearch/transport/client.rb#216
  def add_header(header); end

  # source://opensearch-transport//lib/opensearch/transport/client.rb#224
  def extract_cloud_creds(arguments); end

  # source://opensearch-transport//lib/opensearch/transport/client.rb#198
  def set_api_key; end

  # source://opensearch-transport//lib/opensearch/transport/client.rb#205
...
# @since 7.2.0
#
# source://opensearch-transport//lib/opensearch/transport/client.rb#63
...
# @since 7.0.0
#
# source://opensearch-transport//lib/opensearch/transport/client.rb#57
OpenSearch::Transport::Client::DEFAULT_HOST = T.let(T.unsafe(nil), String)

# source://opensearch-transport//lib/opensearch/transport/client.rb#38
...
# @since 7.2.0
#
# source://opensearch-transport//lib/opensearch/transport/client.rb#68
OpenSearch::Transport::Client::DEFAULT_PORT = T.let(T.unsafe(nil), Integer)

# source://opensearch-transport//lib/opensearch/transport/client.rb#46
OpenSearch::Transport::Client::DEFAULT_TRACER = T.let(T.unsafe(nil), Proc)

# source://opensearch-transport//lib/opensearch/transport/client.rb#36
...
# @since 6.1.1
#
# source://opensearch-transport//lib/opensearch/transport/redacted.rb#34
class OpenSearch::Transport::Redacted < ::Hash
  # @return [Redacted] a new instance of Redacted
  # @since 6.1.1
  #
  # source://opensearch-transport//lib/opensearch/transport/redacted.rb#36
  ...
  # @since 6.1.1
  #
  # source://opensearch-transport//lib/opensearch/transport/redacted.rb#57
  def inspect; end
  ...
  # @since 6.1.1
  #
  # source://opensearch-transport//lib/opensearch/transport/redacted.rb#66
  def to_s; end
  ...
  # @since 6.1.1
  #
  # source://opensearch-transport//lib/opensearch/transport/redacted.rb#78
  def redact(k, v, method); end

  # @since 6.1.1
  #
  # source://opensearch-transport//lib/opensearch/transport/redacted.rb#72
...
# @since 6.1.1
#
# source://opensearch-transport//lib/opensearch/transport/redacted.rb#44
...
# @since 6.1.1
#
# source://opensearch-transport//lib/opensearch/transport/redacted.rb#50
OpenSearch::Transport::Redacted::STRING_REPLACEMENT = T.let(T.unsafe(nil), String)

# source://opensearch-transport//lib/opensearch/transport/transport/serializer/multi_json.rb#29
module OpenSearch::Transport::Transport; end

# @abstract Module with common functionality for transport implementations.
#
# source://opensearch-transport//lib/opensearch/transport/transport/base.rb#33
module OpenSearch::Transport::Transport::Base
  ...
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/base.rb#59
  def initialize(arguments = T.unsafe(nil), &block); end
  ...
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/base.rb#179
  ...
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/base.rb#156
  ...
  # @api private
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/base.rb#187
  ...
  # @api private
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/base.rb#234
  ...
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/base.rb#243
  ...
  # @api private
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/base.rb#195
  ...
  # @api private
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/base.rb#225
  ...
  # @return [Connections::Collection]
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/base.rb#132
  ...
  # @api private
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/base.rb#209
  def __trace(method, path, params, headers, body, url, response, json, took, duration); end

  # Returns the value of attribute connections.
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/base.rb#44
  def connections; end
  ...
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/base.rb#95
  ...
  # @return [Array]
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/base.rb#380
  ...
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/base.rb#45
  def logger; end
  ...
  # @return [Response]
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/base.rb#270
  ...
  # @see Sniffer#hosts
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/base.rb#107
  def reload_connections!; end
  ...
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/base.rb#120
  ...
  # source://opensearch-transport//lib/opensearch/transport/transport/base.rb#418
  def apply_headers(client, options); end

  # source://opensearch-transport//lib/opensearch/transport/transport/base.rb#397
  def decompress_response(body); end

  # source://opensearch-transport//lib/opensearch/transport/transport/base.rb#426
  def find_value(hash, regex); end

  # @return [Boolean]
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/base.rb#410
  def gzipped?(body); end

  # @return [Boolean]
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/base.rb#414
  def use_compression?; end

  # source://opensearch-transport//lib/opensearch/transport/transport/base.rb#434
  def user_agent_header(client); end

  # source://opensearch-transport//lib/opensearch/transport/transport/base.rb#444
  def warnings(warning); end
end

# source://opensearch-transport//lib/opensearch/transport/transport/base.rb#392
OpenSearch::Transport::Transport::Base::ACCEPT_ENCODING = T.let(T.unsafe(nil), String)

# source://opensearch-transport//lib/opensearch/transport/transport/base.rb#389
OpenSearch::Transport::Transport::Base::CONTENT_TYPE_REGEX = T.let(T.unsafe(nil), Regexp)

# source://opensearch-transport//lib/opensearch/transport/transport/base.rb#388
OpenSearch::Transport::Transport::Base::CONTENT_TYPE_STR = T.let(T.unsafe(nil), String)

# source://opensearch-transport//lib/opensearch/transport/transport/base.rb#390
OpenSearch::Transport::Transport::Base::DEFAULT_CONTENT_TYPE = T.let(T.unsafe(nil), String)

# Requests
#
# source://opensearch-transport//lib/opensearch/transport/transport/base.rb#40
OpenSearch::Transport::Transport::Base::DEFAULT_MAX_RETRIES = T.let(T.unsafe(nil), Integer)

# source://opensearch-transport//lib/opensearch/transport/transport/base.rb#36
OpenSearch::Transport::Transport::Base::DEFAULT_PORT = T.let(T.unsafe(nil), Integer)

# source://opensearch-transport//lib/opensearch/transport/transport/base.rb#37
OpenSearch::Transport::Transport::Base::DEFAULT_PROTOCOL = T.let(T.unsafe(nil), String)

# Requests
#
# source://opensearch-transport//lib/opensearch/transport/transport/base.rb#38
OpenSearch::Transport::Transport::Base::DEFAULT_RELOAD_AFTER = T.let(T.unsafe(nil), Integer)

# Seconds
#
# source://opensearch-transport//lib/opensearch/transport/transport/base.rb#39
OpenSearch::Transport::Transport::Base::DEFAULT_RESURRECT_AFTER = T.let(T.unsafe(nil), Integer)

# source://opensearch-transport//lib/opensearch/transport/transport/base.rb#41
OpenSearch::Transport::Transport::Base::DEFAULT_SERIALIZER_CLASS = OpenSearch::Transport::Transport::Serializer::MultiJson

# source://opensearch-transport//lib/opensearch/transport/transport/base.rb#391
OpenSearch::Transport::Transport::Base::GZIP = T.let(T.unsafe(nil), String)

# source://opensearch-transport//lib/opensearch/transport/transport/base.rb#393
OpenSearch::Transport::Transport::Base::GZIP_FIRST_TWO_BYTES = T.let(T.unsafe(nil), String)

# source://opensearch-transport//lib/opensearch/transport/transport/base.rb#394
OpenSearch::Transport::Transport::Base::HEX_STRING_DIRECTIVE = T.let(T.unsafe(nil), String)

# source://opensearch-transport//lib/opensearch/transport/transport/base.rb#395
OpenSearch::Transport::Transport::Base::RUBY_ENCODING = T.let(T.unsafe(nil), TrueClass)

# source://opensearch-transport//lib/opensearch/transport/transport/base.rb#42
OpenSearch::Transport::Transport::Base::SANITIZED_PASSWORD = T.let(T.unsafe(nil), String)

# source://opensearch-transport//lib/opensearch/transport/transport/base.rb#387
OpenSearch::Transport::Transport::Base::USER_AGENT_REGEX = T.let(T.unsafe(nil), Regexp)

# source://opensearch-transport//lib/opensearch/transport/transport/base.rb#386
OpenSearch::Transport::Transport::Base::USER_AGENT_STR = T.let(T.unsafe(nil), String)

# source://opensearch-transport//lib/opensearch/transport/transport/connections/selector.rb#30
...
# @see Connection
#
# source://opensearch-transport//lib/opensearch/transport/transport/connections/collection.rb#38
class OpenSearch::Transport::Transport::Connections::Collection
  ...
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/connections/collection.rb#49
  def initialize(arguments = T.unsafe(nil)); end

  # source://opensearch-transport//lib/opensearch/transport/transport/connections/collection.rb#103
  def [](*args); end
  ...
  # @return [self]
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/connections/collection.rb#117
  ...
  # @return [Array]
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/connections/collection.rb#67
  def alive; end
  ...
  # @return [Array]
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/connections/collection.rb#84
  def all; end
  ...
  # @return [Array]
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/connections/collection.rb#76
  def dead; end

  # source://opensearch-transport//lib/opensearch/transport/transport/connections/collection.rb#99
  def each(&block); end
  ...
  # @return [Connection]
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/connections/collection.rb#95
  def get_connection(options = T.unsafe(nil)); end
  ...
  # @return [Array]
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/connections/collection.rb#59
  def hosts; end
  ...
  # @return [self]
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/connections/collection.rb#127
  def remove(connections); end

  # Returns the value of attribute selector.
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/connections/collection.rb#43
  def selector; end

  # source://opensearch-transport//lib/opensearch/transport/transport/connections/collection.rb#108
  def size; end
...
# source://opensearch-transport//lib/opensearch/transport/transport/connections/collection.rb#41
...
#
# source://opensearch-transport//lib/opensearch/transport/transport/connections/connection.rb#41
class OpenSearch::Transport::Transport::Connections::Connection
  ...
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/connections/connection.rb#50
  def initialize(arguments = T.unsafe(nil)); end
  ...
  # @return [Boolean]
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/connections/connection.rb#152
  def ==(other); end
  ...
  # @return [self]
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/connections/connection.rb#109
  def alive!; end

  # Returns the value of attribute connection.
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/connections/connection.rb#44
  def connection; end
  ...
  # @return [self]
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/connections/connection.rb#96
  def dead!; end
  ...
  # @return [Boolean]
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/connections/connection.rb#87
  def dead?; end
  ...
  # @return [String]
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/connections/connection.rb#79
  ...
  # @return [String]
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/connections/connection.rb#65
  ...
  # @return [self]
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/connections/connection.rb#120
  def healthy!; end
  ...
  # @see #resurrectable?
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/connections/connection.rb#134
  def resurrect!; end
  ...
  # @return [Boolean]
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/connections/connection.rb#142
  def resurrectable?; end

  # @return [String]
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/connections/connection.rb#161
  def to_s; end
end

# source://opensearch-transport//lib/opensearch/transport/transport/connections/connection.rb#42
OpenSearch::Transport::Transport::Connections::Connection::DEFAULT_RESURRECT_TIMEOUT = T.let(T.unsafe(nil), Integer)

# source://opensearch-transport//lib/opensearch/transport/transport/connections/selector.rb#31
...
#
# source://opensearch-transport//lib/opensearch/transport/transport/connections/selector.rb#35
module OpenSearch::Transport::Transport::Connections::Selector::Base
  # @option arguments
  # @param arguments [Hash] a customizable set of options
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/connections/selector.rb#40
  def initialize(arguments = T.unsafe(nil)); end

  # Returns the value of attribute connections.
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/connections/selector.rb#36
  def connections; end
  ...
  # @return [Connection]
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/connections/selector.rb#49
  def select(options = T.unsafe(nil)); end
end

# "Random connection" selector strategy.
#
# source://opensearch-transport//lib/opensearch/transport/transport/connections/selector.rb#56
class OpenSearch::Transport::Transport::Connections::Selector::Random
  ...
  # @return [Connections::Connection]
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/connections/selector.rb#63
  def select(options = T.unsafe(nil)); end
end

# "Round-robin" selector strategy (default).
#
# source://opensearch-transport//lib/opensearch/transport/transport/connections/selector.rb#70
class OpenSearch::Transport::Transport::Connections::Selector::RoundRobin
  ...
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/connections/selector.rb#75
  def initialize(arguments = T.unsafe(nil)); end
  ...
  # @return [Connections::Connection]
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/connections/selector.rb#85
  def select(options = T.unsafe(nil)); end
end

# source://opensearch-transport//lib/opensearch/transport/transport/errors.rb#92
OpenSearch::Transport::Transport::ERRORS = T.let(T.unsafe(nil), Hash)

# Generic client error
#
# source://opensearch-transport//lib/opensearch/transport/transport/errors.rb#33
class OpenSearch::Transport::Transport::Error < ::StandardError; end

# source://opensearch-transport//lib/opensearch/transport/transport/errors.rb#43
module OpenSearch::Transport::Transport::Errors; end

# source://opensearch-transport//lib/opensearch/transport/transport/errors.rb#94
...
# source://opensearch-transport//lib/opensearch/transport/transport/http/faraday.rb#30
...
# @see Transport::Base
#
# source://opensearch-transport//lib/opensearch/transport/transport/http/faraday.rb#36
class OpenSearch::Transport::Transport::HTTP::Faraday
  ...
  # @return [Connections::Connection]
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/http/faraday.rb#71
  def __build_connection(host, options = T.unsafe(nil), block = T.unsafe(nil)); end
  ...
  # @return [Array]
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/http/faraday.rb#81
  def host_unreachable_exceptions; end
  ...
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/http/faraday.rb#44
  def perform_request(method, path, params = T.unsafe(nil), body = T.unsafe(nil), headers = T.unsafe(nil), opts = T.unsafe(nil)); end

  private

  # source://opensearch-transport//lib/opensearch/transport/transport/http/faraday.rb#87
  def user_agent_header(client); end
end

# source://opensearch-transport//lib/opensearch/transport/transport/errors.rb#45
OpenSearch::Transport::Transport::HTTP_STATUSES = T.let(T.unsafe(nil), Hash)

# Wraps the response from OpenSearch.
#
# source://opensearch-transport//lib/opensearch/transport/transport/response.rb#32
class OpenSearch::Transport::Transport::Response
  ...
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/response.rb#38
  def initialize(status, body, headers = T.unsafe(nil)); end

  # Returns the value of attribute body.
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/response.rb#33
  def body; end
...
# source://opensearch-transport//lib/opensearch/transport/transport/serializer/multi_json.rb#30
module OpenSearch::Transport::Transport::Serializer; end

# An abstract class for implementing serializer implementations
#
# source://opensearch-transport//lib/opensearch/transport/transport/serializer/multi_json.rb#34
module OpenSearch::Transport::Transport::Serializer::Base
  ...
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/serializer/multi_json.rb#37
  def initialize(transport = T.unsafe(nil)); end
end

# A default JSON serializer (using [MultiJSON](http://rubygems.org/gems/multi_json))
#
# source://opensearch-transport//lib/opensearch/transport/transport/serializer/multi_json.rb#44
class OpenSearch::Transport::Transport::Serializer::MultiJson
  include ::OpenSearch::Transport::Transport::Serializer::Base

  # Serialize a Hash to JSON string
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/serializer/multi_json.rb#55
  def dump(object, options = T.unsafe(nil)); end

  # De-serialize a Hash from JSON string
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/serializer/multi_json.rb#49
  def load(string, options = T.unsafe(nil)); end
end

# Elasticsearch server error (HTTP status 5xx)
#
# source://opensearch-transport//lib/opensearch/transport/transport/errors.rb#41
class OpenSearch::Transport::Transport::ServerError < ::OpenSearch::Transport::Transport::Error; end

# Handles node discovery ("sniffing")
#
# source://opensearch-transport//lib/opensearch/transport/transport/sniffer.rb#33
class OpenSearch::Transport::Transport::Sniffer
  ...
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/sniffer.rb#41
  ...
  # @return [Array<Hash>]
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/sniffer.rb#55
  def hosts; end

  # Returns the value of attribute timeout.
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/sniffer.rb#37
  def timeout; end
  ...
  #
  # source://opensearch-transport//lib/opensearch/transport/transport/sniffer.rb#36
  def transport; end

  private

  # source://opensearch-transport//lib/opensearch/transport/transport/sniffer.rb#98
  def parse_address_port(publish_address); end

  # source://opensearch-transport//lib/opensearch/transport/transport/sniffer.rb#88
  def parse_publish_address(publish_address); end

  # source://opensearch-transport//lib/opensearch/transport/transport/sniffer.rb#81
  def perform_sniff_request; end
end

# source://opensearch-transport//lib/opensearch/transport/transport/sniffer.rb#34
OpenSearch::Transport::Transport::Sniffer::PROTOCOL = T.let(T.unsafe(nil), String)

# Reloading connections timeout (1 sec by default)
#
# source://opensearch-transport//lib/opensearch/transport/transport/errors.rb#37
class OpenSearch::Transport::Transport::SnifferTimeoutError < ::Timeout::Error; end

# source://opensearch-transport//lib/opensearch/transport/version.rb#29
