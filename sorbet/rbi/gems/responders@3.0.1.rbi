...
# source://responders-3.0.1/lib/responders.rb:6
...
# source://responders-3.0.1/lib/action_controller/respond_with.rb:7
module ActionController::RespondWith
  ...
  #
  # source://responders-3.0.1/lib/action_controller/respond_with.rb:198
  ...
  # current action.
  #
  # source://responders-3.0.1/lib/action_controller/respond_with.rb:242
  ...
  #   end
  #
  # source://responders-3.0.1/lib/action_controller/respond_with.rb:229
...
# source://responders-3.0.1/lib/action_controller/respond_with.rb:16
module ActionController::RespondWith::ClassMethods
  # Clear all mime types in <tt>respond_to</tt>.
  #
  # source://responders-3.0.1/lib/action_controller/respond_with.rb:57
  ...
  # to <tt>:json</tt>.
  #
  # source://responders-3.0.1/lib/action_controller/respond_with.rb:39
...
#
# source://responders-3.0.1/lib/action_controller/responder.rb:122
class ActionController::Responder
  # @return [Responder] a new instance of Responder
  #
  # source://responders-3.0.1/lib/action_controller/responder.rb:131
  def initialize(controller, resources, options = T.unsafe(nil)); end

  # Returns the value of attribute controller.
  #
  # source://responders-3.0.1/lib/action_controller/responder.rb:123
  def controller; end

  # source://responders-3.0.1/lib/action_controller/responder.rb:148
  ...
  # source://responders-3.0.1/lib/action_controller/responder.rb:147
  ...
  #
  # source://responders-3.0.1/lib/action_controller/responder.rb:163
  def respond; end
  ...
  #
  # source://responders-3.0.1/lib/action_controller/responder.rb:186
  def to_format; end

  # HTML format does not render the resource, it always attempt to render a
  # template.
  #
  # source://responders-3.0.1/lib/action_controller/responder.rb:171
  def to_html; end

  # to_js simply tries to render a template. If no template is found, raises the error.
  #
  # source://responders-3.0.1/lib/action_controller/responder.rb:178
  def to_js; end
  ...
  #
  # source://responders-3.0.1/lib/action_controller/responder.rb:212
  def api_behavior; end

  # Returns the resource location by retrieving it from the options or
  # returning the resources array.
  #
  # source://responders-3.0.1/lib/action_controller/responder.rb:227
  def api_location; end

  # By default, render the <code>:edit</code> action for HTML requests with errors, unless
  # the verb was POST.
  #
  # source://responders-3.0.1/lib/action_controller/responder.rb:287
  def default_action; end

  # If a response block was given, use it, otherwise call render on
  # controller.
  #
  # source://responders-3.0.1/lib/action_controller/responder.rb:236
  ...
  #
  # source://responders-3.0.1/lib/action_controller/responder.rb:261
  def display(resource, given_options = T.unsafe(nil)); end

  # source://responders-3.0.1/lib/action_controller/responder.rb:265
  ...
  # @return [Boolean]
  #
  # source://responders-3.0.1/lib/action_controller/responder.rb:271
  def has_errors?; end
  ...
  # @return [Boolean]
  #
  # source://responders-3.0.1/lib/action_controller/responder.rb:276
  def has_renderer?; end

  # @return [Boolean]
  #
  # source://responders-3.0.1/lib/action_controller/responder.rb:280
  def has_view_rendering?; end

  # source://responders-3.0.1/lib/action_controller/responder.rb:295
  def json_resource_errors; end

  # This is the common behavior for formats associated with browsing, like :html, :iphone and so forth.
  #
  # source://responders-3.0.1/lib/action_controller/responder.rb:201
  ...
  # source://responders-3.0.1/lib/action_controller/responder.rb:303
  def rendering_options; end

  # source://responders-3.0.1/lib/action_controller/responder.rb:291
  ...
  # @return [Boolean]
  #
  # source://responders-3.0.1/lib/action_controller/responder.rb:299
  ...
  class << self
    ...
    #
    # source://responders-3.0.1/lib/action_controller/responder.rb:157
    def call(*args); end
  end
end

# source://responders-3.0.1/lib/action_controller/responder.rb:125
ActionController::Responder::DEFAULT_ACTIONS_FOR_VERBS = T.let(T.unsafe(nil), Hash)

# source://responders-3.0.1/lib/responders.rb:11
module Responders; end

# This responder modifies your current responder to redirect
# to the collection page on POST/PUT/DELETE.
#
# source://responders-3.0.1/lib/responders/collection_responder.rb:6
module Responders::CollectionResponder
  ...
  #
  # source://responders-3.0.1/lib/responders/collection_responder.rb:21
  def navigation_location; end
end

# source://responders-3.0.1/lib/responders/controller_method.rb:4
module Responders::ControllerMethod
  ...
  #
  # source://responders-3.0.1/lib/responders/controller_method.rb:21
...
# and :alert.
#
# source://responders-3.0.1/lib/responders/flash_responder.rb:87
module Responders::FlashResponder
  # source://responders-3.0.1/lib/responders/flash_responder.rb:99
  def initialize(controller, resources, options = T.unsafe(nil)); end

  # source://responders-3.0.1/lib/responders/flash_responder.rb:107
  def to_html; end

  # source://responders-3.0.1/lib/responders/flash_responder.rb:112
  def to_js; end

  protected

  # source://responders-3.0.1/lib/responders/flash_responder.rb:166
  def controller_interpolation_options; end

  # source://responders-3.0.1/lib/responders/flash_responder.rb:183
  def flash_defaults_by_namespace(status); end

  # source://responders-3.0.1/lib/responders/flash_responder.rb:151
  def mount_i18n_options(status); end

  # source://responders-3.0.1/lib/responders/flash_responder.rb:175
  def resource_name; end

  # source://responders-3.0.1/lib/responders/flash_responder.rb:135
  def set_flash(key, value); end

  # source://responders-3.0.1/lib/responders/flash_responder.rb:119
  def set_flash_message!; end

  # @return [Boolean]
  #
  # source://responders-3.0.1/lib/responders/flash_responder.rb:147
  def set_flash_message?; end

  # @return [Boolean]
  #
  # source://responders-3.0.1/lib/responders/flash_responder.rb:142
  def set_flash_now?; end

  class << self
    # Returns the value of attribute flash_keys.
    #
    # source://responders-3.0.1/lib/responders/flash_responder.rb:89
    def flash_keys; end
...
#
# source://responders-3.0.1/lib/responders/http_cache_responder.rb:13
module Responders::HttpCacheResponder
  # source://responders-3.0.1/lib/responders/http_cache_responder.rb:14
  def initialize(controller, resources, options = T.unsafe(nil)); end

  # source://responders-3.0.1/lib/responders/http_cache_responder.rb:19
  def to_format; end

  protected

  # source://responders-3.0.1/lib/responders/http_cache_responder.rb:26
  def do_http_cache!; end

  # @return [Boolean]
  #
  # source://responders-3.0.1/lib/responders/http_cache_responder.rb:37
  def do_http_cache?; end

  # @return [Boolean]
  #
  # source://responders-3.0.1/lib/responders/http_cache_responder.rb:42
  def persisted?; end
end

# source://responders-3.0.1/lib/responders/location_responder.rb:4
module Responders::LocationResponder
  class << self
    # @private
    #
    # source://responders-3.0.1/lib/responders/location_responder.rb:5
    def included(_base); end
  end
end

# source://responders-3.0.1/lib/responders.rb:19
