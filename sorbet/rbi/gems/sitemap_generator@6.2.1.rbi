...
#
# source://sitemap_generator-6.2.1/lib/sitemap_generator/adapters/aws_sdk_adapter.rb:8
class SitemapGenerator::AwsSdkAdapter
  ...
  #
  # source://sitemap_generator-6.2.1/lib/sitemap_generator/adapters/aws_sdk_adapter.rb:28
  def initialize(bucket, aws_access_key_id: T.unsafe(nil), aws_secret_access_key: T.unsafe(nil), aws_region: T.unsafe(nil), aws_endpoint: T.unsafe(nil), **options); end

  # Call with a SitemapLocation and string data
  #
  # source://sitemap_generator-6.2.1/lib/sitemap_generator/adapters/aws_sdk_adapter.rb:39
  def write(location, raw_data); end

  private

  # source://sitemap_generator-6.2.1/lib/sitemap_generator/adapters/aws_sdk_adapter.rb:55
  def s3_resource; end

  # source://sitemap_generator-6.2.1/lib/sitemap_generator/adapters/aws_sdk_adapter.rb:51
