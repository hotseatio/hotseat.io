...
# source://hashie-5.0.0/lib/hashie/extensions/stringify_keys.rb:1
module Hashie
...
# source://hashie-5.0.0/lib/hashie/array.rb:5
class Hashie::Array < ::Array
  ...
  # source://hashie-5.0.0/lib/hashie/array.rb:9
  def dig(*indexes); end

  # source://hashie-5.0.0/lib/hashie/extensions/array/pretty_inspect.rb:10
  def inspect; end
end
...
# for keys.
#
# source://hashie-5.0.0/lib/hashie/clash.rb:24
class Hashie::Clash < ::Hash
  ...
  #
  # source://hashie-5.0.0/lib/hashie/clash.rb:32
  ...
  # c.baz!._end! # => c
  #
  # source://hashie-5.0.0/lib/hashie/clash.rb:45
  def _end!; end

  # The parent Clash if this Clash was created via chaining.
  #
  # source://hashie-5.0.0/lib/hashie/clash.rb:27
  def _parent; end

  # source://hashie-5.0.0/lib/hashie/clash.rb:49
  def id(*args); end

  # source://hashie-5.0.0/lib/hashie/clash.rb:53
  def merge_store(key, *args); end

  # source://hashie-5.0.0/lib/hashie/clash.rb:66
...
#
# source://hashie-5.0.0/lib/hashie/dash.rb:15
class Hashie::Dash < ::Hashie::Hash
  ...
  #
  # source://hashie-5.0.0/lib/hashie/dash.rb:104
  def initialize(attributes = T.unsafe(nil), &block); end

  # Retrieve a value from the Dash (will return the
  # property's default value if it hasn't been set).
  #
  # source://hashie-5.0.0/lib/hashie/dash.rb:117
  def [](property); end

  # Set a value on the Dash in a Hash-like way. Only works
  # on pre-existing properties.
  #
  # source://hashie-5.0.0/lib/hashie/dash.rb:131
  ...
  # source://hashie-5.0.0/lib/hashie/dash.rb:137
  def merge(other_hash); end

  # source://hashie-5.0.0/lib/hashie/dash.rb:145
  def merge!(other_hash); end

  # source://hashie-5.0.0/lib/hashie/dash.rb:152
  def replace(other_hash); end

  # source://hashie-5.0.0/lib/hashie/dash.rb:159
  def to_h; end
  ...
  # source://hashie-5.0.0/lib/hashie/dash.rb:166
  ...
  # source://hashie-5.0.0/lib/hashie/dash.rb:203
  def assert_property_exists!(property); end

  # source://hashie-5.0.0/lib/hashie/dash.rb:217
  def assert_property_required!(property, value); end

  # source://hashie-5.0.0/lib/hashie/dash.rb:213
  def assert_property_set!(property); end

  # source://hashie-5.0.0/lib/hashie/dash.rb:207
  def assert_required_attributes_set!; end

  # @raise [NoMethodError]
  #
  # source://hashie-5.0.0/lib/hashie/dash.rb:226
  def fail_no_property_error!(property); end

  # @raise [ArgumentError]
  #
  # source://hashie-5.0.0/lib/hashie/dash.rb:221
  def fail_property_required_error!(property); end

  # source://hashie-5.0.0/lib/hashie/dash.rb:188
  def initialize_attributes(attributes); end

  # @return [Boolean]
  #
  # source://hashie-5.0.0/lib/hashie/dash.rb:230
  def required?(property); end

  # source://hashie-5.0.0/lib/hashie/dash.rb:195
  def update_attributes(attributes); end

  class << self
    # Returns the value of attribute defaults.
    #
    # source://hashie-5.0.0/lib/hashie/dash.rb:60
    def defaults; end

    # Returns the value of attribute getters.
    #
    # source://hashie-5.0.0/lib/hashie/dash.rb:61
    def getters; end

    # @private
    #
    # source://hashie-5.0.0/lib/hashie/dash.rb:69
    ...
    #
    # source://hashie-5.0.0/lib/hashie/dash.rb:36
    ...
    # @return [Boolean]
    #
    # source://hashie-5.0.0/lib/hashie/dash.rb:80
    ...
    # @return [Boolean]
    #
    # source://hashie-5.0.0/lib/hashie/dash.rb:86
    def required?(name); end

    # Returns the value of attribute required_properties.
    #
    # source://hashie-5.0.0/lib/hashie/dash.rb:62
    def required_properties; end

    private

    # source://hashie-5.0.0/lib/hashie/dash.rb:90
    def define_getter_for(property_name); end

    # source://hashie-5.0.0/lib/hashie/dash.rb:96
    def define_setter_for(property_name); end
  end
end

# source://hashie-5.0.0/lib/hashie/extensions/stringify_keys.rb:2
module Hashie::Extensions; end

# source://hashie-5.0.0/lib/hashie/extensions/array/pretty_inspect.rb:3
module Hashie::Extensions::Array; end

# source://hashie-5.0.0/lib/hashie/extensions/array/pretty_inspect.rb:4
module Hashie::Extensions::Array::PrettyInspect
  ...
  class << self
    # @private
    #
    # source://hashie-5.0.0/lib/hashie/extensions/array/pretty_inspect.rb:5
    def included(base); end
  end
end

# source://hashie-5.0.0/lib/hashie/extensions/coercion.rb:9
module Hashie::Extensions::Coercion
  ...
  class << self
    # @private
    #
    # source://hashie-5.0.0/lib/hashie/extensions/coercion.rb:29
    def included(base); end
  end
end

# source://hashie-5.0.0/lib/hashie/extensions/coercion.rb:19
Hashie::Extensions::Coercion::ABSTRACT_CORE_TYPES = T.let(T.unsafe(nil), Hash)

# source://hashie-5.0.0/lib/hashie/extensions/coercion.rb:10
Hashie::Extensions::Coercion::CORE_TYPES = T.let(T.unsafe(nil), Hash)

# source://hashie-5.0.0/lib/hashie/extensions/coercion.rb:64
module Hashie::Extensions::Coercion::ClassMethods
  # source://hashie-5.0.0/lib/hashie/extensions/coercion.rb:167
  def build_coercion(type); end

  # source://hashie-5.0.0/lib/hashie/extensions/coercion.rb:202
  def build_container_coercion(type, value_type); end

  # source://hashie-5.0.0/lib/hashie/extensions/coercion.rb:209
  def build_core_type_coercion(type); end

  # source://hashie-5.0.0/lib/hashie/extensions/coercion.rb:194
  ...
  #
  # source://hashie-5.0.0/lib/hashie/extensions/coercion.rb:82
  ...
  #
  # source://hashie-5.0.0/lib/hashie/extensions/coercion.rb:121
  def coerce_value(from, into, options = T.unsafe(nil)); end

  # source://hashie-5.0.0/lib/hashie/extensions/coercion.rb:161
  def coercion_cache; end

  # source://hashie-5.0.0/lib/hashie/extensions/coercion.rb:156
  def fetch_coercion(type); end

  # source://hashie-5.0.0/lib/hashie/extensions/coercion.rb:217
  def inherited(klass); end

  # Returns the specific key coercion for the specified key,
  # if one exists.
  #
  # source://hashie-5.0.0/lib/hashie/extensions/coercion.rb:96
  def key_coercion(key); end

  # Returns a hash of any existing key coercions.
  #
  # source://hashie-5.0.0/lib/hashie/extensions/coercion.rb:90
  def key_coercions; end

  # Return all value coercions that have the :strict rule as false.
  #
  # source://hashie-5.0.0/lib/hashie/extensions/coercion.rb:146
  def lenient_value_coercions; end

  # Return all value coercions that have the :strict rule as true.
  #
  # source://hashie-5.0.0/lib/hashie/extensions/coercion.rb:141
  def strict_value_coercions; end

  # Fetch the value coercion, if any, for the specified object.
  #
  # source://hashie-5.0.0/lib/hashie/extensions/coercion.rb:151
  ...
  #
  # source://hashie-5.0.0/lib/hashie/extensions/coercion.rb:65
  def key_coercions=(_arg0); end
end

# source://hashie-5.0.0/lib/hashie/extensions/coercion.rb:38
module Hashie::Extensions::Coercion::InstanceMethods
  # source://hashie-5.0.0/lib/hashie/extensions/coercion.rb:53
  def custom_writer(key, value, _convert = T.unsafe(nil)); end

  # source://hashie-5.0.0/lib/hashie/extensions/coercion.rb:57
  def replace(other_hash); end

  # source://hashie-5.0.0/lib/hashie/extensions/coercion.rb:39
  def set_value_with_coercion(key, value); end
end

# source://hashie-5.0.0/lib/hashie.rb:40
module Hashie::Extensions::Dash; end

# source://hashie-5.0.0/lib/hashie/extensions/dash/coercion.rb:4
module Hashie::Extensions::Dash::Coercion
  ...
  class << self
    ...
    #
    # source://hashie-5.0.0/lib/hashie/extensions/dash/coercion.rb:7
    def included(base); end
  end
end

# source://hashie-5.0.0/lib/hashie/extensions/dash/coercion.rb:12
module Hashie::Extensions::Dash::Coercion::ClassMethods
  ...
  #
  # source://hashie-5.0.0/lib/hashie/extensions/dash/coercion.rb:17
  def property(property_name, options = T.unsafe(nil)); end
end

# source://hashie-5.0.0/lib/hashie/extensions/dash/indifferent_access.rb:4
module Hashie::Extensions::Dash::IndifferentAccess
  ...
  # source://hashie-5.0.0/lib/hashie/extensions/dash/indifferent_access.rb:22
  def to_h; end
  ...
  class << self
    # @private
    #
    # source://hashie-5.0.0/lib/hashie/extensions/dash/indifferent_access.rb:5
    def included(base); end

    # source://hashie-5.0.0/lib/hashie/extensions/dash/indifferent_access.rb:10
    ...
    # @return [Boolean]
    #
    # source://hashie-5.0.0/lib/hashie/extensions/dash/indifferent_access.rb:16
    def requires_class_methods?(klass); end
  end
end

# source://hashie-5.0.0/lib/hashie/extensions/dash/indifferent_access.rb:31
module Hashie::Extensions::Dash::IndifferentAccess::ClassMethods
  ...
  # @return [Boolean]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/dash/indifferent_access.rb:34
  def property?(name); end

  # @return [Boolean]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/dash/indifferent_access.rb:50
  def transformation_exists?(name); end

  # source://hashie-5.0.0/lib/hashie/extensions/dash/indifferent_access.rb:45
  def transformed_property(property_name, value); end

  # @return [Boolean]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/dash/indifferent_access.rb:40
  ...
  # @return [Boolean]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/dash/indifferent_access.rb:57
...
#
# source://hashie-5.0.0/lib/hashie/extensions/dash/predefined_values.rb:17
module Hashie::Extensions::Dash::PredefinedValues
  ...
  class << self
    # @private
    #
    # source://hashie-5.0.0/lib/hashie/extensions/dash/predefined_values.rb:18
    def included(base); end
  end
end

# source://hashie-5.0.0/lib/hashie/extensions/dash/predefined_values.rb:24
module Hashie::Extensions::Dash::PredefinedValues::ClassMethods
  # source://hashie-5.0.0/lib/hashie/extensions/dash/predefined_values.rb:27
  def inherited(klass); end

  # source://hashie-5.0.0/lib/hashie/extensions/dash/predefined_values.rb:32
  def property(property_name, options = T.unsafe(nil)); end

  # Returns the value of attribute values_for_properties.
  #
  # source://hashie-5.0.0/lib/hashie/extensions/dash/predefined_values.rb:25
  ...
  # @raise [ArgumentError]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/dash/predefined_values.rb:43
  def assert_predefined_values!(predefined_values); end

  # source://hashie-5.0.0/lib/hashie/extensions/dash/predefined_values.rb:53
  def set_predefined_values(property_name, predefined_values); end

  # @return [Boolean]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/dash/predefined_values.rb:49
  def supported_type?(predefined_values); end
end

# source://hashie-5.0.0/lib/hashie/extensions/dash/predefined_values.rb:58
module Hashie::Extensions::Dash::PredefinedValues::InstanceMethods
  # source://hashie-5.0.0/lib/hashie/extensions/dash/predefined_values.rb:59
  def initialize(*_arg0); end

  private

  # source://hashie-5.0.0/lib/hashie/extensions/dash/predefined_values.rb:67
  def assert_property_values!; end

  # @raise [ArgumentError]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/dash/predefined_values.rb:77
  def fail_property_value_error!(property); end

  # source://hashie-5.0.0/lib/hashie/extensions/dash/predefined_values.rb:81
...
#
# source://hashie-5.0.0/lib/hashie/extensions/dash/property_translation.rb:40
module Hashie::Extensions::Dash::PropertyTranslation
  ...
  class << self
    # @private
    #
    # source://hashie-5.0.0/lib/hashie/extensions/dash/property_translation.rb:41
    def included(base); end
  end
end

# source://hashie-5.0.0/lib/hashie/extensions/dash/property_translation.rb:48
module Hashie::Extensions::Dash::PropertyTranslation::ClassMethods
  ...
  #
  # source://hashie-5.0.0/lib/hashie/extensions/dash/property_translation.rb:54
  def inherited(klass); end

  # source://hashie-5.0.0/lib/hashie/extensions/dash/property_translation.rb:115
  def inverse_translations; end

  # source://hashie-5.0.0/lib/hashie/extensions/dash/property_translation.rb:60
  ...
  #
  # source://hashie-5.0.0/lib/hashie/extensions/dash/property_translation.rb:74
  def property(property_name, options = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/dash/property_translation.rb:94
  def transformation_exists?(name); end

  # source://hashie-5.0.0/lib/hashie/extensions/dash/property_translation.rb:90
  def transformed_property(property_name, value); end

  # Returns the value of attribute transforms.
  #
  # source://hashie-5.0.0/lib/hashie/extensions/dash/property_translation.rb:49
  def transforms; end

  # @return [Boolean]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/dash/property_translation.rb:98
  def translation_exists?(name); end

  # source://hashie-5.0.0/lib/hashie/extensions/dash/property_translation.rb:102
  ...
  # source://hashie-5.0.0/lib/hashie/extensions/dash/property_translation.rb:127
  def define_translation(from, property_name, translator); end

  # source://hashie-5.0.0/lib/hashie/extensions/dash/property_translation.rb:131
  def define_writer_for_source_property(property); end

  # @raise [ArgumentError]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/dash/property_translation.rb:139
  def fail_self_transformation_error!(property_name); end

  # @return [Boolean]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/dash/property_translation.rb:144
  def valid_transformer?(transformer); end
end

# source://hashie-5.0.0/lib/hashie/extensions/dash/property_translation.rb:149
module Hashie::Extensions::Dash::PropertyTranslation::InstanceMethods
  ...
  #
  # source://hashie-5.0.0/lib/hashie/extensions/dash/property_translation.rb:153
  def []=(property, value); end

  # Deletes any keys that have a translation
  #
  # source://hashie-5.0.0/lib/hashie/extensions/dash/property_translation.rb:170
  def initialize_attributes(attributes); end
  ...
  # @return [Boolean]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/dash/property_translation.rb:182
  def property_exists?(property); end

  private

  # source://hashie-5.0.0/lib/hashie/extensions/dash/property_translation.rb:189
...
#   or params hashes.
#
# source://hashie-5.0.0/lib/hashie/extensions/deep_fetch.rb:14
module Hashie::Extensions::DeepFetch
  # source://hashie-5.0.0/lib/hashie/extensions/deep_fetch.rb:17
  def deep_fetch(*args, &block); end
end

# source://hashie-5.0.0/lib/hashie/extensions/deep_fetch.rb:15
class Hashie::Extensions::DeepFetch::UndefinedPathError < ::StandardError; end

# source://hashie-5.0.0/lib/hashie/extensions/deep_find.rb:4
module Hashie::Extensions::DeepFind
  ...
  #
  # source://hashie-5.0.0/lib/hashie/extensions/deep_find.rb:19
  ...
  #
  # source://hashie-5.0.0/lib/hashie/extensions/deep_find.rb:47
  ...
  # source://hashie-5.0.0/lib/hashie/extensions/deep_find.rb:56
  def _deep_find(key, object = T.unsafe(nil)); end

  # source://hashie-5.0.0/lib/hashie/extensions/deep_find.rb:60
  def _deep_find_all(key, object = T.unsafe(nil), matches = T.unsafe(nil)); end
end

# source://hashie-5.0.0/lib/hashie/extensions/deep_locate.rb:3
module Hashie::Extensions::DeepLocate
  ...
  #
  # source://hashie-5.0.0/lib/hashie/extensions/deep_locate.rb:64
  ...
  class << self
    ...
    #   # => [{:title=>"Ruby for beginners", :pages=>120}, ...]
    #
    # source://hashie-5.0.0/lib/hashie/extensions/deep_locate.rb:19
    def deep_locate(comparator, object); end

    private

    # source://hashie-5.0.0/lib/hashie/extensions/deep_locate.rb:68
    def _construct_key_comparator(search_key, object); end

    # source://hashie-5.0.0/lib/hashie/extensions/deep_locate.rb:80
    def _deep_locate(comparator, object, result = T.unsafe(nil)); end

    # @return [Boolean]
    #
    # source://hashie-5.0.0/lib/hashie/extensions/deep_locate.rb:95
    def _match_comparator?(value, comparator, object); end

    # @return [Boolean]
    #
    # source://hashie-5.0.0/lib/hashie/extensions/deep_locate.rb:106
    def activesupport_indifferent?(object); end
  end
end

# source://hashie-5.0.0/lib/hashie/extensions/deep_merge.rb:3
module Hashie::Extensions::DeepMerge
  # Returns a new hash with +self+ and +other_hash+ merged recursively.
  #
  # source://hashie-5.0.0/lib/hashie/extensions/deep_merge.rb:5
  def deep_merge(other_hash, &block); end

  # Returns a new hash with +self+ and +other_hash+ merged recursively.
  # Modifies the receiver in place.
  #
  # source://hashie-5.0.0/lib/hashie/extensions/deep_merge.rb:13
  def deep_merge!(other_hash, &block); end

  private

  # source://hashie-5.0.0/lib/hashie/extensions/deep_merge.rb:21
  def _deep_dup(hash); end

  # source://hashie-5.0.0/lib/hashie/extensions/deep_merge.rb:36
...
#
# source://hashie-5.0.0/lib/hashie/extensions/ignore_undeclared.rb:31
module Hashie::Extensions::IgnoreUndeclared
  # source://hashie-5.0.0/lib/hashie/extensions/ignore_undeclared.rb:32
  def initialize_attributes(attributes); end

  # @return [Boolean]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/ignore_undeclared.rb:41
  def property_exists?(property); end
end
...
#   h['baz'] # => 'blip'
#
# source://hashie-5.0.0/lib/hashie/extensions/indifferent_access.rb:25
module Hashie::Extensions::IndifferentAccess
  ...
  #
  # source://hashie-5.0.0/lib/hashie/extensions/indifferent_access.rb:82
  def convert!; end

  # source://hashie-5.0.0/lib/hashie/extensions/indifferent_access.rb:75
  def convert_key(key); end

  # source://hashie-5.0.0/lib/hashie/extensions/indifferent_access.rb:171
  def except(*keys); end

  # @return [Boolean]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/indifferent_access.rb:131
  ...
  # source://hashie-5.0.0/lib/hashie/extensions/indifferent_access.rb:89
  ...
  # source://hashie-5.0.0/lib/hashie/extensions/indifferent_access.rb:141
  def merge(*args); end

  # source://hashie-5.0.0/lib/hashie/extensions/indifferent_access.rb:147
  def merge!(*_arg0); end

  # source://hashie-5.0.0/lib/hashie/extensions/indifferent_access.rb:164
  def slice(*keys); end

  # source://hashie-5.0.0/lib/hashie/extensions/indifferent_access.rb:151
  def to_hash; end
  ...
  # @return [Boolean]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/indifferent_access.rb:179
  def hash_lacking_indifference?(other); end

  # @return [Boolean]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/indifferent_access.rb:185
  def hash_with_indifference?(other); end

  class << self
    # @api private
    #
    # source://hashie-5.0.0/lib/hashie/extensions/indifferent_access.rb:29
    def convert_key(key); end

    # @private
    #
    # source://hashie-5.0.0/lib/hashie/extensions/indifferent_access.rb:33
    def included(base); end

    # Injects indifferent access into a duplicate of the hash
    # provided. See #inject!
    #
    # source://hashie-5.0.0/lib/hashie/extensions/indifferent_access.rb:71
    def inject(hash); end
    ...
    #
    # source://hashie-5.0.0/lib/hashie/extensions/indifferent_access.rb:64
    def inject!(hash); end
  end
end

# source://hashie-5.0.0/lib/hashie/extensions/key_conflict_warning.rb:3
module Hashie::Extensions::KeyConflictWarning
  ...
  # @return [void]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/key_conflict_warning.rb:17
  ...
  # @return [Boolean]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/key_conflict_warning.rb:32
  ...
  # @return [Boolean]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/key_conflict_warning.rb:41
  ...
  # @return [void]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/key_conflict_warning.rb:49
  def inherited(subclass); end
end

# source://hashie-5.0.0/lib/hashie/extensions/key_conflict_warning.rb:4
class Hashie::Extensions::KeyConflictWarning::CannotDisableMashWarnings < ::StandardError
  ...
  #
  # source://hashie-5.0.0/lib/hashie/extensions/key_conflict_warning.rb:5
  def initialize; end
end

# source://hashie-5.0.0/lib/hashie/extensions/key_conversion.rb:3
module Hashie::Extensions::KeyConversion
  ...
  class << self
    # @private
    #
    # source://hashie-5.0.0/lib/hashie/extensions/key_conversion.rb:4
    def included(base); end
  end
end

# source://hashie-5.0.0/lib/hashie.rb:47
module Hashie::Extensions::Mash; end

# source://hashie-5.0.0/lib/hashie/extensions/mash/define_accessors.rb:4
module Hashie::Extensions::Mash::DefineAccessors
  class << self
    # @private
    #
    # source://hashie-5.0.0/lib/hashie/extensions/mash/define_accessors.rb:12
    def extended(obj); end

    # @private
    #
    # source://hashie-5.0.0/lib/hashie/extensions/mash/define_accessors.rb:5
    def included(klass); end
  end
end

# source://hashie-5.0.0/lib/hashie/extensions/mash/define_accessors.rb:16
class Hashie::Extensions::Mash::DefineAccessors::Ext < ::Module
  # @return [Ext] a new instance of Ext
  #
  # source://hashie-5.0.0/lib/hashie/extensions/mash/define_accessors.rb:17
  def initialize; end

  # source://hashie-5.0.0/lib/hashie/extensions/mash/define_accessors.rb:67
  def define_initializing_reader(key, method_name); end

  # source://hashie-5.0.0/lib/hashie/extensions/mash/define_accessors.rb:57
  def define_predicate(key, method_name); end

  # source://hashie-5.0.0/lib/hashie/extensions/mash/define_accessors.rb:37
  def define_reader(key, method_name); end

  # source://hashie-5.0.0/lib/hashie/extensions/mash/define_accessors.rb:77
  def define_underbang_reader(key, method_name); end

  # source://hashie-5.0.0/lib/hashie/extensions/mash/define_accessors.rb:47
...
#
# source://hashie-5.0.0/lib/hashie/extensions/mash/keep_original_keys.rb:16
module Hashie::Extensions::Mash::KeepOriginalKeys
  ...
  #
  # source://hashie-5.0.0/lib/hashie/extensions/mash/keep_original_keys.rb:43
  ...
  #
  # source://hashie-5.0.0/lib/hashie/extensions/mash/keep_original_keys.rb:28
  def convert_key(key); end
  ...
  class << self
    ...
    # @raise [ArgumentError]
    #
    # source://hashie-5.0.0/lib/hashie/extensions/mash/keep_original_keys.rb:17
...
#
# source://hashie-5.0.0/lib/hashie/extensions/mash/permissive_respond_to.rb:28
module Hashie::Extensions::Mash::PermissiveRespondTo
  ...
  # @return [Boolean]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/mash/permissive_respond_to.rb:53
  ...
  # @return [Boolean]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/mash/permissive_respond_to.rb:43
  ...
  class << self
    ...
    # @return void
    #
    # source://hashie-5.0.0/lib/hashie/extensions/mash/permissive_respond_to.rb:34
    def included(base); end
  end
end

# source://hashie-5.0.0/lib/hashie/extensions/mash/safe_assignment.rb:4
module Hashie::Extensions::Mash::SafeAssignment
  # source://hashie-5.0.0/lib/hashie/extensions/mash/safe_assignment.rb:12
  def []=(*args); end

  # source://hashie-5.0.0/lib/hashie/extensions/mash/safe_assignment.rb:5
...
#   #=> {id: 123, name: "Rey"}
#
# source://hashie-5.0.0/lib/hashie/extensions/mash/symbolize_keys.rb:15
module Hashie::Extensions::Mash::SymbolizeKeys
  ...
  # @return [Symbol, K]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/mash/symbolize_keys.rb:32
  def convert_key(key); end
  ...
  class << self
    ...
    # @return [void]
    #
    # source://hashie-5.0.0/lib/hashie/extensions/mash/symbolize_keys.rb:21
    def included(base); end
  end
end
...
#   h[:abc] # => 'def'
#
# source://hashie-5.0.0/lib/hashie/extensions/merge_initializer.rb:17
module Hashie::Extensions::MergeInitializer
  # source://hashie-5.0.0/lib/hashie/extensions/merge_initializer.rb:18
...
#
# source://hashie-5.0.0/lib/hashie/extensions/method_access.rb:151
module Hashie::Extensions::MethodAccess
  ...
  class << self
    # @private
    #
    # source://hashie-5.0.0/lib/hashie/extensions/method_access.rb:152
    def included(base); end
  end
end
...
# underscores.
#
# source://hashie-5.0.0/lib/hashie/extensions/method_access.rb:234
module Hashie::Extensions::MethodAccessWithOverride
  ...
  class << self
    # @private
    #
    # source://hashie-5.0.0/lib/hashie/extensions/method_access.rb:235
    def included(base); end
  end
end
...
#
# source://hashie-5.0.0/lib/hashie/extensions/method_access.rb:255
module Hashie::Extensions::MethodOverridingInitializer
  include ::Hashie::Extensions::RedefineMethod

  # source://hashie-5.0.0/lib/hashie/extensions/method_access.rb:258
...
#
# source://hashie-5.0.0/lib/hashie/extensions/method_access.rb:199
module Hashie::Extensions::MethodOverridingWriter
  include ::Hashie::Extensions::RedefineMethod

  # source://hashie-5.0.0/lib/hashie/extensions/method_access.rb:202
  def convert_key(key); end

  # source://hashie-5.0.0/lib/hashie/extensions/method_access.rb:206
  def method_missing(name, *args); end
  ...
  # @return [Boolean]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/method_access.rb:223
  ...
  # @return [Boolean]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/method_access.rb:216
...
#   h.hji? # => NoMethodError
#
# source://hashie-5.0.0/lib/hashie/extensions/method_access.rb:108
module Hashie::Extensions::MethodQuery
  # source://hashie-5.0.0/lib/hashie/extensions/method_access.rb:117
  def method_missing(name, *args); end
  ...
  # @return [Boolean]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/method_access.rb:134
  def indifferent_key?(name); end

  # source://hashie-5.0.0/lib/hashie/extensions/method_access.rb:139
  def key_from_query_method(query_method); end

  # @return [Boolean]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/method_access.rb:143
  def query_method?(name); end

  # @return [Boolean]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/method_access.rb:109
  def respond_to_missing?(name, include_private = T.unsafe(nil)); end
end
...
#
# source://hashie-5.0.0/lib/hashie/extensions/method_access.rb:29
module Hashie::Extensions::MethodReader
  # source://hashie-5.0.0/lib/hashie/extensions/method_access.rb:35
  def method_missing(name, *args); end
  ...
  # @return [Boolean]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/method_access.rb:30
  def respond_to_missing?(name, include_private = T.unsafe(nil)); end
end
...
#   h['awesome'] # => 'sauce'
#
# source://hashie-5.0.0/lib/hashie/extensions/method_access.rb:69
module Hashie::Extensions::MethodWriter
  # source://hashie-5.0.0/lib/hashie/extensions/method_access.rb:83
  def convert_key(key); end

  # source://hashie-5.0.0/lib/hashie/extensions/method_access.rb:75
  def method_missing(name, *args); end
  ...
  # @return [Boolean]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/method_access.rb:70
  def respond_to_missing?(name, include_private = T.unsafe(nil)); end
end

# source://hashie-5.0.0/lib/hashie.rb:36
module Hashie::Extensions::Parsers; end

# source://hashie-5.0.0/lib/hashie/extensions/parsers/yaml_erb_parser.rb:8
class Hashie::Extensions::Parsers::YamlErbParser
  # @return [YamlErbParser] a new instance of YamlErbParser
  #
  # source://hashie-5.0.0/lib/hashie/extensions/parsers/yaml_erb_parser.rb:9
  def initialize(file_path, options = T.unsafe(nil)); end

  # source://hashie-5.0.0/lib/hashie/extensions/parsers/yaml_erb_parser.rb:15
  def perform; end

  private

  # source://hashie-5.0.0/lib/hashie/extensions/parsers/yaml_erb_parser.rb:32
  def yaml_safe_load(template, permitted_classes, permitted_symbols, aliases); end

  class << self
    # source://hashie-5.0.0/lib/hashie/extensions/parsers/yaml_erb_parser.rb:25
    def perform(file_path, options = T.unsafe(nil)); end
  end
end

# source://hashie-5.0.0/lib/hashie/extensions/pretty_inspect.rb:3
module Hashie::Extensions::PrettyInspect
  ...
  class << self
    # @private
    #
    # source://hashie-5.0.0/lib/hashie/extensions/pretty_inspect.rb:4
    def included(base); end
  end
end
...
#
# source://hashie-5.0.0/lib/hashie/extensions/method_access.rb:161
module Hashie::Extensions::RedefineMethod
  protected

  # @return [Boolean]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/method_access.rb:164
  def method?(name); end

  # source://hashie-5.0.0/lib/hashie/extensions/method_access.rb:168
  def redefine_method(method_name); end
end

# source://hashie-5.0.0/lib/hashie/extensions/ruby_version.rb:17
class Hashie::Extensions::RubyVersion
  include ::Comparable

  # @return [RubyVersion] a new instance of RubyVersion
  #
  # source://hashie-5.0.0/lib/hashie/extensions/ruby_version.rb:22
  def initialize(version); end

  # source://hashie-5.0.0/lib/hashie/extensions/ruby_version.rb:26
  def <=>(other); end

  # Returns the value of attribute segments.
  #
  # source://hashie-5.0.0/lib/hashie/extensions/ruby_version.rb:20
  def segments; end
  ...
  # source://hashie-5.0.0/lib/hashie/extensions/ruby_version.rb:53
  def split_to_segments(version); end
end

# source://hashie-5.0.0/lib/hashie/extensions/ruby_version_check.rb:5
module Hashie::Extensions::RubyVersionCheck
  ...
  class << self
    # @private
    #
    # source://hashie-5.0.0/lib/hashie/extensions/ruby_version_check.rb:6
    def included(base); end
  end
end

# source://hashie-5.0.0/lib/hashie/extensions/ruby_version_check.rb:10
module Hashie::Extensions::RubyVersionCheck::ClassMethods
  # source://hashie-5.0.0/lib/hashie/extensions/ruby_version_check.rb:11
  def with_minimum_ruby(version); end

  # @return [Boolean]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/ruby_version_check.rb:15
  def with_minimum_ruby?(version); end
end
...
#
# source://hashie-5.0.0/lib/hashie/extensions/strict_key_access.rb:22
module Hashie::Extensions::StrictKeyAccess
  ...
  #
  # source://hashie-5.0.0/lib/hashie/extensions/strict_key_access.rb:48
  def [](key); end

  # @raise [DefaultError]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/strict_key_access.rb:52
  def default(_ = T.unsafe(nil)); end

  # @raise [DefaultError]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/strict_key_access.rb:56
  def default=(_); end

  # @raise [DefaultError]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/strict_key_access.rb:60
  def default_proc; end

  # @raise [DefaultError]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/strict_key_access.rb:64
  def default_proc=(_); end

  # source://hashie-5.0.0/lib/hashie/extensions/strict_key_access.rb:68
  def key(value); end
end

# source://hashie-5.0.0/lib/hashie/extensions/strict_key_access.rb:23
class Hashie::Extensions::StrictKeyAccess::DefaultError < ::StandardError
  # @return [DefaultError] a new instance of DefaultError
  #
  # source://hashie-5.0.0/lib/hashie/extensions/strict_key_access.rb:24
  def initialize; end
end

# source://hashie-5.0.0/lib/hashie/extensions/stringify_keys.rb:3
module Hashie::Extensions::StringifyKeys
  ...
  # to strings.
  #
  # source://hashie-5.0.0/lib/hashie/extensions/stringify_keys.rb:17
  ...
  #   test # => {'abc' => 'def'}
  #
  # source://hashie-5.0.0/lib/hashie/extensions/stringify_keys.rb:10
  def stringify_keys!; end
end

# source://hashie-5.0.0/lib/hashie/extensions/stringify_keys.rb:21
module Hashie::Extensions::StringifyKeys::ClassMethods
  ...
  # @param hash [::Hash]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/stringify_keys.rb:57
  ...
  # @param hash [::Hash]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/stringify_keys.rb:45
  def stringify_keys!(hash); end
  ...
  # @api private
  #
  # source://hashie-5.0.0/lib/hashie/extensions/stringify_keys.rb:25
  def stringify_keys_recursively!(object); end
end

# source://hashie-5.0.0/lib/hashie/extensions/symbolize_keys.rb:3
module Hashie::Extensions::SymbolizeKeys
  ...
  # to symbols.
  #
  # source://hashie-5.0.0/lib/hashie/extensions/symbolize_keys.rb:17
  ...
  #   test # => {:abc => 'def'}
  #
  # source://hashie-5.0.0/lib/hashie/extensions/symbolize_keys.rb:10
  def symbolize_keys!; end
end

# source://hashie-5.0.0/lib/hashie/extensions/symbolize_keys.rb:21
module Hashie::Extensions::SymbolizeKeys::ClassMethods
  ...
  # @param hash [::Hash]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/symbolize_keys.rb:57
  ...
  # @param hash [Hash]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/symbolize_keys.rb:45
  def symbolize_keys!(hash); end
  ...
  # @api private
  #
  # source://hashie-5.0.0/lib/hashie/extensions/symbolize_keys.rb:25
  ...
  # @return [Symbol, K]
  #
  # source://hashie-5.0.0/lib/hashie/extensions/symbolize_keys.rb:72
  def convert_key(key); end
end
...
#
# source://hashie-5.0.0/lib/hashie/hash.rb:8
class Hashie::Hash < ::Hash
  ...
  #
  # source://hashie-5.0.0/lib/hashie/hash.rb:18
  def to_hash(options = T.unsafe(nil)); end

  # The C generator for the json gem doesn't like mashies
  #
  # source://hashie-5.0.0/lib/hashie/hash.rb:42
  def to_json(*args); end

  # Convert this hash into a Mash
  #
  # source://hashie-5.0.0/lib/hashie/hash.rb:13
  def to_mash; end

  private

  # source://hashie-5.0.0/lib/hashie/hash.rb:54
  def flexibly_convert_to_hash(object, options = T.unsafe(nil)); end

  # source://hashie-5.0.0/lib/hashie/hash.rb:48
...
#   mash.author # => <Mash>
#
# source://hashie-5.0.0/lib/hashie/mash.rb:64
class Hashie::Mash < ::Hashie::Hash
  ...
  # source://hashie-5.0.0/lib/hashie/mash.rb:355
  def except(*keys); end
...
# source://hashie-5.0.0/lib/hashie/railtie.rb:6
...
#
# source://hashie-5.0.0/lib/hashie/rash.rb:23
class Hashie::Rash
  # @return [Rash] a new instance of Rash
  #
  # source://hashie-5.0.0/lib/hashie/rash.rb:26
  def initialize(initial = T.unsafe(nil)); end

  # Return the first thing that matches the key.
  #
  # source://hashie-5.0.0/lib/hashie/rash.rb:59
  def [](key); end

  # source://hashie-5.0.0/lib/hashie/rash.rb:45
  def []=(key, value); end

  # Return everything that matches the query.
  #
  # source://hashie-5.0.0/lib/hashie/rash.rb:88
  def all(query); end
  ...
  # @raise [ArgumentError]
  #
  # source://hashie-5.0.0/lib/hashie/rash.rb:66
  def fetch(*args); end

  # source://hashie-5.0.0/lib/hashie/rash.rb:127
  def method_missing(*args, &block); end

  # Returns the value of attribute optimize_every.
  #
  # source://hashie-5.0.0/lib/hashie/rash.rb:24
  ...
  # source://hashie-5.0.0/lib/hashie/rash.rb:37
  def update(other); end

  private

  # source://hashie-5.0.0/lib/hashie/rash.rb:137
  def optimize_if_necessary!; end

  # @return [Boolean]
  #
  # source://hashie-5.0.0/lib/hashie/rash.rb:131
  def respond_to_missing?(method_name, _include_private = T.unsafe(nil)); end
end
...
# in Ruby.
#
# source://hashie-5.0.0/lib/hashie/trash.rb:11
...
#
# source://hashie-5.0.0/lib/hashie/utils.rb:3
module Hashie::Utils
  class << self
    ...
    # @return [Array<Class>]
    #
    # source://hashie-5.0.0/lib/hashie/utils.rb:35
    ...
    # @return [String]
    #
    # source://hashie-5.0.0/lib/hashie/utils.rb:8
    ...
    #
    # source://hashie-5.0.0/lib/hashie/utils.rb:22
