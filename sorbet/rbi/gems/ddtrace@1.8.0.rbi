...
class Datadog::Core::Configuration::Settings
  ...
  #
  # source://ddtrace//lib/datadog/core/configuration/settings.rb#28
  ...
  # source://ddtrace//lib/datadog/core/configuration/settings.rb#324
...
class Datadog::Core::Diagnostics::EnvironmentCollector
  ...
  # Outputs "k1:v1,k2:v2,..."
  #
  # source://ddtrace//lib/datadog/core/diagnostics/environment_logger.rb#281
  def hash_serializer(h); end

  # source://ddtrace//lib/datadog/core/diagnostics/environment_logger.rb#263
  def instrumented_integrations; end

  # Capture all active integration settings into "integrationName_settingName: value" entries.
  #
  # source://ddtrace//lib/datadog/core/diagnostics/environment_logger.rb#268
...
#
# source://ddtrace//lib/datadog/core/diagnostics/health.rb#13
...
# source://ddtrace//lib/datadog/tracing/configuration/ext.rb#83
...
class Datadog::Tracing::Contrib::HTTP::Distributed::Fetcher < ::Datadog::Tracing::Distributed::Fetcher
  ...
  #
  # source://ddtrace//lib/datadog/tracing/contrib/http/distributed/fetcher.rb#17
  def [](name); end
end
...
module Datadog::Tracing::Contrib::HTTP::Instrumentation::InstanceMethods
  ...
  # source://ddtrace//lib/datadog/tracing/contrib/http/instrumentation.rb#104
  ...
  # source://ddtrace//lib/datadog/tracing/contrib/http/instrumentation.rb#108
  ...
  # @return [Boolean]
  #
  # source://ddtrace//lib/datadog/tracing/contrib/http/instrumentation.rb#128
  def analytics_enabled?(request_options); end

  # source://ddtrace//lib/datadog/tracing/contrib/http/instrumentation.rb#132
  def analytics_sample_rate(request_options); end

  # source://ddtrace//lib/datadog/tracing/contrib/http/instrumentation.rb#124
  def datadog_configuration(host = T.unsafe(nil)); end

  # source://ddtrace//lib/datadog/tracing/contrib/http/instrumentation.rb#116
...
module Datadog::Tracing::Contrib::Httpclient::Instrumentation::InstanceMethods
  ...
  # @return [Boolean]
  #
  # source://ddtrace//lib/datadog/tracing/contrib/httpclient/instrumentation.rb#94
  def analytics_enabled?(request_options); end

  # source://ddtrace//lib/datadog/tracing/contrib/httpclient/instrumentation.rb#86
  def annotate_span_with_error!(span, error); end
  ...
  # source://ddtrace//lib/datadog/tracing/contrib/httpclient/instrumentation.rb#90
  def datadog_configuration(host = T.unsafe(nil)); end

  # source://ddtrace//lib/datadog/tracing/contrib/httpclient/instrumentation.rb#98
  def logger; end

  # source://ddtrace//lib/datadog/tracing/contrib/httpclient/instrumentation.rb#108
  def set_analytics_sample_rate(span, request_options); end
...
module Datadog::Tracing::Contrib::Httprb::Instrumentation::InstanceMethods
  ...
  # @return [Boolean]
  #
  # source://ddtrace//lib/datadog/tracing/contrib/httprb/instrumentation.rb#105
  def analytics_enabled?(request_options); end

  # source://ddtrace//lib/datadog/tracing/contrib/httprb/instrumentation.rb#97
  def annotate_span_with_error!(span, error); end
  ...
  # source://ddtrace//lib/datadog/tracing/contrib/httprb/instrumentation.rb#101
  def datadog_configuration(host = T.unsafe(nil)); end

  # source://ddtrace//lib/datadog/tracing/contrib/httprb/instrumentation.rb#109
  def logger; end

  # source://ddtrace//lib/datadog/tracing/contrib/httprb/instrumentation.rb#119
  def set_analytics_sample_rate(span, request_options); end

  # @return [Boolean]
  #
  # source://ddtrace//lib/datadog/tracing/contrib/httprb/instrumentation.rb#113
  def should_skip_distributed_tracing?(client_config); end
end
...
module Datadog::Tracing::Contrib::Pg::Instrumentation::InstanceMethods
  # source://ddtrace//lib/datadog/tracing/contrib/pg/instrumentation.rb#41
  def async_exec(sql, *args); end

  # source://ddtrace//lib/datadog/tracing/contrib/pg/instrumentation.rb#47
  def async_exec_params(sql, params, *args); end

  # source://ddtrace//lib/datadog/tracing/contrib/pg/instrumentation.rb#53
  ...
  # source://ddtrace//lib/datadog/tracing/contrib/pg/instrumentation.rb#59
  def sync_exec(sql, *args); end

  # source://ddtrace//lib/datadog/tracing/contrib/pg/instrumentation.rb#65
  def sync_exec_params(sql, params, *args); end

  # source://ddtrace//lib/datadog/tracing/contrib/pg/instrumentation.rb#71
  ...
  # @return [Boolean]
  #
  # source://ddtrace//lib/datadog/tracing/contrib/pg/instrumentation.rb#139
  def analytics_enabled?; end

  # source://ddtrace//lib/datadog/tracing/contrib/pg/instrumentation.rb#143
  def analytics_sample_rate; end

  # source://ddtrace//lib/datadog/tracing/contrib/pg/instrumentation.rb#110
  def annotate_span_with_query!(span, service); end

  # source://ddtrace//lib/datadog/tracing/contrib/pg/instrumentation.rb#131
  def annotate_span_with_result!(span, result); end

  # source://ddtrace//lib/datadog/tracing/contrib/pg/instrumentation.rb#147
  def comment_propagation; end

  # source://ddtrace//lib/datadog/tracing/contrib/pg/instrumentation.rb#135
  def datadog_configuration; end

  # source://ddtrace//lib/datadog/tracing/contrib/pg/instrumentation.rb#79
  def trace(name, sql: T.unsafe(nil), statement_name: T.unsafe(nil)); end
end
...
class Datadog::Tracing::Distributed::TraceContext
  ...
  #
  # source://ddtrace//lib/datadog/tracing/distributed/trace_context.rb#121
  def build_trace_flags(digest); end

  # @see https://www.w3.org/TR/trace-context/#traceparent-header
  #
  # source://ddtrace//lib/datadog/tracing/distributed/trace_context.rb#93
  ...
  #
  # source://ddtrace//lib/datadog/tracing/distributed/trace_context.rb#116
  def build_traceparent_string(trace_id, parent_id, trace_flags); end

  # @see https://www.w3.org/TR/trace-context/#tracestate-header
  #
  # source://ddtrace//lib/datadog/tracing/distributed/trace_context.rb#136
  def build_tracestate(digest); end

  # Restore `:` back to `=`.
  #
  # source://ddtrace//lib/datadog/tracing/distributed/trace_context.rb#309
  def deserialize_tag_value(value); end

  # source://ddtrace//lib/datadog/tracing/distributed/trace_context.rb#282
  def extract_datadog_fields(dd_tracestate); end

  # source://ddtrace//lib/datadog/tracing/distributed/trace_context.rb#224
  ...
  #
  # source://ddtrace//lib/datadog/tracing/distributed/trace_context.rb#265
  ...
  #
  # source://ddtrace//lib/datadog/tracing/distributed/trace_context.rb#256
  ...
  #
  # source://ddtrace//lib/datadog/tracing/distributed/trace_context.rb#316
  def parse_priority_sampling(sampled, sampling_priority); end

  # source://ddtrace//lib/datadog/tracing/distributed/trace_context.rb#260
  def parse_sampled_flag(trace_flags); end

  # source://ddtrace//lib/datadog/tracing/distributed/trace_context.rb#236
  ...
  #
  # source://ddtrace//lib/datadog/tracing/distributed/trace_context.rb#182
  ...
  #
  # source://ddtrace//lib/datadog/tracing/distributed/trace_context.rb#209
  def serialize_tag_value(value); end

  # source://ddtrace//lib/datadog/tracing/distributed/trace_context.rb#328
...
#
# source://ddtrace//lib/datadog/tracing/distributed/trace_context.rb#339
...
#
# source://ddtrace//lib/datadog/tracing/distributed/trace_context.rb#354
...
# Additionally, `,` and `=` must also be replaced by `_`.
#
# source://ddtrace//lib/datadog/tracing/distributed/trace_context.rb#359
Datadog::Tracing::Distributed::TraceContext::INVALID_TAG_KEY_CHARS = T.let(T.unsafe(nil), Regexp)

# Replace all characters with `_`, except ASCII characters 0x20-0x7E.
# Additionally, `,`, ':' and `;` must also be replaced by `_`.
#
# source://ddtrace//lib/datadog/tracing/distributed/trace_context.rb#364
...
#
# source://ddtrace//lib/datadog/tracing/distributed/trace_context.rb#334
...
#
# source://ddtrace//lib/datadog/tracing/distributed/trace_context.rb#66
...
#
# source://ddtrace//lib/datadog/tracing/distributed/trace_context.rb#349
...
# @see https://www.w3.org/TR/trace-context/#trace-flags
#
# source://ddtrace//lib/datadog/tracing/distributed/trace_context.rb#344
