...
# source://omniauth-oauth2-1.7.3/lib/omniauth/strategies/oauth2.rb:7
module OmniAuth
  class << self
...
# source://omniauth-oauth2-1.7.3/lib/omniauth/strategies/oauth2.rb:8
...
# OAuth 2.0.
#
# source://omniauth-oauth2-1.7.3/lib/omniauth/strategies/oauth2.rb:14
class OmniAuth::Strategies::OAuth2
  ...
  #
  # source://omniauth-oauth2-1.7.3/lib/omniauth/strategies/oauth2.rb:44
  ...
  # source://omniauth-oauth2-1.7.3/lib/omniauth/strategies/oauth2.rb:62
  def authorize_params; end

  # source://omniauth-oauth2-1.7.3/lib/omniauth/strategies/oauth2.rb:84
  def callback_phase; end

  # source://omniauth-oauth2-1.7.3/lib/omniauth/strategies/oauth2.rb:46
  def client; end

  # source://omniauth-oauth2-1.7.3/lib/omniauth/strategies/oauth2.rb:58
  def request_phase; end

  # source://omniauth-oauth2-1.7.3/lib/omniauth/strategies/oauth2.rb:80
  def token_params; end

  protected

  # source://omniauth-oauth2-1.7.3/lib/omniauth/strategies/oauth2.rb:124
  def build_access_token; end

  # source://omniauth-oauth2-1.7.3/lib/omniauth/strategies/oauth2.rb:129
  def deep_symbolize(options); end

  # source://omniauth-oauth2-1.7.3/lib/omniauth/strategies/oauth2.rb:135
  def options_for(option); end

  # source://omniauth-oauth2-1.7.3/lib/omniauth/strategies/oauth2.rb:105
  def pkce_authorize_params; end

  # source://omniauth-oauth2-1.7.3/lib/omniauth/strategies/oauth2.rb:118
  def pkce_token_params; end

  class << self
    # @private
    #
    # source://omniauth-oauth2-1.7.3/lib/omniauth/strategies/oauth2.rb:17
...
#
# source://omniauth-oauth2-1.7.3/lib/omniauth/strategies/oauth2.rb:149
class OmniAuth::Strategies::OAuth2::CallbackError < ::StandardError
  # @return [CallbackError] a new instance of CallbackError
  #
  # source://omniauth-oauth2-1.7.3/lib/omniauth/strategies/oauth2.rb:152
  def initialize(error, error_reason = T.unsafe(nil), error_uri = T.unsafe(nil)); end

  # Returns the value of attribute error.
  #
  # source://omniauth-oauth2-1.7.3/lib/omniauth/strategies/oauth2.rb:150
  def error; end
  ...
  # source://omniauth-oauth2-1.7.3/lib/omniauth/strategies/oauth2.rb:158
  def message; end
end
