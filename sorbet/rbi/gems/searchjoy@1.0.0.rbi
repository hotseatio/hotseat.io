...
# source://searchjoy-1.0.0/lib/searchjoy/track.rb:1
module Searchjoy
  # source://searchjoy-1.0.0/lib/searchjoy.rb:22
  def conversion_name; end

  # source://searchjoy-1.0.0/lib/searchjoy.rb:22
  def conversion_name=(val); end

  # source://searchjoy-1.0.0/lib/searchjoy.rb:27
  def multiple_conversions; end

  # source://searchjoy-1.0.0/lib/searchjoy.rb:27
  def multiple_conversions=(val); end

  # source://searchjoy-1.0.0/lib/searchjoy.rb:23
  def query_name; end

  # source://searchjoy-1.0.0/lib/searchjoy.rb:23
  def query_name=(val); end

  # source://searchjoy-1.0.0/lib/searchjoy.rb:24
  def query_url; end

  # source://searchjoy-1.0.0/lib/searchjoy.rb:24
  def query_url=(val); end

  # source://searchjoy-1.0.0/lib/searchjoy.rb:12
  def time_zone; end

  # source://searchjoy-1.0.0/lib/searchjoy.rb:18
  ...
  class << self
    # source://searchjoy-1.0.0/lib/searchjoy.rb:30
    def attach_to_searchkick!; end

    # source://searchjoy-1.0.0/lib/searchjoy.rb:36
    ...
    # source://searchjoy-1.0.0/lib/searchjoy.rb:13
...
# source://searchjoy-1.0.0/app/models/searchjoy/conversion.rb:2
...
# source://searchjoy-1.0.0/app/models/searchjoy/conversion.rb:0
...
# source://searchjoy-1.0.0/lib/searchjoy/engine.rb:2
class Searchjoy::Engine < ::Rails::Engine; end

# source://searchjoy-1.0.0/app/models/searchjoy/search.rb:2
class Searchjoy::Search < ::ActiveRecord::Base
  ...
  # source://searchjoy-1.0.0/app/models/searchjoy/search.rb:11
  def convert(convertable = T.unsafe(nil)); end

  # source://searchjoy-1.0.0/app/models/searchjoy/search.rb:38
  def converted?; end
  ...
  # source://searchjoy-1.0.0/app/models/searchjoy/search.rb:44
...
# source://searchjoy-1.0.0/app/models/searchjoy/search.rb:0
...
# source://searchjoy-1.0.0/app/controllers/searchjoy/searches_controller.rb:2
class Searchjoy::SearchesController < ::ActionController::Base
  # source://searchjoy-1.0.0/app/controllers/searchjoy/searches_controller.rb:15
  def index; end

  # source://searchjoy-1.0.0/app/controllers/searchjoy/searches_controller.rb:21
  def overview; end

  # source://searchjoy-1.0.0/app/controllers/searchjoy/searches_controller.rb:49
  def recent; end

  # source://searchjoy-1.0.0/app/controllers/searchjoy/searches_controller.rb:46
  def stream; end

  protected

  # source://searchjoy-1.0.0/app/controllers/searchjoy/searches_controller.rb:65
  def set_search_type; end

  # source://searchjoy-1.0.0/app/controllers/searchjoy/searches_controller.rb:61
  def set_search_types; end

  # source://searchjoy-1.0.0/app/controllers/searchjoy/searches_controller.rb:87
  def set_searches; end

  # source://searchjoy-1.0.0/app/controllers/searchjoy/searches_controller.rb:73
  def set_time_range; end

  # source://searchjoy-1.0.0/app/controllers/searchjoy/searches_controller.rb:69
...
# source://searchjoy-1.0.0/lib/searchjoy/track.rb:2
module Searchjoy::Track; end

# source://searchjoy-1.0.0/lib/searchjoy/track.rb:36
module Searchjoy::Track::MultiSearch
  # source://searchjoy-1.0.0/lib/searchjoy/track.rb:37
  def perform; end
end

# source://searchjoy-1.0.0/lib/searchjoy/track.rb:3
module Searchjoy::Track::Query
  # source://searchjoy-1.0.0/lib/searchjoy/track.rb:25
  def execute; end

  # source://searchjoy-1.0.0/lib/searchjoy/track.rb:31
  def search; end

  # source://searchjoy-1.0.0/lib/searchjoy/track.rb:4
  def track; end
end

# source://searchjoy-1.0.0/lib/searchjoy/version.rb:2
