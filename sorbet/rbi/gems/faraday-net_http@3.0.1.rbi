...
class Faraday::Adapter
  # source://faraday/2.6.0/lib/faraday/adapter.rb#28
  def initialize(_app = T.unsafe(nil), opts = T.unsafe(nil), &block); end

  # source://faraday/2.6.0/lib/faraday/adapter.rb#55
  def call(env); end

  # source://faraday/2.6.0/lib/faraday/adapter.rb#50
  def close; end

  # source://faraday/2.6.0/lib/faraday/adapter.rb#41
  def connection(env); end

  private

  # source://faraday/2.6.0/lib/faraday/adapter.rb#86
  def request_timeout(type, options); end

  # source://faraday/2.6.0/lib/faraday/adapter.rb#62
  def save_response(env, status, body, headers = T.unsafe(nil), reason_phrase = T.unsafe(nil), finished: T.unsafe(nil)); end
end

# source://faraday/2.6.0/lib/faraday/adapter.rb#9
...
# source://faraday/2.6.0/lib/faraday/adapter.rb#94
Faraday::Adapter::TIMEOUT_KEYS = T.let(T.unsafe(nil), Hash)

# source://faraday/2.6.0/lib/faraday.rb#34
Faraday::CONTENT_TYPE = T.let(T.unsafe(nil), String)

# source://faraday/2.6.0/lib/faraday/methods.rb#5
Faraday::METHODS_WITH_BODY = T.let(T.unsafe(nil), Array)

# source://faraday/2.6.0/lib/faraday/methods.rb#4
...
# source://faraday/2.6.0/lib/faraday/version.rb#4
