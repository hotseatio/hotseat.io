...
#   def destroy; end
#
# source://rubocop-rails//lib/rubocop/cop/rails/action_order.rb#34
class RuboCop::Cop::Rails::ActionOrder < ::RuboCop::Cop::Base
  ...
  # source://rubocop-rails//lib/rubocop/cop/rails/action_order.rb#58
  def actions; end

  # source://rubocop-rails//lib/rubocop/cop/rails/action_order.rb#54
  def expected_order; end

  # source://rubocop-rails//lib/rubocop/cop/rails/action_order.rb#62
  def find_index(node); end

  # source://rubocop-rails//lib/rubocop/cop/rails/action_order.rb#66
  def register_offense(previous, current); end
end

# source://rubocop-rails//lib/rubocop/cop/rails/action_order.rb#39
...
class RuboCop::Cop::Rails::DynamicFindBy < ::RuboCop::Cop::Base
  ...
  # @return [Boolean]
  #
  # source://rubocop-rails//lib/rubocop/cop/rails/dynamic_find_by.rb#80
  def allowed_method?(node); end

  # @return [Boolean]
  #
  # source://rubocop-rails//lib/rubocop/cop/rails/dynamic_find_by.rb#86
  def allowed_receiver?(node); end

  # source://rubocop-rails//lib/rubocop/cop/rails/dynamic_find_by.rb#67
  def autocorrect(corrector, node); end

  # source://rubocop-rails//lib/rubocop/cop/rails/dynamic_find_by.rb#104
  ...
  # source://rubocop-rails//lib/rubocop/cop/rails/dynamic_find_by.rb#110
  def column_keywords(method); end

  # Returns static method name.
  # If code isn't wrong, returns nil
  #
  # source://rubocop-rails//lib/rubocop/cop/rails/dynamic_find_by.rb#117
  ...
  # @return [Boolean]
  #
  # source://rubocop-rails//lib/rubocop/cop/rails/dynamic_find_by.rb#93
...
class RuboCop::Cop::Rails::HttpStatus < ::RuboCop::Cop::Base
  ...
  # source://rubocop-rails//lib/rubocop/cop/rails/http_status.rb#48
  def http_status(param0 = T.unsafe(nil)); end

  # source://rubocop-rails//lib/rubocop/cop/rails/http_status.rb#61
  def on_send(node); end
  ...
  # source://rubocop-rails//lib/rubocop/cop/rails/http_status.rb#81
...
class RuboCop::Cop::Rails::HttpStatus::NumericStyleChecker
  ...
  #
  # source://rubocop-rails//lib/rubocop/cop/rails/http_status.rb#134
  def node; end
  ...
  # source://rubocop-rails//lib/rubocop/cop/rails/http_status.rb#148
  ...
  # @return [Boolean]
  #
  # source://rubocop-rails//lib/rubocop/cop/rails/http_status.rb#162
...
# source://rubocop-rails//lib/rubocop/cop/rails/http_status.rb#46
...
class RuboCop::Cop::Rails::HttpStatus::SymbolicStyleChecker
  ...
  # Returns the value of attribute node.
  #
  # source://rubocop-rails//lib/rubocop/cop/rails/http_status.rb#95
  def node; end
  ...
  # source://rubocop-rails//lib/rubocop/cop/rails/http_status.rb#109
  def preferred_style; end
...
class RuboCop::Cop::Style::MethodCallWithArgsParentheses < ::RuboCop::Cop::Base
  # source://rubocop/1.37.0/lib/rubocop/cop/style/method_call_with_args_parentheses.rb#210
  def on_csend(node); end
  ...
  # source://rubocop/1.37.0/lib/rubocop/cop/style/method_call_with_args_parentheses.rb#219
  def args_begin(node); end

  # source://rubocop/1.37.0/lib/rubocop/cop/style/method_call_with_args_parentheses.rb#228
  def args_end(node); end

  # source://rubocop/1.37.0/lib/rubocop/cop/style/method_call_with_args_parentheses.rb#232
...
class RuboCop::Cop::Style::RedundantSelf < ::RuboCop::Cop::Base
  # source://rubocop/1.37.0/lib/rubocop/cop/style/redundant_self.rb#59
  def initialize(config = T.unsafe(nil), options = T.unsafe(nil)); end

  # source://rubocop/1.37.0/lib/rubocop/cop/style/redundant_self.rb#67
  def on_and_asgn(node); end

  # source://rubocop/1.37.0/lib/rubocop/cop/style/redundant_self.rb#85
  def on_args(node); end

  # source://rubocop/1.37.0/lib/rubocop/cop/style/redundant_self.rb#119
  def on_block(node); end

  # source://rubocop/1.37.0/lib/rubocop/cop/style/redundant_self.rb#89
  def on_blockarg(node); end

  # source://rubocop/1.37.0/lib/rubocop/cop/style/redundant_self.rb#80
  def on_def(node); end

  # source://rubocop/1.37.0/lib/rubocop/cop/style/redundant_self.rb#80
  def on_defs(node); end

  # source://rubocop/1.37.0/lib/rubocop/cop/style/redundant_self.rb#125
  def on_if(node); end

  # source://rubocop/1.37.0/lib/rubocop/cop/style/redundant_self.rb#103
  def on_in_pattern(node); end

  # source://rubocop/1.37.0/lib/rubocop/cop/style/redundant_self.rb#98
  def on_lvasgn(node); end

  # source://rubocop/1.37.0/lib/rubocop/cop/style/redundant_self.rb#93
  def on_masgn(node); end

  # source://rubocop/1.37.0/lib/rubocop/cop/style/redundant_self.rb#119
  def on_numblock(node); end

  # source://rubocop/1.37.0/lib/rubocop/cop/style/redundant_self.rb#73
  def on_op_asgn(node); end

  # source://rubocop/1.37.0/lib/rubocop/cop/style/redundant_self.rb#67
  def on_or_asgn(node); end

  # source://rubocop/1.37.0/lib/rubocop/cop/style/redundant_self.rb#107
  def on_send(node); end
  ...
  # source://rubocop/1.37.0/lib/rubocop/cop/style/redundant_self.rb#181
  def add_lhs_to_local_variables_scopes(rhs, lhs); end

  # source://rubocop/1.37.0/lib/rubocop/cop/style/redundant_self.rb#189
  def add_masgn_lhs_variables(rhs, lhs); end

  # source://rubocop/1.37.0/lib/rubocop/cop/style/redundant_self.rb#195
  def add_match_var_scopes(in_pattern_node); end

  # source://rubocop/1.37.0/lib/rubocop/cop/style/redundant_self.rb#143
  def add_scope(node, local_variables = T.unsafe(nil)); end

  # source://rubocop/1.37.0/lib/rubocop/cop/style/redundant_self.rb#175
  def allow_self(node); end

  # source://rubocop/1.37.0/lib/rubocop/cop/style/redundant_self.rb#149
  def allowed_send_node?(node); end

  # source://rubocop/1.37.0/lib/rubocop/cop/style/redundant_self.rb#166
  def on_argument(node); end

  # source://rubocop/1.37.0/lib/rubocop/cop/style/redundant_self.rb#158
...
# source://rubocop/1.37.0/lib/rubocop/cop/style/redundant_self.rb#48
RuboCop::Cop::Style::RedundantSelf::KERNEL_METHODS = T.let(T.unsafe(nil), Array)

# source://rubocop/1.37.0/lib/rubocop/cop/style/redundant_self.rb#49
RuboCop::Cop::Style::RedundantSelf::KEYWORDS = T.let(T.unsafe(nil), Array)

# source://rubocop/1.37.0/lib/rubocop/cop/style/redundant_self.rb#47
