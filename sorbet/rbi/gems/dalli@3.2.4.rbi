...
class Dalli::Protocol::Base
  ...
  # @return [Boolean]
  #
  # source://dalli//lib/dalli/protocol/base.rb#50
  def alive?; end
  ...
  # source://dalli//lib/dalli/protocol/base.rb#58
  def lock!; end

  # @return [Boolean]
  #
  # source://dalli//lib/dalli/protocol/base.rb#141
  def multi?; end
  ...
  # source://dalli//lib/dalli/protocol/base.rb#133
  def password; end
  ...
  # Returns nothing.
  #
  # source://dalli//lib/dalli/protocol/base.rb#112
  ...
  # @return [Boolean]
  #
  # source://dalli//lib/dalli/protocol/base.rb#125
  ...
  #
  # source://dalli//lib/dalli/protocol/base.rb#80
  ...
  # @return [Boolean]
  #
  # source://dalli//lib/dalli/protocol/base.rb#137
  ...
  # source://dalli//lib/dalli/protocol/base.rb#60
  def unlock!; end

  # source://forwardable/1.3.2/forwardable.rb#229
  def up!(*args, **_arg1, &block); end

  # source://dalli//lib/dalli/protocol/base.rb#129
  def username; end
  ...
  # @return [Boolean]
  #
  # source://dalli//lib/dalli/protocol/base.rb#189
  def cache_nils?(opts); end

  # source://dalli//lib/dalli/protocol/base.rb#195
  def connect; end
  ...
  #
  # source://dalli//lib/dalli/protocol/base.rb#161
  def verify_state(opkey); end
end

# source://dalli//lib/dalli/protocol/base.rb#150
...
class Dalli::Protocol::ConnectionManager
  ...
  # source://dalli//lib/dalli/protocol/connection_manager.rb#134
  def abort_request!; end

  # source://dalli//lib/dalli/protocol/connection_manager.rb#105
  def close; end

  # @raise [Dalli::NetworkError]
  #
  # source://dalli//lib/dalli/protocol/connection_manager.rb#221
  def close_on_fork; end

  # source://dalli//lib/dalli/protocol/connection_manager.rb#100
  def confirm_ready!; end

  # @return [Boolean]
  #
  # source://dalli//lib/dalli/protocol/connection_manager.rb#118
  def connected?; end
  ...
  #
  # source://dalli//lib/dalli/protocol/connection_manager.rb#83
  def down!; end

  # source://dalli//lib/dalli/protocol/connection_manager.rb#178
  ...
  # source://dalli//lib/dalli/protocol/connection_manager.rb#130
  def finish_request!; end

  # @return [Boolean]
  #
  # source://dalli//lib/dalli/protocol/connection_manager.rb#230
  ...
  # source://dalli//lib/dalli/protocol/connection_manager.rb#234
  def log_down_detected; end

  # source://dalli//lib/dalli/protocol/connection_manager.rb#246
  def log_up_detected; end

  # source://dalli//lib/dalli/protocol/connection_manager.rb#213
  def log_warn_message(err_or_string); end

  # source://dalli//lib/dalli/protocol/connection_manager.rb#174
  def max_allowed_failures; end

  # source://dalli//lib/dalli/protocol/connection_manager.rb#205
  ...
  # @raise [Dalli::NetworkError]
  #
  # source://dalli//lib/dalli/protocol/connection_manager.rb#92
  def raise_down_error; end

  # source://dalli//lib/dalli/protocol/connection_manager.rb#148
  def read(count); end

  # source://dalli//lib/dalli/protocol/connection_manager.rb#138
  def read_line; end
  ...
  #
  # source://dalli//lib/dalli/protocol/connection_manager.rb#170
  def read_nonblock; end

  # @raise [Dalli::NetworkError]
  #
  # source://dalli//lib/dalli/protocol/connection_manager.rb#191
  def reconnect!(message); end

  # @return [Boolean]
  #
  # source://dalli//lib/dalli/protocol/connection_manager.rb#62
  def reconnect_down_server?; end

  # @return [Boolean]
  #
  # source://dalli//lib/dalli/protocol/connection_manager.rb#122
  def request_in_progress?; end

  # source://dalli//lib/dalli/protocol/connection_manager.rb#197
  ...
  # source://dalli//lib/dalli/protocol/connection_manager.rb#96
  ...
  # source://dalli//lib/dalli/protocol/connection_manager.rb#126
  def start_request!; end

  # source://dalli//lib/dalli/protocol/connection_manager.rb#75
  def up!; end
