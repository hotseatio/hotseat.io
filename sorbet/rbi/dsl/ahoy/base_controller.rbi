...
# This is an autogenerated file for dynamic methods in `Ahoy::BaseController`.
# Please instead update this file by running `bin/tapioca dsl Ahoy::BaseController`.
