  ...
  module CommonRelationMethods
    ...
    sig do
      params(
        ...
        order: Symbol,
        block: T.nilable(T.proc.params(object: ::ActionText::EncryptedRichText).void)
      ).returns(T.nilable(T::Enumerator[::ActionText::EncryptedRichText]))
    end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.nilable(T.proc.params(object: T::Array[::ActionText::EncryptedRichText]).void)
      ).returns(T.nilable(T::Enumerator[T::Enumerator[::ActionText::EncryptedRichText]]))
    end
