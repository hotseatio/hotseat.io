...
# Please instead update this file by running `bin/tapioca dsl Relationship`.
...
class Relationship
  ...
  module GeneratedAssociationMethods
    ...
    sig { params(args: T.untyped, blk: T.untyped).returns(::Review) }
    def create_review(*args, &blk); end
  ...
  module GeneratedAttributeMethods
    ...
    def notify_before_last_save; end

    sig { returns(T.untyped) }
    def notify_before_type_cast; end

    sig { returns(T::Boolean) }
    def notify_came_from_user?; end

    sig { returns(T.nilable([T::Boolean, T::Boolean])) }
    def notify_change; end

    sig { returns(T.nilable([T::Boolean, T::Boolean])) }
    def notify_change_to_be_saved; end

    sig { returns(T::Boolean) }
    def notify_changed?; end

    sig { returns(T.nilable(T::Boolean)) }
    def notify_in_database; end

    sig { returns(T.nilable([T::Boolean, T::Boolean])) }
    def notify_previous_change; end

    sig { returns(T::Boolean) }
    def notify_previously_changed?; end

    sig { returns(T.nilable(T::Boolean)) }
    def notify_previously_was; end

    sig { returns(T.nilable(T::Boolean)) }
    def notify_was; end

    sig { void }
    def notify_will_change!; end
    ...
    sig { returns(T.nilable([T::Boolean, T::Boolean])) }
    def saved_change_to_notify; end
    ...
    sig { returns(T::Boolean) }
    def will_save_change_to_notify?; end
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig do
      params(
        records: T.any(::Relationship, T::Enumerable[T.any(::Relationship, T::Enumerable[::Relationship])])
    ...
    sig do
      params(
        records: T.any(::Relationship, Integer, String, T::Enumerable[T.any(::Relationship, Integer, String, T::Enumerable[::Relationship])])
      ).returns(T::Array[::Relationship])
    end
    ...
    sig do
      params(
        other_array: T.any(::Relationship, T::Enumerable[T.any(::Relationship, T::Enumerable[::Relationship])])
      ).returns(T::Array[::Relationship])
    end
