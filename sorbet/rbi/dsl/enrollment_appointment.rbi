  ...
  module CommonRelationMethods
    ...
    sig do
      params(
        ...
        order: Symbol,
        block: T.nilable(T.proc.params(object: ::EnrollmentAppointment).void)
      ).returns(T.nilable(T::Enumerator[::EnrollmentAppointment]))
    end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.nilable(T.proc.params(object: T::Array[::EnrollmentAppointment]).void)
      ).returns(T.nilable(T::Enumerator[T::Enumerator[::EnrollmentAppointment]]))
    end
    ...
    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(T.nilable(::EnrollmentAppointment)) }
    def find_signed(signed_id, purpose: nil); end

    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(::EnrollmentAppointment) }
    def find_signed!(signed_id, purpose: nil); end
