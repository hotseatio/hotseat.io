...
# Please instead update this file by running `bin/tapioca dsl EnrollmentDatum`.
...
class EnrollmentDatum
  ...
  module CommonRelationMethods
    sig { params(block: T.nilable(T.proc.params(record: ::EnrollmentDatum).returns(T.untyped))).returns(T::Boolean) }
    def any?(&block); end
    ...
    sig do
      params(
        ...
        block: T.nilable(T.proc.params(object: ::EnrollmentDatum).void)
      ).returns(::EnrollmentDatum)
    end
    ...
    sig { returns(T::Array[::EnrollmentDatum]) }
    def destroy_all; end

    sig { params(conditions: T.untyped).returns(T::Boolean) }
    def exists?(conditions = :none); end

    sig { returns(T.nilable(::EnrollmentDatum)) }
    def fifth; end

    sig { returns(::EnrollmentDatum) }
    def fifth!; end

    sig { params(args: T.untyped).returns(T.untyped) }
    def find(*args); end

    sig { params(args: T.untyped).returns(T.nilable(::EnrollmentDatum)) }
    def find_by(*args); end

    sig { params(args: T.untyped).returns(::EnrollmentDatum) }
    def find_by!(*args); end
    ...
    sig do
      params(
        ...
        order: Symbol,
        block: T.nilable(T.proc.params(object: ::EnrollmentDatum).void)
      ).returns(T.nilable(T::Enumerator[::EnrollmentDatum]))
    end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.nilable(T.proc.params(object: T::Array[::EnrollmentDatum]).void)
      ).returns(T.nilable(T::Enumerator[T::Enumerator[::EnrollmentDatum]]))
    end
    ...
    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(T.nilable(::EnrollmentDatum)) }
    def find_signed(signed_id, purpose: nil); end

    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(::EnrollmentDatum) }
    def find_signed!(signed_id, purpose: nil); end

    sig { params(arg: T.untyped, args: T.untyped).returns(::EnrollmentDatum) }
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig do
      params(
        records: T.any(::EnrollmentDatum, T::Enumerable[T.any(::EnrollmentDatum, T::Enumerable[::EnrollmentDatum])])
    ...
    sig do
      params(
        records: T.any(::EnrollmentDatum, Integer, String, T::Enumerable[T.any(::EnrollmentDatum, Integer, String, T::Enumerable[::EnrollmentDatum])])
      ).returns(T::Array[::EnrollmentDatum])
    end
    ...
    sig do
      params(
        other_array: T.any(::EnrollmentDatum, T::Enumerable[T.any(::EnrollmentDatum, T::Enumerable[::EnrollmentDatum])])
      ).returns(T::Array[::EnrollmentDatum])
    end
