...
# This is an autogenerated file for dynamic methods in `Blazer::DashboardsController`.
# Please instead update this file by running `bin/tapioca dsl Blazer::DashboardsController`.
