...
# This is an autogenerated file for dynamic methods in `Blazer::UploadsController`.
# Please instead update this file by running `bin/tapioca dsl Blazer::UploadsController`.

class Blazer::UploadsController
