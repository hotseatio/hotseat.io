...
# This is an autogenerated file for dynamic methods in `Blazer::ChecksController`.
# Please instead update this file by running `bin/tapioca dsl Blazer::ChecksController`.
