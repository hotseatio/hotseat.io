...
class NotifyOnNewReviewJob
  sig { params(review: Review, edit: T::Boolean).returns(NotifyOnNewReviewJob) }
  def self.perform_later(review, edit: false); end

  sig { params(review: Review, edit: T::Boolean).returns(NotifyOnNewReviewJob) }
  def self.perform_now(review, edit: false); end
