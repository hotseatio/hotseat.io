...
module ActionController::Helpers
  sig { returns(T.all(ApplicationHelper, ColorHelper, CourseHelper, InstructorHelper, ReviewHelper, SectionHelper, SubjectAreaHelper, TermHelper, UserHelper, Pay::ApplicationHelper, DeviseHelper)) }
  def helpers; end
end
