...
// Default is an OpenTracing-compatible version of the Datadog tracer.
var Default opentracing.Tracer = &opentracer{}

var _ opentracing.Tracer = (*opentracer)(nil)

// opentracer implements opentracing.Tracer on top of the default ddtrace.Tracer.
...
func (t *opentracer) Inject(ctx opentracing.SpanContext, format interface{}, carrier interface{}) error {
	...
	case opentracing.TextMap, opentracing.HTTPHeaders:
		return tracer.Inject(sctx, carrier)
	default:
		return opentracing.ErrUnsupportedFormat
	}
}
