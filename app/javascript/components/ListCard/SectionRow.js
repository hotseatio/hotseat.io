...
function SectionRow(_a) {
    var _b = _a.section, title = _b.title, instructorCount = _b.instructorCount, instructorLabel = _b.instructorLabel, timeLabel = _b.timeLabel, locationLabel = _b.locationLabel, termLabel = _b.termLabel, badgeLabel = _b.badgeLabel, badgeColor = _b.badgeColor, actionButtons = _a.actionButtons;
    return (<li>
          ...
          <div className="min-w-0 flex-1 sm:flex sm:items-center sm:justify-between">
            <div className="sm:flex-1 min-w-0">
              ...
              <div className="sm:flex sm:space-x-3">
                ...
                {timeLabel && (<p className="flex items-center text-sm text-gray-500 dark:text-gray-400">
                    <outline_1.ClockIcon className="flex-shrink-0 mr-1.5 h-5 w-5 text-gray-400 dark:text-gray-500" aria-hidden="true"/>
                    {timeLabel}
                  </p>)}
                {locationLabel && (<p className="flex items-center text-sm text-gray-500 dark:text-gray-400">
                    <outline_1.MapPinIcon className="flex-shrink-0 mr-1.5 h-5 w-5 text-gray-400 dark:text-gray-500" aria-hidden="true"/>
                    {locationLabel}
                  </p>)}
              </div>
            </div>
